package net.wg.gui.components.ribbon.data
{
   ...
   public class RibbonSettings implements IDisposable
   {
      ...
      protected function atlasInit() : void
      {
         ...
         RIBBON_TYPES_MAP[BATTLE_EFFICIENCY_TYPES.MINEFIELD_ZONE] = new RibbonSettingByType(_loc2_,BATTLEATLAS.RIBBONS_DAMAGE_BY_MINE_FIELD,_loc3_,BATTLEATLAS.RIBBONS_DAMAGE_BY_MINE_FIELD_BLIND,1);
         ...
         RIBBON_TYPES_MAP[BATTLE_EFFICIENCY_TYPES.HE_ROCKET] = new RibbonSettingByType(_loc1_,BATTLEATLAS.RIBBONS_HE_ROCKET,_loc1_,BATTLEATLAS.RIBBONS_HE_ROCKET,1);
         RIBBON_TYPES_MAP[BATTLE_EFFICIENCY_TYPES.RECEIVED_HE_ROCKET] = new RibbonSettingByType(_loc2_,BATTLEATLAS.RIBBONS_HE_ROCKET_ENEMY,_loc3_,BATTLEATLAS.RIBBONS_HE_ROCKET_ENEMY_BLIND,1);
         ...
         DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.LIGHT_TANK_ELITE] = new DamageSourceSetting(BATTLEATLAS.WHITE_ICON_LIGHT_TANK_ELITE16X16);
         DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.MEDIUM_TANK_ELITE] = new DamageSourceSetting(BATTLEATLAS.WHITE_ICON_MEDIUM_TANK_ELITE16X16);
         DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.HEAVY_TANK_ELITE] = new DamageSourceSetting(BATTLEATLAS.WHITE_ICON_HEAVY_TANK_ELITE16X16);
         DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.AT_SPG_ELITE] = new DamageSourceSetting(BATTLEATLAS.WHITE_ICON_AT_SPG_ELITE16X16);
         DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.SPG_ELITE] = new DamageSourceSetting(BATTLEATLAS.WHITE_ICON_SPG_ELITE16X16);
      ...
      private function init() : void
      {
         ...
         if(!_isInit)
         {
            ...
            ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.LIGHT_TANK_ELITE] = -2;
            ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.MEDIUM_TANK] = -1;
            ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.MEDIUM_TANK_ELITE] = -1;
            ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.HEAVY_TANK] = 0;
            ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.HEAVY_TANK_ELITE] = 0;
            ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.AT_SPG] = -1;
            ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.AT_SPG_ELITE] = -1;
            ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.SPG] = -1;
            ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.SPG_ELITE] = -1;
            ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.BOSS] = 0;
            ...
            ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.BUNKER] = 0;
            ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.LIGHT_TANK] = 11;
            ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.LIGHT_TANK_ELITE] = 11;
            ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.MEDIUM_TANK] = 11;
            ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.MEDIUM_TANK_ELITE] = 11;
            ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.HEAVY_TANK] = 11;
            ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.HEAVY_TANK_ELITE] = 11;
            ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.AT_SPG] = 11;
            ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.AT_SPG_ELITE] = 11;
            ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.SPG] = 11;
            ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.SPG_ELITE] = 11;
            ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.BOSS] = 11;
