package net.wg.gui.components.ribbon.data
{
   ...
   public class RibbonSettings implements IDisposable
   {
      ...
      protected function atlasInit() : void
      {
         ...
         RIBBON_TYPES_MAP[BATTLE_EFFICIENCY_TYPES.SUPPLY_DESTRUCTION] = new RibbonSettingByType(_loc1_,BATTLEATLAS.RIBBONS_SUPPLY_KILL,_loc1_,BATTLEATLAS.RIBBONS_SUPPLY_KILL,2);
         ...
         DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.PILLBOX] = new DamageSourceSetting(BATTLEATLAS.WHITE_ICON_PILLBOX16X16);
         DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.MORTAR] = new DamageSourceSetting(BATTLEATLAS.WHITE_ICON_MORTAR16X16);
         DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.FLAMER] = new DamageSourceSetting(BATTLEATLAS.WHITE_ICON_FLAMER16X16);
         DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.AIRSHIP] = new DamageSourceSetting(BATTLEATLAS.WHITE_ICON_AIRSHIP16X16);
      ...
      private function init() : void
      {
         ...
         if(!_isInit)
         {
            ...
            ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.PILLBOX] = -2;
            ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.MORTAR] = -2;
            ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.FLAMER] = -2;
            ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.AIRSHIP] = -2;
            ...
            ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.PILLBOX] = 11;
            ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.MORTAR] = 11;
            ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.FLAMER] = 11;
            ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.AIRSHIP] = 11;
