package net.wg.gui.components.carousels
{
   ...
   public class HorizontalScroller extends TwoWayDirectionScroller implements IScroller
   {
      ...
      override protected function layoutChildren() : void
      {
         ...
         if(scrollbarRef != null && dataProvider != null && isInvalidTypes(InvalidationType.DATA,InvalidationType.SIZE,INVALIDATION_TYPE_SCROLLBAR))
         {
      ...
      override protected function draw() : void
      {
         ...
         super.draw();
         if(dataProvider != null && isInvalidTypes(InvalidationType.SIZE,InvalidationType.DATA,INVALIDATION_TYPE_LAYOUT,INVALIDATION_TYPE_PENDING_SCROLL))
         {
