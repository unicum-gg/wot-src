package
{
   public class PO_FILES
   {
      ...
      public static const TEXT_LOOTBOX_FRACTAL_CN:String = "../text/lootbox_fractal_cn.po";
      ...
      public static const TEXT_LOOTBOX_RETRO:String = "../text/lootbox_retro.po";
