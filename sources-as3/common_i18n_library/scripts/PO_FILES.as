package
{
   public class PO_FILES
   {
      ...
      public static const TEXT_BLACK_MARKET:String = "../text/black_market.po";
      ...
      public static const TEXT_COLLECTION_MT_BIRTHDAY2023:String = "../text/collection_mt_birthday2023.po";
      
      public static const TEXT_COLLECTIVE_GOAL:String = "../text/collective_goal.po";
      
      public static const TEXT_COMMON:String = "../text/common.po";
      
      public static const TEXT_COMP7:String = "../text/comp7.po";
      ...
      public static const TEXT_CUSTOMIZATION:String = "../text/customization.po";
      ...
      public static const TEXT_EARLY_ACCESS:String = "../text/early_access.po";
      ...
      public static const TEXT_INTUNION_TANKMEN:String = "../text/intunion_tankmen.po";
      
      public static const TEXT_INTUNION_VEHICLES:String = "../text/intunion_vehicles.po";
      ...
      public static const TEXT_MINICLIENT:String = "../text/miniclient.po";
      ...
      public static const TEXT_PARAGONS:String = "../text/paragons.po";
      
      public static const TEXT_PERSONAL_MISSIONS:String = "../text/personal_missions.po";
      
      public static const TEXT_PERSONAL_MISSIONS_3:String = "../text/personal_missions_3.po";
      ...
      public static const TEXT_PM_ANNOUNCE:String = "../text/pm_announce.po";
      ...
      public static const TEXT_POLL:String = "../text/poll.po";
      ...
      public static const TEXT_PROMO_CODE_REWARD_SCREEN:String = "../text/promo_code_reward_screen.po";
      ...
      public static const TEXT_RESOURCE_WELL:String = "../text/resource_well.po";
      ...
      public static const TEXT_STRONGHOLD:String = "../text/stronghold.po";
      ...
      public static const TEXT_TECHTREE:String = "../text/techtree.po";
      
      public static const TEXT_TELECOM:String = "../text/telecom.po";
      ...
      public static const ALL_ENUM:Array = [TEXT_ACCOUNT_DASHBOARD,TEXT_ACHIEVEMENTS,TEXT_ACHIEVEMENTS_PAGE,TEXT_AOGAS,TEXT_ARENAS,TEXT_ARTEFACTS,TEXT_AWARDS,TEXT_BADGE,TEXT_BAN_REASON,TEXT_BATTLE_HINTS,TEXT_BATTLE_MATTERS,TEXT_BATTLE_PASS,TEXT_BATTLE_RESULTS,TEXT_BATTLE_ROYALE,TEXT_BLACK_MARKET,TEXT_BLUEPRINTS,TEXT_BOOTCAMP,TEXT_CAT,TEXT_CHAT,TEXT_CHINA_TANKMEN,TEXT_CHINA_VEHICLES,TEXT_CLANS,TEXT_COLLECTIONS,TEXT_COLLECTION_BATTLE_PASS_10,TEXT_COLLECTION_BATTLE_PASS_11,TEXT_COLLECTION_BATTLE_PASS_12,TEXT_COLLECTION_MT_BIRTHDAY2023,TEXT_COLLECTIVE_GOAL,TEXT_COMMON,TEXT_COMP7,TEXT_CONTROLS,TEXT_CREW,TEXT_CREW_BOOKS,TEXT_CREW_HELP,TEXT_CREW_OPERATIONS,TEXT_CREW_PERKS,TEXT_CREW_SKINS,TEXT_CREW_WIDGET,TEXT_CURRENCY_RESERVES,TEXT_CUSTOMIZATION,TEXT_CYBERSPORT,TEXT_CZECH_TANKMEN,TEXT_CZECH_VEHICLES,TEXT_DEMOUNT_KIT,TEXT_DEVELOPMENT,TEXT_DIALOGS,TEXT_DOGTAGS,TEXT_EARLY_ACCESS,TEXT_ELITE_WINDOW,TEXT_ENVIRONMENT_TOOLTIPS,TEXT_EPIC_BATTLE,TEXT_ERROR_DLG,TEXT_EVENT,TEXT_EVENT_BOARDS,TEXT_EXCLUDED_MAPS,TEXT_FALLOUT,TEXT_FAQ,TEXT_FORTIFICATIONS,TEXT_FRANCE_TANKMEN,TEXT_FRANCE_VEHICLES,TEXT_GAME_LOADING,TEXT_GB_TANKMEN,TEXT_GB_VEHICLES,TEXT_GERMANY_TANKMEN,TEXT_GERMANY_VEHICLES,TEXT_IGR_VEHICLES,TEXT_INGAME_GUI,TEXT_INGAME_HELP,TEXT_INTUNION_TANKMEN,TEXT_INTUNION_VEHICLES,TEXT_INVITES,TEXT_ITALY_TANKMEN,TEXT_ITALY_VEHICLES,TEXT_ITEM_TYPES,TEXT_JAPAN_TANKMEN,TEXT_JAPAN_VEHICLES,TEXT_LOBBY_HELP,TEXT_LOOTBOXES,TEXT_LORE,TEXT_MANUAL,TEXT_MAPBOX,TEXT_MAPS_TRAINING,TEXT_MARATHON,TEXT_MATCHMAKER,TEXT_MENU,TEXT_MESSENGER,TEXT_MINICLIENT,TEXT_MODE_SELECTOR,TEXT_MOTIVATION_QUESTS,TEXT_MULTINATIONAL_VEHICLES,TEXT_NATIONS,TEXT_OFFERS,TEXT_PARAGONS,TEXT_PERSONAL_MISSIONS,TEXT_PERSONAL_MISSIONS_3,TEXT_PERSONAL_MISSIONS_DETAILS,TEXT_PERSONAL_RESERVES,TEXT_PLATOON,TEXT_PLAYER_SUBSCRIPTIONS,TEXT_PM_ANNOUNCE,TEXT_POINTS_OF_INTEREST,TEXT_POLAND_TANKMEN,TEXT_POLAND_VEHICLES,TEXT_POLL,TEXT_PREBATTLE,TEXT_PREMACC,TEXT_PROFILE,TEXT_PROGRESSIVE_REWARD,TEXT_PROMO_CODE_REWARD_SCREEN,TEXT_QUESTS,TEXT_RANKED_BATTLES,TEXT_READABLE_KEY_NAMES,TEXT_RECERTIFICATION_FORM,TEXT_RESOURCE_WELL,TEXT_SELECTABLE_REWARD,TEXT_SENIORITY_AWARDS,TEXT_SESSION_STATS,TEXT_SETTINGS,TEXT_STORAGE,TEXT_STORE,TEXT_STRONGHOLD,TEXT_SUBSCRIPTION,TEXT_SWEDEN_TANKMEN,TEXT_SWEDEN_VEHICLES,TEXT_SYSTEM_MESSAGES,TEXT_TANK_CAROUSEL_FILTER,TEXT_TANK_SETUP,TEXT_TECHTREE,TEXT_TELECOM,TEXT_TIPS,TEXT_TOOLTIPS,TEXT_TUTORIAL,TEXT_USA_TANKMEN,TEXT_USA_VEHICLES,TEXT_USSR_TANKMEN,TEXT_USSR_VEHICLES,TEXT_VEHICLE_CUSTOMIZATION,TEXT_VEHICLE_CUSTOMIZATION_CN,TEXT_VEHICLE_PREVIEW,TEXT_VEH_COMPARE,TEXT_VEH_POST_PROGRESSION,TEXT_W2C,TEXT_WAITING];
