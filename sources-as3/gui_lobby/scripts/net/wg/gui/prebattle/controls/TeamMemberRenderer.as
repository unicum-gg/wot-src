package net.wg.gui.prebattle.controls
{
   ...
   public class TeamMemberRenderer extends TeamMemberRendererBase
   {
      ...
      private static const TEXT_FIELD_WIDTH:uint = 60;
      ...
      override protected function updateAfterStateChange() : void
      {
         ...
         this.updateValidVehicleState(vehicleLevelField.text != null && this.visible);
         ...
         this.boosterIcon.scaleX = 1 / scaleX;
         this.boosterIcon.scaleY = 1 / scaleY;
      }
      ...
      private function updateNicknamePosX() : void
      {
         ...
         {
            this.boosterIcon.x = textField.x + TEXT_FIELD_WIDTH;
         }
      }
