package net.wg.gui.lobby.vehiclePreview.bottomPanel
{
   ...
   import net.wg.infrastructure.base.meta.impl.VehiclePreviewBottomPanelMeta;
   ...
   public class VPBottomPanel extends VehiclePreviewBottomPanelMeta implements IVehiclePreviewBottomPanelMeta, IStageSizeDependComponent, IVPBottomPanel
   {
      ...
      private function updatePanelData() : void
      {
         ...
         if(this._data)
         {
            ...
            if(StringUtils.isNotEmpty(this._data.customOffer))
            {
               ...
               this.discountValueOverlay.visible = true;
      ...
      private function updatePanelSize() : void
      {
         ...
         if(this._data.isBuyingAvailable)
         {
            ...
            else if(this.customOfferLabelTF.visible)
            {
               ...
               if(this.discountValueOverlay.visible)
               {
                  this.discountValueOverlay.x = this.customOfferLabelTF.x + this.customOfferLabelTF.width - (this.discountValueOverlay.width >> 1) - DISCOUNT_OVERLAY_OFFSET | 0;
                  this.discountValueOverlay.y = this.customOfferLabelTF.y - (this.discountValueOverlay.height - this.customOfferLabelTF.height >> 1);
               }
