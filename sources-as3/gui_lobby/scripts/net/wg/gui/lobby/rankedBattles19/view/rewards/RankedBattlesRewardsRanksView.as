package net.wg.gui.lobby.rankedBattles19.view.rewards
{
   ...
   public class RankedBattlesRewardsRanksView extends RankedBattlesRewardsRanksMeta implements IRankedBattlesRewardsRanksMeta, IStageSizeDependComponent
   {
      ...
      override protected function onPopulate() : void
      {
         ...
         registerFlashComponentS(this.qualificationRewards,RANKEDBATTLES_ALIASES.QUALIFICATION_REWARDS_VIEW_ALIAS);
         super.onPopulate();
      }
      ...
      override protected function draw() : void
      {
         ...
         if(this._rewards && isInvalid(INV_REWARDS))
         {
            ...
            {
               this.onContainerCompleteHandler(null);
            }
            invalidateSize();
         }
      ...
      override protected function onDispose() : void
      {
         ...
         if(isFlashComponentRegisteredS(RANKEDBATTLES_ALIASES.QUALIFICATION_REWARDS_VIEW_ALIAS))
         {
            unregisterFlashComponentS(RANKEDBATTLES_ALIASES.QUALIFICATION_REWARDS_VIEW_ALIAS);
         }
