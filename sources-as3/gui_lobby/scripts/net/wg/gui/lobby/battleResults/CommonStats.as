package net.wg.gui.lobby.battleResults
{
   ...
   public class CommonStats extends UIComponentEx implements IViewStackContent, IEmblemLoadedDelegate
   {
      ...
      override protected function onDispose() : void
      {
         ...
         this.efficiencyList.removeEventListener(FinalStatisticEvent.EFFICIENCY_ICON_ROLL_OUT,this.onEfficiencyIconRollOutHandler);
      ...
      override protected function configUI() : void
      {
         ...
         this.arenaNameLbl.alpha = ARENA_LBL_ALPHA;
      ...
      public function update(param1:Object) : void
      {
         ...
         var _loc8_:PrestigeProgressVO = this._data.prestige;
         var _loc9_:int = 0;
         if(this._progressBlocksData)
         {
            this._progressBlocksData.splice(0,this._progressBlocksData.length);
         }
         else
         {
            this._progressBlocksData = [];
         }
         if(_loc8_ && _loc8_.isLvlUp)
         {
            this._progressBlocksData.push(this._data.prestige);
            _loc9_ += 1;
         }
         this._progressBlocksData = this._statsUtilsManager.mergeArrays(this._progressBlocksData,_loc7_);
         if(_loc3_.comp7Rating)
         {
            this._progressBlocksData.push(_loc3_.comp7Rating);
         }
         ...
         _loc10_ = this._data.progressiveReward;
         ...
         if(!_loc12_)
         {
            ...
            this.initProgressReport(_loc9_,_loc7_.length);
      ...
      private function initEfficiencyList(param1:PersonalDataVO) : void
      {
         ...
         this.efficiencyList.addEventListener(FinalStatisticEvent.EFFICIENCY_ICON_ROLL_OUT,this.onEfficiencyIconRollOutHandler);
      ...
      private function onEfficiencyIconRollOutHandler(param1:FinalStatisticEvent) : void
      {
         App.toolTipMgr.hide();
      }
