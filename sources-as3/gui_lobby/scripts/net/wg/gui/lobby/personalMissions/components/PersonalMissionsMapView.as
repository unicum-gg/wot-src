package net.wg.gui.lobby.personalMissions.components
{
   ...
   public class PersonalMissionsMapView extends PersonalMissionsMapViewMeta implements IViewStackContent, IPersonalMissionsMapViewMeta
   {
      ...
      private static const VERTICAL_SHADOWS_Y_COEFF:Number = 2.5;
      ...
      public var topShadow:DisplayObject = null;
      
      public var bottomShadow:DisplayObject = null;
      ...
      private function updateVerticalShadows() : void
      {
         var _loc2_:int = 0;
         var _loc1_:Boolean = scaleY > 1;
         if(_loc1_)
         {
            _loc2_ = width - this.topShadow.width >> 1;
            this.topShadow.x = this.bottomShadow.x = _loc2_;
            this.topShadow.y = height / VERTICAL_SHADOWS_Y_COEFF - this.topShadow.height | 0;
            this.bottomShadow.y = height - (this.topShadow.height + this.topShadow.y) | 0;
         }
         this.topShadow.visible = this.bottomShadow.visible = _loc1_;
      }
