package net.wg.white_tiger.gui.lobby.settings.components
{
   ...
   public class SettingLabel extends UIComponent
   {
      ...
      override protected function initialize() : void
      {
         ...
         this.descriptionTf.text = WHITE_TIGER_LOBBY.SETTINGDISABLED;
      }
      ...
      {
         App.toolTipMgr.showComplex(WHITE_TIGER_LOBBY.SETTINGSDISABLEDNOTIFICATION);
      }
   }
}
