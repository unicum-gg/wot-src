package net.wg.white_tiger.gui.battle.views.whiteTigerStats
{
   ...
   public class WhiteTigerStatsTableItem extends StatsTableItem
   {
      ...
      private var _resurrectTimer:WhiteTigerHunterResurrectTimer = null;
      
      private var _carrierBg:Sprite = null;
      
      private var _isResurrect:Boolean = false;
      
      public function WhiteTigerStatsTableItem(param1:WhiteTigerFullStatsTable, param2:int, param3:int)
      {
