package net.wg.white_tiger.gui.battle.views.hunterRespawn
{
   ...
   import net.wg.white_tiger.infrastructure.base.meta.impl.WhiteTigerHunterRespawnViewMeta;
   
   public class WhiteTigerHunterRespawnView extends WhiteTigerHunterRespawnViewMeta implements IWhiteTigerHunterRespawnViewMeta, IWhiteTigerTimerAnimation
   {
      ...
      public var hint:WhiteTigerHunterRespawnHint = null;
      ...
      private var _applyTimerImmediately:Boolean = false;
      
      public function WhiteTigerHunterRespawnView()
      {
      ...
      override protected function configUI() : void
      {
         ...
         this.titleTF.text = WHITE_TIGER_BATTLE.HUNTERRESPAWN_TIMERTEXT;
      ...
      public function as_updateTimer(param1:Number, param2:Number, param3:Boolean, param4:Number) : void
      {
         this._applyTimerImmediately = param3;
         this._animHelper.setTime(param1,param2,param4,true);
      ...
      public function updateProgress(param1:Number, param2:int) : void
      {
         ...
         this.timerAnim.setTime(_loc3_,this._applyTimerImmediately);
         if(this._lastTimeSecondsLeft != _loc3_)
         {
            this._lastTimeSecondsLeft = _loc3_;
            App.soundMgr.playControlsSnd(SOUND_STATE,WhiteTigerSoundTypes.WT_EVENT_HUNTER_RESPAWN,null);
         }
      }
