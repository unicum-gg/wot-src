package net.wg.white_tiger.gui.battle
{
   ...
   public class WTBattlePage extends BaseBattlePage
   {
      ...
      public var abilityWidget:WTAbilityWidget = null;
      
      public var teamBasesPanelUI:TeamBasesPanel = null;
      
      public var battleLoadingInject:WTBattleLoading = null;
      ...
      override public function updateStage(param1:Number, param2:Number) : void
      {
         ...
         this.battleLoadingInject.setSize(param1,param2);
         ...
         this.abilityWidget.updateStage(param1,param2);
      ...
      override protected function onPopulate() : void
      {
         ...
         registerComponent(this.hunterRespawn,WHITE_TIGER_BATTLE_VIEW_ALIASES.WT_HUNTER_RESPAWN);
         registerComponent(this.bossTeleport,WHITE_TIGER_BATTLE_VIEW_ALIASES.WT_BOSS_TELEPORT);
         registerComponent(this.bossWidget,WHITE_TIGER_BATTLE_VIEW_ALIASES.WT_BOSS_WIDGET);
         registerComponent(this.abilityWidget,WHITE_TIGER_BATTLE_VIEW_ALIASES.WT_ABILITY_WIDGET);
         registerComponent(this.battleLoadingInject,BATTLE_VIEW_ALIASES.BATTLE_LOADING);
         this.updateWTProgressPosition();
         super.onPopulate();
      }
      ...
      override protected function setComponentsVisibility(param1:Vector.<String>, param2:Vector.<String>) : void
      {
         ...
         {
            if(_loc3_ == WHITE_TIGER_BATTLE_VIEW_ALIASES.WT_HUNTER_RESPAWN || _loc3_ == WHITE_TIGER_BATTLE_VIEW_ALIASES.WT_BOSS_TELEPORT)
            {
      ...
      override protected function getAllowedMinimapSizeIndex(param1:Number) : Number
      {
         ...
         if(!this.playersPanelEvent.isBoss)
         {
            _loc2_ = App.appHeight - this.playersPanelEvent.y - this.playersPanelEvent.height - MINIMAP_OFFSET | 0;
         }
      ...
      private function setMinimapDeploymentMode(param1:String, param2:Boolean) : void
      {
         ...
         switch(param1)
         {
            case WHITE_TIGER_BATTLE_VIEW_ALIASES.WT_HUNTER_RESPAWN:
               _loc3_ = this.hunterRespawn;
               break;
            case WHITE_TIGER_BATTLE_VIEW_ALIASES.WT_BOSS_TELEPORT:
