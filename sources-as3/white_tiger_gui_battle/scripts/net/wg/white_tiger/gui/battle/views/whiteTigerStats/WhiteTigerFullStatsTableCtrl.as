package net.wg.white_tiger.gui.battle.views.whiteTigerStats
{
   ...
   public class WhiteTigerFullStatsTableCtrl extends FullStatsTableCtrl
   {
      
      private static const RIGHT_COLUMN:int = 1;
       
      
      private var _table:WhiteTigerFullStatsTable = null;
      
      public function WhiteTigerFullStatsTableCtrl(param1:WhiteTigerFullStatsTable, param2:StatsBaseMeta)
      {
         this._table = param1;
         super(param1,param2);
      }
      ...
      {
         var _loc3_:WhiteTigerStatsTableItem = this.createPlayerStatsItem(param1,param2);
         var _loc4_:DynamicSquadCtrl = this.createSquadItem(param1,param2);
         _loc4_.addActionHandler(this);
         return new WhiteTigerStatsTableItemHolder(_loc3_,_loc4_,param1 == RIGHT_COLUMN);
      }
      ...
      private function createPlayerStatsItem(param1:int, param2:int) : WhiteTigerStatsTableItem
      {
         return new WhiteTigerStatsTableItem(this._table,param1,param2);
      }
