package net.wg.white_tiger.gui.battle.views.wtBossWidget
{
   ...
   public class BossWidget extends WTBossWidgetMeta implements IWTBossWidgetMeta
   {
      ...
      private static const INVALIDATE_PLASMA_BONUS:uint = InvalidationType.SYSTEM_FLAGS_BORDER << 4;
      ...
      private static const MAX_PLASMA_BONUS:uint = 4;
      ...
      public var plasmaBonus:MovieClip = null;
      ...
      private var _plasmaBonus:uint = 4.294967295E9;
      ...
      {
         super.configUI();
         this.plasmaBonus.visible = false;
      ...
      override protected function draw() : void
      {
         ...
         if(this._data != null)
         {
            ...
            {
               this.eventBossShield.bossType = this._data.bossType;
               this.updateUserProps(this._data);
               this.updateHpData();
               this.updateKills();
               this.updateColorScheme();
               invalidateSize();
               invalidate(INVALIDATE_PLASMA_BONUS);
            }
            ...
            if(this._plasmaBonus != Values.EMPTY_UIID && isInvalid(INVALIDATE_PLASMA_BONUS))
            {
               this.plasmaBonus.visible = true;
               this.plasmaBonus.gotoAndStop(this._plasmaBonus + 1);
            }
         }
      ...
      public function as_setPlasmaBonus(param1:uint) : void
      {
         if(param1 <= MAX_PLASMA_BONUS && this._plasmaBonus != param1)
         {
            this._plasmaBonus = param1;
            invalidate(INVALIDATE_PLASMA_BONUS);
         }
      }
      ...
      public function as_updateDebuff(param1:Number, param2:Number) : void
      {
         ...
         if(_loc4_)
         {
            ...
            if(this._currentDebuffTime > _loc3_)
            {
               ...
               BossWidget.playSound(WT_SOUND_TYPE.WT_EVENT_BOSS_TIME_SHOW);
            }
         }
         else
         {
      ...
      private function updateState() : void
      {
         ...
         {
            playSound(WT_SOUND_TYPE.WT_EVENT_BOSS_PROGRESS_BAR_SHOW);
