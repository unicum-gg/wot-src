package net.wg.white_tiger.gui.battle.views.hunterRespawn
{
   ...
   public class WhiteTigerHunterRespawnHint extends Sprite implements IDisposable
   {
      ...
      public function WhiteTigerHunterRespawnHint()
      {
         ...
         this.hintTF.text = WHITE_TIGER_BATTLE.HUNTERRESPAWN_HINTTEXT;
      }
