package net.wg.white_tiger.gui.battle.views.whiteTigerPlayersPanel.comps
{
   ...
   public class WhiteTigerTimerAnimHelper implements IDisposable
   {
       
      
      private var _animation:IWhiteTigerTimerAnimation = null;
      ...
      public function WhiteTigerTimerAnimHelper(param1:IWhiteTigerTimerAnimation)
      {
         super();
      ...
      {
         this._timeLeft = !!isNaN(param1) ? Number(0) : Number(param1 * Time.MILLISECOND_IN_SECOND);
