package net.wg.white_tiger.gui.battle.views.battleTimer
{
   ...
   import net.wg.white_tiger.infrastructure.base.meta.impl.WhiteTigerBattleTimerMeta;
   import scaleform.clik.motion.Tween;
   
   public class WhiteTigerBattleTimer extends WhiteTigerBattleTimerMeta implements IWhiteTigerBattleTimerMeta, IBattleTimerMeta
   {
      ...
      public var messageContainer:WhiteTigerTextFieldContainer = null;
      ...
      private var _filterAlphaGlowDelta:Number = 0;
      ...
      public function WhiteTigerBattleTimer()
      {
      ...
      private function addMainTextGlitch() : void
      {
         ...
         this._filterAlphaGlowDelta = this._filterCounter < ADD_TIME_GLOW_ALPHA_SHOW ? Number(this._filterCounter / ADD_TIME_GLOW_ALPHA_SHOW) : Number(1);
         var _loc1_:uint = !!this._isBoss ? uint(COLOR_ADD_TIME_MAIN_BOSS) : uint(COLOR_ADD_TIME_MAIN_HUNTER);
         var _loc2_:DropShadowFilter = new DropShadowFilter(0,0,_loc1_,this.easeInSine(this._filterAlphaGlowDelta),ADD_TIME_MAIN_BLUR,ADD_TIME_MAIN_BLUR);
         var _loc3_:DropShadowFilter = new DropShadowFilter(ADD_TIME_GLITCH_DISTANCE * this.easeInSine(this._filterAlphaDistance),0,_loc1_,this.easeInSine(this._filterAlphaDelta),0,0);
         this.minutesTF.filters = [_loc2_,_loc3_];
         this.dots.filters = [_loc2_,_loc3_];
         this.secondsTF.filters = [_loc2_,_loc3_];
         ++this._filterCounter;
         if(this._filterCounter > ADD_TIME_GLITCH_COUNT)
         {
            this.minutesTF.filters = [_loc2_];
            this.dots.filters = [_loc2_];
            this.secondsTF.filters = [_loc2_];
