package net.wg.white_tiger.gui.battle.views.bossTeleportation
{
   ...
   import net.wg.white_tiger.infrastructure.base.meta.impl.WhiteTigerBossTeleportViewMeta;
   
   public class WhiteTigerTeleportView extends WhiteTigerBossTeleportViewMeta implements IWhiteTigerBossTeleportViewMeta
   {
      ...
      public function WhiteTigerTeleportView()
      {
         super();
      }
