package net.wg.white_tiger.gui.battle.views.minimap.entries
{
   ...
   public class WhiteTigerDeploymentPointMinimapEntry extends BattleUIComponent implements ISoundable
   {
      ...
      public static const EVENT_DEPLOYMENT_SELECTED:String = "eventDeploymentSelected";
      ...
      public function WhiteTigerDeploymentPointMinimapEntry()
      {
      ...
      override protected function configUI() : void
      {
         ...
         _loc1_.text = WHITE_TIGER_BATTLE.MINIMAP_RESPAWNENTRY_HINTTEXT;
      ...
      {
         return WhiteTigerSoundTypes.WT_EVENT_DEPLOY_POINT;
      }
      ...
      private function onMouseEventClickHandler(param1:MouseEvent) : void
      {
         ...
         {
            dispatchEvent(new Event(EVENT_DEPLOYMENT_SELECTED,true));
         }
      }
