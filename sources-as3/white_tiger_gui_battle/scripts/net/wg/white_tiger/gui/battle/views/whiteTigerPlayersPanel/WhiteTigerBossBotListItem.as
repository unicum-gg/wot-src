package net.wg.white_tiger.gui.battle.views.whiteTigerPlayersPanel
{
   ...
   public class WhiteTigerBossBotListItem extends BattleUIComponent
   {
      ...
      public function WhiteTigerBossBotListItem()
      {
         super();
      }
      ...
      public function setData(param1:DAAPIWhiteTigerBossBotInfoVO) : void
      {
