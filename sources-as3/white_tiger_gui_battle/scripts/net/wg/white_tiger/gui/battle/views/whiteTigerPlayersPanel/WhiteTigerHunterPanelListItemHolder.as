package net.wg.white_tiger.gui.battle.views.whiteTigerPlayersPanel
{
   ...
   public class WhiteTigerHunterPanelListItemHolder extends BasePlayersListItemHolder
   {
       
      
      private var _isInviteReceived:Boolean = false;
      
      private var _hunterListItem:IHuntersWhiteTigerPanelListItem = null;
      
      public function WhiteTigerHunterPanelListItemHolder(param1:IPlayersPanelListItem)
      {
         super(param1);
         this._hunterListItem = IHuntersWhiteTigerPanelListItem(param1);
      }
      ...
      public function setPlasmaForVehicle(param1:int) : void
      {
         this._hunterListItem.setPlasma(param1);
      }
