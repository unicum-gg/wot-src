package net.wg.white_tiger.gui.battle.views.wtPlayersPanel
{
   ...
   public class BossBotList extends BattleUIComponent
   {
      ...
      private static const CONTAINER_Y:int = 26;
      
      private static const LIST_ITEM_HEIGHT:int = 26;
      
      private static const LIST_ITEMS_MIN_COUNT:uint = 4;
      ...
      private var _listItemsCount:int = 4;
      ...
      public function BossBotList()
      {
         ...
         this._rendererContainer.y = CONTAINER_Y;
      ...
      override public function get height() : Number
      {
         if(this._listItems)
         {
            this._listItemsCount = Math.max(this._listItems.length,this._listItemsCount);
         }
         return this._listItemsCount * LIST_ITEM_HEIGHT + CONTAINER_Y;
      }
