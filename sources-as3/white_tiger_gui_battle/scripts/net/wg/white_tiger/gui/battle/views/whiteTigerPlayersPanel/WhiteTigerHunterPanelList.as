package net.wg.white_tiger.gui.battle.views.whiteTigerPlayersPanel
{
   ...
   public class WhiteTigerHunterPanelList extends BasePlayersPanelList
   {
      ...
      public function WhiteTigerHunterPanelList()
      {
         super();
      }
      ...
      {
         return WhiteTigerHunterPanelListItemHolder;
      }
      ...
      public function setPlasmaValues(param1:Number, param2:int) : void
      {
         var _loc3_:IPlayersPanelListItemHolder = getHolderByVehicleID(param1);
         if(!_loc3_)
         {
         ...
         var _loc4_:* = _loc3_ as WhiteTigerHunterPanelListItemHolder;
         if(_loc4_)
         {
            _loc4_.setPlasmaForVehicle(param2);
         }
         else
         {
            DebugUtils.LOG_WARNING("Incorrect type was assigned as IPlayersPanelListItemHolder, " + "expected WhiteTigerHunterPanelListItemHolder, actual " + typeof _loc3_);
         }
      }
   }
}
