package net.wg.white_tiger.gui.battle.views.staticMarkers
{
   ...
   public class WhiteTigerIndexedMarker extends LocationMarker
   {
       
      
      public function WhiteTigerIndexedMarker()
      {
         super();
      }
      ...
      {
         var _loc2_:WhiteTigerIndexedActionMarker = marker as WhiteTigerIndexedActionMarker;
         if(_loc2_)
         {
            _loc2_.setIsColorBlind(param1);
         }
      }
      ...
      {
         var _loc1_:WhiteTigerIndexedActionMarker = marker as WhiteTigerIndexedActionMarker;
         if(_loc1_)
         {
