package net.wg.white_tiger.gui.battle.views.whiteTigerPlayersPanel
{
   ...
   public class WhiteTigerHunterPanelListItem extends PlayersPanelListItem implements IHuntersWhiteTigerPanelListItem
   {
      ...
      private static const SQUAD_ITEMS_AREA_WIDTH:int = 32;
      ...
      public var resurrectTimer:WhiteTigerHunterResurrectTimer = null;
      
      public var healthBar:WhiteTigerBotHealthBar = null;
      ...
      public function WhiteTigerHunterPanelListItem()
      {
         super();
         this.resurrectTimer.visible = false;
         chatCommandState.visible = false;
         maxPlayerNameWidth = (!!isRightAligned ? WIDTH_RIGHT : WIDTH_LEFT) - ICONS_AREA_WIDTH - fragsTF.width - SQUAD_ITEMS_AREA_WIDTH;
      }
      ...
      {
         bg.imageName = BATTLEATLAS.WHITE_TIGER_PLAYERS_PANEL_BG;
         deadBg.imageName = BATTLEATLAS.WHITE_TIGER_PLAYERS_PANEL_DEAD_BG;
      ...
      override protected function updateColors() : void
      {
         ...
         vehicleIcon.filters = null;
         playerNameFullTF.filters = playerNameCutTF.filters = fragsTF.filters = null;
         var _loc1_:Boolean = getIsCurrentPlayer();
      ...
      private function updateSelfState() : void
      {
