package net.wg.white_tiger.gui.battle.views.shared
{
   ...
   public class WhiteTigerDeploymentMapView extends BattleDisplayable
   {
      ...
      public function WhiteTigerDeploymentMapView()
      {
         super();
      }
      ...
      {
         this.minimap = param1;
         this.minimap.addEventListener(WhiteTigerDeploymentPointMinimapEntry.EVENT_DEPLOYMENT_SELECTED,this.onMinimapDeploymentSelectedHandler);
      ...
      public function detachMinimap() : void
      {
         if(this.minimap)
         {
            this.minimap.removeEventListener(WhiteTigerDeploymentPointMinimapEntry.EVENT_DEPLOYMENT_SELECTED,this.onMinimapDeploymentSelectedHandler);
            this.minimap = null;
         }
      }
      ...
      {
         var _loc2_:WhiteTigerDeploymentPointMinimapEntry = param1.target as WhiteTigerDeploymentPointMinimapEntry;
         if(_loc2_)
         {
