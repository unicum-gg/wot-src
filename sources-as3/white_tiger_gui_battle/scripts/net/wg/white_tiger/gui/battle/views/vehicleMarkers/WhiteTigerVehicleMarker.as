package net.wg.white_tiger.gui.battle.views.vehicleMarkers
{
   ...
   public class WhiteTigerVehicleMarker extends VehicleMarker
   {
      ...
      override protected function updateCriticalLayout() : void
      {
         ...
         var _loc4_:int = !!_loc3_ ? int((this.plasmaHitDamage.damageLabel as WhiteTigerDamageLabel).plasmaDamage.textWidth + this.plasmaHitDamage.plasmaIcon.width + PLASMA_ICON_RIGHT_OFFSET) : int(0);
