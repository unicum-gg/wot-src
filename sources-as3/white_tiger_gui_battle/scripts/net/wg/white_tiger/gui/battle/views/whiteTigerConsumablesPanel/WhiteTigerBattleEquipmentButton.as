package net.wg.white_tiger.gui.battle.views.whiteTigerConsumablesPanel
{
   ...
   public class WhiteTigerBattleEquipmentButton extends BattleEquipmentButton implements IWhiteTigerConsumablesButton
   {
      ...
      public var activeGlow:WhiteTigerBattleEquipmentActiveGlow = null;
      ...
      public function WhiteTigerBattleEquipmentButton()
      {
         super();
      ...
      {
         (glow as WhiteTigerBattleEquipmentButtonGlow).glowBlue();
      ...
      override public function set activated(param1:Boolean) : void
      {
         ...
         (glow as WhiteTigerBattleEquipmentButtonGlow).hideText();
      ...
      override public function setCoolDownTime(param1:Number, param2:Number, param3:Number, param4:int = 1) : void
      {
         ...
         if((_loc5_ == WHITE_TIGER_CONSUMABLES_PANEL_TAGS.BUILTIN_ITEM || _loc5_ == WHITE_TIGER_CONSUMABLES_PANEL_TAGS.TRIGGER_ITEM) && param1 > 0 && this._stage == EQUIPMENT_STAGES_ACTIVE)
         {
            this.activeGlow.hideGlow();
         ...
         if(_loc5_ == WHITE_TIGER_CONSUMABLES_PANEL_TAGS.BUILTIN_ITEM || _loc5_ == WHITE_TIGER_CONSUMABLES_PANEL_TAGS.TRIGGER_ITEM)
         {
            if(param1 <= 0)
            {
               (glow as WhiteTigerBattleEquipmentButtonGlow).glowBlue();
      ...
      override public function set empty(param1:Boolean) : void
      {
         ...
         if(consumablesVO.tag == WHITE_TIGER_CONSUMABLES_PANEL_TAGS.TRIGGER_ITEM || consumablesVO.tag == WHITE_TIGER_CONSUMABLES_PANEL_TAGS.BUILTIN_ITEM)
         {
      ...
      {
         (glow as WhiteTigerBattleEquipmentButtonGlow).hideOnTimeout();
      }
