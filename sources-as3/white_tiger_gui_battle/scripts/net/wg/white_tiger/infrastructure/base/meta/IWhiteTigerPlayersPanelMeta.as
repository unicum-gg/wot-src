package net.wg.white_tiger.infrastructure.base.meta
{
   ...
   public interface IWhiteTigerPlayersPanelMeta extends IEventDispatcher
   {
      ...
      function as_setPlasmaForVehicles(param1:Number, param2:int) : void;
