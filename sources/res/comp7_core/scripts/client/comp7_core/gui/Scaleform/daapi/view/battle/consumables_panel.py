...
from comp7_core.gui.shared.tooltips.comp7_core_tooltips import getRoleEquipmentTooltipParts, getPoIEquipmentDescription
...
class Comp7CoreConsumablesPanel(ConsumablesPanel):
    ...
    def __init__(self):
        super(Comp7CoreConsumablesPanel, self).__init__()
    ...
    def _populate(self):
        super(Comp7CoreConsumablesPanel, self)._populate()
    ...
    def _dispose(self):
        ...
        super(Comp7CoreConsumablesPanel, self)._dispose()
    ...
    def _onEquipmentAdded(self, intCD, item):
        if self.__isRoleEquipment(item):
            ...
            super(Comp7CoreConsumablesPanel, self)._onEquipmentAdded(intCD, item)
    ...
    def _updateEquipmentGlow(self, idx, item):
        if self.__isRoleEquipment(item) or self.__isPoiEquipment(item):
            ...
            super(Comp7CoreConsumablesPanel, self)._updateEquipmentGlow(idx, item)
    ...
    @staticmethod
    def __buildPoIEquipmentTooltipText(item, modeController):
        equipment = item.getDescriptor()
        description = getPoIEquipmentDescription(equipment, modeController)
