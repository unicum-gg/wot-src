...
def getBattleStateComponent():
    ...
    if arena and arena.arenaInfo:
        return arena.arenaInfo.dynamicComponents.get('wtBattleStateComponent')
    else:
        return
...
def getPlasmaBonusComponent():
    arena = avatar_getter.getArena()
    if arena and arena.arenaInfo:
        return arena.arenaInfo.dynamicComponents.get('wtPlasmaBonusComponent')
    else:
        return
...
def getPlayerLives():
    ...
    if playerVehicle and 'VehicleLivesComponent' in playerVehicle.dynamicComponents:
