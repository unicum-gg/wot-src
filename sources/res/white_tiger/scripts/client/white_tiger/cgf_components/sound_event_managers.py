...
class WTShieldSoundSystem(CGF.System):
    ...
    _PLAYER_BOSS_SHIELD_ADDED = {False: 'wt23_w_vo_shield_restored', True: 'wt23_w_vo_shield_restored_eos_one'}
...
class WTGeneratorCaptureSoundSystem(CGF.System, CallbackDelayer):
    ...
    _PLAYER_HUNTER_LAST_GENERATOR_DESTROYED = {False: 'wt23_hunters_vo_last_generator_destroyed', True: 'wt23_hunters_vo_last_generator_destroyed_player_is_capturer'}
    _PLAYER_HUNTER_GENERATOR_DESTROYED = {False: 'wt23_hunters_vo_shield_destroyed', True: 'wt23_hunters_vo_shield_destroyed_player_is_capturer'}
    _PLAYER_BOSS_GENERATOR_BLOCKED = 'wt_w_vo_generator_blocked'
    _PLAYER_BOSS_GENERATOR_DESTROYED = {False: 'wt23_w_vo_shield_destroyed', True: 'wt24_w_vo_shield_destroyed_eos_one'}
