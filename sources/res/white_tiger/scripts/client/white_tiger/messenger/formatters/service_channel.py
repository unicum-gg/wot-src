...
class WTBattleResultsFormatter(BattleResultsFormatter):
    ...
    def __fillWTSpecificCtx(self, battleResults, ctx):
        ...
        if team == WT_TEAMS.BOSS_TEAM:
            ...
            completedBattleQuests = {qname:quest for qname, quest in viewitems(battleResults.get('detailedRewards', {})) if 'battle_quest' in qname if 'battle_quest' in qname}
