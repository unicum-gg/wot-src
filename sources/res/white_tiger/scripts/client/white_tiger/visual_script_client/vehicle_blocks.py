...
class GetGameObjectOfVehicle(Block, VehicleMeta):
    ...
    def _exec(self):
        ...
        if vehicle is None:
            ...
            self.components = {'TankRootGameObject': vehicle_composition.VehicleSlots.CHASSIS, 'HullGameObject': vehicle_composition.VehicleSlots.HULL, 
    ...
    def initParams(cls):
        components = ['TankRootGameObject',
         ...
         'GunGameObject']
        return [
         InitParam('GO to get', SLOT_TYPE.STR, buildStrKeysValue(*components), EDITOR_TYPE.STR_KEY_SELECTOR)]
