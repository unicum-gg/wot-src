...
SPECIAL_HARRIER_MISSION_QUEST_PREFIX = 'wtevent:battle_quest:event:harrier_special'
...
def packWTBonus(preFormattedConditionTuple, isSpecialMission=False, decorationIcon=''):
