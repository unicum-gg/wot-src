...
from white_tiger.gui.white_tiger_gui_constants import SPECIAL_QUEST_GROUP_IDS
...
class WTQuestUIDataPacker(DailyQuestUIDataPacker):
    ...
    def _packModel(self, model):
        ...
        model.setIsSpecialMission(self._event.getGroupID() in SPECIAL_QUEST_GROUP_IDS)
