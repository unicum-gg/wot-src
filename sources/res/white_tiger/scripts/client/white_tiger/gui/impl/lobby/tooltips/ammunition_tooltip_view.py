...
from white_tiger.gui.impl.gen.view_models.views.lobby.tooltips.ammunition_panel_tooltip_view_model import AmmunitionPanelTooltipViewModel
...
_ANIMATION_PATH = 'animations/{}.swf'
_COOLDOWN_TEMPLATE = '{}: {} {}'

class AmmunitionTooltipView(ViewImpl):
    __itemsCache = dependency.descriptor(IItemsCache)

    def __init__(self, *args, **kwargs):
        settings = ViewSettings(layoutID=R.views.white_tiger.mono.lobby.tooltips.ammunition_panel_tooltip(), model=AmmunitionPanelTooltipViewModel())
        settings.args = args
        settings.kwargs = kwargs
        super(AmmunitionTooltipView, self).__init__(settings)
    ...
    def _onLoading(self, *args, **kwargs):
        super(AmmunitionTooltipView, self)._onLoading(*args, **kwargs)
        ...
        with self.viewModel.transaction() as (trx):
            ...
            if item.itemTypeID == GUI_ITEM_TYPE.SHELL:
                ...
                trx.setAdditionalInfoText(backport.text(attribs.features()))
