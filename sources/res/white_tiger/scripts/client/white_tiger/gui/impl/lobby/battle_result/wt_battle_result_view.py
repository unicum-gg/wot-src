...
class WtBattleResultView(ViewImpl):
    __slots__ = ('__arenaUniqueID', '__tooltipParametersCreator', '__tooltipContentCreator',
                 '__eventPlugin', '__questBnsTooltipData', '__battleResultData',
                 '__fieldsGetter', '__reusable', '__results')
