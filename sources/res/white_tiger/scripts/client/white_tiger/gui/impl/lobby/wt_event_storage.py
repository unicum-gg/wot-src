...
class WTEventStorageView(WtEventBasePortalsView):
    ...
    def _updateModel(self):
        ...
        with self.viewModel.transaction() as (model):
            ...
            lootBoxesCount = self.__lootBoxesCtrl.getLootBoxesCountByType(WhiteTigerLootBoxes.WT_BOSS)
            ...
            lootBoxesCount = self.__lootBoxesCtrl.getLootBoxesCountByType(WhiteTigerLootBoxes.WT_TANK)
