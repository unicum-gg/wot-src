...
class ProgressionEntryPointView(ViewComponent[HangarProgressionViewModel]):
    ...
    def createToolTipContent(self, event, contentID):
        if contentID == R.views.white_tiger.mono.lobby.tooltips.progression_widget_tooltip():
            return ProgressionWidgetTooltipView()
        return super(ProgressionEntryPointView, self).createToolTipContent(event, contentID)
