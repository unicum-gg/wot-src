...
TeamStats = namedtuple('teamStats', ('expSegments', 'shots', 'damageDealt', 'hitsReceived',
                                     'other', 'time'))
TeamStatsExpSegments = namedtuple('TeamStatsExpSegments', ('total', 'attack', 'assist',
                                                           'role'))
...
TeamStatsHitsReceived = namedtuple('hitsReceived', ('directHitsReceived', 'piercingsReceived',
                                                    'noDamageHitsReceived'))
TeamStatsOther = namedtuple('other', ('explosionHitsReceived', 'damageBlockedByArmor',
                                      'damageToAllies', 'spotted', 'damageToEnemies',
                                      'damageAssisted', 'damageAssistedSelf', 'stunDuration',
                                      'damageAssistedStun', 'damageAssistedStunSelf',
                                      'stunNum', 'baseCapture', 'mileage'))
