...
from white_tiger.gui.impl.gen.view_models.views.lobby.wt_quests_model import WtQuestsModel, QuestsTabType
from gui.impl.gui_decorators import args2params
from gui.server_events.events_helpers import EventInfoModel
from gui.server_events.events_constants import WT_BOSS_GROUP_ID
from white_tiger.gui.impl.lobby.packers.wt_event_quest_data_packer import WTQuestUIDataPacker
...
class WTQuestsView(SubModelPresenter):
    ...
    def __fillQuests(self, quests, visitedArray, tab):
        if tab == QuestsTabType.ENGINEER:
            availableQuests = self.questContainer.getQuests(WT_BOSS_GROUP_ID, allowCompleted=True)
        else:
            availableQuests = []
