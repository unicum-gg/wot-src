...
class WhiteTigerEconomicTooltipViewModel(FinancialDetailsModel):
    __slots__ = ()

    def __init__(self, properties=6, commands=0):
        super(WhiteTigerEconomicTooltipViewModel, self).__init__(properties=properties, commands=commands)
    ...
    def _initialize(self):
        super(WhiteTigerEconomicTooltipViewModel, self)._initialize()
