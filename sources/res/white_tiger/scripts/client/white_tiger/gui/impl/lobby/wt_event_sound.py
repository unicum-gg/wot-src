...
class WTEventVehicleSoundPlayer(object):
    _SOUND_MAPPING = {'ussr:R97_Object_140_hound_TLXXL': (
                                         _SoundComponent,
                                         ('ev_white_tiger_hangar_electric_substance_Ob140', 'SoundObject_Ob140')), 
       'france:F18_Bat_Chatillon25t_hound_TLXXL': (
                                                 _SoundComponent,
                                                 ('ev_white_tiger_hangar_electric_substance_B25t', 'SoundObject_B25t')), 
       'usa:A120_M48A5_hound_TLXXL': (
                                    _SoundComponent,
                                    ('ev_white_tiger_hangar_electric_substance_M48P', 'SoundObject_M48P')), 
       'czech:Cz04_T50_51_Waf_Hound_3DSt': (
                                          _SoundComponent,
                                          ('ev_white_tiger_hangar_electric_substance_TVP', 'SoundObject_TVP')), 
       'germany:G98_Waffentrager_E100_TLXXL': (
                                             _TicketSoundComponent,
                                             ('ev_white_tiger_hangar_electric_substance_wt', 'SoundObject_E100_TLXXL')), 
       'ussr:R232_IS-7G': (
                         _SoundComponent,
                         ('ev_white_tiger_hangar_electric_substance_wt', 'SoundObject_E100_TLXXL_S')), 
       'ussr:R232_IS-7W': (
                         _SoundComponent,
                         ('ev_white_tiger_hangar_electric_substance_is', 'SoundObject_E100_TLXXL_S'))}
