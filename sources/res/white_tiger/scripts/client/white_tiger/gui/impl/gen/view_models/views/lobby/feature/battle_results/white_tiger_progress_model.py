...
class WhiteTigerProgressModel(ViewModel):
    __slots__ = ()

    def __init__(self, properties=13, commands=0):
        super(WhiteTigerProgressModel, self).__init__(properties=properties, commands=commands)
    ...
    def _initialize(self):
        super(WhiteTigerProgressModel, self)._initialize()
