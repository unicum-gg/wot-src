...
class _WhiteTigerConfig(namedtuple('_WhiteTigerConfig', ('isEnabled', 'peripheryIDs', 'primeTimes', 'seasons',
                                 'cycleTimes', 'specialVehicles', 'lootBoxDailyPurchaseLimit',
                                 'lootBoxCounterEntitlementID', 'specialTankmen',
                                 'autoOpenTime', 'eventShowcaseVehicle'))):
    __slots__ = ()
