...
class Sounds(CONST_CONTAINER):
    ...
    FINAL_NARRATIVE_VOICE_ENTER = 'ev_white_tiger_final_narrative_enter'
    FINAL_NARRATIVE_VOICE_EXIT = 'ev_white_tiger_final_narrative_exit'
    FINAL_NARRATIVE_VOICE_START = 'ev_white_tiger_final_narrative_vo_start'
    FINAL_NARRATIVE_VOICE_STOP = 'ev_white_tiger_final_narrative_vo_stop'
