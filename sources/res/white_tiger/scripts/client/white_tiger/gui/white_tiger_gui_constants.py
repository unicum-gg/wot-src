...
WT_QUEST_HUNTER_SPECIAL_ID = WT_QUEST_HUNTER_GROUP_ID + '_special'
MAX_VISIBLE_QUESTS = 4
HUNTER_QUEST_CHAINS = [
 WT_QUEST_HUNTER_GROUP_ID + '_1',
 WT_QUEST_HUNTER_GROUP_ID + '_2',
 WT_QUEST_HUNTER_GROUP_ID + '_3',
