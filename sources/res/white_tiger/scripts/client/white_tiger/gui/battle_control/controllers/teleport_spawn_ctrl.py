...
class TeleportSpawnController(ViewComponentsController, ISpawnController):
    ...
    def __init__(self):
        ...
        self._teleportationInProgress = False
    ...
    def setEquipment(self, equipment):
        self._teleportationInProgress = True
    ...
    @property
    def teleportationInProgress(self):
        return self._teleportationInProgress
    ...
    def updateTeleportationProgress(self):
        self._teleportationInProgress = False
