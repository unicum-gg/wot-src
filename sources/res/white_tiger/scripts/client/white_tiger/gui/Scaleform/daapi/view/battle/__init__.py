...
def getViewSettings():
    ...
    return (
     ViewSettings(white_tiger_gui_constants.VIEW_ALIAS.WHITE_TIGER_BATTLE_PAGE, WhiteTigerBattlePage, getSwfExtensionUrl('white_tiger', 'whiteTigerBattlePage.swf'), WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
...
class _WhiteTigerBattlePackageBusinessHandler(PackageBusinessHandler):
    ...
    def __init__(self):
        listeners = (
         (
          VIEW_ALIAS.WHITE_TIGER_BATTLE_PAGE, self._loadPage),
         (
          white_tiger_gui_constants.VIEW_ALIAS.WHITE_TIGER_SETTINGS_WINDOW, self.loadViewBySharedEvent))
