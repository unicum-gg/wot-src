...
class WTEventPrimeTimeView(PrimeTimeViewBase):
    ...
    def _dispose(self):
        ...
        super(WTEventPrimeTimeView, self)._dispose()
    ...
    def _getServerText(self, serverList, serverInfo, isServerNameShort=False):
        ...
        return backport.text(R.strings.white_tiger.primeTime.servers())
    ...
    def __getStatusTitle(self):
        ...
        if status in (PrimeTimeStatus.FROZEN, PrimeTimeStatus.NOT_SET):
            return text_styles.grandTitle(backport.text(R.strings.white_tiger.primeTime.status.disableFirst(), server=currServerName))
        return text_styles.grandTitle(backport.text(R.strings.white_tiger.primeTime.status.allServersDisabled()))
