...
_CONFIG = ComponentsConfig(config=(
 (
  ...
  (
   WHITE_TIGER_BATTLE_VIEW_ALIASES.WHITE_TIGER_BATTLE_HINT,
 ...
 (
  white_tiger_gui_constants.BATTLE_CTRL_ID.WT_BATTLE_GUI_CTRL,
  (
   WHITE_TIGER_BATTLE_VIEW_ALIASES.WHITE_TIGER_HUNTER_RESPAWN,
   WHITE_TIGER_BATTLE_VIEW_ALIASES.WHITE_TIGER_BOSS_TELEPORT,
   _SoundPlayerAliases.WHITE_TIGER_RESPAWN_SOUND_PLAYER)),
 (
  BATTLE_CTRL_ID.BATTLE_FIELD_CTRL,
  (
   WHITE_TIGER_BATTLE_VIEW_ALIASES.WHITE_TIGER_PLAYERS_PANEL,)),
 (
 ...
 (
  _SoundPlayerAliases.WHITE_TIGER_RESPAWN_SOUND_PLAYER, WTRespawnSoundPlayer),
 (
...
_EXTERNAL_COMPONENTS = (
 WhiteTigerMarkersManager, WhiteTigerCrosshairPanelContainer, KillCamMarkersManager)
...
class WhiteTigerBattlePage(ClassicPage, ISpawnListener):
    ...
    def __onArenaPeriodChange(self, period, *_):
        ...
        if period == ARENA_PERIOD.AFTERBATTLE:
            hiddenComponents = {
             WHITE_TIGER_BATTLE_VIEW_ALIASES.WHITE_TIGER_HUD,
             WHITE_TIGER_BATTLE_VIEW_ALIASES.WHITE_TIGER_BATTLE_HINT}
            self._setComponentsVisibility(hidden=hiddenComponents)

    def __setVisibilityInitBattlePeriod(self):
        visibleComponents = {WHITE_TIGER_BATTLE_VIEW_ALIASES.WHITE_TIGER_PLAYERS_PANEL,
         WHITE_TIGER_BATTLE_VIEW_ALIASES.WHITE_TIGER_HUD}
    ...
    def showSpawnPoints(self):
        ...
        visibleComponents = {
         ...
         WHITE_TIGER_BATTLE_VIEW_ALIASES.WHITE_TIGER_HUD} | self._spawnVisibleComponents
    ...
    def _onRegisterFlashComponent(self, viewPy, alias):
        ...
        if alias in (WHITE_TIGER_BATTLE_VIEW_ALIASES.WHITE_TIGER_BOSS_TELEPORT,
         WHITE_TIGER_BATTLE_VIEW_ALIASES.WHITE_TIGER_HUNTER_RESPAWN):
    ...
    def _spawnViewAlias(self):
        if self._spawnType == SpawnType.TELEPORT:
            return WHITE_TIGER_BATTLE_VIEW_ALIASES.WHITE_TIGER_BOSS_TELEPORT
        return WHITE_TIGER_BATTLE_VIEW_ALIASES.WHITE_TIGER_HUNTER_RESPAWN
    ...
    def _onBattleLoadingFinish(self):
        ...
        if BigWorld.player().arena.period != ARENA_PERIOD.BATTLE:
            self._setComponentsVisibility(hidden={WHITE_TIGER_BATTLE_VIEW_ALIASES.WHITE_TIGER_PLAYERS_PANEL,
             WHITE_TIGER_BATTLE_VIEW_ALIASES.WHITE_TIGER_HUD})
        else:
            self.__setVisibilityInitBattlePeriod()
