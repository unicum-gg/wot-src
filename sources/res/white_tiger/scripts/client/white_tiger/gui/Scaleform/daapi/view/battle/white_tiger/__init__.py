...
def getViewSettings():
    ...
    from white_tiger.gui.Scaleform.daapi.view.battle.white_tiger import ability_widget
    from white_tiger.gui.Scaleform.daapi.view.battle.white_tiger import missile_widget
    ...
    from white_tiger.gui.Scaleform.daapi.view.battle.white_tiger import wt_vehicle_messages
    from white_tiger.gui.Scaleform.daapi.view.battle.white_tiger import wt_vehicle_errors
    from white_tiger.gui.Scaleform.daapi.view.battle.white_tiger import battle_loading
    from white_tiger.gui.Scaleform.daapi.view.battle.white_tiger import ingame_menu
    from white_tiger.gui.Scaleform.daapi.view.battle.white_tiger import indicators
    return (
     ViewSettings(VIEW_ALIAS.EVENT_BATTLE_PAGE, WhiteTigerBattlePage, getSwfExtensionUrl('white_tiger', 'WTBattlePage.swf'), WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
     ComponentSettings(BATTLE_VIEW_ALIASES.BATTLE_LOADING, battle_loading.WtBattleLoading, ScopeTemplates.DEFAULT_SCOPE),
     ViewSettings(VIEW_ALIAS.INGAME_MENU, ingame_menu.WTIngameMenu, 'ingameMenu.swf', WindowLayer.TOP_WINDOW, None, ScopeTemplates.DEFAULT_SCOPE, isModal=True, canClose=False, canDrag=False),
     ...
     ComponentSettings(BATTLE_VIEW_ALIASES.VEHICLE_ERROR_MESSAGES, wt_vehicle_errors.WTVehicleErrorMessages, ScopeTemplates.DEFAULT_SCOPE),
     ...
     ComponentSettings(WHITE_TIGER_BATTLE_VIEW_ALIASES.WT_BOSS_WIDGET, boss_widget.WhiteTigerBossWidget, ScopeTemplates.DEFAULT_SCOPE),
     ComponentSettings(WHITE_TIGER_BATTLE_VIEW_ALIASES.WT_HUNTER_RESPAWN, hunter_respawn.WhiteTigerHunterRespawnView, ScopeTemplates.DEFAULT_SCOPE),
     ComponentSettings(WHITE_TIGER_BATTLE_VIEW_ALIASES.WT_BOSS_TELEPORT, boss_teleport.WhiteTigerBossTeleportView, ScopeTemplates.DEFAULT_SCOPE),
     ...
     ComponentSettings(BATTLE_VIEW_ALIASES.SIXTH_SENSE, indicators.WTSixthSenseIndicator, ScopeTemplates.DEFAULT_SCOPE),
     ComponentSettings(BATTLE_VIEW_ALIASES.BATTLE_HINT, battle_hint.BattleHint, ScopeTemplates.DEFAULT_SCOPE),
     ComponentSettings(WHITE_TIGER_BATTLE_VIEW_ALIASES.WT_ABILITY_WIDGET, ability_widget.WhiteTigerAbilityWidgetView, ScopeTemplates.DEFAULT_SCOPE),
     ComponentSettings(WHITE_TIGER_BATTLE_VIEW_ALIASES.WT_MISSILE_WIDGET, missile_widget.WhiteTigerMissileWidgetView, ScopeTemplates.DEFAULT_SCOPE),
     ViewSettings(BATTLE_VIEW_ALIASES.VEHICLE_MESSAGES, wt_vehicle_messages.WTVehicleMessages, None, WindowLayer.UNDEFINED, None, None, ScopeTemplates.DEFAULT_SCOPE))


def getBusinessHandlers():
    return (
     _WhiteTigerBattlePackageBusinessHandler(),)
...
class _WhiteTigerBattlePackageBusinessHandler(PackageBusinessHandler):
    ...
    def __init__(self):
        listeners = (
         (
          VIEW_ALIAS.EVENT_BATTLE_PAGE, self._loadPage),)
