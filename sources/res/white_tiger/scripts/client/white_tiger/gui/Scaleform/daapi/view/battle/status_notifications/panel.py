...
import logging
from white_tiger.gui.Scaleform.daapi.view.battle.status_notifications import sn_items as wt_sn_items
...
from white_tiger.gui.Scaleform.genConsts.WT_BATTLE_NOTIFICATIONS_TIMER_LINKAGES import WT_BATTLE_NOTIFICATIONS_TIMER_LINKAGES as _WTLINKS
from white_tiger.gui.Scaleform.genConsts.WT_BATTLE_NOTIFICATIONS_TIMER_TYPES import WT_BATTLE_NOTIFICATIONS_TIMER_TYPES as _WTTYPES
...
class WhiteTigerStatusNotificationTimerPanel(StatusNotificationTimerPanel):
    ...
    def _generateNotificationTimerSettings(self):
        ...
        self._addNotificationTimerSetting(data, _TYPES.OVERTURNED, _LINKS.OVERTURNED_GREEN_ICON, link, _COLORS.GREEN)
        self._addNotificationTimerSetting(data, _TYPES.HALF_OVERTURNED, _LINKS.HALF_OVERTURNED_ICON, link, _COLORS.GREEN)
        self._addNotificationTimerSetting(data, _WTTYPES.WT_HYPERION_WARNING_CHARGING, _WTLINKS.WT_HYPERION_WARNING_ICON, link, _COLORS.ORANGE, countdownVisible=True)
        link = _LINKS.SECONDARY_TIMER_UI
        self._addNotificationTimerSetting(data, _TYPES.STUN, _WTLINKS.WT_STUN_ICON, link, _COLORS.ORANGE, noiseVisible=True, text=INGAME_GUI.STUN_INDICATOR)
        return data