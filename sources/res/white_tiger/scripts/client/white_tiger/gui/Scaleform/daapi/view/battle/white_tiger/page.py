...
_HUNTER_PAGES = ('eventHunterHint1', 'eventHunterHint2', 'eventHunterHint3', 'eventHunterHint4',
                 'eventHunterHint5')
_BOSS_PAGES = ('eventBossHint1', 'eventBossHint2', 'eventBossHint3', 'eventBossHint4',
               'eventBossHint5')
...
class WhiteTigerBattlePage(ClassicPage, ISpawnListener):
    ...
    def __setVisibilityInitBattlePeriod(self):
        visibleComponents = {
         BATTLE_VIEW_ALIASES.PLAYERS_PANEL_EVENT, WHITE_TIGER_BATTLE_VIEW_ALIASES.WT_BOSS_WIDGET}
