...
def getViewSettings():
    ...
    return (
     ...
     ViewSettings(WHITE_TIGER_ALIASES.WT_PRIME_TIME_VIEW, WTEventPrimeTimeView, getSwfExtensionUrl('white_tiger', 'WTPrimeTime.swf'), WindowLayer.TOP_SUB_VIEW, WHITE_TIGER_ALIASES.WT_PRIME_TIME_VIEW, ScopeTemplates.LOBBY_TOP_SUB_SCOPE, True),
     ...
     ViewSettings(VIEW_ALIAS.CONFIGURABLE_VEHICLE_PREVIEW, WTConfigurableVehiclePreview, 'vehiclePreview.swf', WindowLayer.SUB_VIEW, VIEW_ALIAS.CONFIGURABLE_VEHICLE_PREVIEW, ScopeTemplates.LOBBY_SUB_SCOPE),
     ViewSettings(VIEW_ALIAS.STYLE_PREVIEW, WTVehicleStylePreview, 'vehicleBasePreview.swf', WindowLayer.SUB_VIEW, VIEW_ALIAS.STYLE_PREVIEW, ScopeTemplates.LOBBY_SUB_SCOPE))
