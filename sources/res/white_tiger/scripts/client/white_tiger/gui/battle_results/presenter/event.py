...
def setWidgets(model, reusable):
    ...
    progressData = reusable.personal.getQuestsProgress()
    completedQuests = []
...
def _getQuests(groupIDs):
    ...
    def filterFunc(quest):
        return quest.isEventBattlesQuest() and quest.getGroupID() in groupIDs and quest.isCompleted()
