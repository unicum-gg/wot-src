...
class WTBattleStateComponent(DynamicScriptComponent):
    ...
    def __notifyPlasmaDamage(self, plasmaDamageDict):
        ...
        if feedback:
            feedback.onVehicleFeedbackReceived(FEEDBACK_EVENT_ID.WT_VEHICLE_DISCRETE_DAMAGE_RECEIVED, plasmaDamageDict['targetID'], (plasmaDamageDict['attackerID'],
             plasmaDamageDict['plasmaDamage']))