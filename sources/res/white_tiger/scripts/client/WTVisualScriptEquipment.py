...
from helpers.fixed_dict import getVisualScriptEquipmentState, getVisualScriptEquipmentPublicState
...
class WTVisualScriptEquipment(DynamicScriptComponent):
    __sessionProvider = dependency.descriptor(IBattleSessionProvider)

    def __init__(self):
        super(WTVisualScriptEquipment, self).__init__()
        self._vsPlan = None
        self._context = None
        return
