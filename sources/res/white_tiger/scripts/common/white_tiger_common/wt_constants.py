...
WTHyperionTimerViewState = namedtuple('WTHyperionTimerViewState', [
 'visible', 'totalTime', 'finishTime'])
...
class WT_MATCHMAKER_STATS(object):
    BOSS_DEQUEUED_BY_USER = 'wtBossDequeuedByUserCount'
    HUNTER_DEQUEUED_BY_USER = 'wtHunterDequeuedByUserCount'
    BOSS_DENAILS = 'wtBossKickedFromQueueCount'
    HUNTER_DENAILS = 'wtHunterKickedFromQueueCount'
    BOSS_WAIT_TIME = 'wtBossWaitTime'
    HUNTER_WAIT_TIME = 'wtHunterWaitTime'
    QUICK_TICKET_BOSS = 'wtBossesWithQuickTicketCount'
    ALL = (
