...
@ReprInjector.simple(('__currentVehicleID', 'currentVehicleID'), ('__fallTanksAttachedInfo',
                                                                  'fallTanksAttachedInfo'))
class FallTanksBattleController(IFallTanksBattleController):
    __slots__ = ('__playerVehicleID', '__currentVehicleID', '__fallTanksAttachedInfo',
                 '__eManager', 'onFallTanksAttachedInfoUpdate')
