...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.FALL_TANKS_BATTLE_PAGE, FallTanksPage, getSwfExtensionUrl('fall_tanks', 'fallTanksBattlePage.swf'), WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
...
def getBusinessHandlers():
    return (
     BattlePageBusinessHandler(VIEW_ALIAS.FALL_TANKS_BATTLE_PAGE),)