...
_BATTLE_EVENTS_SETTINGS_TO_BATTLE_EFFICIENCY_TYPES = {BATTLE_EVENTS.ENEMY_KILL: (
                            FALL_TANKS_BATTLE_EFFICIENCY_TYPES.FALL_TANKS_DESTRUCTION,)}
...
class FallTanksBattleRibbonsPanel(BattleRibbonsPanel):
    ...
    def _getRibbonsConfig(self):
        return [
         [
          FALL_TANKS_BATTLE_EFFICIENCY_TYPES.FALL_TANKS_DESTRUCTION,
          backport.text(R.strings.fall_tanks.efficiencyRibbons.fallTanksKill())]]