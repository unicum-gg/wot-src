...
BATTLE_PASS_TOKEN_CREW_BOOK_OFFER = BATTLE_PASS_OFFER_TOKEN_PREFIX + 'crewbook:'
BATTLE_PASS_TOKEN_CREW_BOOK_GIFT_OFFER = BATTLE_PASS_OFFER_TOKEN_PREFIX + 'crewbook_gift:'
