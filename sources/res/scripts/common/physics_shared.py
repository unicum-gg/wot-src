...
def updateCommonConf():
    BigWorld.setupPhysicsParam('CONTACT_ENERGY_POW', CONTACT_ENERGY_POW)
    BigWorld.setupPhysicsParam('CONTACT_ENERGY_POW2', CONTACT_ENERGY_POW2)
    BigWorld.setupPhysicsParam('SLOPE_FRICTION_FUNC_DEF', SLOPE_FRICTION_FUNC_DEF)
    BigWorld.setupPhysicsParam('SLOPE_FRICTION_FUNC_VAL', SLOPE_FRICTION_FUNC_VAL)
    BigWorld.setupPhysicsParam('SLOPE_FRICTION_MODELS_FUNC_VAL', SLOPE_FRICTION_MODELS_FUNC_VAL)
    BigWorld.setupPhysicsParam('CONTACT_FRICTION_TERRAIN', CONTACT_FRICTION_TERRAIN)
    BigWorld.setupPhysicsParam('CONTACT_FRICTION_STATICS', CONTACT_FRICTION_STATICS)
    BigWorld.setupPhysicsParam('CONTACT_FRICTION_EXTRA', CONTACT_FRICTION_EXTRA)
    BigWorld.setupPhysicsParam('CONTACT_FRICTION_DESTRUCTIBLES', CONTACT_FRICTION_DESTRUCTIBLES)
    BigWorld.setupPhysicsParam('CONTACT_FRICTION_VEHICLES', CONTACT_FRICTION_VEHICLES)
    BigWorld.setupPhysicsParam('VEHICLE_ON_BODY_DEFAULT_FRICTION', VEHICLE_ON_BODY_DEFAULT_FRICTION)
    BigWorld.setupPhysicsParam('ROLLER_REACTION_COEFF_FOR_STATIC', ROLLER_REACTION_COEFF_FOR_STATIC)
    BigWorld.setupPhysicsParam('ROLLER_FRICTION_GAIN_MIN', ROLLER_FRICTION_GAIN_MIN)
    BigWorld.setupPhysicsParam('ROLLER_FRICTION_GAIN_MAX', ROLLER_FRICTION_GAIN_MAX)
    BigWorld.setupPhysicsParam('ROLLER_FRICTION_ANGLE_MIN', ROLLER_FRICTION_ANGLE_MIN)
    BigWorld.setupPhysicsParam('ROLLER_FRICTION_ANGLE_MAX', ROLLER_FRICTION_ANGLE_MAX)
    BigWorld.setupPhysicsParam('ARENA_BOUNDS_FRICTION_HOR', ARENA_BOUNDS_FRICTION_HOR)
    BigWorld.setupPhysicsParam('ARENA_BOUNDS_FRICTION_VERT', ARENA_BOUNDS_FRICTION_VERT)
    BigWorld.setupPhysicsParam('USE_PSEUDO_CONTACTS', USE_PSEUDO_CONTACTS)
    BigWorld.setupPhysicsParam('CONTACT_PENETRATION', CONTACT_PENETRATION)
    BigWorld.setupPhysicsParam('WARMSTARTING_VEHICLE_VEHICLE', WARMSTARTING_VEHICLE_VEHICLE)
    BigWorld.setupPhysicsParam('WARMSTARTING_VEHICLE_STATICS', WARMSTARTING_VEHICLE_STATICS)
    BigWorld.setupPhysicsParam('WARMSTARTING_THRESHOLD', WARMSTARTING_THRESHOLD)
...
def configurePhysicsMode(cfg, typeDesc, gravityFactor):
    ...
    cfg['isPitchHullAimingAvailable'] = typeDesc.isPitchHullAimingAvailable
