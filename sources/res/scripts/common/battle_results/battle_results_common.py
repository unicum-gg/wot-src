...
BATTLE_RESULTS = [
 ...
 (
  'damageAssistedStun', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_ALL),
 (
 ...
 (
  'noDamageDirectHitsReceived', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_ALL),
 (
 ...
 (
  'deathCount', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_ALL),
 (
  'flagActions', list, [0] * len(FLAG_ACTION.RANGE), None, 'sumInEachPos', ENTRY_TYPE.VEHICLE_ALL),
 (
  'soloFlagCapture', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_ALL),
 (
 ...
 (
  'creditsContributionIn', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'creditsContributionOut', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'originalCreditsToDraw', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'creditsToDraw', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'damageBeforeTeamWasDamaged', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'killsBeforeTeamWasDamaged', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'percentFromTotalTeamDamage', float, 0.0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'winAloneAgainstVehicleCount', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'percentFromSecondBestDamage', float, 0.0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'killedAndDamagedByAllSquadmates', int, 0, None, 'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  'damagedWhileMoving', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
 ...
 (
  'creditsReplay', str, '', ValueReplayPacker(), 'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
 ...
 (
  'freeXPReplay', str, '', ValueReplayPacker(), 'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
  'originalTMenXP', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'tmenXPReplay', str, '', ValueReplayPacker(), 'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
  'tmenXP', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'originalGold', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'goldReplay', str, '', ValueReplayPacker(), 'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
  'gold', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'originalCrystal', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'crystalReplay', str, '', ValueReplayPacker(), 'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
 ...
 (
  'factualFreeXP', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'factualCredits', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'subtotalCredits', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'subtotalXP', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'subtotalFreeXP', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'subtotalTMenXP', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'subtotalGold', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'subtotalCrystal', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
 ...
 (
  'eventFreeXPList', list, [], None, 'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
  'eventTMenXPList', list, [], None, 'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
  'eventGoldList', list, [], None, 'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
 ...
 (
  'eventTMenXPFactor100List', list, [], None, 'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
  'eventGoldFactor100List', list, [], None, 'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
  'originalXPPenalty', int, 0, None, 'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
  'originalCreditsPenalty', int, 0, None, 'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
  'originalCreditsContributionIn', int, 0, None, 'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
  'originalCreditsContributionOut', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'premiumVehicleXP', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'premiumVehicleXPFactor100', int, 0, None, 'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
  'squadXP', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
 ...
 (
  'referral20Credits', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
 ...
 (
  'appliedPremiumXPFactor100', int, 0, None, 'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  'premiumTmenXPFactor100', int, 0, None, 'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  'premiumPlusTmenXPFactor100', int, 0, None, 'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  'appliedPremiumTmenXPFactor100', int, 0, None, 'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  'premiumCreditsFactor100', int, 0, None, 'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  'premiumPlusCreditsFactor100', int, 0, None, 'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  'appliedPremiumCreditsFactor100', int, 0, None, 'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  'premSquadCreditsFactor100', int, 0, None, 'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  'originalPremSquadCredits', int, 0, None, 'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  'premSquadCredits', int, 0, None, 'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  'dailyXPFactor10', int, 0, None, 'max', ENTRY_TYPE.VEHICLE_SELF),
 (
  'additionalXPFactor10', int, 0, None, 'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
  'igrXPFactor10', int, 0, None, 'max', ENTRY_TYPE.VEHICLE_SELF),
 (
  'aogasFactor10', int, 0, None, 'max', ENTRY_TYPE.VEHICLE_SELF),
 (
  'refSystemXPFactor10', int, 0, None, 'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  'fairplayFactor10', int, 0, None, 'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
  'orderCredits', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'orderXP', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'orderFreeXP', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'orderTMenXP', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'orderCreditsFactor100', int, 0, None, 'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  'orderXPFactor100', int, 0, None, 'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  'orderFreeXPFactor100', int, 0, None, 'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  'orderTMenXPFactor100', int, 0, None, 'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  'boosterCredits', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'boosterXP', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'boosterFreeXP', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'boosterTMenXP', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'boosterCreditsFactor100', int, 0, None, 'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  'boosterXPFactor100', int, 0, None, 'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  'boosterFreeXPFactor100', int, 0, None, 'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  'boosterTMenXPFactor100', int, 0, None, 'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  'playerRankXP', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'playerRankXPFactor100', int, 0, None, 'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  'isPremium', bool, False, None, 'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  'premMask', int, 0, None, 'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  'xpByTmen', list, [], None, 'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
  'autoRepairCost', int, 0, None, 'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
  'autoLoadCost', tuple, (0, 0), None, 'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
  'autoEquipCost', tuple, (0, 0, 0), None, 'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
  'autoEquipBoostersCost', tuple, (0, 0, 0), None, 'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
  'prevMarkOfMastery', int, 0, None, 'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
  'markOfMastery', int, 0, None, 'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
 ...
 (
  'damageRating', int, 0, None, 'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
  'battleNum', int, 0, None, 'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
 ...
 (
  'originalCreditsPenaltySquad', int, 0, None, 'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
  'originalCreditsContributionInSquad', int, 0, None, 'skip', ENTRY_TYPE.VEHICLE_SELF),
 (
  'originalCreditsContributionOutSquad', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'avatarDamageDealt', int, 0, None, 'skip', ENTRY_TYPE.ACCOUNT_ALL),
 (
  'avatarKills', int, 0, None, 'skip', ENTRY_TYPE.ACCOUNT_ALL),
 (
  'avatarDamaged', int, 0, None, 'skip', ENTRY_TYPE.ACCOUNT_ALL),
 (
  'totalDamaged', int, 0, None, 'skip', ENTRY_TYPE.ACCOUNT_ALL),
 (
  'fairplayViolations', tuple, (0, 0, 0), None, 'skip', ENTRY_TYPE.ACCOUNT_ALL),
 (
  'badges', tuple, BadgesCommon.selectedBadgesEmpty(), None, 'skip', ENTRY_TYPE.ACCOUNT_ALL),
 (
  'rankChange', int, 0, None, 'skip', ENTRY_TYPE.ACCOUNT_SELF),
 (
  'avatarAmmo', list, [], None, 'skip', ENTRY_TYPE.ACCOUNT_SELF),
 (
  'avatarDamageEventList', set, set(), None, 'skip', ENTRY_TYPE.ACCOUNT_SELF),
 (
 ...
 (
  'isAbsoluteNoviceBattle', bool, False, None, 'skip', ENTRY_TYPE.SERVER),
 (
  'isNoviceBattle', bool, False, None, 'skip', ENTRY_TYPE.SERVER),
 (
 ...
 (
  'eventFreeXP', int, 0, None, 'sum', ENTRY_TYPE.ACCOUNT_SELF),
 (
  'eventTMenXP', int, 0, None, 'sum', ENTRY_TYPE.ACCOUNT_SELF),
 (
  'eventGold', int, 0, None, 'sum', ENTRY_TYPE.ACCOUNT_SELF),
 (
 ...
 (
  'xp', int, 0, None, 'sum', ENTRY_TYPE.ACCOUNT_SELF),
 (
  'freeXP', int, 0, None, 'sum', ENTRY_TYPE.ACCOUNT_SELF),
 (
  'crystal', int, 0, None, 'sum', ENTRY_TYPE.ACCOUNT_SELF),
 (
  'name', str, '', None, 'skip', ENTRY_TYPE.PLAYER_INFO),
 (
  'realName', str, '', None, 'skip', ENTRY_TYPE.PLAYER_INFO),
 (
  'clanDBID', int, 0, None, 'skip', ENTRY_TYPE.PLAYER_INFO),
 (
  'clanAbbrev', str, '', None, 'skip', ENTRY_TYPE.PLAYER_INFO),
 (
 ...
 (
  'arenaTypeID', int, 0, None, 'skip', ENTRY_TYPE.COMMON),
 (
  'arenaCreateTime', int, 0, None, 'skip', ENTRY_TYPE.COMMON),
 (
  'winnerTeam', int, 0, None, 'skip', ENTRY_TYPE.COMMON),
 (
  'finishReason', int, 0, None, 'skip', ENTRY_TYPE.COMMON),
 (
  'gasAttackWinnerTeam', int, -1, None, 'skip', ENTRY_TYPE.COMMON),
 (
  'duration', int, 0, None, 'skip', ENTRY_TYPE.COMMON),
 (
 ...
 (
  ...
  'joinCritsByType', ENTRY_TYPE.SERVER),
 (
  'innerModuleCritCount', int, 0, None, 'sum', ENTRY_TYPE.SERVER),
 (
  'innerModuleDestrCount', int, 0, None, 'sum', ENTRY_TYPE.SERVER),
 (
  'isAnyOurCrittedInnerModules', int, 0, None, 'max', ENTRY_TYPE.SERVER),
 (
  'killsAssistedTrack', int, 0, None, 'sum', ENTRY_TYPE.SERVER),
 (
  'killsAssistedRadio', int, 0, None, 'sum', ENTRY_TYPE.SERVER),
 (
  'killsAssistedStun', int, 0, None, 'sum', ENTRY_TYPE.SERVER),
 (
  'damagedVehicleCntAssistedTrack', int, 0, None, 'sum', ENTRY_TYPE.SERVER),
 (
  'damagedVehicleCntAssistedRadio', int, 0, None, 'sum', ENTRY_TYPE.SERVER),
 (
 ...
 (
  'damageAssistedRadioWhileInvisible', int, 0, None, 'sum', ENTRY_TYPE.SERVER),
 (
  'damageAssistedTrackWhileInvisible', int, 0, None, 'sum', ENTRY_TYPE.SERVER),
 (
  'damageAssistedStunWhileInvisible', int, 0, None, 'sum', ENTRY_TYPE.SERVER),
 (
  'damageEventList', dict, {}, None, 'joinTargetEventLists', ENTRY_TYPE.SERVER),
 (
  'stunEventList', dict, {}, None, 'joinTargetEventLists', ENTRY_TYPE.SERVER),
 (
  'assistEventList', dict, {}, None, 'joinTargetEventLists', ENTRY_TYPE.SERVER),
 (
  'damageFromEnemiesEventList', dict, {}, None, 'joinTargetEventLists', ENTRY_TYPE.SERVER),
 (
  'multiDamageEvents', dict, {}, None, 'joinDicts', ENTRY_TYPE.SERVER),
 (
  'multiStunEvents', dict, {}, None, 'joinDicts', ENTRY_TYPE.SERVER),
 (
  'inBattleMaxSniperSeries', int, 0, None, 'max', ENTRY_TYPE.SERVER),
 (
  'inBattleMaxKillingSeries', int, 0, None, 'max', ENTRY_TYPE.SERVER),
 (
  'inBattleMaxPiercingSeries', int, 0, None, 'max', ENTRY_TYPE.SERVER),
 (
  'firstDamageTime', int, 0, None, 'min', ENTRY_TYPE.SERVER),
 (
  'consumedAmmo', None, None, None, 'skip', ENTRY_TYPE.SERVER),
 (
  'ironShieldDamage', int, 0, None, 'sum', ENTRY_TYPE.SERVER),
 (
 ...
 (
  'explosionEnemyHits', int, 0, None, 'sum', ENTRY_TYPE.SERVER),
 (
  'piercingEnemyHits', int, 0, None, 'sum', ENTRY_TYPE.SERVER),
 (
  'indirectEnemyHits', int, 0, None, 'sum', ENTRY_TYPE.SERVER),
 (
  'enemyHits', int, 0, None, 'sum', ENTRY_TYPE.SERVER),
 (
  'spottedBeforeWeBecameSpotted', int, 0, None, 'sum', ENTRY_TYPE.SERVER),
 (
  'spottedAndDamagedSPG', int, 0, None, 'sum', ENTRY_TYPE.SERVER),
 (
  'damageList', list, [], None, 'extend', ENTRY_TYPE.SERVER),
 (
  'killList', list, [], None, 'extend', ENTRY_TYPE.SERVER),
 (
 ...
 (
  'directivesCredits', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'directivesXP', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'directivesFreeXP', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'directivesTMenXP', int, 0, None, 'sum', ENTRY_TYPE.VEHICLE_SELF),
 (
  'directivesCreditsFactor100', int, 0, None, 'any', ENTRY_TYPE.VEHICLE_SELF),
 (
  'directivesXPFactor100', int, 0, None, 'any', ENTRY_TYPE.VEHICLE_SELF),
 (
