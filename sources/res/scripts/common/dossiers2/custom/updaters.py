...
def __updateFromAccountDossier109(compDescr):
    blocksLayout = [
     ...
     'achievementsRated7x7', 'rated7x7Cut', 'globalMapMiddle', 'globalMapChampion', 'globalMapAbsolute',
     'maxGlobalMapMiddle', 'maxGlobalMapChampion', 'maxGlobalMapAbsolute', 'globalMapCommonCut', 'fallout',
     'falloutCut', 'maxFallout', 'falloutAchievements', 'ranked', 'maxRanked', 'rankedCut',
     'rankedSeasons', 'rankedCurrent', 'rankedPrevious', 'maxRankedCurrent', 'maxRankedPrevious',
     'rankedCurrentCut', 'rankedPreviousCut', 'rankedCurrentCycle', 'rankedPreviousCycle',
...
def __updateFromAccountDossier110(compDescr):
    blocksLayout = [
     ...
     'rankedCurrentCut', 'rankedPreviousCut', 'rankedCurrentCycle', 'rankedPreviousCycle',
     'a30x30', 'a30x30Cut', 'max30x30', 'markOfMasteryCut', 'playerBadges',
     'epicBattle', 'epicBattleCut', 'maxEpicBattle', 'epicBattleAchievements']
    updateCtx = {'dossierCompDescr': compDescr, 
       'blockSizeFormat': 'H', 
       'versionFormat': 'H', 
       'blocksLayout': blocksLayout}
...
def __updateFromAccountDossier117(compDescr):
    ...
    getHeader(updateCtx)
    formats = [
     ('rankedDivisionFighter', 'I'),
     ('rankedStayingPower', 'I')]
    addRecords(updateCtx, 'achievements', formats, {})
...
def __updateFromAccountDossier119(compDescr):
    blocksLayout = [
     ...
     'maxHistorical', 'historicalAchievements', 'historicalCut', 'uniqueAchievements', 'fortBattles',
     'maxFortBattles', 'fortBattlesCut', 'fortSorties', 'maxFortSorties', 'fortSortiesCut', 'fortBattlesInClan',
     'maxFortBattlesInClan', 'fortSortiesInClan', 'maxFortSortiesInClan', 'fortAchievements', 'singleAchievements',
     'clanAchievements', 'rated7x7', 'maxRated7x7', 'achievementsRated7x7', 'rated7x7Cut', 'globalMapMiddle',
     'globalMapChampion', 'globalMapAbsolute', 'maxGlobalMapMiddle', 'maxGlobalMapChampion', 'maxGlobalMapAbsolute',
     'globalMapCommonCut', 'fallout', 'falloutCut', 'maxFallout', 'falloutAchievements', 'ranked', 'maxRanked',
     'rankedCut', 'rankedSeasons', 'a30x30', 'a30x30Cut', 'max30x30', 'markOfMasteryCut', 'playerBadges',
     'epicBattle', 'epicBattleCut', 'maxEpicBattle', 'epicBattleAchievements', 'rankedSeason1', 'rankedSeason2',
     'rankedSeason3', 'maxRankedSeason1', 'maxRankedSeason2', 'maxRankedSeason3', 'rankedCutSeason1',
     'rankedCutSeason2', 'rankedCutSeason3', 'rankedArchive', 'maxRankedArchive', 'rankedCutArchive']
    updateCtx = {'dossierCompDescr': compDescr, 
       'blockSizeFormat': 'H', 
       'versionFormat': 'H', 
       'blocksLayout': blocksLayout}
...
def __updateFromAccountDossier120(compDescr):
    blocksLayout = [
     ...
     'achievementsRated7x7', 'rated7x7Cut', 'globalMapMiddle', 'globalMapChampion', 'globalMapAbsolute',
     'maxGlobalMapMiddle', 'maxGlobalMapChampion', 'maxGlobalMapAbsolute', 'globalMapCommonCut', 'fallout',
     'falloutCut', 'maxFallout', 'falloutAchievements', 'ranked', 'maxRanked', 'rankedCut', 'rankedSeasons',
     'a30x30', 'a30x30Cut', 'max30x30', 'markOfMasteryCut', 'playerBadges',
     'epicBattle', 'epicBattleCut', 'maxEpicBattle', 'epicBattleAchievements',
     'rankedSeason1', 'rankedSeason2', 'rankedSeason3',
     'maxRankedSeason1', 'maxRankedSeason2', 'maxRankedSeason3',
     'rankedCutSeason1', 'rankedCutSeason2', 'rankedCutSeason3',
     'rankedArchive', 'maxRankedArchive', 'rankedCutArchive']
    updateCtx = {'dossierCompDescr': compDescr, 
       'blockSizeFormat': 'H', 
       'versionFormat': 'H', 
       'blocksLayout': blocksLayout}
...
def __updateFromAccountDossier124(compDescr):
    ...
    updateCtx = {'dossierCompDescr': compDescr, 
       ...
       'blocksLayout': blocksLayout}
    getHeader(updateCtx)
    packing = {'rankedDivisionFighter': (198, 'I'), 'rankedStayingPower': (202, 'I')}
...
def __updateFromAccountDossier126(compDescr):
    blocksLayout = [
     ...
     'epicBattle', 'epicBattleCut', 'maxEpicBattle', 'epicBattleAchievements', 'rankedSeason1', 'rankedSeason2',
     'rankedSeason3', 'maxRankedSeason1', 'maxRankedSeason2', 'maxRankedSeason3', 'rankedCutSeason1',
     'rankedCutSeason2', 'rankedCutSeason3', 'rankedArchive', 'maxRankedArchive', 'rankedCutArchive', 'epicSeasons']
    updateCtx = {'dossierCompDescr': compDescr, 
       'blockSizeFormat': 'H', 
       'versionFormat': 'H', 
       'blocksLayout': blocksLayout}
...
def __updateFromAccountDossier129(compDescr):
    blocksLayout = [
     ...
     'rankedSeason3', 'maxRankedSeason1', 'maxRankedSeason2', 'maxRankedSeason3', 'rankedCutSeason1',
     'rankedCutSeason2', 'rankedCutSeason3', 'rankedArchive', 'maxRankedArchive', 'rankedCutArchive',
     'epicSeasons', 'battleRoyaleSeasons']
    updateCtx = {'dossierCompDescr': compDescr, 
       'blockSizeFormat': 'H', 
       'versionFormat': 'H', 
       'blocksLayout': blocksLayout}
...
def __updateFromAccountDossier133(compDescr):
    blocksLayout = [
     ...
     'maxHistorical', 'historicalAchievements', 'historicalCut', 'uniqueAchievements', 'fortBattles',
     'maxFortBattles', 'fortBattlesCut', 'fortSorties', 'maxFortSorties', 'fortSortiesCut', 'fortBattlesInClan',
     'maxFortBattlesInClan', 'fortSortiesInClan', 'maxFortSortiesInClan', 'fortAchievements',
     'singleAchievements',
     'clanAchievements', 'rated7x7', 'maxRated7x7', 'achievementsRated7x7', 'rated7x7Cut', 'globalMapMiddle',
     'globalMapChampion', 'globalMapAbsolute', 'maxGlobalMapMiddle', 'maxGlobalMapChampion',
     'maxGlobalMapAbsolute',
     'globalMapCommonCut', 'fallout', 'falloutCut', 'maxFallout', 'falloutAchievements', 'ranked', 'maxRanked',
     'rankedCut', 'rankedSeasons', 'a30x30', 'a30x30Cut', 'max30x30', 'markOfMasteryCut', 'playerBadges',
     'epicBattle', 'epicBattleCut', 'maxEpicBattle', 'epicBattleAchievements', 'rankedSeason1', 'rankedSeason2',
     'rankedSeason3', 'maxRankedSeason1', 'maxRankedSeason2', 'maxRankedSeason3', 'rankedCutSeason1',
     'rankedCutSeason2', 'rankedCutSeason3', 'rankedArchive', 'maxRankedArchive', 'rankedCutArchive',
     'epicSeasons', 'battleRoyaleSeasons', 'ranked_10x10', 'maxRanked_10x10', 'rankedCut_10x10']
    updateCtx = {'dossierCompDescr': compDescr, 
       'blockSizeFormat': 'H', 
       'versionFormat': 'H', 
       'blocksLayout': blocksLayout}
...
def __updateFromAccountDossier137(compDescr):
    blocksLayout = [
     ...
     'rankedSeason3', 'maxRankedSeason1', 'maxRankedSeason2', 'maxRankedSeason3', 'rankedCutSeason1',
     'rankedCutSeason2', 'rankedCutSeason3', 'rankedArchive', 'maxRankedArchive', 'rankedCutArchive',
     'epicSeasons', 'battleRoyaleSeasons', 'ranked_10x10', 'maxRanked_10x10', 'rankedCut_10x10', 'steamAchievements']
    updateCtx = {'dossierCompDescr': compDescr, 
       'blockSizeFormat': 'H', 
       'versionFormat': 'H', 
       'blocksLayout': blocksLayout}
...
def __updateFromAccountDossier144(compDescr):
    blocksLayout = [
     ...
     'rankedSeason3', 'maxRankedSeason1', 'maxRankedSeason2', 'maxRankedSeason3', 'rankedCutSeason1',
     'rankedCutSeason2', 'rankedCutSeason3', 'rankedArchive', 'maxRankedArchive', 'rankedCutArchive',
     'epicSeasons', 'battleRoyaleSeasons', 'ranked_10x10',
     'maxRanked_10x10', 'rankedCut_10x10', 'steamAchievements',
     'comp7Season1', 'maxComp7Season1', 'comp7CutSeason1']
    updateCtx = {'dossierCompDescr': compDescr, 
       'blockSizeFormat': 'H', 
       'versionFormat': 'H', 
       'blocksLayout': blocksLayout}
    ...
    return (
     145, updateCtx['dossierCompDescr'])
...
def __updateFromAccountDossier145(compDescr):
    blocksLayout = [
     ...
     'rankedCutSeason2', 'rankedCutSeason3', 'rankedArchive', 'maxRankedArchive', 'rankedCutArchive',
     'epicSeasons', 'battleRoyaleSeasons', 'ranked_10x10', 'maxRanked_10x10', 'rankedCut_10x10',
     'steamAchievements', 'comp7Season1', 'maxComp7Season1', 'comp7CutSeason1', 'comp7Season2', 'maxComp7Season2',
     'comp7CutSeason2']
    updateCtx = {'dossierCompDescr': compDescr, 
       'blockSizeFormat': 'H', 
       'versionFormat': 'H', 
...
def __updateFromAccountDossier147(compDescr):
    ...
    return (
     148, updateCtx['dossierCompDescr'])
...
def __updateFromAccountDossier148(compDescr):
    blocksLayout = [
     ...
     'epicSeasons', 'battleRoyaleSeasons', 'ranked_10x10', 'maxRanked_10x10', 'rankedCut_10x10',
     'steamAchievements', 'comp7Season1', 'maxComp7Season1', 'comp7CutSeason1', 'comp7Season2', 'maxComp7Season2',
     'comp7CutSeason2', 'comp7Season3', 'maxComp7Season3', 'comp7CutSeason3', 'comp7ArchiveGriffin',
     'maxComp7ArchiveGriffin', 'comp7CutArchiveGriffin']
    updateCtx = {'dossierCompDescr': compDescr, 
       'blockSizeFormat': 'H', 
       'versionFormat': 'H', 
       'blocksLayout': blocksLayout}
    getHeader(updateCtx)
    comp7SeasonsPacking = {'spotted': (32, 'I'), 'losses': (12, 'I'), 'roleSkillUsed': (124, 'I'), 'damageAssistedTrack': (56, 'I'), 
       'damageReceived': (40, 'I'), 'battlesOnStunningVehicles': (100, 'I'), 
       'piercingsReceived': (72, 'I'), 'originalXP': (52, 'I'), 
       'damageAssistedRadio': (60, 'I'), 'battlesCount': (4, 'I'), 'survivedBattles': (16, 'I'), 
       'winSeries': (112, 'I'), 'piercings': (84, 'I'), 'damageBlockedByArmor': (96, 'I'), 
       'noDamageDirectHitsReceived': (68, 'I'), 'xp': (0, 'I'), 'droppedCapturePoints': (48, 'I'), 
       'healthRepair': (128, 'I'), 'directHitsReceived': (64, 'I'), 
       'comp7PrestigePoints': (120, 'I'), 'explosionHitsReceived': (76, 'I'), 
       'winAndSurvived': (88, 'I'), 'capturePoints': (44, 'I'), 'potentialDamageReceived': (92, 'I'), 
       'damageDealt': (36, 'I'), 'damageAssistedStun': (108, 'I'), 
       'squadWinSeries': (116, 'I'), 'explosionHits': (80, 'I'), 'wins': (8, 'I'), 
       'poiCapturable': (132, 'I'), 'frags': (20, 'I'), 'stunNum': (104, 'I'), 'shots': (24, 'I'), 
       'directHits': (28, 'I')}
    comp7SeasonsNewPacking = {'spotted': (32, 'I'), 'losses': (12, 'I'), 'roleSkillUsed': (132, 'I'), 'damageAssistedTrack': (56, 'I'), 
       'damageReceived': (40, 'I'), 'battlesOnStunningVehicles': (100, 'I'), 
       'piercingsReceived': (72, 'I'), 'originalXP': (52, 'I'), 
       'damageAssistedRadio': (60, 'I'), 'battlesCount': (4, 'I'), 'survivedBattles': (16, 'I'), 
       'winSeries': (112, 'I'), 'piercings': (84, 'I'), 'damageBlockedByArmor': (96, 'I'), 
       'noDamageDirectHitsReceived': (68, 'I'), 'xp': (0, 'I'), 
       'droppedCapturePoints': (48, 'I'), 'healthRepair': (136, 'I'), 'comp7PrestigePoints': (128, 'I'), 
       'directHitsReceived': (64, 'I'), 'superSquadWins': (124, 'I'), 
       'explosionHitsReceived': (76, 'I'), 'winAndSurvived': (88, 'I'), 
       'capturePoints': (44, 'I'), 'potentialDamageReceived': (92, 'I'), 
       'damageDealt': (36, 'I'), 'superSquadBattlesCount': (120, 'I'), 
       'damageAssistedStun': (108, 'I'), 'squadWinSeries': (116, 'I'), 
       'explosionHits': (80, 'I'), 'wins': (8, 'I'), 'poiCapturable': (140, 'I'), 
       'frags': (20, 'I'), 'stunNum': (104, 'I'), 'shots': (24, 'I'), 
       'directHits': (28, 'I')}
    seasonsNumber = 3
    ...
    maxComp7SeasonsPacking = {'maxDamage': (3, 'H'), 'maxXPVehicle': (5, 'I'), 'maxDamageVehicle': (13, 'I'), 'maxFrags': (2, 'B'), 
       'maxXP': (0, 'H'), 'maxHealthRepair': (29, 'H'), 'maxComp7PrestigePointsVehicle': (19, 'I'), 
       'maxEquipmentDamageDealt': (23, 'H'), 'maxFragsVehicle': (9, 'I'), 
       'maxSquadWinSeries': (37, 'H'), 'maxComp7PrestigePoints': (17, 'H'), 
       'maxWinSeries': (35, 'H'), 'maxEquipmentDamageDealtVehicle': (25, 'I'), 
...
def __updateFromAccountDossier150(compDescr):
    ...
    return (
     151, updateCtx['dossierCompDescr'])
...
def __updateFromAccountDossier151(compDescr):
    blocksLayout = [
     ...
     'steamAchievements', 'comp7Season1', 'maxComp7Season1', 'comp7CutSeason1', 'comp7Season2', 'maxComp7Season2',
     'comp7CutSeason2', 'comp7Season3', 'maxComp7Season3', 'comp7CutSeason3', 'comp7ArchiveGriffin',
     'maxComp7ArchiveGriffin', 'comp7CutArchiveGriffin', 'prestigeSystem']
    updateCtx = {'dossierCompDescr': compDescr, 
       'blockSizeFormat': 'H', 
       'versionFormat': 'H', 
       'blocksLayout': blocksLayout}
    ...
    return (
     152, updateCtx['dossierCompDescr'])
...
def __updateFromAccountDossier152(compDescr):
    ...
    return (
     153, updateCtx['dossierCompDescr'])
...
def __updateFromAccountDossier153(compDescr):
    ...
    return (
     154, updateCtx['dossierCompDescr'])
...
def __updateFromAccountDossier154(compDescr):
    blocksLayout = [
     ...
     'steamAchievements', 'comp7Season1', 'maxComp7Season1', 'comp7CutSeason1', 'comp7Season2', 'maxComp7Season2',
     'comp7CutSeason2', 'comp7Season3', 'maxComp7Season3', 'comp7CutSeason3', 'comp7ArchiveGriffin',
     'maxComp7ArchiveGriffin', 'comp7CutArchiveGriffin', 'prestigeSystem', 'vehicleAchievements',
    ...
    return (
     155, updateCtx['dossierCompDescr'])
...
def __updateFromAccountDossier155(compDescr):
    ...
    return (
     156, updateCtx['dossierCompDescr'])
...
def __updateFromAccountDossier156(compDescr):
    blocksLayout = [
     ...
     'comp7CutSeason2', 'comp7Season3', 'maxComp7Season3', 'comp7CutSeason3', 'comp7ArchiveGriffin',
     'maxComp7ArchiveGriffin', 'comp7CutArchiveGriffin', 'prestigeSystem', 'vehicleAchievements',
     'customizationAchievements', 'comp7ArchivePegasus', 'maxComp7ArchivePegasus', 'comp7CutArchivePegasus']
    updateCtx = {'dossierCompDescr': compDescr, 
       'blockSizeFormat': 'H', 
       'versionFormat': 'H', 
       'blocksLayout': blocksLayout}
    getHeader(updateCtx)
    comp7SeasonsPacking = {'spotted': (32, 'I'), 'losses': (12, 'I'), 'roleSkillUsed': (132, 'I'), 'damageAssistedTrack': (56, 'I'), 
       'damageReceived': (40, 'I'), 'battlesOnStunningVehicles': (100, 'I'), 
       'piercingsReceived': (72, 'I'), 'originalXP': (52, 'I'), 
       'damageAssistedRadio': (60, 'I'), 'battlesCount': (4, 'I'), 'survivedBattles': (16, 'I'), 
       'winSeries': (112, 'I'), 'piercings': (84, 'I'), 'damageBlockedByArmor': (96, 'I'), 
...
def __updateFromAccountDossier159(compDescr):
    ...
    updateCtx = {'dossierCompDescr': compDescr, 
       ...
       'blocksLayout': blocksLayout}
    getHeader(updateCtx)
    BADGES_TO_REMOVE = (152, 154, 155, 156)
    playerBadges = getDictBlockRecordValues(updateCtx, 'playerBadges', 'I', 'I')
    for badge_id in BADGES_TO_REMOVE:
        playerBadges.pop((badge_id,), None)
...
def __updateFromAccountDossier160(compDescr):
    ...
    updateCtx = {'dossierCompDescr': compDescr, 
       ...
       'blocksLayout': blocksLayout}
    getHeader(updateCtx)
    BADGES_TO_REMOVE = (173, 174, 175, 152)
    playerBadges = getDictBlockRecordValues(updateCtx, 'playerBadges', 'I', 'I')
    for badge_id in BADGES_TO_REMOVE:
        playerBadges.pop((badge_id,), None)
    ...
    return (161, updateCtx['dossierCompDescr'])


def __updateFromAccountDossier161(compDescr):
    blocksLayout = [
     'a15x15', 'a15x15_2', 'clan', 'clan2', 'company', 'company2', 'a7x7', 'achievements', 'vehTypeFrags',
     'a15x15Cut', 'rareAchievements', 'total', 'a7x7Cut', 'max15x15', 'max7x7', 'achievements7x7', 'historical',
     'maxHistorical', 'historicalAchievements', 'historicalCut', 'uniqueAchievements', 'fortBattles',
    ...
    updateCtx = {'dossierCompDescr': compDescr, 
       ...
       'blocksLayout': blocksLayout}
    getHeader(updateCtx)
    addBlock(updateCtx, 'commendations')
    setVersion(updateCtx, 162)
    return (162, updateCtx['dossierCompDescr'])


def __updateFromAccountDossier162(compDescr):
    blocksLayout = [
     'a15x15', 'a15x15_2', 'clan', 'clan2', 'company', 'company2', 'a7x7', 'achievements', 'vehTypeFrags',
     'a15x15Cut', 'rareAchievements', 'total', 'a7x7Cut', 'max15x15', 'max7x7', 'achievements7x7', 'historical',
     'maxHistorical', 'historicalAchievements', 'historicalCut', 'uniqueAchievements', 'fortBattles',
    ...
    updateCtx = {'dossierCompDescr': compDescr, 
       ...
       'blocksLayout': blocksLayout}
    getHeader(updateCtx)
    addBlock(updateCtx, 'statTrackersVehStatsCut')
    setVersion(updateCtx, 163)
    return (163, updateCtx['dossierCompDescr'])


def __updateFromAccountDossier163(compDescr):
    blocksLayout = [
     'a15x15', 'a15x15_2', 'clan', 'clan2', 'company', 'company2', 'a7x7', 'achievements', 'vehTypeFrags',
     'a15x15Cut', 'rareAchievements', 'total', 'a7x7Cut', 'max15x15', 'max7x7', 'achievements7x7', 'historical',
     'maxHistorical', 'historicalAchievements', 'historicalCut', 'uniqueAchievements', 'fortBattles',
     ...
     'maxComp7ArchiveGriffin', 'comp7CutArchiveGriffin', 'prestigeSystem', 'vehicleAchievements',
     'customizationAchievements', 'comp7ArchivePegasus', 'maxComp7ArchivePegasus', 'comp7CutArchivePegasus',
     'commendations', 'statTrackersVehStatsCut']
    updateCtx = {'dossierCompDescr': compDescr, 
       'blockSizeFormat': 'H', 
       'versionFormat': 'H', 
       'blocksLayout': blocksLayout}
    getHeader(updateCtx)
    formats = [
     ('readyForBattleAssault', 'B'),
     ('readyForBattleSniper', 'B'),
     ('readyForBattleSupport', 'B')]
    addRecords(updateCtx, 'achievements', formats, {})
    setVersion(updateCtx, 164)
    return (164, updateCtx['dossierCompDescr'])


def __updateFromAccountDossier164(compDescr):
    blocksLayout = [
     'a15x15', 'a15x15_2', 'clan', 'clan2', 'company', 'company2', 'a7x7', 'achievements', 'vehTypeFrags',
     'a15x15Cut', 'rareAchievements', 'total', 'a7x7Cut', 'max15x15', 'max7x7', 'achievements7x7', 'historical',
     'maxHistorical', 'historicalAchievements', 'historicalCut', 'uniqueAchievements', 'fortBattles',
    ...
    updateCtx = {'dossierCompDescr': compDescr, 
       ...
       'blocksLayout': blocksLayout}
    getHeader(updateCtx)
    addBlock(updateCtx, 'comp7ArchiveManticore')
    addBlock(updateCtx, 'maxComp7ArchiveManticore')
    addBlock(updateCtx, 'comp7CutArchiveManticore')
    setVersion(updateCtx, 165)
    return (
     165, updateCtx['dossierCompDescr'])


def __updateFromAccountDossier165(compDescr):
    blocksLayout = [
     'a15x15', 'a15x15_2', 'clan', 'clan2', 'company', 'company2', 'a7x7', 'achievements', 'vehTypeFrags',
     'a15x15Cut', 'rareAchievements', 'total', 'a7x7Cut', 'max15x15', 'max7x7', 'achievements7x7', 'historical',
     'maxHistorical', 'historicalAchievements', 'historicalCut', 'uniqueAchievements', 'fortBattles',
     ...
     'maxComp7ArchiveGriffin', 'comp7CutArchiveGriffin', 'prestigeSystem', 'vehicleAchievements',
     'customizationAchievements', 'comp7ArchivePegasus', 'maxComp7ArchivePegasus', 'comp7CutArchivePegasus',
     'commendations', 'statTrackersVehStatsCut', 'comp7ArchiveManticore', 'maxComp7ArchiveManticore',
     'comp7CutArchiveManticore']
    updateCtx = {'dossierCompDescr': compDescr, 
       'blockSizeFormat': 'H', 
       'versionFormat': 'H', 
       'blocksLayout': blocksLayout}
    ...
    comp7SeasonsPacking = {'spotted': (32, 'I'), 'losses': (12, 'I'), 'roleSkillUsed': (132, 'I'), 'damageAssistedTrack': (56, 'I'), 
       ...
       'directHits': (28, 'I')}
    seasonsNumber = 3
    archiveSeasons('comp7ArchiveManticore', seasonsNumber, updateCtx, comp7SeasonsPacking, comp7SeasonsPacking)
    maxComp7SeasonsPacking = {'maxDamage': (3, 'H'), 'maxXPVehicle': (5, 'I'), 'maxDamageVehicle': (13, 'I'), 'maxFrags': (2, 'B'), 
       'maxXP': (0, 'H'), 'maxHealthRepair': (29, 'H'), 'maxComp7PrestigePointsVehicle': (19, 'I'), 
       'maxEquipmentDamageDealt': (23, 'H'), 'maxFragsVehicle': (9, 'I'), 
       'maxSquadWinSeries': (37, 'H'), 'maxComp7PrestigePoints': (17, 'H'), 
       'maxWinSeries': (35, 'H'), 'maxEquipmentDamageDealtVehicle': (25, 'I'), 
       'maxHealthRepairVehicle': (31, 'I')}
    archiveMaxSeasons('maxComp7ArchiveManticore', seasonsNumber, updateCtx, maxComp7SeasonsPacking)
    archiveCutSeasons('comp7CutArchiveManticore', seasonsNumber, updateCtx)
    BADGES_TO_REMOVE = (178, 179, 180)
    playerBadges = getDictBlockRecordValues(updateCtx, 'playerBadges', 'I', 'I')
    for badge_id in BADGES_TO_REMOVE:
        playerBadges.pop((badge_id,), None)

    updateDictRecords(updateCtx, 'playerBadges', 'I', 'I', playerBadges)
    setVersion(updateCtx, 166)
    return (
     166, updateCtx['dossierCompDescr'])


def __updateFromAccountDossier166(compDescr):
    blocksLayout = [
     'a15x15', 'a15x15_2', 'clan', 'clan2', 'company', 'company2', 'a7x7', 'achievements', 'vehTypeFrags',
     'a15x15Cut', 'rareAchievements', 'total', 'a7x7Cut', 'max15x15', 'max7x7', 'achievements7x7', 'historical',
     'maxHistorical', 'historicalAchievements', 'historicalCut', 'uniqueAchievements', 'fortBattles',
    ...
    getHeader(updateCtx)
    formats = [
     ('steamGetTankLevel11Medal', 'B')]
    addRecords(updateCtx, 'steamAchievements', formats, {})
    setVersion(updateCtx, 167)
    return (
     167, updateCtx['dossierCompDescr'])


def __updateFromAccountDossier167(compDescr):
    blocksLayout = [
     'a15x15', 'a15x15_2', 'clan', 'clan2', 'company', 'company2', 'a7x7', 'achievements', 'vehTypeFrags',
     'a15x15Cut', 'rareAchievements', 'total', 'a7x7Cut', 'max15x15', 'max7x7', 'achievements7x7', 'historical',
     'maxHistorical', 'historicalAchievements', 'historicalCut', 'uniqueAchievements', 'fortBattles',
    ...
    updateCtx = {'dossierCompDescr': compDescr, 
       ...
       'blocksLayout': blocksLayout}
    getHeader(updateCtx)
    BADGES_TO_REMOVE = (200, 201, 202, 152, 175)
    playerBadges = getDictBlockRecordValues(updateCtx, 'playerBadges', 'I', 'I')
    for badge_id in BADGES_TO_REMOVE:
        playerBadges.pop((badge_id,), None)

    updateDictRecords(updateCtx, 'playerBadges', 'I', 'I', playerBadges)
    setVersion(updateCtx, 168)
    return (
     168, updateCtx['dossierCompDescr'])


def __updateFromAccountDossier168(compDescr):
    blocksLayout = [
     'a15x15', 'a15x15_2', 'clan', 'clan2', 'company', 'company2', 'a7x7', 'achievements', 'vehTypeFrags',
     'a15x15Cut', 'rareAchievements', 'total', 'a7x7Cut', 'max15x15', 'max7x7', 'achievements7x7', 'historical',
     'maxHistorical', 'historicalAchievements', 'historicalCut', 'uniqueAchievements', 'fortBattles',
    ...
    updateCtx = {'dossierCompDescr': compDescr, 
       ...
       'blocksLayout': blocksLayout}
    getHeader(updateCtx)
    BADGES_TO_REMOVE = (225, 226, 227, 152)
    playerBadges = getDictBlockRecordValues(updateCtx, 'playerBadges', 'I', 'I')
    for badge_id in BADGES_TO_REMOVE:
        playerBadges.pop((badge_id,), None)

    updateDictRecords(updateCtx, 'playerBadges', 'I', 'I', playerBadges)
    setVersion(updateCtx, 169)
    return (
     169, updateCtx['dossierCompDescr'])


def __updateFromAccountDossier169(compDescr):
    blocksLayout = [
     'a15x15', 'a15x15_2', 'clan', 'clan2', 'company', 'company2', 'a7x7', 'achievements', 'vehTypeFrags',
     'a15x15Cut', 'rareAchievements', 'total', 'a7x7Cut', 'max15x15', 'max7x7', 'achievements7x7', 'historical',
     'maxHistorical', 'historicalAchievements', 'historicalCut', 'uniqueAchievements', 'fortBattles',
    ...
    getHeader(updateCtx)
    formats = [
     ('readyForBattleFossaAssault', 'B'),
     ('readyForBattleFossaSniper', 'B'),
     ('readyForBattleFossaSupport', 'B')]
    addRecords(updateCtx, 'achievements', formats, {})
    setVersion(updateCtx, 170)
    return (170, updateCtx['dossierCompDescr'])


def __updateFromAccountDossier170(compDescr):
    blocksLayout = [
     'a15x15', 'a15x15_2', 'clan', 'clan2', 'company', 'company2', 'a7x7', 'achievements', 'vehTypeFrags',
     'a15x15Cut', 'rareAchievements', 'total', 'a7x7Cut', 'max15x15', 'max7x7', 'achievements7x7', 'historical',
     'maxHistorical', 'historicalAchievements', 'historicalCut', 'uniqueAchievements', 'fortBattles',
    ...
    updateCtx = {'dossierCompDescr': compDescr, 
       ...
       'blocksLayout': blocksLayout}
    getHeader(updateCtx)
    addBlock(updateCtx, 'comp7ArchiveDragon')
    addBlock(updateCtx, 'maxComp7ArchiveDragon')
    addBlock(updateCtx, 'comp7CutArchiveDragon')
    setVersion(updateCtx, 171)
    return (
     171, updateCtx['dossierCompDescr'])


def __updateFromAccountDossier171(compDescr):
    blocksLayout = [
     'a15x15', 'a15x15_2', 'clan', 'clan2', 'company', 'company2', 'a7x7', 'achievements', 'vehTypeFrags',
     'a15x15Cut', 'rareAchievements', 'total', 'a7x7Cut', 'max15x15', 'max7x7', 'achievements7x7', 'historical',
     'maxHistorical', 'historicalAchievements', 'historicalCut', 'uniqueAchievements', 'fortBattles',
     ...
     'customizationAchievements', 'comp7ArchivePegasus', 'maxComp7ArchivePegasus', 'comp7CutArchivePegasus',
     'commendations', 'statTrackersVehStatsCut', 'comp7ArchiveManticore', 'maxComp7ArchiveManticore',
     'comp7CutArchiveManticore', 'comp7ArchiveDragon', 'maxComp7ArchiveDragon', 'comp7CutArchiveDragon']
    updateCtx = {'dossierCompDescr': compDescr, 
       'blockSizeFormat': 'H', 
       'versionFormat': 'H', 
       'blocksLayout': blocksLayout}
    ...
    comp7SeasonsPacking = {'spotted': (32, 'I'), 'losses': (12, 'I'), 'roleSkillUsed': (132, 'I'), 'damageAssistedTrack': (56, 'I'), 
       ...
       'directHits': (28, 'I')}
    seasonsNumber = 3
    archiveSeasons('comp7ArchiveDragon', seasonsNumber, updateCtx, comp7SeasonsPacking, comp7SeasonsPacking)
    maxComp7SeasonsPacking = {'maxDamage': (3, 'H'), 'maxXPVehicle': (5, 'I'), 'maxDamageVehicle': (13, 'I'), 'maxFrags': (2, 'B'), 
       'maxXP': (0, 'H'), 'maxHealthRepair': (29, 'H'), 'maxComp7PrestigePointsVehicle': (19, 'I'), 
       'maxEquipmentDamageDealt': (23, 'H'), 'maxFragsVehicle': (9, 'I'), 
       'maxSquadWinSeries': (37, 'H'), 'maxComp7PrestigePoints': (17, 'H'), 
       'maxWinSeries': (35, 'H'), 'maxEquipmentDamageDealtVehicle': (25, 'I'), 
       'maxHealthRepairVehicle': (31, 'I')}
    archiveMaxSeasons('maxComp7ArchiveDragon', seasonsNumber, updateCtx, maxComp7SeasonsPacking)
    archiveCutSeasons('comp7CutArchiveDragon', seasonsNumber, updateCtx)
    BADGES_TO_REMOVE = (231, 232, 233)
    playerBadges = getDictBlockRecordValues(updateCtx, 'playerBadges', 'I', 'I')
    for badge_id in BADGES_TO_REMOVE:
        playerBadges.pop((badge_id,), None)

    updateDictRecords(updateCtx, 'playerBadges', 'I', 'I', playerBadges)
    setVersion(updateCtx, 172)
    return (
     172, updateCtx['dossierCompDescr'])
...
def __updateFromVehicleDossier100(compDescr):
    ...
    updateCtx = {'dossierCompDescr': compDescr, 
       ...
       'blocksLayout': blocksLayout}
    getHeader(updateCtx)
    recordsPacking = {'maxDamage': (3, 'H'), 'maxFrags': (2, 'B'), 'maxXP': (0, 'H')}
...
def __updateFromVehicleDossier104(compDescr):
    blocksLayout = [
     'a15x15', 'a15x15_2', 'clan', 'clan2', 'company', 'company2', 'a7x7', 'achievements', 'vehTypeFrags',
     'total', 'max15x15', 'max7x7', 'inscriptions', 'emblems', 'camouflages', 'compensation', 'achievements7x7',
     'historical', 'maxHistorical', 'uniqueAchievements', 'fortBattles', 'maxFortBattles', 'fortSorties',
     'maxFortSorties', 'fortAchievements', 'singleAchievements', 'clanAchievements', 'rated7x7',
     'maxRated7x7', 'globalMapCommon', 'maxGlobalMapCommon', 'fallout', 'maxFallout', 'falloutAchievements',
     'ranked', 'maxRanked', 'rankedSeasons', 'a30x30', 'max30x30', 'epicBattle', 'maxEpicBattle',
     'epicBattleAchievements', 'maxRankedSeason1', 'maxRankedSeason2', 'maxRankedSeason3']
    updateCtx = {'dossierCompDescr': compDescr, 
       'blockSizeFormat': 'H', 
       'versionFormat': 'H', 
       'blocksLayout': blocksLayout}
...
def __updateFromVehicleDossier105(compDescr):
    blocksLayout = [
     ...
     'maxRated7x7', 'globalMapCommon', 'maxGlobalMapCommon', 'fallout', 'maxFallout', 'falloutAchievements',
     'ranked', 'maxRanked', 'rankedSeasons', 'a30x30', 'max30x30', 'epicBattle', 'maxEpicBattle',
     'epicBattleAchievements', 'maxRankedSeason1', 'maxRankedSeason2', 'maxRankedSeason3', 'ranked_10x10',
     'maxRanked_10x10']
    updateCtx = {'dossierCompDescr': compDescr, 
       'blockSizeFormat': 'H', 
       'versionFormat': 'H', 
    ...
    playedBonusBattlesRecords = [
     (
      116, 'I', ranked10x10Values['playedBonusBattles'])]
...
def __updateFromVehicleDossier108(compDescr):
    blocksLayout = [
     ...
     'ranked', 'maxRanked', 'rankedSeasons', 'a30x30', 'max30x30', 'epicBattle', 'maxEpicBattle',
     'epicBattleAchievements', 'maxRankedSeason1', 'maxRankedSeason2', 'maxRankedSeason3', 'ranked_10x10',
     'maxRanked_10x10', 'comp7Season1', 'maxComp7Season1', 'comp7Season2', 'maxComp7Season2']
    updateCtx = {'dossierCompDescr': compDescr, 
       'blockSizeFormat': 'H', 
       'versionFormat': 'H', 
       'blocksLayout': blocksLayout}
...
def __updateFromVehicleDossier110(compDescr):
    blocksLayout = [
     ...
     'ranked', 'maxRanked', 'rankedSeasons', 'a30x30', 'max30x30', 'epicBattle', 'maxEpicBattle',
     'epicBattleAchievements', 'maxRankedSeason1', 'maxRankedSeason2', 'maxRankedSeason3', 'ranked_10x10',
     'maxRanked_10x10', 'comp7Season1', 'maxComp7Season1', 'comp7Season2', 'maxComp7Season2', 'comp7Season3',
     'maxComp7Season3', 'comp7ArchiveGriffin', 'maxComp7ArchiveGriffin']
    updateCtx = {'dossierCompDescr': compDescr, 
       'blockSizeFormat': 'H', 
       'versionFormat': 'H', 
       'blocksLayout': blocksLayout}
...
def __updateFromVehicleDossier112(compDescr):
    blocksLayout = [
     ...
     'epicBattleAchievements', 'maxRankedSeason1', 'maxRankedSeason2', 'maxRankedSeason3', 'ranked_10x10',
     'maxRanked_10x10', 'comp7Season1', 'maxComp7Season1', 'comp7Season2', 'maxComp7Season2', 'comp7Season3',
     'maxComp7Season3', 'comp7ArchiveGriffin', 'maxComp7ArchiveGriffin', 'comp7ArchivePegasus',
...
def __updateFromVehicleDossier114(compDescr):
    blocksLayout = [
     ...
     'maxRanked_10x10', 'comp7Season1', 'maxComp7Season1', 'comp7Season2', 'maxComp7Season2', 'comp7Season3',
     'maxComp7Season3', 'comp7ArchiveGriffin', 'maxComp7ArchiveGriffin', 'comp7ArchivePegasus',
     'maxComp7ArchivePegasus', 'comp7ArchiveManticore', 'maxComp7ArchiveManticore']
    updateCtx = {'dossierCompDescr': compDescr, 
       'blockSizeFormat': 'H', 
       'versionFormat': 'H', 
       'blocksLayout': blocksLayout}
...
def __updateFromVehicleDossier116(compDescr):
    blocksLayout = [
     ...
     'maxRanked_10x10', 'comp7Season1', 'maxComp7Season1', 'comp7Season2', 'maxComp7Season2', 'comp7Season3',
     'maxComp7Season3', 'comp7ArchiveGriffin', 'maxComp7ArchiveGriffin', 'comp7ArchivePegasus',
     'maxComp7ArchivePegasus', 'comp7ArchiveManticore', 'maxComp7ArchiveManticore', 'comp7ArchiveDragon',
     'maxComp7ArchiveDragon']
    updateCtx = {'dossierCompDescr': compDescr, 
       'blockSizeFormat': 'H', 
       'versionFormat': 'H', 
       'blocksLayout': blocksLayout}
