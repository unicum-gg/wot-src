...
class ACCOUNT_ATTR:
    ...
    FORCE_ONBOARDING_DISABLED = 274877906944
...
OPT_DEVICES_RESTORE_SETTING = 'isOptionalDeviceRestoreEnabled'
...
class EVENT_TYPE:
    ...
    NAME_TO_TYPE = {'battleQuest': BATTLE_QUEST, 
       ...
       'personalMissionQuest': PERSONAL_MISSION, 
       'group': GROUP, 
       'tutorial': TUTORIAL, 
...
WINBACK_NOVICE_TOKEN = 'winback:novice'
...
ACTION_LABEL_TO_TYPE = {'blockAndTakeDamage': ACTION_TYPE.BLOCK_AND_TAKE_DAMAGE, 
   ...
   'doSmokeAssist': ACTION_TYPE.DO_SMOKE_ASSIST, 
   'doMineFieldEq': ACTION_TYPE.DO_MINEFIELD_EQ}
...
BATTLE_MODE_VEH_TAGS_EXCEPT_RANKED = BATTLE_MODE_VEHICLE_TAGS - {'ranked'}
...
INVULNERABLE_EXTRAS = ('engine', 'ammoBay', 'fuelTank', 'radio', 'gun', 'track', 'turretRotator',
                       'surveyingDevice', 'crew')
