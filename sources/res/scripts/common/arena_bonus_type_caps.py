...
class ARENA_BONUS_TYPE_CAPS():
    ...
    ALWAYS_PROCESS_PENALTIES = 'ALWAYS_PROCESS_PENALTIES'
    ...
    ANTI_OVERTURN = 'ANTI_OVERTURN'
    LIFT_OVER = 'LIFT_OVER'
    DAMAGES_ALWAYS_VISIBLE = 'DAMAGES_ALWAYS_VISIBLE'
    DOSSIER_STEPS_ACHIEVEMENTS_RANKED = 'DOSSIER_STEPS_ACHIEVEMENTS_RANKED'
    DOSSIER_SUMMARY_VEHICLE_RANKED_CUT = 'DOSSIER_SUMMARY_VEHICLE_RANKED_CUT'
    NO_POOLING = 'NO_POOLING'
    COMP7_SKILL_SWITCH = 'COMP7_SKILL_SWITCH'
