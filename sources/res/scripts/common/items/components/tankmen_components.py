...
class SPECIAL_VOICE_TAG(object):
    ...
    DR26_TIMURKA = 'DR26_Timurka_specialVoice'
    ...
    KIN_DZA_DZA_2024 = ('UefSpecialVoice', 'BiSpecialVoice', 'DyadyaVovaSpecialVoice',
                        'ScripachSpecialVoice')
    ...
    PORTAL_2025 = ('portal25_carev_specialVoice', 'portal25_vasilieva_specialVoice',
                   'portal25_koshcheev_specialVoice', 'portal25_yaginskaya_specialVoice')
    NY_2026 = ('ny26_character01_specialVoice', 'ny26_character02_specialVoice', 'ny26_character03_specialVoice',
               'ny26_character04_specialVoice', 'ny26_character05_specialVoice',
               'ny26_ded_terentiy_specialVoice')
