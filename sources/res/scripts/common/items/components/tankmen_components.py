...
class SPECIAL_VOICE_TAG(object):
    ...
    JAGER_MAILAND = 'jager_mailand_SpecialVoice'
    JAGER_MOUZAKROBAT = 'jager_mouzAkrobat_SpecialVoice'
    ...
    BP_H6 = ('tankmen_bp1006_1', 'tankmen_bp1006_2', 'tankmen_bp1006_3', 'tankmen_bp1006_4',
             'tankmen_bp1006_5', 'tankmen_bp1006_6')
    BP_19_M = ('tankmen_bp19_5', 'tankmen_bp19_6', 'tankmen_bp19_7', 'tankmen_bp19_8',
               'tankmen_bp19_9')
    BP_20_M = ('tankmen_bp20_5', 'tankmen_bp20_6', 'tankmen_bp20_7', 'tankmen_bp20_8',
               'tankmen_bp20_9')
    MT_LB_4 = 'tankmen_mtlb4_1'
    ALL = (
