...
class HANGAR_ALIASES(object):
    ...
    STRONGHOLD_TANK_CAROUSEL = 'strongholdTankCarousel'
    ...
    GF_HEADER_WIDGET = 'gfHeaderWidget'
    ...
    ARMORY_YARD_STYLE_PREVIEW = 'armoryYardStylePreview'
    ARMORY_YARD_VEH_POST_PROGRESSION = 'armoryYardVehPostProgression'
    MUSEUM_VIEW = 'museumView'
    ...
    MODIFIED_VEHICLE_PARAMETERS = 'modifiedVehicleParameters'
    STRONGHOLD_WIDGET = 'strongholdWidget'
    BATTLE_MODIFIERS_PANEL = 'battleModifiersPanel'
    ...
    BIRTHDAY_HEADER_ENTRY_POINT = 'BirthdayHeaderEntryPoint'
    BLACK_MARKET_ENTRY_POINT = 'BlackMarketEntryPoint'
    PARAGONS_BANNER_ENTRY_POINT = 'ParagonsBannerEntryPoint'
    SUMMER_SALE_ENTRY_POINT = 'SummerSaleEntryPoint'
    TANK_ACADEMY_ENTRY_POINT = 'TankAcademyEntryPoint'
    WT_EVENT_ENTRY_POINT = 'WTEventEntryPoint'
    WT_HEADER_WIDGET = 'wtHeaderWidget'
    WT_LOOT_BOXES_WIDGET = 'wtLootBoxesWidget'
    WT_CAROUSEL_WIDGET = 'wtCarouselWidget'
    WT_CREW_WIDGET = 'wtCrewWidget'
    WT_VEHICLE_PARAMS_WIDGET = 'wtVehicleParamsWidget'