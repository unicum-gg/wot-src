...
class BATTLE_EFFICIENCY_TYPES(object):
    ...
    DAMAGE_MODIFIER_ABILITY = 'damageModifierAbility'
    ...
    RECEIVED_BY_ENERGY_SHIELD = 'wtReceivedByEnergyShield'
    DEALT_BY_ENERGY_SHIELD = 'wtDealtByEnergyShield'
    DEALT_BY_MISSILE = 'wtDealtByMissile'
    RECEIVED_BY_MISSILE = 'wtReceivedByMissile'
    RECEIVED_BY_ANOMALY = 'wtReceivedByAnomaly'
    DEALT_BY_ANOMALY = 'wtDealtByAnomaly'
    RECEIVED_BY_STUN_AREA_MOD_A = 'wtReceivedByStunAreaModA'
    DEALT_BY_STUN_AREA_MOD_A = 'wtDealtByStunAreaModA'