...
class BATTLE_VIEW_ALIASES(object):
    ...
    COMP7_SIXTH_SENSE_INDICATOR = 'comp7SixthSenseIndicator'
    ...
    CONCENTRATION_WIDGET = 'concentrationWidget'
    CHARGE_SHOT_WIDGET = 'chargeShotWidget'
    STANCE_DANCE_WIDGET_FIGHT = 'stanceDanceFightWidget'
    STANCE_DANCE_WIDGET_TURBO = 'stanceDanceTurboWidget'
    POWER_WIDGET = 'powerWidget'
    SUPPORT_WEAPON = 'supportWeapon'
    PILLBOX_SIEGE_WIDGET = 'pillboxSiegeWidget'
    TARGET_DESIGNATOR_WIDGET = 'targetDesignatorWidget'
    CHARGEABLE_BURST_WIDGET = 'chargeableBurstWidget'
    ...
    AUXILIARY_ROCKET_LAUNCHER_WIDGET = 'auxiliaryRocketLauncherWidget'
    SHELL_PARAMS_SWITCHER_WIDGET = 'shellParamsSwitcherWidget'
    SHELL_CALIBRATION_WIDGET = 'shellCalibrationWidget'
    ...
    PILLBOX_SIEGE_DECORATIVE_CROSSHAIR = 'pillboxSiegeDecorativeCrosshair'
    OVERHEAT_DECORATIVE_CROSSHAIR = 'overheatDecorativeCrosshair'
    FURY_DECORATIVE_CROSSHAIR = 'furyDecorativeCrosshair'
    ...
    SIGHT_POINTER_UNDER_SCANNING_INDICATOR = 'sightPointerUnderScanningIndicator'
    SIGHT_POINTER_SPOTTED_INDICATOR = 'sightPointerSpottedIndicator'
