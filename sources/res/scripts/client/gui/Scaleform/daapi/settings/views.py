...
class VIEW_ALIAS(COMMON_VIEW_ALIAS):
    ...
    RESOURCE_WELL_PROGRESSION = 'resourceWellProgression'
    RESOURCE_WELL_COMPLETED_PROGRESSION = 'resourceWellCompletedProgression'
    ...
    MAPS_TRAINING_BATTLE_RESULTS = 'mapsTrainingBattleResults'
    ...
    PET_EVENT = 'petEvent'
    PET_EVENT_FULLSCREEN = 'petEventFullscreen'
    JM_MAP_VIEW = 'jmMapView'
...
VIEW_BATTLE_PAGE_ALIAS_BY_ARENA_GUI_TYPE = {ARENA_GUI_TYPE.EPIC_RANDOM: VIEW_ALIAS.EPIC_RANDOM_PAGE, 
   ...
   ARENA_GUI_TYPE.EPIC_TRAINING: VIEW_ALIAS.EPIC_BATTLE_PAGE, ARENA_GUI_TYPE.EVENT_BATTLES: VIEW_ALIAS.EVENT_BATTLE_PAGE, 
