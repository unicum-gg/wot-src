...
def getViewSettings():
    ...
    from gui.Scaleform.daapi.view.lobby.vehicle_preview.stat_track_vehicle_preview import StatTrackVehiclePreview
    ...
    return (
     ...
     ViewSettings(VIEW_ALIAS.STAT_TRACK_VEHICLE_PREVIEW, StatTrackVehiclePreview, 'vehiclePreview.swf', WindowLayer.SUB_VIEW, VIEW_ALIAS.STAT_TRACK_VEHICLE_PREVIEW, ScopeTemplates.LOBBY_SUB_SCOPE),
     ...
     ViewSettings(VIEW_ALIAS.EARLY_ACCESS_VEHICLE_PREVIEW, EarlyAccessVehiclePreview, 'vehiclePreview.swf', WindowLayer.SUB_VIEW, VIEW_ALIAS.EARLY_ACCESS_VEHICLE_PREVIEW, ScopeTemplates.LOBBY_SUB_SCOPE),
...
class LobbyPackageBusinessHandler(PackageBusinessHandler):
    ...
    def __init__(self):
        listeners = (
         ...
         (
          VIEW_ALIAS.EARLY_ACCESS_VEHICLE_PREVIEW, self.loadViewByCtxEvent),
         (
         ...
         (
          VIEW_ALIAS.STAT_TRACK_VEHICLE_PREVIEW, self.loadViewByCtxEvent))
...
class LobbyDialogsHandler(PackageBusinessHandler):
    ...
    def __punishmentWindowHandler(self, event):
        self.loadViewWithGenName(VIEW_ALIAS.PUNISHMENT_DIALOG, None, event.meta, event.handler)
        return
