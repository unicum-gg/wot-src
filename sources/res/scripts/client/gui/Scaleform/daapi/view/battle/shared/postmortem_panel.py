import logging, typing, WWISE, BattleReplay, BigWorld
...
class PostmortemPanel(_SummaryPostmortemPanel):
    __slots__ = ('__playerInfo', '_isPlayerVehicle', '__maxHealth', '__healthPercent',
                 '__isInPostmortem', '_deathAlreadySet', '__isColorBlind')
    ...
    def _buildVehicleDeathDisplayData(self, vTypeInfoVO, vehClass=None, vehImg=None, vehLvl=None, vehName=None):
        ...
        if vTypeInfoVO.isOnlyForBattleRoyaleBattles:
            ...
            vehImg = backport.image(R.images.gui.maps.icons.vehicle.small.dyn(Vehicle.getIconResourceName(iconName))())
        if vehLvl is None:
        ...
        return (
         vehClass, vehImg, vehLvl, vehName)
