...
class PoICapturingSN(PointOfInterestSN):
    ...
    def getIconNames(self, value=None):
        ...
        if poiType == PoiType.ILLUMINATION_FLARE:
            return (_LINKS.POI_GREEN_ILLUMINATION_FLARE_ICON, _LINKS.POI_GREEN_ILLUMINATION_FLARE_SMALL_ICON)
        return (
         self.NOT_CHANGE_DEFAULT_ICON, self.NOT_CHANGE_DEFAULT_ICON)
...
class PoICooldownSN(PointOfInterestSN):
    ...
    def getIconNames(self, value=None):
        ...
        if poiType == PoiType.ILLUMINATION_FLARE:
            return (_LINKS.POI_ORANGE_ILLUMINATION_FLARE_ICON, _LINKS.POI_ORANGE_ILLUMINATION_FLARE_SMALL_ICON)
        return (
         self.NOT_CHANGE_DEFAULT_ICON, self.NOT_CHANGE_DEFAULT_ICON)
