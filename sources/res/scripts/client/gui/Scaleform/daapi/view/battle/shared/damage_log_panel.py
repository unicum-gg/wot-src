...
_MODE_IMAGES = {BATTLE_LOG_MECHANIC_SHOT.NOT_DEFINED: '', 
...
class _ShellModeImgVOModel(_VOModel):
    shellModeImg = _VOModelProperty(name='shellModeImg')
...
class _ShellModeImgVOBuilder(_IVOBuilder):
    ...
    def _getShellModeImg(self, info):
        if info.isShot():
            return _MODE_IMAGES.get(info.getAttackerMechanicShotMode(), '')
...
class _DamageActionImgVOBuilder(_ActionImgVOBuilder):
    __slots__ = ('__shotIcon', '__fireIcon', '__ramIcon', '__wcIcon', '__berserkerIcon',
                 '__spawnBotDmgIcon', '__mineFieldIcon', '__smokeDmgIcon', '__corrodingShotDmgIcon',
                 '__fireCircleDmgIcon', '__clingBranderDmgIcon', '__thunderStrikeIcon',
                 '__airstrikeIcon', '__artilleryIcon', '__airstrikeZoneIcon', '__deathZoneIcon',
                 '__battleshipIcon', '__destroyerIcon', '__heRocketIcon')
