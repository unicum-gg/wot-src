...
from gui.Scaleform.daapi.view.lobby.storage.inventory.inventory_cm_handlers import ModulesShellsCMHandler, ModulesShellsNoSaleCMHandler, DemountKitsCMHandler, RecertificationFormsCMHandler, MentoringLicensesCMHandler
...
def getSectionsList():
    return (
     ...
     {'id': STORAGE_CONSTANTS.PERSONAL_RESERVES, 
        ...
        'viewId': STORAGE_CONSTANTS.PERSONAL_RESERVES_VIEW, 
