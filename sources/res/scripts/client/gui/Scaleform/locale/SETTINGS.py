...
class SETTINGS(object):
    ...
    UI_EFFECTS = '#settings:UI_EFFECTS'
    UI_EFFECTS_HEADER = '#settings:UI_EFFECTS/header'
    UI_EFFECTS_BODY = '#settings:UI_EFFECTS/body'
    UI_EFFECTS_ATTENTION = '#settings:UI_EFFECTS/attention'
    ...
    SOUND_VIVOX_BUTTONS_TEST_INIT = '#settings:sound/vivox/buttons/test_init'
    ...
    FEEDBACK_TAB_BATTLEEVENTS_CHECKBOX_STUN = '#settings:feedback/tab/battleEvents/checkbox/Stun'
    ...
    FEEDBACK_TAB_RIBBONS_STUN = '#settings:feedback/tab/ribbons/stun'
    ...
    FEEDBACK_TAB_SIXTHSENSE = '#settings:feedback/tab/sixthSense'
    FEEDBACK_TAB_SIXTHSENSE_ALPHA = '#settings:feedback/tab/sixthSense/alpha'
    FEEDBACK_TAB_SIXTHSENSE_SIZE = '#settings:feedback/tab/sixthSense/size'
    FEEDBACK_TAB_SIXTHSENSE_SIZE_SMALL = '#settings:feedback/tab/sixthSense/size/small'
    FEEDBACK_TAB_SIXTHSENSE_SIZE_BIG = '#settings:feedback/tab/sixthSense/size/big'
    ...
    GAME_ENABLEBATTLECONTEXTHINTS_LABEL = '#settings:game/enableBattleContextHints/label'
    GAME_ENABLEBATTLECONTEXTHINTS_CHECKBOX = '#settings:game/enableBattleContextHints/checkbox'
    GAME_RESETBATTLECONTEXTHINTS_BUTTON = '#settings:game/resetBattleContextHints/button'
