...
class MENU(object):
    ...
    MAPBLACKLIST_TIMELEFTSHORT = '#menu:mapBlackList/timeLeftShort'
    ...
    BOOSTERS_TIMELEFT = '#menu:boosters/timeLeft'
    HEADERBUTTONS_FIGHTBTN_TOOLTIP_COMP7BANISSET = '#menu:headerButtons/fightBtn/tooltip/comp7BanIsSet'
    COPY = '#menu:copy'
    LEGAL = '#menu:legal'
    LEGALINFO_CLOSEBTN = '#menu:legalInfo/closeBtn'
    LOGIN_RSS_READMORE = '#menu:login/rss/readMore'
    LOGIN_SERVER = '#menu:login/server'
    LOGIN_ACCOUNT = '#menu:login/account'
    LOGIN_CHANGEAACCOUNT = '#menu:login/changeAaccount'
    LOGIN_SUBMITBYSOCIAL = '#menu:login/submitBySocial'
    LOGIN_FASTENTER = '#menu:login/fastEnter'
    LOGIN_LOGIN = '#menu:login/login'
    LOGIN_VERSION = '#menu:login/version'
    LOGIN_PASSWORD = '#menu:login/password'
    LOGIN_REGISTRATIONLINK = '#menu:login/registrationLink'
    LOGIN_RECOVERYLINK = '#menu:login/recoveryLink'
    LOGIN_REMEMBERPASSWORD = '#menu:login/rememberPassword'
    LOGIN_REMEMBERPASSWORDIGR = '#menu:login/rememberPasswordIgr'
    LOGIN_REMEMBERPASSWORDIGRWARNING = '#menu:login/rememberPasswordIgrWarning'
    LOGIN_OK = '#menu:login/ok'
    LOGIN_AUTO = '#menu:login/auto'
    LOGIN_CAPS = '#menu:login/caps'
    LOGIN_QUITFROMAUTOLOGIN = '#menu:login/quitFromAutoLogin'
    LOGIN_STATUS_EMPTY_LOGIN = '#menu:login/status/empty_login'
    LOGIN_STATUS_INVALID_LOGIN_LENGTH = '#menu:login/status/invalid_login_length'
    ...
    LOGIN_STATUS_CONNECTION_FAILED = '#menu:login/status/CONNECTION_FAILED'
    LOGIN_STATUS_DNS_LOOKUP_FAILED = '#menu:login/status/DNS_LOOKUP_FAILED'
    LOGIN_STATUS_UNKNOWN_ERROR = '#menu:login/status/UNKNOWN_ERROR'
    LOGIN_STATUS_CANCELLED = '#menu:login/status/CANCELLED'
    ...
    LOGIN_STATUS_LOGIN_REJECTED_SERVER_NOT_READY = '#menu:login/status/LOGIN_REJECTED_SERVER_NOT_READY'
    LOGIN_STATUS_LOGIN_REJECTED_BASEAPP_OVERLOAD = '#menu:login/status/LOGIN_REJECTED_BASEAPP_OVERLOAD'
    LOGIN_STATUS_LOGIN_REJECTED_CELLAPP_OVERLOAD = '#menu:login/status/LOGIN_REJECTED_CELLAPP_OVERLOAD'
    LOGIN_STATUS_LOGIN_REJECTED_DBMGR_OVERLOAD = '#menu:login/status/LOGIN_REJECTED_DBMGR_OVERLOAD'
    LOGIN_STATUS_LOGIN_REJECTED_LOGINS_NOT_ALLOWED = '#menu:login/status/LOGIN_REJECTED_LOGINS_NOT_ALLOWED'
    ...
    LOGIN_STATUS_LOGIN_REJECTED_DB_NOT_READY = '#menu:login/status/LOGIN_REJECTED_DB_NOT_READY'
    LOGIN_STATUS_LOGIN_REJECTED_NO_BASEAPPS = '#menu:login/status/LOGIN_REJECTED_NO_BASEAPPS'
    LOGIN_STATUS_LOGIN_REJECTED_NO_LOGINAPP_RESPONSE = '#menu:login/status/LOGIN_REJECTED_NO_LOGINAPP_RESPONSE'
    LOGIN_STATUS_LOGIN_REJECTED_NO_LOGINAPP = '#menu:login/status/LOGIN_REJECTED_NO_LOGINAPP'
    LOGIN_STATUS_LOGIN_REJECTED_BASEAPP_TIMEOUT = '#menu:login/status/LOGIN_REJECTED_BASEAPP_TIMEOUT'
    LOGIN_STATUS_LOGIN_REJECTED_BASEAPPMGR_TIMEOUT = '#menu:login/status/LOGIN_REJECTED_BASEAPPMGR_TIMEOUT'
    LOGIN_STATUS_LOGIN_MALFORMED_REQUEST = '#menu:login/status/LOGIN_MALFORMED_REQUEST'
    LOGIN_STATUS_PUBLIC_KEY_LOOKUP_FAILED = '#menu:login/status/PUBLIC_KEY_LOOKUP_FAILED'
    LOGIN_STATUS_ALREADY_ONLINE_LOCALLY = '#menu:login/status/ALREADY_ONLINE_LOCALLY'
    LOGIN_STATUS_LOGIN_REJECTED_BAN = '#menu:login/status/LOGIN_REJECTED_BAN'
    LOGIN_STATUS_LOGIN_REJECTED_BAN_UNLIMITED = '#menu:login/status/LOGIN_REJECTED_BAN_UNLIMITED'
    LOGIN_STATUS_LOGIN_CUSTOM_DEFINED_ERROR = '#menu:login/status/LOGIN_CUSTOM_DEFINED_ERROR'
    LOGIN_STATUS_LOGIN_REJECTED_LOGIN_QUEUE = '#menu:login/status/LOGIN_REJECTED_LOGIN_QUEUE'
    ...
    LOGIN_STATUS_LOGIN_REJECTED_IP_ADDRESS_BAN = '#menu:login/status/LOGIN_REJECTED_IP_ADDRESS_BAN'
    ...
    LOADING_BATTLETYPES_6 = '#menu:loading/battleTypes/6'
    ...
    LOADING_BATTLETYPES_11 = '#menu:loading/battleTypes/11'
    ...
    LOADING_BATTLETYPES_35 = '#menu:loading/battleTypes/35'
    LOADING_BATTLETYPES_DESC_35 = '#menu:loading/battleTypes/desc/35'
    ...
    REPORT_CONTENT = '#menu:report_content'
    ...
    TANKMANTRAININGWINDOW_TITLE = '#menu:tankmanTrainingWindow/title'
    ...
    TANKMANTRAININGWINDOW_CLOSEBTN = '#menu:tankmanTrainingWindow/closeBtn'
    TANKMANRECRUITRENDERER_PERSONALCASE = '#menu:tankmanRecruitRenderer/personalCase'
    TANKMANRECRUITRENDERER_COMMANDER = '#menu:tankmanRecruitRenderer/commander'
    TANKMANRECRUITRENDERER_GUNNER = '#menu:tankmanRecruitRenderer/gunner'
    TANKMANRECRUITRENDERER_LOADER = '#menu:tankmanRecruitRenderer/loader'
    TANKMANRECRUITRENDERER_DRIVER = '#menu:tankmanRecruitRenderer/driver'
    TANKMANRECRUITRENDERER_RADIOMAN = '#menu:tankmanRecruitRenderer/radioman'
    TANKMANRECRUITRENDERER_DESCR = '#menu:tankmanRecruitRenderer/descr'
    TANKMANRECRUITRENDERER_UNLOAD = '#menu:tankmanRecruitRenderer/unload'
    CAROUSEL_TANK_FILTER_ALL = '#menu:carousel_tank_filter/all'
    CAROUSEL_TANK_FILTER_LIGHTTANK = '#menu:carousel_tank_filter/lightTank'
    CAROUSEL_TANK_FILTER_MEDIUMTANK = '#menu:carousel_tank_filter/mediumTank'
    CAROUSEL_TANK_FILTER_HEAVYTANK = '#menu:carousel_tank_filter/heavyTank'
    CAROUSEL_TANK_FILTER_AT_SPG = '#menu:carousel_tank_filter/AT-SPG'
    CAROUSEL_TANK_FILTER_SPG = '#menu:carousel_tank_filter/SPG'
    CAROUSEL_TANK_FILTER_ASSAULT = '#menu:carousel_tank_filter/assault'
    CAROUSEL_TANK_FILTER_UNIVERSAL = '#menu:carousel_tank_filter/universal'
    CAROUSEL_TANK_FILTER_BREAK = '#menu:carousel_tank_filter/break'
    CAROUSEL_TANK_FILTER_SNIPER = '#menu:carousel_tank_filter/sniper'
    CAROUSEL_TANK_FILTER_SUPPORT = '#menu:carousel_tank_filter/support'
    CAROUSEL_TANK_FILTER_SCOUT = '#menu:carousel_tank_filter/scout'
    ...
    STORE_VEHICLESTATES_CREWNOTFULL = '#menu:store/vehicleStates/crewNotFull'
    ...
    CURRENTVEHICLESTATUS_UNSUITABLETOQUEUE = '#menu:currentVehicleStatus/unsuitableToQueue'
    ...
    AMMORELOAD_RELOADTITLE = '#menu:ammoReload/reloadTitle'
    AMMORELOAD_ONINVENTORY = '#menu:ammoReload/onInventory'
    AMMORELOAD_ADDITIONBUY = '#menu:ammoReload/additionBuy'
    AMMORELOAD_INTANK = '#menu:ammoReload/inTank'
    AMMORELOAD_PIERCINGPOWER_TITLE = '#menu:ammoReload/piercingPower/title'
    AMMORELOAD_PIERCINGPOWER_UNITS = '#menu:ammoReload/piercingPower/units'
    AMMORELOAD_DAMAGE_TITLE = '#menu:ammoReload/damage/title'
    AMMORELOAD_DAMAGE_UNITS = '#menu:ammoReload/damage/units'
    AMMORELOAD_AUTOFILL = '#menu:ammoReload/autoFill'
    AMMORELOAD_CLEARAMMUNITION = '#menu:ammoReload/clearAmmunition'
    AMMORELOAD_CANCEL = '#menu:ammoReload/cancel'
    ...
    PREBATTLE_SEARCHPLAYERS = '#menu:prebattle/searchPlayers'
    PREBATTLE_BATTLEREADY = '#menu:prebattle/battleReady'
    ...
    PREBATTLE_INVITATIONS_LABELS_DEFAULTINVITETEXT_TOOLTIP = '#menu:prebattle/invitations/labels/defaultInviteText/tooltip'
    PREBATTLE_INVITATIONS_BUTTONS_SEARCH = '#menu:prebattle/invitations/buttons/search'
    PREBATTLE_INVITATIONS_BUTTONS_SEND = '#menu:prebattle/invitations/buttons/send'
    PREBATTLE_INVITATIONS_BUTTONS_CANCEL = '#menu:prebattle/invitations/buttons/cancel'
    PREBATTLE_INVITATIONS_ERRORS_USEROFFLINE = '#menu:prebattle/invitations/errors/userOffline'
    PREBATTLE_INVITATIONS_ERRORS_EXISTSINRECEIVELIST = '#menu:prebattle/invitations/errors/existsInReceiveList'
    PREBATTLE_INVITATIONS_ERRORS_SELECTUSERTOADD = '#menu:prebattle/invitations/errors/selectUserToAdd'
    PREBATTLE_INVITATIONS_ERRORS_SELECTUSERTOREMOVE = '#menu:prebattle/invitations/errors/selectUserToRemove'
    PREBATTLE_INVITATIONS_ERRORS_USERLISTEMPTY = '#menu:prebattle/invitations/errors/userListEmpty'
    PREBATTLE_INVITATIONS_ERRORS_RECEIVERLISTEMPTY = '#menu:prebattle/invitations/errors/receiverListEmpty'
    PREBATTLE_INVITATIONS_ERRORS_ADDIGNOREDUSER = '#menu:prebattle/invitations/errors/addIgnoredUser'
    PREBATTLE_INVITATIONS_ERRORS_NOTFOUNDUSERS = '#menu:prebattle/invitations/errors/notFoundUsers'
    NATIONS_TITLE = '#menu:nations/title'
    NATIONS_USSR = '#menu:nations/ussr'
    NATIONS_GERMANY = '#menu:nations/germany'
    NATIONS_USA = '#menu:nations/usa'
    NATIONS_FRANCE = '#menu:nations/france'
    ...
    LEVELS_4 = '#menu:levels/4'
    LEVELS_5 = '#menu:levels/5'
    LEVELS_6 = '#menu:levels/6'
    LEVELS_7 = '#menu:levels/7'
    ...
    LEVELS_ROMAN_4 = '#menu:levels/roman/4'
    LEVELS_ROMAN_5 = '#menu:levels/roman/5'
    LEVELS_ROMAN_6 = '#menu:levels/roman/6'
    LEVELS_ROMAN_7 = '#menu:levels/roman/7'
    ...
    NATION_TREE_TITLE_USA = '#menu:nation_tree/title/usa'
    NATION_TREE_TITLE_FRANCE = '#menu:nation_tree/title/france'
    ...
    TANK_PARAMS_FURYMAXRELOADEFFAVGDPM = '#menu:tank_params/furyMaxReloadEffAvgDpm'
    TANK_PARAMS_FURYMAXRELOADEFFICIENCYLEVEL = '#menu:tank_params/furyMaxReloadEfficiencyLevel'
    TANK_PARAMS_FURYRELOADSPEEDBONUSPEREFFICIENCYLEVEL = '#menu:tank_params/furyReloadSpeedBonusPerEfficiencyLevel'
    TANK_PARAMS_FURYRELOADEFFICIENCYLEVELDURATION = '#menu:tank_params/furyReloadEfficiencyLevelDuration'
    TANK_PARAMS_FURYRELOADEFFICIENCYLEVELPERHIT = '#menu:tank_params/furyReloadEfficiencyLevelPerHit'
    TANK_PARAMS_FURYRELOADEFFICIENCYLEVELPERDESTRUCTION = '#menu:tank_params/furyReloadEfficiencyLevelPerDestruction'
    TANK_PARAMS_ACCURACYDISPERSIONCAP = '#menu:tank_params/accuracyDispersionCap'
    TANK_PARAMS_ACCURACYWHILEMOVINGDISPERSIONCAP = '#menu:tank_params/accuracyWhileMovingDispersionCap'
    TANK_PARAMS_MAXACCURACYLEVEL = '#menu:tank_params/maxAccuracyLevel'
    TANK_PARAMS_ACCURACYDISPERSIONPERLEVEL = '#menu:tank_params/accuracyDispersionPerLevel'
    TANK_PARAMS_ACCURACYSPEEDLIMIT = '#menu:tank_params/accuracySpeedLimit'
    TANK_PARAMS_ACCURACYLEVELGAINTIME = '#menu:tank_params/accuracyLevelGainTime'
    TANK_PARAMS_PREHEATDMGCAP = '#menu:tank_params/preheatDmgCap'
    TANK_PARAMS_PREHEATDISPERSIONCAP = '#menu:tank_params/preheatDispersionCap'
    TANK_PARAMS_PREHEATTIMETOFULL = '#menu:tank_params/preheatTimeToFull'
    TANK_PARAMS_PREHEATTIMETOZERO = '#menu:tank_params/preheatTimeToZero'
    TANK_PARAMS_PREHEATSPEEDLIMIT = '#menu:tank_params/preheatSpeedLimit'
    TANK_PARAMS_PREHEATTRANSITIONDELAY = '#menu:tank_params/preheatTransitionDelay'
    TANK_PARAMS_ENGINEPOWERWITHBOOSTERS = '#menu:tank_params/enginePowerWithBoosters'
    TANK_PARAMS_TOPSPEEDWITHBOOSTERS = '#menu:tank_params/topSpeedWithBoosters'
    TANK_PARAMS_REVERSESPEEDREDUCTIONWITHBOOSTERS = '#menu:tank_params/reverseSpeedReductionWithBoosters'
    TANK_PARAMS_TRAVERSESPEEDREDUCTIONWITHBOOSTERS = '#menu:tank_params/traverseSpeedReductionWithBoosters'
    TANK_PARAMS_BOOSTERDURATION = '#menu:tank_params/boosterDuration'
    TANK_PARAMS_BOOSTERCOOLINGTIME = '#menu:tank_params/boosterCoolingTime'
    TANK_PARAMS_REACTIVATIONLIMIT = '#menu:tank_params/reactivationLimit'
    TANK_PARAMS_REACTIVATIONDELAY = '#menu:tank_params/reactivationDelay'
    TANK_PARAMS_HEATAVGDMGPERLVL = '#menu:tank_params/heatAvgDmgPerLvl'
    TANK_PARAMS_HEATTIMETOREACHLEVEL = '#menu:tank_params/heatTimeToReachLevel'
    TANK_PARAMS_HEATTIMEBEFOREOVERHEAT = '#menu:tank_params/heatTimeBeforeOverheat'
    TANK_PARAMS_HEATCHARGEOVERHEATDURATION = '#menu:tank_params/heatChargeOverheatDuration'
    TANK_PARAMS_PASSIVECOINCIDECESHOOTINGCHARGE = '#menu:tank_params/passiveCoincideceShootingCharge'
    TANK_PARAMS_ACTIVECOINCIDECESHOOTINGCHARGE = '#menu:tank_params/activeCoincideceShootingCharge'
    TANK_PARAMS_COINCIDENCEELECTROMECHANICALSIGHTDURATION = '#menu:tank_params/coincidenceElectromechanicalSightDuration'
    TANK_PARAMS_AIMINGTIMECOINCIDENCEELECTROMECHANICALSIGHT = '#menu:tank_params/aimingTimeCoincidenceElectromechanicalSight'
    TANK_PARAMS_DISPERSIONAT100MCOINCIDENCEELECTROMECHANICALSIGHT = '#menu:tank_params/dispersionAt100mCoincidenceElectromechanicalSight'
    TANK_PARAMS_RELOADTIMECOINCIDENCE = '#menu:tank_params/reloadTimeCoincidence'
    TANK_PARAMS_SWITCHENGINEMODEBOTHMODES = '#menu:tank_params/switchEngineModeBothModes'
    TANK_PARAMS_TURBOSPEEDCAP = '#menu:tank_params/turboSpeedCap'
    TANK_PARAMS_ENGINETURBOPOWERCAP = '#menu:tank_params/engineTurboPowerCap'
    TANK_PARAMS_AIMINGTIMETURBO = '#menu:tank_params/aimingTimeTurbo'
    TANK_PARAMS_MOVEMENTTRAVERSEDISPERSIONTURBO = '#menu:tank_params/movementTraverseDispersionTurbo'
    TANK_PARAMS_HULLTRAVERSEDISPERSIONTURBO = '#menu:tank_params/hullTraverseDispersionTurbo'
    TANK_PARAMS_GUNTRAVERSEDISPERSIONTURBO = '#menu:tank_params/gunTraverseDispersionTurbo'
    TANK_PARAMS_IONAFTERBURNERPASSIVETURBOCHARGE = '#menu:tank_params/ionAfterburnerPassiveTurboCharge'
    TANK_PARAMS_IONAFTERBURNERACTIVETURBOCHARGE = '#menu:tank_params/ionAfterburnerActiveTurboCharge'
    TANK_PARAMS_IONAFTERBURNERDURATION = '#menu:tank_params/ionAfterburnerDuration'
    TANK_PARAMS_IONAFTERBURNERDURATIONSPEEDCAP = '#menu:tank_params/ionAfterburnerDurationSpeedCap'
    TANK_PARAMS_IONAFTERBURNERDURATIONENGINEPOWER = '#menu:tank_params/ionAfterburnerDurationEnginePower'
    TANK_PARAMS_DESIGNATORINITIALCOOLDOWNS = '#menu:tank_params/designatorInitialCooldownS'
    ...
    TANK_PARAMS_SHELLCALIBRATIONAVGPENETRATION = '#menu:tank_params/shellCalibrationAvgPenetration'
    TANK_PARAMS_SHELLCALIBRATIONAVGDAMAGE = '#menu:tank_params/shellCalibrationAvgDamage'
    ...
    TANK_PARAMS_FORWARDMAXSPEED = '#menu:tank_params/forwardMaxSpeed'
    TANK_PARAMS_CHASSISMODULEROTATIONSPEED = '#menu:tank_params/chassisModuleRotationSpeed'
    TANK_PARAMS_TURRETMODULEROTATIONSPEED = '#menu:tank_params/turretModuleRotationSpeed'
    TANK_PARAMS_GUNMODULEAVGDAMAGELIST = '#menu:tank_params/gunModuleAvgDamageList'
    ...
    TANK_PARAMS_RADARRADIUS = '#menu:tank_params/radarRadius'
    TANK_PARAMS_RADARCOOLDOWN = '#menu:tank_params/radarCooldown'
    ...
    TANK_PARAMS_IMPROVEDDAMAGEENEMIESBYRAMMING = '#menu:tank_params/improvedDamageEnemiesByRamming'
    TANK_PARAMS_IMPROVEDDAMAGEENEMIESCHASSISBYRAMMING = '#menu:tank_params/improvedDamageEnemiesChassisByRamming'
    TANK_PARAMS_CONCENTRATIONMODECOOLDOWN = '#menu:tank_params/concentrationModeCooldown'
    TANK_PARAMS_CONCENTRATIONMODEDURATION = '#menu:tank_params/concentrationModeDuration'
    TANK_PARAMS_EXTRASHOTCLIPRELOADTIME = '#menu:tank_params/extraShotClipReloadTime'
    TANK_PARAMS_POWERMODETHRESHOLD = '#menu:tank_params/powerModeThreshold'
    TANK_PARAMS_POWERMODEDURATION = '#menu:tank_params/powerModeDuration'
    TANK_PARAMS_SECONDARYRELOADTIMESECS = '#menu:tank_params/secondaryReloadTimeSecs'
    TANK_PARAMS_SECONDARYTOTALBURSTSIZE = '#menu:tank_params/secondaryTotalBurstSize'
    TANK_PARAMS_SECONDARYAVGDAMAGE = '#menu:tank_params/secondaryAvgDamage'
    TANK_PARAMS_SECONDARYAVGPIERCINGPOWER = '#menu:tank_params/secondaryAvgPiercingPower'
    TANK_PARAMS_PILLBOXHORIZONTALROTATIONSPEED = '#menu:tank_params/pillboxHorizontalRotationSpeed'
    TANK_PARAMS_PILLBOXVERTICALROTATIONSPEED = '#menu:tank_params/pillboxVerticalRotationSpeed'
    TANK_PARAMS_PILLBOXSWITCHONTIME = '#menu:tank_params/pillboxSwitchOnTime'
    TANK_PARAMS_PILLBOXSWITCHOFFTIME = '#menu:tank_params/pillboxSwitchOffTime'
    TANK_PARAMS_CHARGEABLEBURSTPENETRATIONCOUNT = '#menu:tank_params/chargeableBurstPenetrationCount'
    TANK_PARAMS_CHARGEABLEBURSTSIZE = '#menu:tank_params/chargeableBurstSize'
    TANK_PARAMS_CHARGEABLEBURSTRELOAD = '#menu:tank_params/chargeableBurstReload'
    TANK_PARAMS_CHARGEABLEBURSTDISPERSION = '#menu:tank_params/chargeableBurstDispersion'
    TANK_PARAMS_STATIONARYRELOADSWITCHONTIME = '#menu:tank_params/stationaryReloadSwitchOnTime'
    TANK_PARAMS_STATIONARYRELOADSWITCHOFFTIME = '#menu:tank_params/stationaryReloadSwitchOffTime'
    TANK_PARAMS_EXTENDEDTITLE_DUALACCURACYCOOLINGDELAY = '#menu:tank_params/extendedTitle/dualAccuracyCoolingDelay'
    TANK_PARAMS_EXTENDEDTITLE_BUSTLEFEEDSWITCHINGTOBAF = '#menu:tank_params/extendedTitle/bustleFeedSwitchingToBAF'
    TANK_PARAMS_EXTENDEDTITLE_BUSTLEFEEDMAXSPEED = '#menu:tank_params/extendedTitle/bustleFeedMaxSpeed'
    ...
    TANK_PARAMS_VALUES_PARAM12_VALUE3 = '#menu:tank_params/values/param12/value3'
    TANK_PARAMS_VALUES_PARAM10_VALUE0 = '#menu:tank_params/values/param10/value0'
    TANK_PARAMS_VALUES_PARAM10_VALUE1 = '#menu:tank_params/values/param10/value1'
    TANK_PARAMS_VALUES_PARAM10_VALUE2 = '#menu:tank_params/values/param10/value2'
    TANK_PARAMS_VALUES_PARAM10_VALUE3 = '#menu:tank_params/values/param10/value3'
    TANK_PARAMS_VALUES_PARAM11_VALUE0 = '#menu:tank_params/values/param11/value0'
    TANK_PARAMS_VALUES_PARAM11_VALUE1 = '#menu:tank_params/values/param11/value1'
    ...
    TANK_PARAMS_SHELLPARAMSSWITCHINGTIME = '#menu:tank_params/shellParamsSwitchingTime'
    ...
    TANK_PARAMS_FACTOR = '#menu:tank_params/factor'
    TANK_PARAMS_KG = '#menu:tank_params/kg'
    TANK_PARAMS_MPS = '#menu:tank_params/mps'
    TANK_PARAMS_QUANTITY = '#menu:tank_params/quantity'
    ...
    TANK_PARAMS_PERACTIVATION = '#menu:tank_params/perActivation'
    ...
    TANK_PARAMS_SHELLPENETRATIONLOSS = '#menu:tank_params/shellPenetrationLoss'
    ...
    TANK_PARAMS_AUXILIARYROCKETLAUNCHERRELOADTIME = '#menu:tank_params/auxiliaryRocketLauncherReloadTime'
    TANK_PARAMS_AUXILIARYROCKETLAUNCHERAVGDAMAGE = '#menu:tank_params/auxiliaryRocketLauncherAvgDamage'
    TANK_PARAMS_AUXILIARYROCKETLAUNCHERPENETRATION = '#menu:tank_params/auxiliaryRocketLauncherPenetration'
    TANK_PARAMS_AUXILIARYROCKETLAUNCHERVELOCITY = '#menu:tank_params/auxiliaryRocketLauncherVelocity'
    TANK_PARAMS_AUXILIARYROCKETLAUNCHERDISPERSION = '#menu:tank_params/auxiliaryRocketLauncherDispersion'
    TANK_PARAMS_AUTORELOADERSURGEMAXCHARGES = '#menu:tank_params/autoreloaderSurgeMaxCharges'
    TANK_PARAMS_AUTORELOADERSURGEINITCHARGES = '#menu:tank_params/autoreloaderSurgeInitCharges'
    TANK_PARAMS_AUTORELOADERSURGECHARGETIMESLOW = '#menu:tank_params/autoreloaderSurgeChargeTimeSlow'
    TANK_PARAMS_AUTORELOADERSURGECHARGETIMEFAST = '#menu:tank_params/autoreloaderSurgeChargeTimeFast'
    TANK_PARAMS_AUTORELOADERSURGEBOOSTEDRELOADTIME = '#menu:tank_params/autoreloaderSurgeBoostedReloadTime'
    TANK_PARAMS_BUSTLEFEEDDAMAGEPERSHOT = '#menu:tank_params/bustleFeedDamagePerShot'
    TANK_PARAMS_BUSTLEFEEDRATEOFFIRE = '#menu:tank_params/bustleFeedRateOfFire'
    TANK_PARAMS_BUSTLEFEEDSWITCHINGTOEASMMODE = '#menu:tank_params/bustleFeedSwitchingToEASMMode'
    TANK_PARAMS_BUSTLEFEEDSWITCHINGTOSTANDARDMODE = '#menu:tank_params/bustleFeedSwitchingToStandardMode'
    TANK_PARAMS_BUSTLEFEEDMAXSPEED = '#menu:tank_params/bustleFeedMaxSpeed'
    TANK_PARAMS_SIGHTPOINTERDEPLOYTIME = '#menu:tank_params/sightPointerDeployTime'
    TANK_PARAMS_SIGHTPOINTERRELOADTIME = '#menu:tank_params/sightPointerReloadTime'
    TANK_PARAMS_SIGHTPOINTERDURATION = '#menu:tank_params/sightPointerDuration'
    TANK_PARAMS_SIGHTPOINTERROTATIONSPEED = '#menu:tank_params/sightPointerRotationSpeed'
    TANK_PARAMS_SIGHTPOINTERSECTORANGLESTART = '#menu:tank_params/sightPointerSectorAngleStart'
    TANK_PARAMS_SIGHTPOINTERSECTORANGLEEND = '#menu:tank_params/sightPointerSectorAngleEnd'
    TANK_PARAMS_SIGHTPOINTERSELFSPOTTINGTIME = '#menu:tank_params/sightPointerSelfSpottingTime'
    TANK_PARAMS_SIGHTPOINTERVIEWRANGE = '#menu:tank_params/sightPointerViewRange'
    TANK_PARAMS_SIGHTPOINTERCONSEALMENTFOLIAGE = '#menu:tank_params/sightPointerConsealmentFoliage'
    TANK_PARAMS_SIGHTPOINTERCONSEALMENTMOVING = '#menu:tank_params/sightPointerConsealmentMoving'
    ...
    EXTRAPARAMS_NAME_VEHICLEHESHELLDAMAGERESISTANCE = '#menu:extraParams/name/vehicleHEShellDamageResistance'
    EXTRAPARAMS_NAME_VEHICLEFALLINGDAMAGERESISTANCE = '#menu:extraParams/name/vehicleFallingDamageResistance'
    ...
    EXTRAPARAMS_NAME_VEHPENALTYFORDAMAGEDENGINE = '#menu:extraParams/name/vehPenaltyForDamagedEngine'
    EXTRAPARAMS_NAME_VEHPENALTYFORDAMAGEDAMMORACK = '#menu:extraParams/name/vehPenaltyForDamagedAmmorack'
    ...
    EXTRAPARAMS_NAME_MEDIUMGROUNDFACTOR = '#menu:extraParams/name/mediumGroundFactor'
    EXTRAPARAMS_NAME_SOFTGROUNDFACTOR = '#menu:extraParams/name/softGroundFactor'
    EXTRAPARAMS_NAME_VEHICLEENEMYSPOTTINGTIME = '#menu:extraParams/name/vehicleEnemySpottingTime'
    EXTRAPARAMS_NAME_PENALTYTODAMAGEDSURVEYINGDEVICE = '#menu:extraParams/name/penaltyToDamagedSurveyingDevice'
    ...
    HEADERBUTTONS_BATTLE_TYPES_RANKED_AVAILABILITY_YEARENDED = '#menu:headerButtons/battle/types/ranked/availability/yearEnded'
    ...
    HEADERBUTTONS_BATTLE_TYPES_HISTORICALBATTLES = '#menu:headerButtons/battle/types/historicalBattles'
    HEADERBUTTONS_BATTLE_TYPES_HISTORICALBATTLES_DESCR = '#menu:headerButtons/battle/types/historicalBattles/descr'
    ...
    HEADERBUTTONS_BATTLE_TYPES_COMP7LIGHTSQUAD = '#menu:headerButtons/battle/types/comp7LightSquad'
    ...
    HEADERBUTTONS_BATTLE_BUTTON_BATTLE = '#menu:headerButtons/battle/button/battle'
    HEADERBUTTONS_READY = '#menu:headerButtons/ready'
    HEADERBUTTONS_NOTREADY = '#menu:headerButtons/notReady'
    HEADERBUTTONS_NAVIGATION_BACK = '#menu:headerButtons/navigation/back'
    ...
    HEADERBUTTONS_FIGHTBTN_TOOLTIP_COMP7BATTLEONLY_HEADER = '#menu:headerButtons/fightBtn/tooltip/comp7BattleOnly/header'
    HEADERBUTTONS_FIGHTBTN_TOOLTIP_COMP7BATTLEONLY_BODY = '#menu:headerButtons/fightBtn/tooltip/comp7BattleOnly/body'
    ...
    HEADERBUTTONS_MODESELECTOR = '#menu:headerButtons/modeSelector'
    ...
    HEADERBUTTONS_TOURNAMENT = '#menu:headerButtons/tournament'
    ...
    HEADER_LEVEL_2 = '#menu:header/level/2'
    HEADER_LEVEL_3 = '#menu:header/level/3'
    HEADER_LEVEL_4 = '#menu:header/level/4'
    HEADER_LEVEL_5 = '#menu:header/level/5'
    HEADER_LEVEL_6 = '#menu:header/level/6'
    HEADER_LEVEL_7 = '#menu:header/level/7'
    ...
    HEADER_WOTPLUSEXCLUSIVEVEHICLETYPE_LIGHTTANK = '#menu:header/wotPlusExclusiveVehicleType/lightTank'
    HEADER_WOTPLUSEXCLUSIVEVEHICLETYPE_MEDIUMTANK = '#menu:header/wotPlusExclusiveVehicleType/mediumTank'
    HEADER_WOTPLUSEXCLUSIVEVEHICLETYPE_HEAVYTANK = '#menu:header/wotPlusExclusiveVehicleType/heavyTank'
    HEADER_WOTPLUSEXCLUSIVEVEHICLETYPE_AT_SPG = '#menu:header/wotPlusExclusiveVehicleType/AT-SPG'
    HEADER_WOTPLUSEXCLUSIVEVEHICLETYPE_SPG = '#menu:header/wotPlusExclusiveVehicleType/SPG'
    HEADER_WOTPLUSEXCLUSIVEVEHICLETYPE_ALLIANCE_USSR = '#menu:header/wotPlusExclusiveVehicleType/Alliance-USSR'
    HEADER_WOTPLUSEXCLUSIVEVEHICLETYPE_ALLIANCE_GERMANY = '#menu:header/wotPlusExclusiveVehicleType/Alliance-Germany'
    HEADER_WOTPLUSEXCLUSIVEVEHICLETYPE_ALLIANCE_USA = '#menu:header/wotPlusExclusiveVehicleType/Alliance-USA'
    HEADER_WOTPLUSEXCLUSIVEVEHICLETYPE_ALLIANCE_FRANCE = '#menu:header/wotPlusExclusiveVehicleType/Alliance-France'
    ...
    HEADER_ACCOUNT_POPOVER_TOALLPROGRESS = '#menu:header/account/popover/toAllProgress'
    HEADER_ACCOUNT_POPOVER_CLAN_HEADER = '#menu:header/account/popover/clan/header'
    HEADER_ACCOUNT_POPOVER_CLAN_NOT_ENABLED_BTNLABEL = '#menu:header/account/popover/clan/not_enabled/btnLabel'
    HEADER_ACCOUNT_POPOVER_CLAN_ENABLED_BTNLABEL = '#menu:header/account/popover/clan/enabled/btnLabel'
    HEADER_ACCOUNT_POPOVER_CLAN_POSITION_LEADER = '#menu:header/account/popover/clan/position/leader'
    HEADER_ACCOUNT_POPOVER_CLAN_POSITION_VICE_LEADER = '#menu:header/account/popover/clan/position/vice_leader'
    HEADER_ACCOUNT_POPOVER_CLAN_POSITION_RECRUITER = '#menu:header/account/popover/clan/position/recruiter'
    HEADER_ACCOUNT_POPOVER_CLAN_POSITION_TREASURER = '#menu:header/account/popover/clan/position/treasurer'
    HEADER_ACCOUNT_POPOVER_CLAN_POSITION_DIPLOMAT = '#menu:header/account/popover/clan/position/diplomat'
    HEADER_ACCOUNT_POPOVER_CLAN_POSITION_COMMANDER = '#menu:header/account/popover/clan/position/commander'
    HEADER_ACCOUNT_POPOVER_CLAN_POSITION_PRIVATE = '#menu:header/account/popover/clan/position/private'
    HEADER_ACCOUNT_POPOVER_CLAN_POSITION_RECRUIT = '#menu:header/account/popover/clan/position/recruit'
    HEADER_ACCOUNT_POPOVER_CLAN_POSITION_STAFF = '#menu:header/account/popover/clan/position/staff'
    HEADER_ACCOUNT_POPOVER_CLAN_POSITION_JUNIOR = '#menu:header/account/popover/clan/position/junior'
    HEADER_ACCOUNT_POPOVER_CLAN_POSITION_RESERVIST = '#menu:header/account/popover/clan/position/reservist'
    HEADER_ACCOUNT_POPOVER_CREW_HEADER = '#menu:header/account/popover/crew/header'
    ...
    HEADER_ACCOUNT_POPOVER_CREW_POSITION_TREASURER = '#menu:header/account/popover/crew/position/treasurer'
    HEADER_ACCOUNT_POPOVER_CREW_POSITION_DIPLOMAT = '#menu:header/account/popover/crew/position/diplomat'
    ...
    EXCHANGE_TOEXCHANGE = '#menu:exchange/toexchange'
    EXCHANGE_RESULT = '#menu:exchange/result'
    ...
    PROFILE_HEADER_REGISTRATIONDATETITLE = '#menu:profile/header/registrationDateTitle'
    PROFILE_HEADER_LASTBATTLEDATETITLE = '#menu:profile/header/lastBattleDateTitle'
    PROFILE_CLAN_LABEL = '#menu:profile/clan/label'
    PROFILE_HEADER_CLAN_POSITION = '#menu:profile/header/clan/position'
    PROFILE_HEADER_CLAN_JOINDATE = '#menu:profile/header/clan/joinDate'
    PROFILE_HEADER_CLAN_POSITION_LEADER = '#menu:profile/header/clan/position/leader'
    PROFILE_HEADER_CLAN_POSITION_VICE_LEADER = '#menu:profile/header/clan/position/vice_leader'
    PROFILE_HEADER_CLAN_POSITION_RECRUITER = '#menu:profile/header/clan/position/recruiter'
    PROFILE_HEADER_CLAN_POSITION_TREASURER = '#menu:profile/header/clan/position/treasurer'
    PROFILE_HEADER_CLAN_POSITION_DIPLOMAT = '#menu:profile/header/clan/position/diplomat'
    PROFILE_HEADER_CLAN_POSITION_COMMANDER = '#menu:profile/header/clan/position/commander'
    PROFILE_HEADER_CLAN_POSITION_PRIVATE = '#menu:profile/header/clan/position/private'
    PROFILE_HEADER_CLAN_POSITION_RECRUIT = '#menu:profile/header/clan/position/recruit'
    PROFILE_HEADER_CLAN_POSITION_STAFF = '#menu:profile/header/clan/position/staff'
    PROFILE_HEADER_CLAN_POSITION_JUNIOR = '#menu:profile/header/clan/position/junior'
    PROFILE_HEADER_CLAN_POSITION_RESERVIST = '#menu:profile/header/clan/position/reservist'
    PROFILE_HEADER_FIGHTS = '#menu:profile/header/fights'
    ...
    PROFILE_STATS_BLOCKS_COMMON = '#menu:profile/stats/blocks/common'
    PROFILE_STATS_BLOCKS_BATTLEEFFECT = '#menu:profile/stats/blocks/battleeffect'
    PROFILE_STATS_BLOCKS_CREDITS = '#menu:profile/stats/blocks/credits'
    PROFILE_STATS_BLOCKS_STUDYING = '#menu:profile/stats/blocks/studying'
    ...
    PROFILE_STATS_ITEMS_MAXXP = '#menu:profile/stats/items/maxXP'
    PROFILE_STATS_ITEMS_MAXFRAGS = '#menu:profile/stats/items/maxFrags'
    PROFILE_STATS_ITEMS_BATTLESCOUNT = '#menu:profile/stats/items/battlesCount'
    PROFILE_STATS_ITEMS_WINS = '#menu:profile/stats/items/wins'
    PROFILE_STATS_ITEMS_LOSSES = '#menu:profile/stats/items/losses'
    PROFILE_STATS_ITEMS_SURVIVEDBATTLES = '#menu:profile/stats/items/survivedBattles'
    PROFILE_STATS_ITEMS_LASTBATTLETIME = '#menu:profile/stats/items/lastBattleTime'
    PROFILE_STATS_ITEMS_EFFECTIVESHOTS = '#menu:profile/stats/items/effectiveShots'
    PROFILE_STATS_ITEMS_DAMAGEDEALT = '#menu:profile/stats/items/damageDealt'
    PROFILE_STATS_ITEMS_HEROES = '#menu:profile/stats/items/heroes'
    PROFILE_STATS_ITEMS_WARRIOR = '#menu:profile/stats/items/warrior'
    PROFILE_STATS_ITEMS_INVADER = '#menu:profile/stats/items/invader'
    PROFILE_STATS_ITEMS_SNIPER = '#menu:profile/stats/items/sniper'
    PROFILE_STATS_ITEMS_DEFENDER = '#menu:profile/stats/items/defender'
    PROFILE_STATS_ITEMS_STEELWALL = '#menu:profile/stats/items/steelwall'
    PROFILE_STATS_ITEMS_SUPPORTER = '#menu:profile/stats/items/supporter'
    PROFILE_STATS_ITEMS_SCOUT = '#menu:profile/stats/items/scout'
    PROFILE_STATS_ITEMS_MEDALKAY = '#menu:profile/stats/items/medalKay'
    PROFILE_EXCHANGE = '#menu:profile/exchange'
    PROFILE_PREMIUMBUY = '#menu:profile/premiumBuy'
    PROFILE_PREMIUMCONTINUE = '#menu:profile/premiumContinue'
    PROFILE_PREMIUNEXPIRATIONDATE = '#menu:profile/premiunExpirationDate'
    ACCOUNTTYPES_GUEST = '#menu:accountTypes/guest'
    ...
    ACCOUNTTYPES_PREMIUMSHORT = '#menu:accountTypes/premiumShort'
    ACCOUNTTYPES_SUBSCRIPTION = '#menu:accountTypes/subscription'
    ACCOUNTTYPES_PREMIUMPLUS = '#menu:accountTypes/premiumPlus'
    ACCOUNTTYPES_PREMIUMPLUSSHORT = '#menu:accountTypes/premiumPlusShort'
    ...
    PREMIUM_BONUS = '#menu:premium/bonus'
    ...
    PREMIUM_PERIODS_DAYS14 = '#menu:premium/periods/days14'
    PREMIUM_PERIODS_DAYS30 = '#menu:premium/periods/days30'
    PREMIUM_PERIODS_DAYS90 = '#menu:premium/periods/days90'
    ...
    PREMIUM_PACKET_DAYS14 = '#menu:premium/packet/days14'
    PREMIUM_PACKET_DAYS30 = '#menu:premium/packet/days30'
    PREMIUM_PACKET_DAYS90 = '#menu:premium/packet/days90'
    ...
    MODULEINFO_SHELLPARAMSSWITCHER = '#menu:moduleInfo/shellParamsSwitcher'
    ...
    MODULEINFO_AUXILIARYROCKETLAUNCHER = '#menu:moduleInfo/auxiliaryRocketLauncher'
    ...
    MODULEINFO_PARAMS_ARTDELAYRANGE = '#menu:moduleInfo/params/artDelayRange'
    MODULEINFO_PARAMS_LEVEL_LBL = '#menu:moduleInfo/params/level_lbl'
    ...
    MODULEINFO_PARAMS_FOOTNOTE_MAXSHOTDISTANCE = '#menu:moduleInfo/params/footnote/maxShotDistance'
    MODULEINFO_PARAMS_FOOTNOTE_NOPIERCINGDISTANCE = '#menu:moduleInfo/params/footnote/noPiercingDistance'
    MODULEINFO_PARAMS_FOOTNOTE_PIERCINGDISTANCE = '#menu:moduleInfo/params/footnote/piercingDistance'
    MODULEINFO_PARAMS_FOOTNOTE_NOPIERCINGDISTANCE_MAXDISTANCE = '#menu:moduleInfo/params/footnote/noPiercingDistance/maxDistance'
    MODULEINFO_PARAMS_FOOTNOTE_GUARANTEEDDAMAGE = '#menu:moduleInfo/params/footnote/guaranteedDamage'
    MODULEINFO_PARAMS_FOOTNOTE_PENETRATIONLOSS = '#menu:moduleInfo/params/footnote/penetrationLoss'
    MODULEINFO_PARAMS_FOOTNOTE_SCREENSARMORMULTIPLIER = '#menu:moduleInfo/params/footnote/screensArmorMultiplier'
    ...
    MODULEINFO_PARAMS_MAXHEALTH = '#menu:moduleInfo/params/maxHealth'
    MODULEINFO_PARAMS_MAXHULLHEALTH = '#menu:moduleInfo/params/maxHullHealth'
    MODULEINFO_PARAMS_HULLWEIGHT = '#menu:moduleInfo/params/hullWeight'
    MODULEINFO_PARAMS_HULLANDCHASSISWEIGHT = '#menu:moduleInfo/params/hullAndChassisWeight'
    MODULEINFO_PARAMS_HULLARMOR = '#menu:moduleInfo/params/hullArmor'
    ...
    MODULEINFO_PARAMS_CRITICALHITCHANCE = '#menu:moduleInfo/params/criticalHitChance'
    ...
    VEHICLEINFO_PARAMS_ROCKETACCELERATIONSPEEDLIMITS = '#menu:vehicleInfo/params/rocketAccelerationSpeedLimits'
    ...
    VEHICLEINFO_TABS_CREW = '#menu:vehicleInfo/tabs/crew'
    VEHICLEINFO_CLOSEBTN = '#menu:vehicleInfo/closeBtn'
    VEHICLEINFO_COMPAREBTN_LABEL = '#menu:vehicleInfo/compareBtn/label'
    VEHICLEINFO_NATIONCHANGEBTN_LABEL = '#menu:vehicleInfo/nationChangeBtn/label'
    VEHICLEINFO_COMPAREBTN_TOOLTIP_HEADER = '#menu:vehicleInfo/compareBtn/tooltip/header'
    ...
    RESEARCH_LABELS_BUTTON_NATIONCHANGE = '#menu:research/labels/button/nationChange'
    ...
    INVENTORY_MENU_VEHICLE_TAGS_LIGHTTANK_NAME = '#menu:inventory/menu/vehicle/tags/lightTank/name'
    INVENTORY_MENU_VEHICLE_TAGS_MEDIUMTANK_NAME = '#menu:inventory/menu/vehicle/tags/mediumTank/name'
    INVENTORY_MENU_VEHICLE_TAGS_HEAVYTANK_NAME = '#menu:inventory/menu/vehicle/tags/heavyTank/name'
    INVENTORY_MENU_VEHICLE_TAGS_AT_SPG_NAME = '#menu:inventory/menu/vehicle/tags/at-spg/name'
    INVENTORY_MENU_VEHICLE_TAGS_SPG_NAME = '#menu:inventory/menu/vehicle/tags/spg/name'
    ...
    INVENTORY_MENU_MODULE_TYPES_VEHICLETURRET_NAME = '#menu:inventory/menu/module/types/vehicleTurret/name'
    INVENTORY_MENU_MODULE_TYPES_VEHICLEGUN_NAME = '#menu:inventory/menu/module/types/vehicleGun/name'
    INVENTORY_MENU_MODULE_TYPES_VEHICLEENGINE_NAME = '#menu:inventory/menu/module/types/vehicleEngine/name'
    INVENTORY_MENU_MODULE_TYPES_VEHICLERADIO_NAME = '#menu:inventory/menu/module/types/vehicleRadio/name'
    INVENTORY_MENU_MODULE_FITS_NAME = '#menu:inventory/menu/module/fits/name'
    INVENTORY_MENU_MODULE_FITS_MYVEHICLE_NAME = '#menu:inventory/menu/module/fits/myVehicle/name'
    INVENTORY_MENU_MODULE_FITS_MYVEHICLES_NAME = '#menu:inventory/menu/module/fits/myVehicles/name'
    INVENTORY_MENU_MODULE_FITS_OTHERVEHICLES_NAME = '#menu:inventory/menu/module/fits/otherVehicles/name'
    INVENTORY_MENU_MODULE_EXTRA_NAME = '#menu:inventory/menu/module/extra/name'
    INVENTORY_MENU_MODULE_EXTRA_ONVEHICLE_NAME = '#menu:inventory/menu/module/extra/onVehicle/name'
    INVENTORY_MENU_SHELL_NAME = '#menu:inventory/menu/shell/name'
    ...
    INVENTORY_MENU_SHELL_FITS_NAME = '#menu:inventory/menu/shell/fits/name'
    INVENTORY_MENU_SHELL_FITS_MYVEHICLEGUN_NAME = '#menu:inventory/menu/shell/fits/myVehicleGun/name'
    INVENTORY_MENU_SHELL_FITS_MYINVENTORYGUNS_NAME = '#menu:inventory/menu/shell/fits/myInventoryGuns/name'
    INVENTORY_MENU_SHELL_FITS_MYVEHICLESINVENTORYGUNS_NAME = '#menu:inventory/menu/shell/fits/myVehiclesInventoryGuns/name'
    INVENTORY_MENU_SHELL_FITS_OTHERGUNS_NAME = '#menu:inventory/menu/shell/fits/otherGuns/name'
    INVENTORY_MENU_OPTIONALDEVICE_NAME = '#menu:inventory/menu/optionalDevice/name'
    INVENTORY_MENU_OPTIONALDEVICE_FITS_NAME = '#menu:inventory/menu/optionalDevice/fits/name'
    INVENTORY_MENU_OPTIONALDEVICE_FITS_MYVEHICLE_NAME = '#menu:inventory/menu/optionalDevice/fits/myVehicle/name'
    INVENTORY_MENU_OPTIONALDEVICE_FITS_MYVEHICLES_NAME = '#menu:inventory/menu/optionalDevice/fits/myVehicles/name'
    INVENTORY_MENU_OPTIONALDEVICE_FITS_OTHERVEHICLES_NAME = '#menu:inventory/menu/optionalDevice/fits/otherVehicles/name'
    INVENTORY_MENU_OPTIONALDEVICE_EXTRA_NAME = '#menu:inventory/menu/optionalDevice/extra/name'
    INVENTORY_MENU_OPTIONALDEVICE_EXTRA_ONVEHICLE_NAME = '#menu:inventory/menu/optionalDevice/extra/onVehicle/name'
    INVENTORY_MENU_BATTLEBOOSTER_NAME = '#menu:inventory/menu/battleBooster/name'
    INVENTORY_MENU_BATTLEBOOSTER_TARGETTYPE_ALLKIND_NAME = '#menu:inventory/menu/battleBooster/targetType/allKind/name'
    INVENTORY_MENU_BATTLEBOOSTER_TARGETTYPE_FORCREW_NAME = '#menu:inventory/menu/battleBooster/targetType/forCrew/name'
    INVENTORY_MENU_BATTLEBOOSTER_TARGETTYPE_FOREQUIPMENT_NAME = '#menu:inventory/menu/battleBooster/targetType/forEquipment/name'
    INVENTORY_MENU_EQUIPMENT_NAME = '#menu:inventory/menu/equipment/name'
    INVENTORY_MENU_EQUIPMENT_FITS_NAME = '#menu:inventory/menu/equipment/fits/name'
    INVENTORY_MENU_EQUIPMENT_FITS_MYVEHICLE_NAME = '#menu:inventory/menu/equipment/fits/myVehicle/name'
    INVENTORY_MENU_EQUIPMENT_FITS_MYVEHICLES_NAME = '#menu:inventory/menu/equipment/fits/myVehicles/name'
    INVENTORY_MENU_EQUIPMENT_FITS_OTHERVEHICLES_NAME = '#menu:inventory/menu/equipment/fits/otherVehicles/name'
    INVENTORY_ERRORS_RESERVED = '#menu:inventory/errors/reserved'
    INVENTORY_DEVICE_ERRORS_NOT_REMOVABLE = '#menu:inventory/device/errors/not_removable'
    INVENTORY_DEVICE_ERRORS_RESERVED = '#menu:inventory/device/errors/reserved'
    INVENTORY_TABLE_HEADER_COUNT = '#menu:inventory/table/header/count'
    ...
    SHOP_MENU_MODULE_TYPES_VEHICLEENGINE_NAME = '#menu:shop/menu/module/types/vehicleEngine/name'
    SHOP_MENU_MODULE_TYPES_VEHICLERADIO_NAME = '#menu:shop/menu/module/types/vehicleRadio/name'
    SHOP_MENU_MODULE_FITS_NAME = '#menu:shop/menu/module/fits/name'
    SHOP_MENU_MODULE_FITS_MYVEHICLE_NAME = '#menu:shop/menu/module/fits/myVehicle/name'
    SHOP_MENU_MODULE_FITS_MYVEHICLES_NAME = '#menu:shop/menu/module/fits/myVehicles/name'
    SHOP_MENU_MODULE_FITS_OTHERVEHICLES_NAME = '#menu:shop/menu/module/fits/otherVehicles/name'
    SHOP_MENU_MODULE_EXTRA_NAME = '#menu:shop/menu/module/extra/name'
    SHOP_MENU_MODULE_EXTRA_LOCKED_NAME = '#menu:shop/menu/module/extra/locked/name'
    SHOP_MENU_MODULE_EXTRA_ONVEHICLE_NAME = '#menu:shop/menu/module/extra/onVehicle/name'
    SHOP_MENU_MODULE_EXTRA_INHANGAR_NAME = '#menu:shop/menu/module/extra/inHangar/name'
    SHOP_MENU_SHELL_NAME = '#menu:shop/menu/shell/name'
    ...
    SHOP_MENU_SHELL_FITS_NAME = '#menu:shop/menu/shell/fits/name'
    SHOP_MENU_SHELL_FITS_MYVEHICLEGUN_NAME = '#menu:shop/menu/shell/fits/myVehicleGun/name'
    SHOP_MENU_SHELL_FITS_MYINVENTORYGUNS_NAME = '#menu:shop/menu/shell/fits/myInventoryGuns/name'
    SHOP_MENU_SHELL_FITS_MYVEHICLESINVENTORYGUNS_NAME = '#menu:shop/menu/shell/fits/myVehiclesInventoryGuns/name'
    SHOP_MENU_SHELL_FITS_OTHERGUNS_NAME = '#menu:shop/menu/shell/fits/otherGuns/name'
    SHOP_MENU_OPTIONALDEVICE_NAME = '#menu:shop/menu/optionalDevice/name'
    SHOP_MENU_OPTIONALDEVICE_FITS_NAME = '#menu:shop/menu/optionalDevice/fits/name'
    SHOP_MENU_OPTIONALDEVICE_FITS_MYVEHICLE_NAME = '#menu:shop/menu/optionalDevice/fits/myVehicle/name'
    SHOP_MENU_OPTIONALDEVICE_FITS_MYVEHICLES_NAME = '#menu:shop/menu/optionalDevice/fits/myVehicles/name'
    SHOP_MENU_OPTIONALDEVICE_FITS_OTHERVEHICLES_NAME = '#menu:shop/menu/optionalDevice/fits/otherVehicles/name'
    SHOP_MENU_OPTIONALDEVICE_EXTRA_NAME = '#menu:shop/menu/optionalDevice/extra/name'
    SHOP_MENU_OPTIONALDEVICE_EXTRA_ONVEHICLE_NAME = '#menu:shop/menu/optionalDevice/extra/onVehicle/name'
    SHOP_MENU_BATTLEBOOSTER_NAME = '#menu:shop/menu/battleBooster/name'
    SHOP_MENU_BATTLEBOOSTER_TARGETTYPE_ALLKIND_NAME = '#menu:shop/menu/battleBooster/targetType/allKind/name'
    SHOP_MENU_BATTLEBOOSTER_TARGETTYPE_FORCREW_NAME = '#menu:shop/menu/battleBooster/targetType/forCrew/name'
    SHOP_MENU_BATTLEBOOSTER_TARGETTYPE_FOREQUIPMENT_NAME = '#menu:shop/menu/battleBooster/targetType/forEquipment/name'
    SHOP_MENU_EQUIPMENT_NAME = '#menu:shop/menu/equipment/name'
    SHOP_MENU_EQUIPMENT_FITS_NAME = '#menu:shop/menu/equipment/fits/name'
    SHOP_MENU_EQUIPMENT_FITS_MYVEHICLE_NAME = '#menu:shop/menu/equipment/fits/myVehicle/name'
    ...
    SHOP_TABLE_HEADER_COUNT_VEHICLE = '#menu:shop/table/header/count/vehicle'
    SHOP_TABLE_HEADER_COUNT_MODULE = '#menu:shop/table/header/count/module'
    SHOP_TABLE_HEADER_COUNT_SHELL = '#menu:shop/table/header/count/shell'
    SHOP_TABLE_HEADER_COUNT_OPTIONALDEVICE = '#menu:shop/table/header/count/optionalDevice'
    SHOP_TABLE_HEADER_COUNT_EQUIPMENT = '#menu:shop/table/header/count/equipment'
    SHOP_TABLE_HEADER_COUNT_BATTLEBOOSTER = '#menu:shop/table/header/count/battleBooster'
    ...
    SHOP_TABLE_NOTFORSALE = '#menu:shop/table/notForSale'
    ...
    VEHICLE_RESTORELEFT_HOURS = '#menu:vehicle/restoreLeft/hours'
    ...
    TRAINING_JOINBUTTON = '#menu:training/joinButton'
    TRAINING_LISTTITLE = '#menu:training/listTitle'
    TRAINING_PLAYERSLABEL = '#menu:training/playersLabel'
    TRAINING_ROOMSLABEL = '#menu:training/roomsLabel'
    ...
    TRAINING_INFO_STARTBUTTON = '#menu:training/info/startButton'
    TRAINING_INFO_SETTINGSBUTTON = '#menu:training/info/settingsButton'
    TRAINING_INFO_INVITEBUTTON = '#menu:training/info/inviteButton'
    TRAINING_INFO_EXITBUTTON = '#menu:training/info/exitButton'
    TRAINING_INFO_DELETEBUTTON = '#menu:training/info/deleteButton'
    TRAINING_INFO_OBSERVER = '#menu:training/info/observer'
    TRAINING_INFO_TEAM1LABEL = '#menu:training/info/team1Label'
    ...
    TRAINING_INFO_TIMEOUT_VALUE = '#menu:training/info/timeout/value'
    TRAINING_INFO_MAXPLAYERS = '#menu:training/info/maxPlayers'
    TRAINING_INFO_OWNER = '#menu:training/info/owner'
    TRAINING_INFO_VOICECHAT = '#menu:training/info/voiceChat'
    TRAINING_INFO_STATES_STATE0 = '#menu:training/info/states/state0'
    TRAINING_INFO_STATES_STATE1 = '#menu:training/info/states/state1'
    TRAINING_INFO_STATES_STATE2 = '#menu:training/info/states/state2'
    TRAINING_INFO_STATES_STATE4 = '#menu:training/info/states/state4'
    TRAINING_INFO_STATES_STATE8 = '#menu:training/info/states/state8'
    TRAINING_INFO_STATES_STATE17 = '#menu:training/info/states/state17'
    TRAINING_INFO_STATES_STATE20 = '#menu:training/info/states/state20'
    TRAINING_INFO_STATES_STATE24 = '#menu:training/info/states/state24'
    TRAINING_INFO_USECOMMONVOICECHAT = '#menu:training/info/useCommonVoiceChat'
    ...
    VEHICLESCAROUSEL_CONTEXTMENU_VEHICLERESEARCH = '#menu:vehiclesCarousel/contextMenu/vehicleResearch'
    VEHICLESCAROUSEL_CONTEXTMENU_VEHICLECHECK = '#menu:vehiclesCarousel/contextMenu/vehicleCheck'
    VEHICLESCAROUSEL_CONTEXTMENU_VEHICLEUNCHECK = '#menu:vehiclesCarousel/contextMenu/vehicleUncheck'
    TANKMEN_LOCKREASON_INBATTLE = '#menu:tankmen/lockReason/inbattle'
    TANKMEN_LOCKREASON_PREBATTLE = '#menu:tankmen/lockReason/prebattle'
    TANKMEN_LOCKREASON_BROKEN = '#menu:tankmen/lockReason/broken'
    TANKMEN_LOCKREASON_DISABLED = '#menu:tankmen/lockReason/disabled'
    ...
    HANGAR_AMMUNITIONPANEL_TECHNICALMAITENANCE_AMMO_CHECKBOXAUTO = '#menu:hangar/ammunitionPanel/technicalMaitenance/ammo/checkboxAuto'
    ...
    HANGAR_AMMUNITIONPANEL_TECHNICALMAITENANCE_EQUIPMENT_LIST_BUY = '#menu:hangar/ammunitionPanel/technicalMaitenance/equipment/list/buy'
    HANGAR_AMMUNITIONPANEL_TECHNICALMAITENANCE_EQUIPMENT_LIST_PRICE = '#menu:hangar/ammunitionPanel/technicalMaitenance/equipment/list/price'
    HANGAR_AMMUNITIONPANEL_TECHNICALMAITENANCE_BUTTONS_REPAIR = '#menu:hangar/ammunitionPanel/technicalMaitenance/buttons/repair'
    HANGAR_AMMUNITIONPANEL_TECHNICALMAITENANCE_BUTTONS_AMMO = '#menu:hangar/ammunitionPanel/technicalMaitenance/buttons/ammo'
    HANGAR_AMMUNITIONPANEL_TECHNICALMAITENANCE_BUTTONS_EQUIPMENT = '#menu:hangar/ammunitionPanel/technicalMaitenance/buttons/equipment'
    ...
    CONTEXTMENU_REMOVEFROMIGNORED = '#menu:contextMenu/removeFromIgnored'
    CONTEXTMENU_ENABLECOMMUNICATIONS = '#menu:contextMenu/enableCommunications'
    CONTEXTMENU_DISABLECOMMUNICATIONS = '#menu:contextMenu/disableCommunications'
    CONTEXTMENU_COPYTOCLIPBOARD = '#menu:contextMenu/copyToClipBoard'
    CONTEXTMENU_SETMUTED = '#menu:contextMenu/setMuted'
    CONTEXTMENU_UNSETMUTED = '#menu:contextMenu/unsetMuted'
    CONTEXTMENU_MODULEINFO = '#menu:contextMenu/moduleInfo'
    CONTEXTMENU_SELL = '#menu:contextMenu/sell'
    ...
    CONTEXTMENU_CREATECOMP7LIGHTSQUAD = '#menu:contextMenu/createComp7LightSquad'
    ...
    CONTEXTMENU_ASSIGNPRIVATE = '#menu:contextMenu/assignPrivate'
    CONTEXTMENU_ASSIGNOFFICER = '#menu:contextMenu/assignOfficer'
    ...
    DENUNCIATION_7 = '#menu:denunciation/7'
    STEAM_TITLE = '#menu:steam/title'
    STEAM_GOLDPACKETSELECT = '#menu:steam/goldPacketSelect'
    ...
    FINALSTATISTIC_WINDOW_TITLE = '#menu:finalStatistic/window/title'
    ...
    CLASSES_SPG = '#menu:classes/SPG'
    CLASSES_AT_SPG = '#menu:classes/AT-SPG'
    ...
    BONUSTYPE_7 = '#menu:bonusType/7'
    BONUSTYPE_8 = '#menu:bonusType/8'
    BONUSTYPE_9 = '#menu:bonusType/9'
    ...
    BONUSTYPE_49 = '#menu:bonusType/49'
    ...
    DATETIME_WEEKDAYS_FULL_4 = '#menu:dateTime/weekDays/full/4'
    DATETIME_WEEKDAYS_FULL_5 = '#menu:dateTime/weekDays/full/5'
    DATETIME_WEEKDAYS_FULL_6 = '#menu:dateTime/weekDays/full/6'
    DATETIME_WEEKDAYS_FULL_7 = '#menu:dateTime/weekDays/full/7'
    DATETIME_WEEKDAYS_SHORT_1 = '#menu:dateTime/weekDays/short/1'
    DATETIME_WEEKDAYS_SHORT_2 = '#menu:dateTime/weekDays/short/2'
    DATETIME_WEEKDAYS_SHORT_3 = '#menu:dateTime/weekDays/short/3'
    DATETIME_WEEKDAYS_SHORT_4 = '#menu:dateTime/weekDays/short/4'
    DATETIME_WEEKDAYS_SHORT_5 = '#menu:dateTime/weekDays/short/5'
    DATETIME_WEEKDAYS_SHORT_6 = '#menu:dateTime/weekDays/short/6'
    DATETIME_WEEKDAYS_SHORT_7 = '#menu:dateTime/weekDays/short/7'
    DATETIME_MONTHS_FULL_1 = '#menu:dateTime/months/full/1'
    DATETIME_MONTHS_FULL_2 = '#menu:dateTime/months/full/2'
    DATETIME_MONTHS_FULL_3 = '#menu:dateTime/months/full/3'
    DATETIME_MONTHS_FULL_4 = '#menu:dateTime/months/full/4'
    DATETIME_MONTHS_FULL_5 = '#menu:dateTime/months/full/5'
    DATETIME_MONTHS_FULL_6 = '#menu:dateTime/months/full/6'
    DATETIME_MONTHS_FULL_7 = '#menu:dateTime/months/full/7'
    DATETIME_MONTHS_FULL_8 = '#menu:dateTime/months/full/8'
    DATETIME_MONTHS_FULL_9 = '#menu:dateTime/months/full/9'
    ...
    DATETIME_MONTHS_SHORT_4 = '#menu:dateTime/months/short/4'
    DATETIME_MONTHS_SHORT_5 = '#menu:dateTime/months/short/5'
    DATETIME_MONTHS_SHORT_6 = '#menu:dateTime/months/short/6'
    DATETIME_MONTHS_SHORT_7 = '#menu:dateTime/months/short/7'
    DATETIME_MONTHS_SHORT_8 = '#menu:dateTime/months/short/8'
    DATETIME_MONTHS_SHORT_9 = '#menu:dateTime/months/short/9'
    ...
    AWARDWINDOW_TELECOMAWARD_TITLE_DEFAULT = '#menu:awardWindow/telecomAward/title/default'
    AWARDWINDOW_TELECOMAWARD_HEADER_DEFAULT = '#menu:awardWindow/telecomAward/header/default'
    AWARDWINDOW_TELECOMAWARD_DESCRIPTION_FULL_DEFAULT = '#menu:awardWindow/telecomAward/description/full/default'
    AWARDWINDOW_TELECOMAWARD_DESCRIPTION_FULL_TWITCHPRIME = '#menu:awardWindow/telecomAward/description/full/Twitchprime'
    AWARDWINDOW_TELECOMAWARD_DESCRIPTION_WITHBROTHERHOOD_DEFAULT = '#menu:awardWindow/telecomAward/description/withBrotherhood/default'
    AWARDWINDOW_TELECOMAWARD_DESCRIPTION_WITHBROTHERHOOD_TWITCHPRIME = '#menu:awardWindow/telecomAward/description/withBrotherhood/Twitchprime'
    AWARDWINDOW_TELECOMAWARD_DESCRIPTION_WITHOUTCREW_DEFAULT = '#menu:awardWindow/telecomAward/description/withoutCrew/default'
    AWARDWINDOW_TELECOMAWARD_DESCRIPTION_WITHOUTCREW_TWITCHPRIME = '#menu:awardWindow/telecomAward/description/withoutCrew/Twitchprime'
    AWARDWINDOW_TELECOMAWARD_DESCRIPTION_PREM_DEFAULT = '#menu:awardWindow/telecomAward/description/prem/default'
    AWARDWINDOW_TELECOMAWARD_VEHICLES_DEFAULT = '#menu:awardWindow/telecomAward/vehicles/default'
    AWARDWINDOW_TELECOMAWARD_VEHICLES_TWITCHPRIME = '#menu:awardWindow/telecomAward/vehicles/Twitchprime'
    AWARDWINDOW_TELECOMAWARD_SUBDESCRIPTION_DEFAULT = '#menu:awardWindow/telecomAward/subdescription/default'
    AWARDWINDOW_TELECOMAWARD_BUTTON_LABEL_DEFAULT = '#menu:awardWindow/telecomAward/button/label/default'
    AWARDWINDOW_MISSION_COMPLETE = '#menu:awardWindow/mission/complete'
    AWARDWINDOW_MISSION_CONDITIONCOMPLETE = '#menu:awardWindow/mission/conditionComplete'
    ...
    AWARDWINDOW_MISSION_ADDITIONALNOTCOMPLETE = '#menu:awardWindow/mission/additionalNotComplete'
    AWARDWINDOW_PERSONALMISSION_COMPLETE = '#menu:awardWindow/personalMission/complete'
    AWARDWINDOW_PERSONALMISSION_COMPLETEWITHHONORS = '#menu:awardWindow/personalMission/completeWithHonors'
    AWARDWINDOW_PERSONALMISSION_MAINCONDITIONCOMPLETED = '#menu:awardWindow/personalMission/mainConditionCompleted'
    AWARDWINDOW_PERSONALMISSION_ALREADYCOMPLETED = '#menu:awardWindow/personalMission/alreadyCompleted'
    AWARDWINDOW_PERSONALMISSION_SIDECONDITIONCOMPLETED = '#menu:awardWindow/personalMission/sideConditionCompleted'
    AWARDWINDOW_PERSONALMISSION_SIDECONDITIONNOTCOMPLETED = '#menu:awardWindow/personalMission/sideConditionNotCompleted'
    AWARDWINDOW_PERSONALMISSION_AVAILABLE = '#menu:awardWindow/personalMission/available'
    AWARDWINDOW_PERSONALMISSION_NEXTBUTTON = '#menu:awardWindow/personalMission/nextButton'
    AWARDWINDOW_PERSONALMISSION_NEXTBUTTON_TOOLTIP_HEADER = '#menu:awardWindow/personalMission/nextButton/tooltip/header'
    AWARDWINDOW_PERSONALMISSION_NEXTBUTTON_TOOLTIP_BODY = '#menu:awardWindow/personalMission/nextButton/tooltip/body'
    ...
    AWARDWINDOW_RECRUITERAWARD_TITLE = '#menu:awardWindow/recruiterAward/title'
    ...
    TIME_TIMEVALUE_LESSMIN = '#menu:Time/timeValue/lessMin'
    TIME_TIMEVALUESHORT_DAYS = '#menu:Time/timeValueShort/days'
    ...
    TIME_TIMELEFTSHORT_DAYS = '#menu:Time/timeLeftShort/days'
    TIME_TIMELEFTSHORT_HOURS = '#menu:Time/timeLeftShort/hours'
    TIME_TIMELEFTSHORT_MIN = '#menu:Time/timeLeftShort/min'
    TIME_TIMELEFTSHORT_LESSMIN = '#menu:Time/timeLeftShort/lessMin'
    MAPBLACKLIST_TIMELEFTSHORT_DAYS = '#menu:mapBlackList/timeLeftShort/days'
    ...
    BOOSTERS_TIMELEFT_DAYS = '#menu:boosters/timeLeft/days'
    BOOSTERS_TIMELEFT_HOURS = '#menu:boosters/timeLeft/hours'
    BOOSTERS_TIMELEFT_MIN = '#menu:boosters/timeLeft/min'
    BOOSTERS_TIMELEFT_LESSMIN = '#menu:boosters/timeLeft/lessMin'
    ...
    TIMELEFT_SHORT_HOUR = '#menu:timeLeft/short/hour'
    TIMELEFT_SHORT_MIN = '#menu:timeLeft/short/min'
    TIMELEFT_SHORT_LESSMIN = '#menu:timeLeft/short/lessMin'
    TIMELEFT_FULL_DAY = '#menu:timeLeft/full/day'
    TIMELEFT_FULL_HOUR = '#menu:timeLeft/full/hour'
    TIMELEFT_FULL_MIN = '#menu:timeLeft/full/min'
    ...
    CRYSTALS_INFO_TITLE = '#menu:crystals/info/title'
    CRYSTALS_INFO_TAB_GETTAB = '#menu:crystals/info/tab/getTab'
    CRYSTALS_INFO_TAB_EARNTAB = '#menu:crystals/info/tab/earnTab'
    ...
    CRYSTALS_INFO_TAB_EARN_LEVEL_DESCRIPTIONCONTENT_LEVEL10AND11 = '#menu:crystals/info/tab/earn/level/descriptionContent/level10And11'
    ...
    CRYSTALS_INFO_TAB_EARN_MARKER_DESCRIPTION_3 = '#menu:crystals/info/tab/earn/marker/description/3'
    CRYSTALS_INFO_TAB_EARN_MARKER_DESCRIPTIONCONTENT_WEEK = '#menu:crystals/info/tab/earn/marker/descriptionContent/week'
    ...
    ROLEEXP_ROLENAME_ROLE_LT_SCOUT = '#menu:roleExp/roleName/role_LT_scout'
    ROLEEXP_ROLEGROUPNAME_ROLE_LT_SCOUT = '#menu:roleExp/roleGroupName/role_LT_scout'
    ROLEEXP_ROLENAME_ROLE_LT_SUPPORT = '#menu:roleExp/roleName/role_LT_support'
    ROLEEXP_ROLEGROUPNAME_ROLE_LT_SUPPORT = '#menu:roleExp/roleGroupName/role_LT_support'
    ...
    ROLEEXP_ROLEDESCR_ROLE_LT_SCOUT = '#menu:roleExp/roleDescr/role_LT_scout'
    ROLEEXP_ROLEDESCR_ROLE_LT_SUPPORT = '#menu:roleExp/roleDescr/role_LT_support'
    ...
    CRYSTALS_INFO_TAB_SPEND_CARD_SPECIALEQUIPMENT_TITLE = '#menu:crystals/info/tab/spend/card/specialEquipment/title'
    ...
    CONTEXTMENU_CREWWIDGETPERSONALFILE = '#menu:contextMenu/crewWidgetPersonalFile'
    CONTEXTMENU_CREWWIDGETRETRAIN = '#menu:contextMenu/crewWidgetRetrain'
    CONTEXTMENU_CREWWIDGETCHANGECREWMEMBER = '#menu:contextMenu/crewWidgetChangeCrewMember'
    ...
    CONTEXTMENU_ENUM = (
     ...
     CONTEXTMENU_REMOVEFROMIGNORED,
     CONTEXTMENU_ENABLECOMMUNICATIONS,
     CONTEXTMENU_DISABLECOMMUNICATIONS,
     CONTEXTMENU_COPYTOCLIPBOARD,
     CONTEXTMENU_SETMUTED,
     CONTEXTMENU_UNSETMUTED,
     CONTEXTMENU_MODULEINFO,
     CONTEXTMENU_SELL,
     ...
     CONTEXTMENU_CREATECOMP7LIGHTSQUAD,
     CONTEXTMENU_INVITE,
     CONTEXTMENU_APPEAL,
     ...
     CONTEXTMENU_BOT,
     CONTEXTMENU_ASSIGNPRIVATE,
     CONTEXTMENU_ASSIGNOFFICER,
     ...
     CONTEXTMENU_CREWWIDGETPERSONALFILE,
     CONTEXTMENU_CREWWIDGETRETRAIN,
     CONTEXTMENU_CREWWIDGETCHANGECREWMEMBER,
    ...
    TANK_PARAMS_ENUM = (
     ...
     TANK_PARAMS_FURYRELOADEFFICIENCYLEVELPERHIT,
     TANK_PARAMS_FURYRELOADEFFICIENCYLEVELPERDESTRUCTION,
     TANK_PARAMS_ACCURACYDISPERSIONCAP,
     TANK_PARAMS_ACCURACYWHILEMOVINGDISPERSIONCAP,
     TANK_PARAMS_MAXACCURACYLEVEL,
     TANK_PARAMS_ACCURACYDISPERSIONPERLEVEL,
     TANK_PARAMS_ACCURACYSPEEDLIMIT,
     TANK_PARAMS_ACCURACYLEVELGAINTIME,
     TANK_PARAMS_PREHEATDMGCAP,
     TANK_PARAMS_PREHEATDISPERSIONCAP,
     TANK_PARAMS_PREHEATTIMETOFULL,
     TANK_PARAMS_PREHEATTIMETOZERO,
     TANK_PARAMS_PREHEATSPEEDLIMIT,
     TANK_PARAMS_PREHEATTRANSITIONDELAY,
     TANK_PARAMS_ENGINEPOWERWITHBOOSTERS,
     TANK_PARAMS_TOPSPEEDWITHBOOSTERS,
     TANK_PARAMS_REVERSESPEEDREDUCTIONWITHBOOSTERS,
     TANK_PARAMS_TRAVERSESPEEDREDUCTIONWITHBOOSTERS,
     TANK_PARAMS_BOOSTERDURATION,
     TANK_PARAMS_BOOSTERCOOLINGTIME,
     TANK_PARAMS_REACTIVATIONLIMIT,
     TANK_PARAMS_REACTIVATIONDELAY,
     TANK_PARAMS_HEATAVGDMGPERLVL,
     TANK_PARAMS_HEATTIMETOREACHLEVEL,
     TANK_PARAMS_HEATTIMEBEFOREOVERHEAT,
     TANK_PARAMS_HEATCHARGEOVERHEATDURATION,
     TANK_PARAMS_PASSIVECOINCIDECESHOOTINGCHARGE,
     TANK_PARAMS_ACTIVECOINCIDECESHOOTINGCHARGE,
     TANK_PARAMS_COINCIDENCEELECTROMECHANICALSIGHTDURATION,
     TANK_PARAMS_AIMINGTIMECOINCIDENCEELECTROMECHANICALSIGHT,
     TANK_PARAMS_DISPERSIONAT100MCOINCIDENCEELECTROMECHANICALSIGHT,
     TANK_PARAMS_RELOADTIMECOINCIDENCE,
     TANK_PARAMS_SWITCHENGINEMODEBOTHMODES,
     TANK_PARAMS_TURBOSPEEDCAP,
     TANK_PARAMS_ENGINETURBOPOWERCAP,
     TANK_PARAMS_AIMINGTIMETURBO,
     TANK_PARAMS_MOVEMENTTRAVERSEDISPERSIONTURBO,
     TANK_PARAMS_HULLTRAVERSEDISPERSIONTURBO,
     TANK_PARAMS_GUNTRAVERSEDISPERSIONTURBO,
     TANK_PARAMS_IONAFTERBURNERPASSIVETURBOCHARGE,
     TANK_PARAMS_IONAFTERBURNERACTIVETURBOCHARGE,
     TANK_PARAMS_IONAFTERBURNERDURATION,
     TANK_PARAMS_IONAFTERBURNERDURATIONSPEEDCAP,
     TANK_PARAMS_IONAFTERBURNERDURATIONENGINEPOWER,
     TANK_PARAMS_DESIGNATORINITIALCOOLDOWNS,
     ...
     TANK_PARAMS_SHELLCALIBRATIONAVGPENETRATION,
     TANK_PARAMS_SHELLCALIBRATIONAVGDAMAGE,
     ...
     TANK_PARAMS_FORWARDMAXSPEED,
     TANK_PARAMS_CHASSISMODULEROTATIONSPEED,
     TANK_PARAMS_TURRETMODULEROTATIONSPEED,
     TANK_PARAMS_GUNMODULEAVGDAMAGELIST,
     ...
     TANK_PARAMS_RADARRADIUS,
     TANK_PARAMS_RADARCOOLDOWN,
     ...
     TANK_PARAMS_IMPROVEDDAMAGEENEMIESBYRAMMING,
     TANK_PARAMS_IMPROVEDDAMAGEENEMIESCHASSISBYRAMMING,
     TANK_PARAMS_CONCENTRATIONMODECOOLDOWN,
     TANK_PARAMS_CONCENTRATIONMODEDURATION,
     TANK_PARAMS_EXTRASHOTCLIPRELOADTIME,
     TANK_PARAMS_POWERMODETHRESHOLD,
     TANK_PARAMS_POWERMODEDURATION,
     TANK_PARAMS_SECONDARYRELOADTIMESECS,
     TANK_PARAMS_SECONDARYTOTALBURSTSIZE,
     TANK_PARAMS_SECONDARYAVGDAMAGE,
     TANK_PARAMS_SECONDARYAVGPIERCINGPOWER,
     TANK_PARAMS_PILLBOXHORIZONTALROTATIONSPEED,
     TANK_PARAMS_PILLBOXVERTICALROTATIONSPEED,
     TANK_PARAMS_PILLBOXSWITCHONTIME,
     TANK_PARAMS_PILLBOXSWITCHOFFTIME,
     TANK_PARAMS_CHARGEABLEBURSTPENETRATIONCOUNT,
     TANK_PARAMS_CHARGEABLEBURSTSIZE,
     TANK_PARAMS_CHARGEABLEBURSTRELOAD,
     TANK_PARAMS_CHARGEABLEBURSTDISPERSION,
     TANK_PARAMS_STATIONARYRELOADSWITCHONTIME,
     TANK_PARAMS_STATIONARYRELOADSWITCHOFFTIME,
     TANK_PARAMS_EXTENDEDTITLE_DUALACCURACYCOOLINGDELAY,
     TANK_PARAMS_EXTENDEDTITLE_BUSTLEFEEDSWITCHINGTOBAF,
     TANK_PARAMS_EXTENDEDTITLE_BUSTLEFEEDMAXSPEED,
     TANK_PARAMS_VALUES_PARAM12_VALUE0,
     TANK_PARAMS_VALUES_PARAM12_VALUE1,
     TANK_PARAMS_VALUES_PARAM12_VALUE2,
     TANK_PARAMS_VALUES_PARAM12_VALUE3,
     TANK_PARAMS_VALUES_PARAM10_VALUE0,
     TANK_PARAMS_VALUES_PARAM10_VALUE1,
     TANK_PARAMS_VALUES_PARAM10_VALUE2,
     TANK_PARAMS_VALUES_PARAM10_VALUE3,
     TANK_PARAMS_VALUES_PARAM11_VALUE0,
     TANK_PARAMS_VALUES_PARAM11_VALUE1,
     ...
     TANK_PARAMS_SHELLPARAMSSWITCHINGTIME,
     TANK_PARAMS_T,
     TANK_PARAMS_P,
     TANK_PARAMS_PT,
     TANK_PARAMS_MPH,
     ...
     TANK_PARAMS_AUXILIARYROCKETLAUNCHERRELOADTIME,
     TANK_PARAMS_AUXILIARYROCKETLAUNCHERAVGDAMAGE,
     TANK_PARAMS_AUXILIARYROCKETLAUNCHERPENETRATION,
     TANK_PARAMS_AUXILIARYROCKETLAUNCHERVELOCITY,
     TANK_PARAMS_AUXILIARYROCKETLAUNCHERDISPERSION,
     TANK_PARAMS_AUTORELOADERSURGEMAXCHARGES,
     TANK_PARAMS_AUTORELOADERSURGEINITCHARGES,
     TANK_PARAMS_AUTORELOADERSURGECHARGETIMESLOW,
     TANK_PARAMS_AUTORELOADERSURGECHARGETIMEFAST,
     TANK_PARAMS_AUTORELOADERSURGEBOOSTEDRELOADTIME,
     TANK_PARAMS_BUSTLEFEEDDAMAGEPERSHOT,
     TANK_PARAMS_BUSTLEFEEDRATEOFFIRE,
     TANK_PARAMS_BUSTLEFEEDSWITCHINGTOEASMMODE,
     TANK_PARAMS_BUSTLEFEEDSWITCHINGTOSTANDARDMODE,
     TANK_PARAMS_BUSTLEFEEDMAXSPEED,
     TANK_PARAMS_SIGHTPOINTERDEPLOYTIME,
     TANK_PARAMS_SIGHTPOINTERRELOADTIME,
     TANK_PARAMS_SIGHTPOINTERDURATION,
     TANK_PARAMS_SIGHTPOINTERROTATIONSPEED,
     TANK_PARAMS_SIGHTPOINTERSECTORANGLESTART,
     TANK_PARAMS_SIGHTPOINTERSECTORANGLEEND,
    ...
    BOOSTER_DESCRIPTION_ENUM = (
     ...
     BOOSTER_DESCRIPTION_BOOSTER_FREE_XP_AND_CREW_XP,
