...
class INGAME_GUI(object):
    ...
    PLAYER_ERRORS_MECHANICS_SUPPORTWEAPON_CANT_SHOOT = '#ingame_gui:player_errors/mechanics/supportWeapon/cant_shoot'
    PLAYER_ERRORS_MECHANICS_AUXILIARYROCKETLAUNCHER_CANT_SHOOT = '#ingame_gui:player_errors/mechanics/auxiliaryRocketLauncher/cant_shoot'
    PLAYER_ERRORS_MECHANICS_AUTORELOADERSURGE_NOCHARGES = '#ingame_gui:player_errors/mechanics/autoreloaderSurge/noCharges'
    PLAYER_ERRORS_MECHANICS_AUTORELOADERSURGE_CLIPFULL = '#ingame_gui:player_errors/mechanics/autoreloaderSurge/clipFull'
    PLAYER_ERRORS_MECHANICS_AUTORELOADERSURGE_NOAMMO = '#ingame_gui:player_errors/mechanics/autoreloaderSurge/noAmmo'
    PLAYER_ERRORS_MECHANICS_AUTORELOADERSURGE_RELOADINGSMALL = '#ingame_gui:player_errors/mechanics/autoreloaderSurge/reloadingSmall'
    ...
    SHELLS_KINDS_PARAMS_HEADER_BUSTLEFEED = '#ingame_gui:shells_kinds/params/header/bustleFeed'
    SHELLS_KINDS_PARAMS_HEADER_LOWCHARGESHOT = '#ingame_gui:shells_kinds/params/header/lowChargeShot'
    SHELLS_KINDS_PARAMS_HEADER_SHELLCALIBRATION = '#ingame_gui:shells_kinds/params/header/shellCalibration'
    SHELLS_KINDS_PARAMS_HEADER_SHELLPARAMSSWITCHER = '#ingame_gui:shells_kinds/params/header/shellParamsSwitcher'
    ...
    SHELLS_KINDS_PARAMS_NORMALIZATIONANGLE = '#ingame_gui:shells_kinds/params/normalizationAngle'
    SHELLS_KINDS_PARAMS_RICOCHETANGLE = '#ingame_gui:shells_kinds/params/ricochetAngle'
    SHELLS_KINDS_PARAMS_CRITICALHITCHANCE = '#ingame_gui:shells_kinds/params/criticalHitChance'
    SHELLS_KINDS_PARAMS_CRITICALHITCHANCE_STANDARD = '#ingame_gui:shells_kinds/params/criticalHitChance/standard'
    SHELLS_KINDS_PARAMS_CRITICALHITCHANCE_INCREASED = '#ingame_gui:shells_kinds/params/criticalHitChance/increased'
    SHELLS_KINDS_PARAMS_CRITICALHITCHANCE_DECREASED = '#ingame_gui:shells_kinds/params/criticalHitChance/decreased'
    SHELLS_KINDS_PARAMS_PENETRATIONLOSSVALUETEMPLATE = '#ingame_gui:shells_kinds/params/penetrationLossValueTemplate'
    SHELLS_KINDS_PARAMS_PENETRATIONLOSS = '#ingame_gui:shells_kinds/params/penetrationLoss'
    ...
    VEHICLE_MESSAGES_DEVICE_DESTROYED_AT_MINEFIELD_ZONE_SELF_SUICIDE = '#ingame_gui:vehicle_messages/DEVICE_DESTROYED_AT_MINEFIELD_ZONE_SELF_SUICIDE'
    VEHICLE_MESSAGES_DEVICE_DESTROYED_AT_MINEFIELD_ZONE_ALLY_SUICIDE = '#ingame_gui:vehicle_messages/DEVICE_DESTROYED_AT_MINEFIELD_ZONE_ALLY_SUICIDE'
    ...
    POSTMORTEM_MESSAGES_DEATH_FROM_MINEFIELD_ZONE_SELF_SUICIDE = '#ingame_gui:postmortem_messages/DEATH_FROM_MINEFIELD_ZONE_SELF_SUICIDE'
    ...
    PLAYER_MESSAGES_DEATH_FROM_MINEFIELD_ZONE_ALLY_SUICIDE = '#ingame_gui:player_messages/DEATH_FROM_MINEFIELD_ZONE_ALLY_SUICIDE'
    PLAYER_MESSAGES_DEATH_FROM_MINEFIELD_ZONE_SELF_SUICIDE = '#ingame_gui:player_messages/DEATH_FROM_MINEFIELD_ZONE_SELF_SUICIDE'
    ...
    EFFICIENCYRIBBONS_MINEFIELDZONE = '#ingame_gui:efficiencyRibbons/minefieldZone'
    ...
    EFFICIENCYRIBBONS_HEROCKET = '#ingame_gui:efficiencyRibbons/heRocket'
    EFFICIENCYRIBBONS_RECEIVEDHEROCKET = '#ingame_gui:efficiencyRibbons/receivedHERocket'
    ...
    INTUITION_TIMERANGE = '#ingame_gui:intuition/timeRange'
    ...
    SIEGEMODE_HINT_SHELLPARAMSSWITCHER = '#ingame_gui:siegeMode/hint/shellParamsSwitcher'
    ...
    SIEGEMODE_HINT_BUSTLEFEED = '#ingame_gui:siegeMode/hint/bustleFeed'
    ...
    SPOTTED_INDICATOR = '#ingame_gui:spotted/indicator'
    SPOTTED_SECONDS = '#ingame_gui:spotted/seconds'
    ...
    HELPSCREEN_PILLBOX_PRESS = '#ingame_gui:helpScreen/pillbox/press'
    HELPSCREEN_PILLBOX_DESCRIPTION_ENTER = '#ingame_gui:helpScreen/pillbox/description/enter'
    HELPSCREEN_PILLBOX_DESCRIPTION_EXITSIEGE = '#ingame_gui:helpScreen/pillbox/description/exitSiege'
    HELPSCREEN_PILLBOX_DESCRIPTION_EXITPILLBOX = '#ingame_gui:helpScreen/pillbox/description/exitPillbox'
    HELPSCREEN_PILLBOX_NOBINDING = '#ingame_gui:helpScreen/pillbox/noBinding'
    ...
    QUICKREPLY_HINT_TOCOMMEND = '#ingame_gui:quickReply/hint/toCommend'
    ...
    EFFICIENCYRIBBONS_ENUM = (
     ...
     EFFICIENCYRIBBONS_MINEFIELDZONE,
     ...
     EFFICIENCYRIBBONS_HEROCKET,
     EFFICIENCYRIBBONS_RECEIVEDHEROCKET,
