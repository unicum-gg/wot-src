...
class INGAME_GUI(object):
    ...
    DEVICES_TRACK_RESERVE = '#ingame_gui:devices/track/reserve'
    DEVICES_TRACK_MAIN = '#ingame_gui:devices/track/main'
    DEVICES_TRACK_INNER = '#ingame_gui:devices/track/inner'
    DEVICES_TRACK_OUTER = '#ingame_gui:devices/track/outer'
    DEVICES_TRACK_FRONT = '#ingame_gui:devices/track/front'
    DEVICES_TRACK_BACK = '#ingame_gui:devices/track/back'
    ...
    CHAT_SHORTCUTS_RELOADING_CASSETTE_AUTO_SHOOT = '#ingame_gui:chat_shortcuts/reloading_cassette_auto_shoot'
    ...
    CHAT_SHORTCUTS_RELOADING_READY_CASSETTE_AUTO_SHOOT = '#ingame_gui:chat_shortcuts/reloading_ready_cassette_auto_shoot'
    ...
    CHAT_EXAMPLE_RELOADING_CASSETTE_AUTO_SHOOT = '#ingame_gui:chat_example/reloading_cassette_auto_shoot'
    ...
    CHAT_EXAMPLE_RELOADING_READY_CASSETTE_AUTO_SHOOT = '#ingame_gui:chat_example/reloading_ready_cassette_auto_shoot'
    ...
    SHELLS_KINDS_HOLLOW_CHARGE_DF = '#ingame_gui:shells_kinds/HOLLOW_CHARGE_DF'
    SHELLS_KINDS_HIGH_EXPLOSIVE_DF = '#ingame_gui:shells_kinds/HIGH_EXPLOSIVE_DF'
    SHELLS_KINDS_ARMOR_PIERCING_DF = '#ingame_gui:shells_kinds/ARMOR_PIERCING_DF'
    SHELLS_KINDS_ARMOR_PIERCING_HE_DF = '#ingame_gui:shells_kinds/ARMOR_PIERCING_HE_DF'
    SHELLS_KINDS_ARMOR_PIERCING_CR_DF = '#ingame_gui:shells_kinds/ARMOR_PIERCING_CR_DF'
    ...
    SHELLS_KINDS_PARAMS_SHOTSPEEDACCELERATED = '#ingame_gui:shells_kinds/params/shotSpeedAccelerated'
    ...
    DAMAGELOG_SHELLTYPE_HOLLOW_CHARGE_DF = '#ingame_gui:damageLog/shellType/HOLLOW_CHARGE_DF'
    DAMAGELOG_SHELLTYPE_HIGH_EXPLOSIVE_DF = '#ingame_gui:damageLog/shellType/HIGH_EXPLOSIVE_DF'
    DAMAGELOG_SHELLTYPE_ARMOR_PIERCING_DF = '#ingame_gui:damageLog/shellType/ARMOR_PIERCING_DF'
    DAMAGELOG_SHELLTYPE_ARMOR_PIERCING_HE_DF = '#ingame_gui:damageLog/shellType/ARMOR_PIERCING_HE_DF'
    DAMAGELOG_SHELLTYPE_ARMOR_PIERCING_CR_DF = '#ingame_gui:damageLog/shellType/ARMOR_PIERCING_CR_DF'
    ...
    BATTLEENDWARNING_COMP7_1_TEXT = '#ingame_gui:battleEndWarning/comp7_1/text'
    BATTLEENDWARNING_COMP7_2_TEXT = '#ingame_gui:battleEndWarning/comp7_2/text'
    ...
    CHAT_SHORTCUTS_ENUM = (
     ...
     CHAT_SHORTCUTS_RELOADING_CASSETTE_AUTO_SHOOT,
     CHAT_SHORTCUTS_RELOADING_READY,
     CHAT_SHORTCUTS_RELOADING_READY_CASSETTE,
     CHAT_SHORTCUTS_RELOADING_READY_CASSETTE_AUTO_SHOOT,
    ...
    CHAT_EXAMPLE_ENUM = (
     ...
     CHAT_EXAMPLE_RELOADING_CASSETTE_AUTO_SHOOT,
     CHAT_EXAMPLE_RELOADING_READY,
     CHAT_EXAMPLE_TURN_BACK,
     CHAT_EXAMPLE_RELOADING_READY_CASSETTE,
     CHAT_EXAMPLE_RELOADING_READY_CASSETTE_AUTO_SHOOT,
