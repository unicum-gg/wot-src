...
class TOOLTIPS(object):
    ...
    LOBY_MESSENGER_REFERRAL_BUTTON = '#tooltips:loby_messenger/referral_button'
    ...
    VEHICLEPREVIEW_MODULS_EARLYACCESS = '#tooltips:vehiclePreview/moduls/earlyAccess'
    VEHICLEPREVIEW_MODULS_NOMODULES = '#tooltips:vehiclePreview/moduls/noModules'
    ...
    SETTINGS_RIBBONS_ENEMYSTUN_HEADER = '#tooltips:settings/ribbons/enemyStun/header'
    SETTINGS_RIBBONS_ENEMYSTUN_BODY = '#tooltips:settings/ribbons/enemyStun/body'
    ...
    ONLY10MODE_HEADER = '#tooltips:only10Mode/header'
    ONLY10MODE_BODY = '#tooltips:only10Mode/body'
    ONLY10MODE_ATTENTION = '#tooltips:only10Mode/attention'
    ...
    EPICBATTLESOFFER_TITLE_GUIDE_GIFT = '#tooltips:epicBattlesOffer/title/guide_gift'
    EPICBATTLESOFFER_TITLE_BOOK_GIFT = '#tooltips:epicBattlesOffer/title/book_gift'
    ...
    HANGAR_STARTBTN_NOTSUPPORTFOR11LVL_HEADER = '#tooltips:hangar/startBtn/notSupportFor11lvl/header'
    HANGAR_STARTBTN_NOTSUPPORTFOR11LVL_BODY = '#tooltips:hangar/startBtn/notSupportFor11lvl/body'
    ...
    CREWBUNDLE_BONUS_BASICROLEBOOST_100 = '#tooltips:crewBundle/bonus/basicRoleBoost_100'
    ...
    PERSONAL_CASE_SKILLS_DROPSKILLSBUTTON_HEADER = '#tooltips:personal_case/skills/dropSkillsButton/header'
    PERSONAL_CASE_SKILLS_DROPSKILLSBUTTON_BODY = '#tooltips:personal_case/skills/dropSkillsButton/body'
    PERSONAL_CASE_SKILLS_DROPSKILLSBUTTON_NOSKILL_HEADER = '#tooltips:personal_case/skills/dropSkillsButton/noSkill/header'
    PERSONAL_CASE_SKILLS_DROPSKILLSBUTTON_NOSKILL_BODY = '#tooltips:personal_case/skills/dropSkillsButton/noSkill/body'
    PERSONAL_CASE_SKILLS_DROPSKILLSBUTTON_INBATTLE_HEADER = '#tooltips:personal_case/skills/dropSkillsButton/inBattle/header'
    PERSONAL_CASE_SKILLS_DROPSKILLSBUTTON_INBATTLE_BODY = '#tooltips:personal_case/skills/dropSkillsButton/inBattle/body'
    ...
    PERSONAL_CASE_SKILLS_ACCTEACHINGOFSKILLBTN_SELECTSKILL_HEADER = '#tooltips:personal_case/skills/accTeachingOfSkillBtn/selectSkill/header'
    PERSONAL_CASE_SKILLS_ACCTEACHINGOFSKILLBTN_SELECTSKILL_BODY = '#tooltips:personal_case/skills/accTeachingOfSkillBtn/selectSkill/body'
    ...
    MODULEFITS_UNSUITABLE_BATTLEMODE_HEADER = '#tooltips:moduleFits/unsuitable_battlemode/header'
    MODULEFITS_UNSUITABLE_BATTLEMODE_TEXT = '#tooltips:moduleFits/unsuitable_battlemode/text'
    MODULEFITS_COMPARE_HEADER = '#tooltips:moduleFits/compare/header'
    MODULEFITS_COMPARE_TEXT = '#tooltips:moduleFits/compare/text'
    ...
    BATTLEBOOSTER_USELESS_NO_SUITABLE_EQUIPMENT = '#tooltips:battleBooster/useless/no_suitable_equipment'
    BATTLEBOOSTER_USELESS_COMPARE = '#tooltips:battleBooster/useless/compare'
    BATTLEBOOSTER_USELESS_UNSUITABLE_BATTLEMODE = '#tooltips:battleBooster/useless/unsuitable_battlemode'
    ...
    VEHICLE_EA_PRICE = '#tooltips:vehicle/ea_price'
    VEHICLE_UNLOCKPRICEAFTEREA = '#tooltips:vehicle/unlockPriceAfterEA'
    ...
    VEHICLE_TELECOMRENTING = '#tooltips:vehicle/telecomRenting'
    ...
    VEHICLE_STATTRACK_LABEL = '#tooltips:vehicle/statTrack/label'
    VEHICLE_STATTRACK_LABELCOUNT = '#tooltips:vehicle/statTrack/labelCount'
    ...
    QUESTS_PROGRESS_EARLYACCESS = '#tooltips:quests/progress/earlyAccess'
    ...
    QUESTS_LINKBTN_EARLYACCESS = '#tooltips:quests/linkBtn/earlyAccess'
    ...
    VEHICLESTATUS_TEMPUNAVAILABLE_HEADER = '#tooltips:vehicleStatus/tempUnavailable/header'
    VEHICLESTATUS_ROTATIONGROUPUNLOCKED_HEADER = '#tooltips:vehicleStatus/rotationGroupUnlocked/header'
    VEHICLESTATUS_FORBIDDENVEHICLE_BODY = '#tooltips:vehicleStatus/forbiddenVehicle/body'
    ...
    TANKMAN_VEHICLESPECIALIZATION = '#tooltips:tankman/vehicleSpecialization'
    TANKMAN_COMMANDERFEATURES_COMMANDERBONUS = '#tooltips:tankman/commanderFeatures/commanderBonus'
    ...
    RESEARCHPAGE_VEHICLE_STATUS_EARLYACCESSPARENTVEHICLEISLOCKED_HEADER = '#tooltips:researchPage/vehicle/status/earlyAccessParentVehicleIsLocked/header'
    RESEARCHPAGE_VEHICLE_STATUS_EARLYACCESSPARENTVEHICLEISLOCKED_TEXT = '#tooltips:researchPage/vehicle/status/earlyAccessParentVehicleIsLocked/text'
    RESEARCHPAGE_VEHICLE_STATUS_EARLYACCESSNOTENOUGHTOKENS_HEADER = '#tooltips:researchPage/vehicle/status/earlyAccessNotEnoughTokens/header'
    ...
    TECHTREEPAGE_EVENTGENERAL_TIME = '#tooltips:techTreePage/eventGeneral/time'
    ...
    TECHTREEPAGE_EARLYACCESSENTRYPOINTTOOLTIP_HEADER = '#tooltips:techTreePage/earlyAccessEntryPointTooltip/header'
    TECHTREEPAGE_EARLYACCESSENTRYPOINTTOOLTIP_BODY = '#tooltips:techTreePage/earlyAccessEntryPointTooltip/body'
    TECHTREEPAGE_EARLYACCESSQUESTSENTRYPOINTTOOLTIP_HEADER = '#tooltips:techTreePage/earlyAccessQuestsEntryPointTooltip/header'
    TECHTREEPAGE_EARLYACCESSQUESTSENTRYPOINTTOOLTIP_BODY = '#tooltips:techTreePage/earlyAccessQuestsEntryPointTooltip/body'
    TECHTREEPAGE_EARLYACCESSBUYENTRYPOINTTOOLTIP_HEADER = '#tooltips:techTreePage/earlyAccessBuyEntryPointTooltip/header'
    TECHTREEPAGE_EARLYACCESSBUYENTRYPOINTTOOLTIP_BODY = '#tooltips:techTreePage/earlyAccessBuyEntryPointTooltip/body'
    TECHTREEPAGE_EARLYACCESSVEHICLELOCKEDTOOLTIP_HEADER = '#tooltips:techTreePage/earlyAccessVehicleLockedTooltip/header'
    TECHTREEPAGE_EARLYACCESSVEHICLELOCKEDTOOLTIP_BODY = '#tooltips:techTreePage/earlyAccessVehicleLockedTooltip/body'
    TECHTREEPAGE_EARLYACCESSVEHICLELOCKEDTOOLTIP_WILLAVAILABLE = '#tooltips:techTreePage/earlyAccessVehicleLockedTooltip/willAvailable'
    ...
    BLUEPRINT_VEHICLEBLUEPRINTTOOLTIP_VEHICLEISINEARLYACCESS_HEADER = '#tooltips:blueprint/VehicleBlueprintTooltip/vehicleIsInEarlyAccess/header'
    BLUEPRINT_VEHICLEBLUEPRINTTOOLTIP_VEHICLEISINEARLYACCESS_BODY = '#tooltips:blueprint/VehicleBlueprintTooltip/vehicleIsInEarlyAccess/body'
    BLUEPRINT_VEHICLEBLUEPRINTTOOLTIP_VEHICLEISINEARLYACCESSBLOCKED_HEADER = '#tooltips:blueprint/VehicleBlueprintTooltip/vehicleIsInEarlyAccessBlocked/header'
    BLUEPRINT_VEHICLEBLUEPRINTTOOLTIP_VEHICLEISINEARLYACCESSBLOCKED_BODY = '#tooltips:blueprint/VehicleBlueprintTooltip/vehicleIsInEarlyAccessBlocked/body'
    ...
    VEHICLESELLDIALOG_ACCEPTBUTTONTOOLTIP_NOTENOUGHTANKMENBERTHS_BODY = '#tooltips:vehicleSellDialog/acceptButtonTooltip/notEnoughTankmenBerths/body'
    ...
    CONTACT_STATUS_INBATTLE_COMP7 = '#tooltips:Contact/status/inBattle/comp7'
    ...
    AWARDITEM_HONEY_COIN_HEADER = '#tooltips:awardItem/honey_coin/header'
    AWARDITEM_HONEY_COIN_BODY = '#tooltips:awardItem/honey_coin/body'
    ...
    AWARDITEM_REWARDSSLOTS_HEADER = '#tooltips:awardItem/rewardsSlots/header'
    AWARDITEM_REWARDSSLOTS_SUBHEADER = '#tooltips:awardItem/rewardsSlots/subHeader'
    AWARDITEM_REWARDSSLOTS_BODY1 = '#tooltips:awardItem/rewardsSlots/body1'
    AWARDITEM_REWARDSSLOTS_BODY2 = '#tooltips:awardItem/rewardsSlots/body2'
    AWARDITEM_REWARDSSLOTS_FOOTER = '#tooltips:awardItem/rewardsSlots/footer'
    ...
    AWARDITEM_TEAM_CREDITS_BONUS_HEADER = '#tooltips:awardItem/team_credits_bonus/header'
    AWARDITEM_TEAM_CREDITS_BONUS_BODY = '#tooltips:awardItem/team_credits_bonus/body'
    AWARDITEM_DAILY_QUESTS_REWARDS_HEADER = '#tooltips:awardItem/daily_quests_rewards/header'
    AWARDITEM_DAILY_QUESTS_REWARDS_BODY = '#tooltips:awardItem/daily_quests_rewards/body'
    ...
    AWARDITEM_COMP7TOKENCOUPONREWARD_HEADER = '#tooltips:awardItem/comp7TokenCouponReward/header'
    AWARDITEM_COMP7TOKENCOUPONREWARD_BODY = '#tooltips:awardItem/comp7TokenCouponReward/body'
    AWARDITEM_QUESTS_HEADER = '#tooltips:awardItem/quests/header'
    AWARDITEM_QUESTS_BODY = '#tooltips:awardItem/quests/body'
    ...
    RANKEDBATTLEVIEW_STATS_TOTALSTAGES_HEADER = '#tooltips:rankedBattleView/stats/totalStages/header'
    RANKEDBATTLEVIEW_STATS_TOTALSTAGES_BODY = '#tooltips:rankedBattleView/stats/totalStages/body'
    RANKEDBATTLEVIEW_STATS_TOTALBATTLES_HEADER = '#tooltips:rankedBattleView/stats/totalBattles/header'
    RANKEDBATTLEVIEW_STATS_TOTALBATTLES_BODY = '#tooltips:rankedBattleView/stats/totalBattles/body'
    ...
    TANK_PARAMS_DESC_CHASSISREPAIRTIMEMULTITRACK_MULTITRACKPARALLEL = '#tooltips:tank_params/desc/chassisRepairTimeMultiTrack/multiTrackParallel'
    TANK_PARAMS_DESC_CHASSISREPAIRTIMEMULTITRACK_MULTITRACKSEQUENT = '#tooltips:tank_params/desc/chassisRepairTimeMultiTrack/multiTrackSequent'
    ...
    VEHICLEPARAMS_BONUSES_TITLE_BATTLE_MODIFIERS = '#tooltips:vehicleParams/bonuses/title/battle_modifiers'
    ...
    VEHICLEPARAMS_PENALTY_CREWLEVEL = '#tooltips:vehicleParams/penalty/crewLevel'
    VEHICLEPARAMS_PENALTY_TANKMANDIFFERENTVEHICLE_TEMPLATE = '#tooltips:vehicleParams/penalty/tankmanDifferentVehicle/template'
    VEHICLEPARAMS_PENALTY_BATTLEMODIFIERS = '#tooltips:vehicleParams/penalty/battleModifiers'
    VEHICLEPARAMS_PENALTY_CREWDIFFERENTVEHICLE = '#tooltips:vehicleParams/penalty/crewDifferentVehicle'
    ...
    VEHICLEPARAMS_BATTLE_MODIFIER = '#tooltips:vehicleParams/battle_modifier'
    ...
    VEHICLEPREVIEW_VEHICLEPANEL_INFO_HEADER_CREW_ISPERK = '#tooltips:vehiclePreview/vehiclePanel/info/header/crew/isPerk'
    VEHICLEPREVIEW_VEHICLEPANEL_INFO_HEADER_CREW_ISABILLITY = '#tooltips:vehiclePreview/vehiclePanel/info/header/crew/isAbillity'
    ...
    VEHICLEPREVIEW_MODULS_NOMODULES_HEADER = '#tooltips:vehiclePreview/moduls/noModules/header'
    VEHICLEPREVIEW_MODULS_NOMODULES_BODY = '#tooltips:vehiclePreview/moduls/noModules/body'
    VEHICLEPREVIEW_MODULS_EARLYACCESS_HEADER = '#tooltips:vehiclePreview/moduls/earlyAccess/header'
    VEHICLEPREVIEW_MODULS_EARLYACCESS_BODY = '#tooltips:vehiclePreview/moduls/earlyAccess/body'
    ...
    QUESTS_BONUSES_TOKEN_VERSUS_AI_REGULAR_BODY = '#tooltips:quests/bonuses/token/versus_ai_regular/body'
    QUESTS_BONUSES_TOKEN_VERSUS_AI_WINBACK_BODY = '#tooltips:quests/bonuses/token/versus_ai_winback/body'
    ...
    HANGAR_HEADER_MONEYTOOLTIP_GOLDNAME = '#tooltips:hangar/header/moneyTooltip/goldName'
    HANGAR_HEADER_MONEYTOOLTIP_CREDITSNAME = '#tooltips:hangar/header/moneyTooltip/creditsName'
    HANGAR_HEADER_MONEYTOOLTIP_PURCHASEDVALUE = '#tooltips:hangar/header/moneyTooltip/purchasedValue'
    HANGAR_HEADER_MONEYTOOLTIP_EARNEDVALUE = '#tooltips:hangar/header/moneyTooltip/earnedValue'
    HANGAR_HEADER_MONEYTOOLTIP_TOTALVALUE = '#tooltips:hangar/header/moneyTooltip/totalValue'
    ...
    ADVANCED_HOLLOW_CHARGE_DF = '#tooltips:advanced/HOLLOW_CHARGE_DF'
    ADVANCED_HIGH_EXPLOSIVE = '#tooltips:advanced/HIGH_EXPLOSIVE'
    ADVANCED_HIGH_EXPLOSIVE_DF = '#tooltips:advanced/HIGH_EXPLOSIVE_DF'
    ADVANCED_HIGH_EXPLOSIVE_STUN = '#tooltips:advanced/HIGH_EXPLOSIVE_STUN'
    ADVANCED_HIGH_EXPLOSIVE_MODERN = '#tooltips:advanced/HIGH_EXPLOSIVE_MODERN'
    ADVANCED_HIGH_EXPLOSIVE_DF_MODERN = '#tooltips:advanced/HIGH_EXPLOSIVE_DF_MODERN'
    ADVANCED_ARMOR_PIERCING = '#tooltips:advanced/ARMOR_PIERCING'
    ADVANCED_ARMOR_PIERCING_DF = '#tooltips:advanced/ARMOR_PIERCING_DF'
    ADVANCED_ARMOR_PIERCING_CR = '#tooltips:advanced/ARMOR_PIERCING_CR'
    ADVANCED_ARMOR_PIERCING_FSDS = '#tooltips:advanced/ARMOR_PIERCING_FSDS'
    ADVANCED_FLAME = '#tooltips:advanced/FLAME'
    ADVANCED_FLAME_STUN = '#tooltips:advanced/FLAME_STUN'
    ...
    ADVANCED_GUNCOOLING = '#tooltips:advanced/gunCooling'
    ADVANCED_DUALGUNCOOLING = '#tooltips:advanced/dualGunCooling'
    ...
    ADVANCED_RELATIVEABILITY = '#tooltips:advanced/relativeAbility'
    ...
    ADVANCED_HEADER_SHELLTYPE_ARMOR_PIERCING_FSDS = '#tooltips:advanced/header/shellType/ARMOR_PIERCING_FSDS'
    ADVANCED_HEADER_SHELLTYPE_FLAME = '#tooltips:advanced/header/shellType/FLAME'
    ADVANCED_HEADER_SHELLTYPE_HIGH_EXPLOSIVE_DF = '#tooltips:advanced/header/shellType/HIGH_EXPLOSIVE_DF'
    ADVANCED_HEADER_SHELLTYPE_ARMOR_PIERCING_DF = '#tooltips:advanced/header/shellType/ARMOR_PIERCING_DF'
    ADVANCED_HEADER_SHELLTYPE_HOLLOW_CHARGE_DF = '#tooltips:advanced/header/shellType/HOLLOW_CHARGE_DF'
    ...
    SQUADBONUS_RANKED_DESCRIPTION = '#tooltips:squadBonus/ranked/description'
    ...
    SQUADBONUS_COMPLEX_RANKED_HEADER = '#tooltips:squadBonus/complex/ranked/header'
    SQUADBONUS_COMPLEX_RANKED_BODY = '#tooltips:squadBonus/complex/ranked/body'
    ...
    BATTLEPASSOFFER_FOOTER_ERROR = '#tooltips:battlePassOffer/footer/error'
    ...
    BATTLEPASSOFFER_TITLE_DELUXE_GIFT = '#tooltips:battlePassOffer/title/deluxe_gift'
    BATTLEPASSOFFER_FOOTER_DELUXE_GIFT = '#tooltips:battlePassOffer/footer/deluxe_gift'
    BATTLEPASSOFFER_TITLE_STYLE_GIFT = '#tooltips:battlePassOffer/title/style_gift'
    ...
    BATTLEPASSOFFER_TITLE_BOOK_GIFT = '#tooltips:battlePassOffer/title/book_gift'
    BATTLEPASSOFFER_FOOTER_BOOK_GIFT = '#tooltips:battlePassOffer/footer/book_gift'
    BATTLEPASSOFFER_TITLE_EXPEQUIPMENTS_GIFT = '#tooltips:battlePassOffer/title/expequipments_gift'
    BATTLEPASSOFFER_FOOTER_EXPEQUIPMENTS_GIFT = '#tooltips:battlePassOffer/footer/expequipments_gift'
    ...
    SELECTABLECREWBOOK_BOOK_FOOTER = '#tooltips:selectableCrewbook/book/footer'
    ...
    SELECTABLECREWBOOK_BOOK_TITLE = '#tooltips:selectableCrewbook/book/title'
    ...
    ACCOUNTCOMPLETIONHANGAR_TITLE = '#tooltips:accountCompletionHangar/title'
    ACCOUNTCOMPLETIONHANGAR_TEXT = '#tooltips:accountCompletionHangar/text'
    ACCOUNTCOMPLETIONHANGAR_HOLDER = '#tooltips:accountCompletionHangar/holder'
    ACCOUNTCOMPLETIONHANGAR_EMAIL_TITLE = '#tooltips:accountCompletionHangar/email/title'
    ACCOUNTCOMPLETIONHANGAR_EMAIL_TEXT = '#tooltips:accountCompletionHangar/email/text'
    ACCOUNTCOMPLETIONHANGAR_EMAIL_PRIZETITLE = '#tooltips:accountCompletionHangar/email/prizeTitle'
    ...
    ACCOUNTCOMPLETION_CREDENTIALS_SUBTITLE_HEADER = '#tooltips:accountCompletion/credentials/subtitle/header'
    ...
    MODE_SELECTOR_UNAVAILABLE_COSMIC = '#tooltips:mode_selector/unavailable/cosmic'
    ...
    MODE_SELECTOR_POPOVER_DOMINATION_HEADER = '#tooltips:mode_selector/popover/domination/header'
    MODE_SELECTOR_POPOVER_DOMINATION_BODY = '#tooltips:mode_selector/popover/domination/body'
    MODE_SELECTOR_POPOVER_ASSAULT_HEADER = '#tooltips:mode_selector/popover/assault/header'
    MODE_SELECTOR_POPOVER_ASSAULT_BODY = '#tooltips:mode_selector/popover/assault/body'
    MODE_SELECTOR_POPOVER_EPICSTANDARD_HEADER = '#tooltips:mode_selector/popover/epicStandard/header'
    MODE_SELECTOR_POPOVER_EPICSTANDARD_BODY = '#tooltips:mode_selector/popover/epicStandard/body'
    MODE_SELECTOR_POPOVER_EPICSTANDARD_ATTENTION = '#tooltips:mode_selector/popover/epicStandard/attention'
    MODE_SELECTOR_POPOVER_DEVMAPS_HEADER = '#tooltips:mode_selector/popover/devMaps/header'
    MODE_SELECTOR_POPOVER_DEVMAPS_BODY = '#tooltips:mode_selector/popover/devMaps/body'
    ...
    IDLE_CREW_TOOLTIP_STATUS_UNAVAILABLE_DESCRIPTION_INCOMPATIBLECREW = '#tooltips:idle_crew_tooltip/status/unavailable/description/incompatibleCrew'
    ...
    DEMOACCOUNTRENAMINGHANGAR_TITLE = '#tooltips:demoAccountRenamingHangar/title'
    DEMOACCOUNTRENAMINGHANGAR_TEXT = '#tooltips:demoAccountRenamingHangar/text'
    DEMOACCOUNTRENAMINGHANGAR_HOLDER = '#tooltips:demoAccountRenamingHangar/holder'
    DEMOACCOUNTRENAMING_NOTAVAILABLE_HEADER = '#tooltips:demoAccountRenaming/notAvailable/header'
    DEMOACCOUNTRENAMING_NOTAVAILABLE_BODY = '#tooltips:demoAccountRenaming/notAvailable/body'
    ...
    ROLESKILL_START_CHARGE = '#tooltips:roleSkill/start_charge'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_BP12MT_1_DESC = '#tooltips:notrecruitedtankman/tankmen_bp12MT_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12MT_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp12MT_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12MT_2_DESC = '#tooltips:notrecruitedtankman/tankmen_bp12MT_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12MT_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp12MT_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12MT_3_DESC = '#tooltips:notrecruitedtankman/tankmen_bp12MT_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12MT_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp12MT_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12MT_4_DESC = '#tooltips:notrecruitedtankman/tankmen_bp12MT_4/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12MT_4_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp12MT_4/label'
    NOTRECRUITEDTANKMAN_COMMANDER_MF_TRUS_DESC = '#tooltips:notrecruitedtankman/commander_mf_Trus/desc'
    NOTRECRUITEDTANKMAN_COMMANDER_MF_TRUS_LABEL = '#tooltips:notrecruitedtankman/commander_mf_Trus/label'
    NOTRECRUITEDTANKMAN_COMMANDER_MF_BALBES_DESC = '#tooltips:notrecruitedtankman/commander_mf_Balbes/desc'
    NOTRECRUITEDTANKMAN_COMMANDER_MF_BALBES_LABEL = '#tooltips:notrecruitedtankman/commander_mf_Balbes/label'
    NOTRECRUITEDTANKMAN_COMMANDER_MF_BYVALY_DESC = '#tooltips:notrecruitedtankman/commander_mf_Byvaly/desc'
    NOTRECRUITEDTANKMAN_COMMANDER_MF_BYVALY_LABEL = '#tooltips:notrecruitedtankman/commander_mf_Byvaly/label'
    NOTRECRUITEDTANKMAN_COMMANDER_NIKOLAY_KUZNETSOV_DESC = '#tooltips:notrecruitedtankman/commander_Nikolay_Kuznetsov/desc'
    NOTRECRUITEDTANKMAN_COMMANDER_NIKOLAY_KUZNETSOV_LABEL = '#tooltips:notrecruitedtankman/commander_Nikolay_Kuznetsov/label'
    ...
    TRAININGLEVEL_ADDITIONALQUALIFICATION = '#tooltips:trainingLevel/additionalQualification'
    TRAININGLEVEL_MODIFIERS_LABEL = '#tooltips:trainingLevel/modifiers/label'
    TRAININGLEVEL_MODIFIERS_BASELEVEL = '#tooltips:trainingLevel/modifiers/baseLevel'
    TRAININGLEVEL_MODIFIERS_COMMANDERBONUS = '#tooltips:trainingLevel/modifiers/commanderBonus'
    TRAININGLEVEL_MODIFIERS_PERKS = '#tooltips:trainingLevel/modifiers/perks'
    TRAININGLEVEL_MODIFIERS_EQUIPMENT = '#tooltips:trainingLevel/modifiers/equipment'
    TRAININGLEVEL_MODIFIERS_UNSUITABLESPECIALIZATION = '#tooltips:trainingLevel/modifiers/unsuitableSpecialization'
    TRAININGLEVEL_FINALVALUE = '#tooltips:trainingLevel/finalValue'
    TRAININGLEVEL_DESCRIPTION = '#tooltips:trainingLevel/description'
    ...
    PERKAVAILABLE_HEADER = '#tooltips:perkAvailable/header'
    PERKAVAILABLE_ZEROPERK = '#tooltips:perkAvailable/zeroPerk'
    PERKAVAILABLE_PARTLY = '#tooltips:perkAvailable/partly'
    PERKAVAILABLE_MULTIPLE = '#tooltips:perkAvailable/multiple'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_HW_IVANCAREVICH_DESC = '#tooltips:notrecruitedtankman/tankmen_hw_IvanCarevich/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_HW_IVANCAREVICH_LABEL = '#tooltips:notrecruitedtankman/tankmen_hw_IvanCarevich/label'
    NOTRECRUITEDTANKMAN_TANKMEN_HW_VASILISA_DESC = '#tooltips:notrecruitedtankman/tankmen_hw_Vasilisa/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_HW_VASILISA_LABEL = '#tooltips:notrecruitedtankman/tankmen_hw_Vasilisa/label'
    NOTRECRUITEDTANKMAN_TANKMEN_HW_KASHCHEI_DESC = '#tooltips:notrecruitedtankman/tankmen_hw_Kashchei/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_HW_KASHCHEI_LABEL = '#tooltips:notrecruitedtankman/tankmen_hw_Kashchei/label'
    NOTRECRUITEDTANKMAN_TANKMEN_HW_BABAYAGA_DESC = '#tooltips:notrecruitedtankman/tankmen_hw_BabaYaga/desc'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_MF_5_D_VOVA_LABEL = '#tooltips:notrecruitedtankman/tankmen_MF_5_d_Vova/label'
    NOTRECRUITEDTANKMAN_TANKMEN_MF_5_D_VOVA_DESC = '#tooltips:notrecruitedtankman/tankmen_MF_5_d_Vova/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_MF_6_SCRIPACH_LABEL = '#tooltips:notrecruitedtankman/tankmen_MF_6_Scripach/label'
    NOTRECRUITEDTANKMAN_TANKMEN_MF_6_SCRIPACH_DESC = '#tooltips:notrecruitedtankman/tankmen_MF_6_Scripach/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_MF_7_UEF_LABEL = '#tooltips:notrecruitedtankman/tankmen_MF_7_Uef/label'
    NOTRECRUITEDTANKMAN_TANKMEN_MF_7_UEF_DESC = '#tooltips:notrecruitedtankman/tankmen_MF_7_Uef/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_MF_8_BI_LABEL = '#tooltips:notrecruitedtankman/tankmen_MF_8_Bi/label'
    NOTRECRUITEDTANKMAN_TANKMEN_MF_8_BI_DESC = '#tooltips:notrecruitedtankman/tankmen_MF_8_Bi/desc'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_2024_RACER_1_DESC = '#tooltips:notrecruitedtankman/tankmen_2024_racer_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_2024_RACER_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_2024_racer_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_2024_RACER_2_DESC = '#tooltips:notrecruitedtankman/tankmen_2024_racer_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_2024_RACER_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_2024_racer_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_2024_RACER_3_DESC = '#tooltips:notrecruitedtankman/tankmen_2024_racer_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_2024_RACER_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_2024_racer_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_2024_RACER_4_DESC = '#tooltips:notrecruitedtankman/tankmen_2024_racer_4/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_2024_RACER_4_LABEL = '#tooltips:notrecruitedtankman/tankmen_2024_racer_4/label'
    QUESTS_BONUSES_TOKEN_LOCKPICK_HEADER = '#tooltips:quests/bonuses/token/lockpick/header'
    QUESTS_BONUSES_TOKEN_LOCKPICK_BODY = '#tooltips:quests/bonuses/token/lockpick/body'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_AC_1_DESC = '#tooltips:notrecruitedtankman/tankmen_BP14_AC_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_AC_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_BP14_AC_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_AC_2_DESC = '#tooltips:notrecruitedtankman/tankmen_BP14_AC_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_AC_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_BP14_AC_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_AC_3_DESC = '#tooltips:notrecruitedtankman/tankmen_BP14_AC_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_AC_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_BP14_AC_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_AC_4_DESC = '#tooltips:notrecruitedtankman/tankmen_BP14_AC_4/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_AC_4_LABEL = '#tooltips:notrecruitedtankman/tankmen_BP14_AC_4/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_AC_5_DESC = '#tooltips:notrecruitedtankman/tankmen_BP14_AC_5/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_AC_5_LABEL = '#tooltips:notrecruitedtankman/tankmen_BP14_AC_5/label'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_WT2024_MARAT_DESC = '#tooltips:notrecruitedtankman/tankmen_WT2024_Marat/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_WT2024_MARAT_LABEL = '#tooltips:notrecruitedtankman/tankmen_WT2024_Marat/label'
    NOTRECRUITEDTANKMAN_TANKMEN_WT2024_ELISA_DESC = '#tooltips:notrecruitedtankman/tankmen_WT2024_Elisa/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_WT2024_ELISA_LABEL = '#tooltips:notrecruitedtankman/tankmen_WT2024_Elisa/label'
    NOTRECRUITEDTANKMAN_TANKMEN_WT2024_L_KRIEGER_DESC = '#tooltips:notrecruitedtankman/tankmen_WT2024_L_Krieger/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_WT2024_L_KRIEGER_LABEL = '#tooltips:notrecruitedtankman/tankmen_WT2024_L_Krieger/label'
    NOTRECRUITEDTANKMAN_TANKMEN_WT2024_L_MARAT_DESC = '#tooltips:notrecruitedtankman/tankmen_WT2024_L_Marat/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_WT2024_L_MARAT_LABEL = '#tooltips:notrecruitedtankman/tankmen_WT2024_L_Marat/label'
    NOTRECRUITEDTANKMAN_TANKMEN_WT2024_L_MILADA_DESC = '#tooltips:notrecruitedtankman/tankmen_WT2024_L_Milada/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_WT2024_L_MILADA_LABEL = '#tooltips:notrecruitedtankman/tankmen_WT2024_L_Milada/label'
    NOTRECRUITEDTANKMAN_TANKMEN_WT2024_L_PAUL_DESC = '#tooltips:notrecruitedtankman/tankmen_WT2024_L_Paul/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_WT2024_L_PAUL_LABEL = '#tooltips:notrecruitedtankman/tankmen_WT2024_L_Paul/label'
    NOTRECRUITEDTANKMAN_TANKMEN_WT2024_L_ELISA_DESC = '#tooltips:notrecruitedtankman/tankmen_WT2024_L_Elisa/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_WT2024_L_ELISA_LABEL = '#tooltips:notrecruitedtankman/tankmen_WT2024_L_Elisa/label'
    NOTRECRUITEDTANKMAN_TANKMEN_T3_1_DESC = '#tooltips:notrecruitedtankman/tankmen_T3_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_T3_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_T3_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_T3_2_DESC = '#tooltips:notrecruitedtankman/tankmen_T3_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_T3_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_T3_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_T3_3_DESC = '#tooltips:notrecruitedtankman/tankmen_T3_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_T3_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_T3_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_T3_4_DESC = '#tooltips:notrecruitedtankman/tankmen_T3_4/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_T3_4_LABEL = '#tooltips:notrecruitedtankman/tankmen_T3_4/label'
    NOTRECRUITEDTANKMAN_TANKMEN_T3_5_DESC = '#tooltips:notrecruitedtankman/tankmen_T3_5/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_T3_5_LABEL = '#tooltips:notrecruitedtankman/tankmen_T3_5/label'
    NOTRECRUITEDTANKMAN_NY25_TANKMEN_1_LABEL = '#tooltips:notrecruitedtankman/ny25_tankmen_1/label'
    NOTRECRUITEDTANKMAN_NY25_TANKMEN_1_DESC = '#tooltips:notrecruitedtankman/ny25_tankmen_1/desc'
    NOTRECRUITEDTANKMAN_NY25_TANKMEN_2_LABEL = '#tooltips:notrecruitedtankman/ny25_tankmen_2/label'
    NOTRECRUITEDTANKMAN_NY25_TANKMEN_2_DESC = '#tooltips:notrecruitedtankman/ny25_tankmen_2/desc'
    NOTRECRUITEDTANKMAN_NY25_TANKMEN_3_LABEL = '#tooltips:notrecruitedtankman/ny25_tankmen_3/label'
    NOTRECRUITEDTANKMAN_NY25_TANKMEN_3_DESC = '#tooltips:notrecruitedtankman/ny25_tankmen_3/desc'
    NOTRECRUITEDTANKMAN_NY25_TANKMEN_4_LABEL = '#tooltips:notrecruitedtankman/ny25_tankmen_4/label'
    NOTRECRUITEDTANKMAN_NY25_TANKMEN_4_DESC = '#tooltips:notrecruitedtankman/ny25_tankmen_4/desc'
    NOTRECRUITEDTANKMAN_NY25_TANKMEN_5_LABEL = '#tooltips:notrecruitedtankman/ny25_tankmen_5/label'
    ...
    NOTRECRUITEDTANKMAN_NY25_TAMATAMA_DESC = '#tooltips:notrecruitedtankman/ny25_tamatama/desc'
    NOTRECRUITEDTANKMAN_NY25_HVATAIKA_LABEL = '#tooltips:notrecruitedtankman/ny25_hvataika/label'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_MAY25_1_DESC = '#tooltips:notrecruitedtankman/tankmen_May25_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_MAY25_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_May25_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_MAY25_2_DESC = '#tooltips:notrecruitedtankman/tankmen_May25_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_MAY25_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_May25_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_MAY25_3_DESC = '#tooltips:notrecruitedtankman/tankmen_May25_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_MAY25_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_May25_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP16_M_DESC = '#tooltips:notrecruitedtankman/tankmen_BP16_M/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP16_M_LABEL = '#tooltips:notrecruitedtankman/tankmen_BP16_M/label'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_DR2025_1_DESC = '#tooltips:notrecruitedtankman/tankmen_DR2025_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_DR2025_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_DR2025_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_DR2025_2_DESC = '#tooltips:notrecruitedtankman/tankmen_DR2025_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_DR2025_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_DR2025_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_DR2025_3_DESC = '#tooltips:notrecruitedtankman/tankmen_DR2025_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_DR2025_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_DR2025_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_DR2025_4_DESC = '#tooltips:notrecruitedtankman/tankmen_DR2025_4/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_DR2025_4_LABEL = '#tooltips:notrecruitedtankman/tankmen_DR2025_4/label'
    NOTRECRUITEDTANKMAN_TANKMEN_WT2025_1_DESC = '#tooltips:notrecruitedtankman/tankmen_WT2025_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_WT2025_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_WT2025_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_WT2025_2_DESC = '#tooltips:notrecruitedtankman/tankmen_WT2025_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_WT2025_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_WT2025_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_WT2025_3_DESC = '#tooltips:notrecruitedtankman/tankmen_WT2025_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_WT2025_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_WT2025_3/label'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_PORTAL25_1_DESC = '#tooltips:notrecruitedtankman/tankmen_Portal25_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_PORTAL25_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_Portal25_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_PORTAL25_2_DESC = '#tooltips:notrecruitedtankman/tankmen_Portal25_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_PORTAL25_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_Portal25_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_PORTAL25_3_DESC = '#tooltips:notrecruitedtankman/tankmen_Portal25_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_PORTAL25_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_Portal25_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_PORTAL25_4_DESC = '#tooltips:notrecruitedtankman/tankmen_Portal25_4/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_PORTAL25_4_LABEL = '#tooltips:notrecruitedtankman/tankmen_Portal25_4/label'
    NOTRECRUITEDTANKMAN_NY26_KRIEGER_LABEL = '#tooltips:notrecruitedtankman/ny26_krieger/label'
    ...
    NOTRECRUITEDTANKMAN_NY26_SNOWMAIDEN_2_DESC = '#tooltips:notrecruitedtankman/ny26_snowmaiden_2/desc'
    NOTRECRUITEDTANKMAN_NY26_SNOWMAIDEN_3_LABEL = '#tooltips:notrecruitedtankman/ny26_snowmaiden_3/label'
    ...
    NEWBIE_RESTRICTIONS_HEADER_TITLE = '#tooltips:newbie_restrictions/header/title'
    NEWBIE_RESTRICTIONS_HEADER_SUBTITLE_ONE_CONDITION = '#tooltips:newbie_restrictions/header/subtitle/one_condition'
    NEWBIE_RESTRICTIONS_HEADER_SUBTITLE_FEW_CONDITIONS = '#tooltips:newbie_restrictions/header/subtitle/few_conditions'
    NEWBIE_RESTRICTIONS_HEADER_SUBTITLE_ONE_OF_CONDITIONS = '#tooltips:newbie_restrictions/header/subtitle/one_of_conditions'
    NEWBIE_RESTRICTIONS_CONDITION_MINVEHICLELEVEL = '#tooltips:newbie_restrictions/condition/minVehicleLevel'
    NEWBIE_RESTRICTIONS_CONDITION_ISINCLAN = '#tooltips:newbie_restrictions/condition/isInClan'
    NEWBIE_RESTRICTIONS_CONDITION_SEPARATOR = '#tooltips:newbie_restrictions/condition/separator'
    NEWBIE_RESTRICTIONS_CONDITION_BATTLESCOUNTTHRESHOLD = '#tooltips:newbie_restrictions/condition/battlesCountThreshold'
    NEWBIE_RESTRICTIONS_CONDITION_VEHICLELEVELTHRESHOLD = '#tooltips:newbie_restrictions/condition/vehicleLevelThreshold'
    NEWBIE_RESTRICTIONS_FOOTER_PERSONAL_MISSIONS_TITLE = '#tooltips:newbie_restrictions/footer/personal_missions/title'
    NEWBIE_RESTRICTIONS_FOOTER_PERSONAL_MISSIONS_DESC = '#tooltips:newbie_restrictions/footer/personal_missions/desc'
    NEWBIE_RESTRICTIONS_FOOTER_TOURNAMENTS_TITLE = '#tooltips:newbie_restrictions/footer/tournaments/title'
    NEWBIE_RESTRICTIONS_FOOTER_TOURNAMENTS_DESC = '#tooltips:newbie_restrictions/footer/tournaments/desc'
    NEWBIE_RESTRICTIONS_FOOTER_VERSUS_AI_TITLE = '#tooltips:newbie_restrictions/footer/versus_ai/title'
    NEWBIE_RESTRICTIONS_FOOTER_VERSUS_AI_DESC = '#tooltips:newbie_restrictions/footer/versus_ai/desc'
    NEWBIE_RESTRICTIONS_FOOTER_STRONGHOLD_TITLE = '#tooltips:newbie_restrictions/footer/stronghold/title'
    NEWBIE_RESTRICTIONS_FOOTER_STRONGHOLD_DESC = '#tooltips:newbie_restrictions/footer/stronghold/desc'
    NEWBIE_RESTRICTIONS_FOOTER_RANKED_TITLE = '#tooltips:newbie_restrictions/footer/ranked/title'
    NEWBIE_RESTRICTIONS_FOOTER_RANKED_DESC = '#tooltips:newbie_restrictions/footer/ranked/desc'
    NEWBIE_RESTRICTIONS_FOOTER_SPEC_BATTLES_TITLE = '#tooltips:newbie_restrictions/footer/spec_battles/title'
    NEWBIE_RESTRICTIONS_FOOTER_SPEC_BATTLES_DESC = '#tooltips:newbie_restrictions/footer/spec_battles/desc'
    NEWBIE_RESTRICTIONS_FOOTER_COMP7_TITLE = '#tooltips:newbie_restrictions/footer/comp7/title'
    NEWBIE_RESTRICTIONS_FOOTER_COMP7_DESC = '#tooltips:newbie_restrictions/footer/comp7/desc'
    NEWBIE_RESTRICTIONS_FOOTER_ARCADE_TITLE = '#tooltips:newbie_restrictions/footer/arcade/title'
    NEWBIE_RESTRICTIONS_FOOTER_ARCADE_DESC = '#tooltips:newbie_restrictions/footer/arcade/desc'
    NEWBIE_RESTRICTIONS_FOOTER_FIELD_TRIALS_TITLE = '#tooltips:newbie_restrictions/footer/field_trials/title'
    NEWBIE_RESTRICTIONS_FOOTER_FIELD_TRIALS_DESC = '#tooltips:newbie_restrictions/footer/field_trials/desc'
    NEWBIE_RESTRICTIONS_FOOTER_FRONTLINE_TITLE = '#tooltips:newbie_restrictions/footer/frontline/title'
    NEWBIE_RESTRICTIONS_FOOTER_FRONTLINE_DESC = '#tooltips:newbie_restrictions/footer/frontline/desc'
    NEWBIE_RESTRICTIONS_FOOTER_CHATS_TITLE = '#tooltips:newbie_restrictions/footer/chats/title'
    NEWBIE_RESTRICTIONS_FOOTER_CHATS_DESC = '#tooltips:newbie_restrictions/footer/chats/desc'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_DR2026_1_DESC = '#tooltips:notrecruitedtankman/tankmen_DR2026_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_DR2026_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_DR2026_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_DR2026_2_DESC = '#tooltips:notrecruitedtankman/tankmen_DR2026_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_DR2026_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_DR2026_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_DR2026_3_DESC = '#tooltips:notrecruitedtankman/tankmen_DR2026_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_DR2026_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_DR2026_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_DR2026_4_DESC = '#tooltips:notrecruitedtankman/tankmen_DR2026_4/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_DR2026_4_LABEL = '#tooltips:notrecruitedtankman/tankmen_DR2026_4/label'
    NOTRECRUITEDTANKMAN_TANKMEN_DR2026_5_DESC = '#tooltips:notrecruitedtankman/tankmen_DR2026_5/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_DR2026_5_LABEL = '#tooltips:notrecruitedtankman/tankmen_DR2026_5/label'
    NOTRECRUITEDTANKMAN_TANKMEN_SUMMER26_1_DESC = '#tooltips:notrecruitedtankman/tankmen_Summer26_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_SUMMER26_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_Summer26_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_SUMMER26_2_DESC = '#tooltips:notrecruitedtankman/tankmen_Summer26_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_SUMMER26_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_Summer26_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_SUMMER26_3_DESC = '#tooltips:notrecruitedtankman/tankmen_Summer26_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_SUMMER26_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_Summer26_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_SUMMER26_4_DESC = '#tooltips:notrecruitedtankman/tankmen_Summer26_4/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_SUMMER26_4_LABEL = '#tooltips:notrecruitedtankman/tankmen_Summer26_4/label'
    SETTINGS_RESETBATTLECONTEXTHINTS_ENABLED_BODY = '#tooltips:settings/resetBattleContextHints/enabled/body'
    SETTINGS_RESETBATTLECONTEXTHINTS_DISABLED_BODY = '#tooltips:settings/resetBattleContextHints/disabled/body'
    SETTINGS_BATTLECONTEXTHINTS_DISABLED_BODY = '#tooltips:settings/battleContextHints/disabled/body'
    AWARDITEM_GOLDENTICKET_HEADER = '#tooltips:awardItem/goldenticket/header'
    AWARDITEM_GOLDENTICKET_BODY = '#tooltips:awardItem/goldenticket/body'
    NOTRECRUITEDTANKMAN_TANKMEN_WT2026_1_DESC = '#tooltips:notrecruitedtankman/tankmen_WT2026_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_WT2026_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_WT2026_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_WT2026_2_DESC = '#tooltips:notrecruitedtankman/tankmen_WT2026_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_WT2026_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_WT2026_2/label'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_BP21_5_DESC = '#tooltips:notrecruitedtankman/tankmen_BP21_5/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP21_5_LABEL = '#tooltips:notrecruitedtankman/tankmen_BP21_5/label'
    ...
    AWARDITEM_ALL_HEADER_ENUM = (
     ...
     AWARDITEM_TEAM_CREDITS_BONUS_HEADER,
     AWARDITEM_DAILY_QUESTS_REWARDS_HEADER,
     AWARDITEM_COMP7TOKENWEEKLYREWARD_HEADER,
     AWARDITEM_COMP7TOKENCOUPONREWARD_HEADER,
     AWARDITEM_QUESTS_HEADER,
     AWARDITEM_GOLDENTICKET_HEADER)
    AWARDITEM_ALL_BODY_ENUM = (
     ...
     AWARDITEM_TEAM_CREDITS_BONUS_BODY,
     AWARDITEM_DAILY_QUESTS_REWARDS_BODY,
     AWARDITEM_COMP7TOKENWEEKLYREWARD_BODY,
     AWARDITEM_COMP7TOKENCOUPONREWARD_BODY,
     AWARDITEM_QUESTS_BODY,
     AWARDITEM_GOLDENTICKET_BODY)
    ...
    ADVANCED_ENUM = (
     ...
     ADVANCED_HOLLOW_CHARGE_DF,
     ADVANCED_HIGH_EXPLOSIVE,
     ADVANCED_HIGH_EXPLOSIVE_DF,
     ADVANCED_HIGH_EXPLOSIVE_STUN,
     ADVANCED_HIGH_EXPLOSIVE_MODERN,
     ADVANCED_HIGH_EXPLOSIVE_DF_MODERN,
     ADVANCED_ARMOR_PIERCING,
     ADVANCED_ARMOR_PIERCING_DF,
     ADVANCED_ARMOR_PIERCING_CR,
     ADVANCED_ARMOR_PIERCING_FSDS,
     ADVANCED_FLAME,
     ADVANCED_FLAME_STUN,
     ...
     ADVANCED_HEADER_SHELLTYPE_ARMOR_PIERCING_FSDS,
     ADVANCED_HEADER_SHELLTYPE_FLAME,
     ADVANCED_HEADER_SHELLTYPE_HIGH_EXPLOSIVE_DF,
     ADVANCED_HEADER_SHELLTYPE_ARMOR_PIERCING_DF,
     ADVANCED_HEADER_SHELLTYPE_HOLLOW_CHARGE_DF,
    ...
    NOTRECRUITEDTANKMAN_ALL_LABEL_ENUM = (
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_BP12MT_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12MT_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12MT_3_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12MT_4_LABEL,
     NOTRECRUITEDTANKMAN_COMMANDER_MF_TRUS_LABEL,
     NOTRECRUITEDTANKMAN_COMMANDER_MF_BALBES_LABEL,
     NOTRECRUITEDTANKMAN_COMMANDER_MF_BYVALY_LABEL,
     NOTRECRUITEDTANKMAN_COMMANDER_NIKOLAY_KUZNETSOV_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_HW_IVANCAREVICH_LABEL,
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_MF_5_D_VOVA_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_MF_6_SCRIPACH_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_MF_7_UEF_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_MF_8_BI_LABEL,
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_2024_RACER_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_2024_RACER_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_2024_RACER_3_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_2024_RACER_4_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_AC_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_AC_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_AC_3_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_AC_4_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_AC_5_LABEL,
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_WT2024_MARAT_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_WT2024_ELISA_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_WT2024_L_KRIEGER_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_WT2024_L_MARAT_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_WT2024_L_MILADA_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_WT2024_L_PAUL_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_WT2024_L_ELISA_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_T3_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_T3_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_T3_3_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_T3_4_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_T3_5_LABEL,
     NOTRECRUITEDTANKMAN_NY25_TANKMEN_1_LABEL,
     NOTRECRUITEDTANKMAN_NY25_TANKMEN_2_LABEL,
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_DR2025_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_DR2025_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_DR2025_3_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_DR2025_4_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_WT2025_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_WT2025_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_WT2025_3_LABEL,
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_PORTAL25_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_PORTAL25_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_PORTAL25_3_LABEL,
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_DR2026_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_DR2026_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_DR2026_3_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_DR2026_4_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_DR2026_5_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_SUMMER26_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_SUMMER26_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_SUMMER26_3_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_SUMMER26_4_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_WT2026_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_WT2026_2_LABEL,
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_BP21_5_LABEL)
    NOTRECRUITEDTANKMAN_ALL_DESC_ENUM = (
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_BP12MT_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12MT_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12MT_3_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12MT_4_DESC,
     NOTRECRUITEDTANKMAN_COMMANDER_MF_TRUS_DESC,
     NOTRECRUITEDTANKMAN_COMMANDER_MF_BALBES_DESC,
     NOTRECRUITEDTANKMAN_COMMANDER_MF_BYVALY_DESC,
     NOTRECRUITEDTANKMAN_COMMANDER_NIKOLAY_KUZNETSOV_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_HW_IVANCAREVICH_DESC,
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_MF_5_D_VOVA_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_MF_6_SCRIPACH_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_MF_7_UEF_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_MF_8_BI_DESC,
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_2024_RACER_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_2024_RACER_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_2024_RACER_3_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_2024_RACER_4_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_AC_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_AC_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_AC_3_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_AC_4_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_AC_5_DESC,
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_WT2024_MARAT_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_WT2024_ELISA_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_WT2024_L_KRIEGER_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_WT2024_L_MARAT_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_WT2024_L_MILADA_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_WT2024_L_PAUL_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_WT2024_L_ELISA_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_T3_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_T3_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_T3_3_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_T3_4_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_T3_5_DESC,
     NOTRECRUITEDTANKMAN_NY25_TANKMEN_1_DESC,
     NOTRECRUITEDTANKMAN_NY25_TANKMEN_2_DESC,
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_DR2025_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_DR2025_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_DR2025_3_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_DR2025_4_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_WT2025_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_WT2025_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_WT2025_3_DESC,
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_PORTAL25_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_PORTAL25_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_PORTAL25_3_DESC,
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_DR2026_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_DR2026_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_DR2026_3_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_DR2026_4_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_DR2026_5_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_SUMMER26_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_SUMMER26_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_SUMMER26_3_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_SUMMER26_4_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_WT2026_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_WT2026_2_DESC,
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_BP21_5_DESC)
