...
class TOOLTIPS(object):
    ...
    HEADER_BUTTONS_PERSONALMISSIONSDISABLED = '#tooltips:header/buttons/personalMissionsDisabled'
    ...
    BATTLERESULTS_PREMIUMBONUS_TANKSTATECHANGED = '#tooltips:battleResults/premiumBonus/tankStateChanged'
    BATTLERESULTS_PREMIUMBONUS_TANKMENSTATECHANGED = '#tooltips:battleResults/premiumBonus/tankmenStateChanged'
    TRADEINUNAVAILABLE = '#tooltips:tradeInUnavailable'
    TRADEINNOVEHICLES = '#tooltips:tradeInNoVehicles'
    SENIORITYAWARDS_HANGARENTRYPOINT_TOOLTIP = '#tooltips:seniorityAwards/hangarEntryPoint/tooltip'
    ...
    HANGAR_AMMO_PANEL_DEVICE_DISABLED = '#tooltips:hangar/ammo_panel/device/disabled'
    HANGAR_AMMO_PANEL_EQUIPMENT_EMPTY = '#tooltips:hangar/ammo_panel/equipment/empty'
    HANGAR_AMMO_PANEL_EQUIPMENT_DISABLED = '#tooltips:hangar/ammo_panel/equipment/disabled'
    HANGAR_AMMO_PANEL_BATTLEBOOSTER_EMPTY = '#tooltips:hangar/ammo_panel/battleBooster/empty'
    HANGAR_AMMO_PANEL_BATTLEBOOSTER_DISABLED = '#tooltips:hangar/ammo_panel/battleBooster/disabled'
    HANGAR_MAINTENANCE = '#tooltips:hangar/maintenance'
    HANGAR_MAINTENANCE_DISABLED = '#tooltips:hangar/maintenance/disabled'
    ...
    HEADER_BUTTONS_REPLAYS = '#tooltips:header/buttons/replays'
    ...
    HEADER_BUTTONS_TOURNAMENTS = '#tooltips:header/buttons/tournaments'
    HEADER_PREMIUM_BUY = '#tooltips:header/premium_buy'
    HEADER_PREMIUM_EXTEND = '#tooltips:header/premium_extend'
    HEADER_PREMIUM_UPGRADE = '#tooltips:header/premium_upgrade'
    ...
    BATTLETYPES_EPIC_TRAINING = '#tooltips:battleTypes/epic_training'
    ...
    PERSONALMISSIONS_OPERATION_FOOTER_ACTIVATECAMPAIGN = '#tooltips:personalMissions/operation/footer/activateCampaign'
    PERSONALMISSIONS_OPERATION_FOOTER_ACTIVATEMISSIONS = '#tooltips:personalMissions/operation/footer/activateMissions'
    ...
    PERSONALMISSIONS_STATUS_ONPAUSE = '#tooltips:personalMissions/status/onPause'
    ...
    STORAGE_MAINMENU_OFFERS = '#tooltips:storage/mainMenu/offers'
    ...
    PREBATTLE_READYBUTTON_VEHICLESREQUIRED3 = '#tooltips:prebattle/readyButton/vehiclesRequired3'
    ...
    PREMIUMPLUS_DAYS_HEADER = '#tooltips:premiumPlus/days/header'
    ...
    SETTINGS_MINIMAPCIRCLES_MINIMUMSPOTTINGRANGE_TITLE = '#tooltips:settings/minimapCircles/minimumSpottingRange/title'
    SETTINGS_MINIMAPCIRCLES_MINIMUMSPOTTINGRANGE_BODY = '#tooltips:settings/minimapCircles/minimumSpottingRange/body'
    ...
    SETTINGS_MOUSE_SENSITIVITY_INVERTATIONHOR_HEADER = '#tooltips:settings/mouse/sensitivity/invertationHor/header'
    SETTINGS_MOUSE_SENSITIVITY_INVERTATIONHOR_BODY = '#tooltips:settings/mouse/sensitivity/invertationHor/body'
    SETTINGS_MOUSE_SENSITIVITY_INVERTATIONVERT_HEADER = '#tooltips:settings/mouse/sensitivity/invertationVert/header'
    SETTINGS_MOUSE_SENSITIVITY_INVERTATIONVERT_BODY = '#tooltips:settings/mouse/sensitivity/invertationVert/body'
    SETTINGS_KEYBOARD_BACKDRAFTINVERT_HEADER = '#tooltips:settings/keyboard/backDraftInvert/header'
    SETTINGS_KEYBOARD_BACKDRAFTINVERT_BODY = '#tooltips:settings/keyboard/backDraftInvert/body'
    ...
    ACTIONPRICE_BODY_FRONTLINE = '#tooltips:actionPrice/body/frontline'
    ACTIONPRICE_BODY_FRONTLINE_WITH_SSE = '#tooltips:actionPrice/body/frontline_with_sse'
    ...
    SHOWCOMMINPLAYERLIST_HEADER = '#tooltips:showCommInPlayerList/header'
    SHOWCOMMINPLAYERLIST_BODY = '#tooltips:showCommInPlayerList/body'
    SETTINGS_SWITCHEQUIPMENT_HEADER = '#tooltips:settings/switchEquipment/header'
    SETTINGS_SWITCHEQUIPMENT_BODY = '#tooltips:settings/switchEquipment/body'
    SETTINGS_SWITCHEQUIPMENT_BODYFOOTER = '#tooltips:settings/switchEquipment/bodyFooter'
    SETTINGS_SHOWLOCATIONMARKERS_HEADER = '#tooltips:settings/showLocationMarkers/header'
    SETTINGS_SHOWLOCATIONMARKERS_BODY = '#tooltips:settings/showLocationMarkers/body'
    SETTINGS_SHOWLOCATIONMARKERS_BODYFOOTER = '#tooltips:settings/showLocationMarkers/bodyFooter'
    SHOWBASEMARKERS_HEADER = '#tooltips:showBaseMarkers/header'
    SHOWBASEMARKERS_BODY = '#tooltips:showBaseMarkers/body'
    ENABLECOMMENDATIONS_HEADER = '#tooltips:enableCommendations/header'
    ENABLECOMMENDATIONS_BODY = '#tooltips:enableCommendations/body'
    ENABLETIERGROUPING_HEADER = '#tooltips:enableTierGrouping/header'
    ENABLETIERGROUPING_BODY = '#tooltips:enableTierGrouping/body'
    ...
    ANONYMIZER_BODYFOOTER_RESTRICTED = '#tooltips:anonymizer/bodyFooter/restricted'
    ANONYMIZER_BODYFOOTER_INBATTLE = '#tooltips:anonymizer/bodyFooter/inBattle'
    ANONYMIZER_BODYFOOTER_DEFAULT = '#tooltips:anonymizer/bodyFooter/default'
    ANONYMIZER_BATTLE_TEAMLIST_CLAN = '#tooltips:anonymizer/battle/teamList/clan'
    ANONYMIZER_BATTLE_TEAMLIST_NOCLAN = '#tooltips:anonymizer/battle/teamList/noClan'
    DISPLAYPLATOONMEMBERS_HEADER = '#tooltips:displayPlatoonMembers/header'
    DISPLAYPLATOONMEMBERS_BODY = '#tooltips:displayPlatoonMembers/body'
    DISPLAYPLATOONMEMBERS_ATTENTION = '#tooltips:displayPlatoonMembers/attention'
    LOGINSERVERSELECTION_HEADER = '#tooltips:loginServerSelection/header'
    ...
    NEWBIEPREBATTLEHINTS_HEADER = '#tooltips:newbiePrebattleHints/header'
    NEWBIEPREBATTLEHINTS_BODY = '#tooltips:newbiePrebattleHints/body'
    NEWBIEBATTLEHINTS_HEADER = '#tooltips:newbieBattleHints/header'
    NEWBIEBATTLEHINTS_BODY = '#tooltips:newbieBattleHints/body'
    ...
    CUSTOMIZATIONDISPLAYTYPE_HISTORICAL_BODY = '#tooltips:customizationDisplayType/historical/body'
    CUSTOMIZATIONDISPLAYTYPE_NOTHISTORICAL_HEADER = '#tooltips:customizationDisplayType/notHistorical/header'
    CUSTOMIZATIONDISPLAYTYPE_NOTHISTORICAL_BODY = '#tooltips:customizationDisplayType/notHistorical/body'
    CUSTOMIZATIONDISPLAYTYPE_ALL_HEADER = '#tooltips:customizationDisplayType/all/header'
    CUSTOMIZATIONDISPLAYTYPE_ALL_BODY = '#tooltips:customizationDisplayType/all/body'
    ...
    DEVMAPS_HEADER = '#tooltips:devMaps/header'
    DEVMAPS_BODY = '#tooltips:devMaps/body'
    EPICBATTLEWIDGET_HEADER = '#tooltips:epicBattleWidget/header'
    EPICBATTLEWIDGET_DESC_NOPRESTIGE = '#tooltips:epicBattleWidget/desc/noPrestige'
    EPICBATTLEWIDGET_DESC_NORMAL = '#tooltips:epicBattleWidget/desc/normal'
    EPICBATTLEWIDGET_DESC_MAXPRESTIGE = '#tooltips:epicBattleWidget/desc/maxPrestige'
    EPICBATTLEWIDGET_INFO_MAXPRESTIGEINSEASON = '#tooltips:epicBattleWidget/info/maxPrestigeInSeason'
    EPICBATTLEWIDGET_INFO_PRESTIGE = '#tooltips:epicBattleWidget/info/prestige'
    EPICBATTLEWIDGET_INFO_MAXLEVEL = '#tooltips:epicBattleWidget/info/maxLevel'
    EPICBATTLEWIDGET_INFO_MAXPRESTIGE = '#tooltips:epicBattleWidget/info/maxPrestige'
    ...
    EPICBATTLESOFFER_TITLE_EXPEQUIPMENTS_GIFT = '#tooltips:epicBattlesOffer/title/expequipments_gift'
    ...
    BATTLEBORDERMAPTYPEBUTTONBAR_INFO_BODY = '#tooltips:battleBorderMapTypeButtonBar/info/body'
    BATTLEBORDERMAPTYPEBUTTONBAR_INFO_ATTENTION = '#tooltips:battleBorderMapTypeButtonBar/info/attention'
    LIMITEDUISETTINGBLOCK_INFO_HEADER = '#tooltips:limitedUISettingBlock/info/header'
    LIMITEDUISETTINGBLOCK_INFO_BODY = '#tooltips:limitedUISettingBlock/info/body'
    LIMITEDUISETTINGBLOCK_INFO_ATTENTION = '#tooltips:limitedUISettingBlock/info/attention'
    ARMORFLASHLIGHT_PERFORMANCEIMPACTINFO_HEADER = '#tooltips:armorFlashlight/performanceImpactInfo/header'
    ARMORFLASHLIGHT_PERFORMANCEIMPACTINFO_BODY = '#tooltips:armorFlashlight/performanceImpactInfo/body'
    ARMORFLASHLIGHT_PERFORMANCEIMPACTINFO_ATTENTION = '#tooltips:armorFlashlight/performanceImpactInfo/attention'
    ARMORFLASHLIGHT_RESOLUTIONSCALINGINFO_HEADER = '#tooltips:armorFlashlight/resolutionScalingInfo/header'
    ARMORFLASHLIGHT_RESOLUTIONSCALINGINFO_BODY = '#tooltips:armorFlashlight/resolutionScalingInfo/body'
    ARMORFLASHLIGHT_RESOLUTIONSCALINGINFO_ATTENTION = '#tooltips:armorFlashlight/resolutionScalingInfo/attention'
    GAMMA_HEADER = '#tooltips:gamma/header'
    GAMMA_BODY = '#tooltips:gamma/body'
    GAMMA_ATTENTION = '#tooltips:gamma/attention'
    ...
    WALLET_NOT_AVAILABLE_EQUIPCOIN_HEADER = '#tooltips:wallet/not_available_equipCoin/header'
    WALLET_NOT_AVAILABLE_EQUIPCOIN_BODY = '#tooltips:wallet/not_available_equipCoin/body'
    ...
    BATTLETYPES_EPIC_TRAINING_HEADER = '#tooltips:battleTypes/epic_training/header'
    BATTLETYPES_EPIC_TRAINING_BODY = '#tooltips:battleTypes/epic_training/body'
    ...
    BATTLETYPES_RANKED_RANK_ISUNBURNABLE = '#tooltips:battleTypes/ranked/rank/isUnburnable'
    BATTLETYPES_RANKED_RANK_ISLASTINDIVISION = '#tooltips:battleTypes/ranked/rank/isLastInDivision'
    BATTLETYPES_RANKED_RANK_ISLASTINDIVISION_LEAGUE = '#tooltips:battleTypes/ranked/rank/isLastInDivision/league'
    BATTLETYPES_RANKED_RANK_ISFIRSTINDIVISION = '#tooltips:battleTypes/ranked/rank/isFirstInDivision'
    BATTLETYPES_RANKED_RANK_ANOTHERDIVISION = '#tooltips:battleTypes/ranked/rank/anotherDivision'
    BATTLETYPES_RANKED_HAVESHIELD = '#tooltips:battleTypes/ranked/haveShield'
    BATTLETYPES_RANKED_SHIELDBREAKED = '#tooltips:battleTypes/ranked/shieldBreaked'
    BATTLETYPES_RANKED_SHIELDBREAKEDRANKLOST = '#tooltips:battleTypes/ranked/shieldBreakedRankLost'
    BATTLETYPES_RANKED_HAVEDISPOSABLESHIELD = '#tooltips:battleTypes/ranked/haveDisposableShield'
    BATTLETYPES_RANKED_RANK_REWARD = '#tooltips:battleTypes/ranked/rank/reward'
    BATTLETYPES_RANKED_RANK_QUALIFICATIONREWARD = '#tooltips:battleTypes/ranked/rank/qualificationReward'
    ...
    BATTLETYPES_RANKED_RANK_STATUS_RECEIVEDQUALIFICATION = '#tooltips:battleTypes/ranked/rank/status/receivedQualification'
    BATTLETYPES_RANKED_RANK_STATUS_NOTEARNED = '#tooltips:battleTypes/ranked/rank/status/notearned'
    BATTLETYPES_RANKED_RANK_STATUS_QUALIFICATIONNOTEARNED = '#tooltips:battleTypes/ranked/rank/status/qualificationNotEarned'
    ...
    BATTLETYPES_RANKED_RANK_CONDITIONS_QUALIFICATION = '#tooltips:battleTypes/ranked/rank/conditions/qualification'
    ...
    BATTLETYPES_RANKED_BONUSBATTLE_TITLE = '#tooltips:battleTypes/ranked/bonusBattle/title'
    BATTLETYPES_RANKED_BONUSBATTLE_PERSISTENT_TITLE = '#tooltips:battleTypes/ranked/bonusBattle/persistent/title'
    BATTLETYPES_RANKED_BONUSBATTLE_DAILY_TITLE = '#tooltips:battleTypes/ranked/bonusBattle/daily/title'
    BATTLETYPES_RANKED_BONUSBATTLE_DAILY_BODYINCOME = '#tooltips:battleTypes/ranked/bonusBattle/daily/bodyIncome'
    ...
    BATTLETYPES_MAPBOX_TILLSTART = '#tooltips:battleTypes/mapbox/tillStart'
    BATTLETYPES_MAPBOX_TILLEND = '#tooltips:battleTypes/mapbox/tillEnd'
    BATTLETYPES_MAPBOX_TILLSTARTCYCLE = '#tooltips:battleTypes/mapbox/tillStartCycle'
    BATTLETYPES_MAPBOX_TILLENDCYCLE = '#tooltips:battleTypes/mapbox/tillEndCycle'
    ...
    HANGAR_STARTBTN_MAPSTRAINING_NOTREADY_HEADER = '#tooltips:hangar/startBtn/mapsTraining/notReady/header'
    HANGAR_STARTBTN_MAPSTRAINING_NOTREADY_BODY = '#tooltips:hangar/startBtn/mapsTraining/notReady/body'
    HANGAR_STARTBTN_BATTLEROYALE_NOTRENTED_HEADER = '#tooltips:hangar/startBtn/battleRoyale/notRented/header'
    HANGAR_STARTBTN_BATTLEROYALE_NOTRENTED_BODY = '#tooltips:hangar/startBtn/battleRoyale/notRented/body'
    HANGAR_STARTBTN_BATTLEROYALE_TELECOMRENTALISOVER_HEADER = '#tooltips:hangar/startBtn/battleRoyale/telecomRentalIsOver/header'
    HANGAR_STARTBTN_BATTLEROYALE_TELECOMRENTALISOVER_BODY = '#tooltips:hangar/startBtn/battleRoyale/telecomRentalIsOver/body'
    HANGAR_STARTBTN_BATTLEROYALE_WOTPLUSEXCLUSIVEUNAVAILABLE_HEADER = '#tooltips:hangar/startBtn/battleRoyale/wotPlusExclusiveUnavailable/header'
    ...
    HANGAR_STARTBTN_WRONGSQUADVEHICLELEVEL_HEADER = '#tooltips:hangar/startBtn/wrongSquadVehicleLevel/header'
    HANGAR_STARTBTN_WRONGSQUADVEHICLELEVEL_BODY = '#tooltips:hangar/startBtn/wrongSquadVehicleLevel/body'
    HANGAR_STARTBTN_WRONGSQUADVEHICLE_HEADER = '#tooltips:hangar/startBtn/wrongSquadVehicle/header'
    HANGAR_STARTBTN_WRONGSQUADVEHICLE_BODY = '#tooltips:hangar/startBtn/wrongSquadVehicle/body'
    ...
    ACHIEVEMENT_PARAMS_STEPSLEFT = '#tooltips:achievement/params/stepsLeft'
    ...
    ACHIEVEMENT_PARAMS_VEHICLESTOHAVEINGARAGE = '#tooltips:achievement/params/vehiclesToHaveInGarage'
    ...
    HEADER_PREMIUM_UPGRADE_HEADER = '#tooltips:header/premium_upgrade/header'
    HEADER_PREMIUM_UPGRADE_BODY = '#tooltips:header/premium_upgrade/body'
    ...
    HEADER_BUTTONS_GOLD_FIRSTDESC = '#tooltips:header/buttons/gold/firstDesc'
    ...
    HEADER_BUTTONS_CRYSTAL_DESCRIPTIONTITLE = '#tooltips:header/buttons/crystal/descriptionTitle'
    HEADER_BUTTONS_CRYSTAL_DESCRIPTION0 = '#tooltips:header/buttons/crystal/description0'
    HEADER_BUTTONS_CRYSTAL_DESCRIPTION1 = '#tooltips:header/buttons/crystal/description1'
    HEADER_BUTTONS_CRYSTAL_DESCRIPTIONVEHICLE = '#tooltips:header/buttons/crystal/descriptionVehicle'
    HEADER_BUTTONS_CRYSTAL_CLICKDESC = '#tooltips:header/buttons/crystal/clickDesc'
    HEADER_BUTTONS_EQUIPCOIN_TITLE = '#tooltips:header/buttons/equipCoin/title'
    ...
    HEADER_BUTTONS_GOLDALTERNATIVE_CLICKDESC = '#tooltips:header/buttons/goldAlternative/clickDesc'
    ...
    HEADER_BUTTONS_BRCOIN_TITLE = '#tooltips:header/buttons/brcoin/title'
    HEADER_BUTTONS_BRCOIN_FIRSTDESC = '#tooltips:header/buttons/brcoin/firstDesc'
    ...
    HANGAR_UNLOCKBUTTON_FOOTER = '#tooltips:hangar/unlockButton/footer'
    HANGAR_MAINTENANCE_HEADER = '#tooltips:hangar/maintenance/header'
    HANGAR_MAINTENANCE_BODY = '#tooltips:hangar/maintenance/body'
    HANGAR_MAINTENANCE_DISABLED_HEADER = '#tooltips:hangar/maintenance/disabled/header'
    HANGAR_MAINTENANCE_DISABLED_BODY = '#tooltips:hangar/maintenance/disabled/body'
    HANGAR_EASYTANKEQUIP_HEADER = '#tooltips:hangar/easyTankEquip/header'
    HANGAR_EASYTANKEQUIP_BODY = '#tooltips:hangar/easyTankEquip/body'
    HANGAR_EASYTANKEQUIP_DISABLED_SWITCH_HEADER = '#tooltips:hangar/easyTankEquip/disabled/switch/header'
    HANGAR_EASYTANKEQUIP_DISABLED_SWITCH_BODY = '#tooltips:hangar/easyTankEquip/disabled/switch/body'
    HANGAR_EASYTANKEQUIP_DISABLED_INAPPROPRIATEVEHICLE_BODY = '#tooltips:hangar/easyTankEquip/disabled/inappropriateVehicle/body'
    HANGAR_EASYTANKEQUIP_DISABLED_DEFAULT_HEADER = '#tooltips:hangar/easyTankEquip/disabled/default/header'
    HANGAR_EASYTANKEQUIP_DISABLED_DEFAULT_BODY = '#tooltips:hangar/easyTankEquip/disabled/default/body'
    ...
    HANGAR_NATIONCHANGE_HEADER = '#tooltips:hangar/nationChange/header'
    HANGAR_NATIONCHANGE_BODY = '#tooltips:hangar/nationChange/body'
    HANGAR_NATIONCHANGE_DISABLED_HEADER = '#tooltips:hangar/nationChange/disabled/header'
    HANGAR_NATIONCHANGE_DISABLED_BODY_INBATTLE = '#tooltips:hangar/nationChange/disabled/body/inBattle'
    HANGAR_NATIONCHANGE_DISABLED_BODY_DESTROYED = '#tooltips:hangar/nationChange/disabled/body/destroyed'
    HANGAR_NATIONCHANGE_DISABLED_BODY_INSQUAD = '#tooltips:hangar/nationChange/disabled/body/inSquad'
    ...
    CREWBUNDLE_HOWTOGET = '#tooltips:crewBundle/howToGet'
    CREWBUNDLE_BONUSES = '#tooltips:crewBundle/bonuses'
    CREWBUNDLE_BONUS_ANYADDITIONALSKILL = '#tooltips:crewBundle/bonus/anyAdditionalSkill'
    CREWBUNDLE_BONUS_SAMEBLOODZEROSKILL = '#tooltips:crewBundle/bonus/sameBloodZeroSkill'
    CREWBUNDLE_HEADER_OFFSPRING = '#tooltips:crewBundle/header/offspring'
    CREWBUNDLE_HOWTOGET_OFFSPRING = '#tooltips:crewBundle/howToGet/offspring'
    HANGAR_CREW_RUDY_DOG_USSR_HEADER = '#tooltips:hangar/crew/rudy/dog/ussr/header'
    HANGAR_CREW_RUDY_DOG_USSR_BODY = '#tooltips:hangar/crew/rudy/dog/ussr/body'
    HANGAR_CREW_RUDY_DOG_POLAND_HEADER = '#tooltips:hangar/crew/rudy/dog/poland/header'
    HANGAR_CREW_RUDY_DOG_POLAND_BODY = '#tooltips:hangar/crew/rudy/dog/poland/body'
    HANGAR_CREW_MORESKILLS = '#tooltips:hangar/crew/moreskills'
    HANGAR_CREW_ASSIGNEDTO = '#tooltips:hangar/crew/assignedTo'
    HANGAR_CREW_NEW_FREE_SKILL_AVAILABLE_HEADER = '#tooltips:hangar/crew/new_free_skill_available/header'
    ...
    HANGAR_AMMO_PANEL_DEVICE_DISABLED_HEADER = '#tooltips:hangar/ammo_panel/device/disabled/header'
    HANGAR_AMMO_PANEL_DEVICE_DISABLED_BODY = '#tooltips:hangar/ammo_panel/device/disabled/body'
    ...
    HANGAR_AMMO_PANEL_EQUIPMENT_DISABLED_HEADER = '#tooltips:hangar/ammo_panel/equipment/disabled/header'
    HANGAR_AMMO_PANEL_EQUIPMENT_DISABLED_BODY = '#tooltips:hangar/ammo_panel/equipment/disabled/body'
    ...
    HANGAR_AMMO_PANEL_BATTLEBOOSTER_DISABLED_HEADER = '#tooltips:hangar/ammo_panel/battleBooster/disabled/header'
    HANGAR_AMMO_PANEL_BATTLEBOOSTER_DISABLED_BODY = '#tooltips:hangar/ammo_panel/battleBooster/disabled/body'
    ...
    MODULEFITS_DISMANTLING = '#tooltips:moduleFits/dismantling'
    ...
    MODULEFITS_EQUIPCOIN_ERROR_HEADER = '#tooltips:moduleFits/equipcoin_error/header'
    MODULEFITS_EQUIPCOIN_ERROR_TEXT = '#tooltips:moduleFits/equipcoin_error/text'
    ...
    MODULEFITS_ALREADY_INSTALLED_HIDDENVEHICLECOUNT = '#tooltips:moduleFits/already_installed/hiddenVehicleCount'
    ...
    MODULEFITS_SIMILAR_DEVICE_ALREADY_INSTALLED_HEADER = '#tooltips:moduleFits/similar_device_already_installed/header'
    MODULEFITS_SIMILAR_DEVICE_ALREADY_INSTALLED_TEXT = '#tooltips:moduleFits/similar_device_already_installed/text'
    MODULEFITS_USELESS_BATTLE_BOOSTER_HEADER = '#tooltips:moduleFits/useless_battle_booster/header'
    MODULEFITS_USELESS_BATTLE_BOOSTER_TEXT = '#tooltips:moduleFits/useless_battle_booster/text'
    MODULEFITS_USELESS_CREW_SKILL_BATTLE_BOOSTER_HEADER = '#tooltips:moduleFits/useless_crew_skill_battle_booster/header'
    MODULEFITS_USELESS_CREW_SKILL_BATTLE_BOOSTER_TEXT = '#tooltips:moduleFits/useless_crew_skill_battle_booster/text'
    ...
    MODULEFITS_BATTLEBOOSTER_CANNOTBUY_HEADER = '#tooltips:moduleFits/battleBooster/cannotBuy/header'
    MODULEFITS_BATTLEBOOSTER_CANNOTBUY_DESCRIPTION = '#tooltips:moduleFits/battleBooster/cannotBuy/description'
    ...
    CREWSKILLBATTLEBOOSTER_USELESS_BODY = '#tooltips:crewSkillBattleBooster/useless/body'
    BATTLEBOOSTER_REPLACE = '#tooltips:battleBooster/replace'
    BATTLEBOOSTER_BUY_USELESS_UPPER_DESCRIPTION = '#tooltips:battleBooster/buy/useless/upper_description'
    BATTLEBOOSTER_BUY_USELESS_LOWER_DESCRIPTION = '#tooltips:battleBooster/buy/useless/lower_description'
    ...
    TANKS_CAROUSEL_VEHICLESTATES_DISABLED = '#tooltips:tanks_carousel/vehicleStates/disabled'
    ...
    LOBY_MESSENGER_REFERRAL_BUTTON_HEADER = '#tooltips:loby_messenger/referral_button/header'
    LOBY_MESSENGER_REFERRAL_BUTTON_BODY = '#tooltips:loby_messenger/referral_button/body'
    LOBY_MESSENGER_REFERRAL_BUTTON_NEW_SEASON_HEADER = '#tooltips:loby_messenger/referral_button/new_season/header'
    LOBY_MESSENGER_REFERRAL_BUTTON_NEW_SEASON_BODY = '#tooltips:loby_messenger/referral_button/new_season/body'
    ...
    LOBBY_MESSENGER_LISTVIEW_NEWS_TOOLTIP_HEADER = '#tooltips:lobby_messenger/listView/news/tooltip/header'
    LOBBY_MESSENGER_LISTVIEW_NEWS_TOOLTIP_BODY = '#tooltips:lobby_messenger/listView/news/tooltip/body'
    ...
    HEADER_BUTTONS_TOURNAMENTS_HEADER = '#tooltips:header/buttons/tournaments/header'
    HEADER_BUTTONS_TOURNAMENTS_BODY = '#tooltips:header/buttons/tournaments/body'
    HEADER_BUTTONS_REPLAYS_HEADER = '#tooltips:header/buttons/replays/header'
    HEADER_BUTTONS_REPLAYS_BODY = '#tooltips:header/buttons/replays/body'
    ...
    HEADER_BUTTONS_MANUAL_HEADER = '#tooltips:header/buttons/manual/header'
    HEADER_BUTTONS_MANUAL_BODY = '#tooltips:header/buttons/manual/body'
    ...
    HEADER_BUTTONS_PERSONALMISSIONSDISABLED_HEADER = '#tooltips:header/buttons/personalMissionsDisabled/header'
    HEADER_BUTTONS_PERSONALMISSIONSDISABLED_BODY = '#tooltips:header/buttons/personalMissionsDisabled/body'
    ...
    EQUIPMENT_BUILTIN = '#tooltips:equipment/builtIn'
    ...
    VEHICLE_LEVEL_AND_TYPE = '#tooltips:vehicle/level_and_type'
    VEHICLE_CREW = '#tooltips:vehicle/crew'
    VEHICLE_CREWROLES = '#tooltips:vehicle/crewRoles'
    VEHICLE_ROLE = '#tooltips:vehicle/role'
    ...
    VEHICLE_RENTLEFT_EPIC_BASE = '#tooltips:vehicle/rentLeft/epic/base'
    VEHICLE_RENTLEFT_EPIC_DAYSLEFT = '#tooltips:vehicle/rentLeft/epic/daysLeft'
    VEHICLE_RENTLEFT_EPIC_HOURSLEFT = '#tooltips:vehicle/rentLeft/epic/hoursLeft'
    VEHICLE_RENTLEFT_EPIC_MINSLEFT = '#tooltips:vehicle/rentLeft/epic/minsLeft'
    ...
    VEHICLE_WOTPLUSRENTING_TITLE = '#tooltips:vehicle/wotPlusRenting/title'
    ...
    VEHICLE_BATTLEPASS_EARNINGLIMIT = '#tooltips:vehicle/battlePass/earningLimit'
    VEHICLE_BATTLEPASS_REWARD = '#tooltips:vehicle/battlePass/reward'
    VEHICLE_BATTLEPASS_LIMITREACHED = '#tooltips:vehicle/battlePass/limitReached'
    VEHICLE_BONDS_EARNINGLIMIT = '#tooltips:vehicle/bonds/earningLimit'
    VEHICLE_BONDS_LIMITREACHED = '#tooltips:vehicle/bonds/limitReached'
    ...
    QUESTS_BATTLEPASS_LINKBTN = '#tooltips:quests/battlePass/linkBtn'
    QUESTS_LINKBTN_BATTLEPASS_SELECT = '#tooltips:quests/linkBtn/battlePass/select'
    QUESTS_PRESTIGEPROGRESS_LINKBTN = '#tooltips:quests/prestigeProgress/linkBtn'
    ...
    VEHICLESTATUS_DISABLED_HEADER = '#tooltips:vehicleStatus/disabled/header'
    ...
    VEHICLESTATUS_WOT_PLUS_EXCLUSIVE_VEHICLE_DISABLED_HEADER = '#tooltips:vehicleStatus/wot_plus_exclusive_vehicle_disabled/header'
    ...
    VEHICLESTATUS_DEALISOVER_BEELINEKZ_TEXT = '#tooltips:vehicleStatus/dealIsOver/BeelineKZ/text'
    VEHICLESTATUS_DEALISOVER_MOLDTELECOM_HEADER = '#tooltips:vehicleStatus/dealIsOver/MoldTelecom/header'
    VEHICLESTATUS_DEALISOVER_MOLDTELECOM_TEXT = '#tooltips:vehicleStatus/dealIsOver/MoldTelecom/text'
    ...
    TRADEININFO_HEADER = '#tooltips:tradeInInfo/header'
    TRADEININFO_TRADEOFFOFFER = '#tooltips:tradeInInfo/tradeOffOffer'
    TRADEININFO_DISCOUNT = '#tooltips:tradeInInfo/discount'
    TRADEININFO_ACTIONTIME = '#tooltips:tradeInInfo/actionTime'
    TRADEINUNAVAILABLE_HEADER = '#tooltips:tradeInUnavailable/header'
    TRADEINUNAVAILABLE_BODY = '#tooltips:tradeInUnavailable/body'
    TRADEINUNAVAILABLE_BATTLE = '#tooltips:tradeInUnavailable/battle'
    TRADEINUNAVAILABLE_DAMAGED = '#tooltips:tradeInUnavailable/damaged'
    TRADEINUNAVAILABLE_INPREBATTLE = '#tooltips:tradeInUnavailable/inPrebattle'
    TRADEINUNAVAILABLE_LOCKED = '#tooltips:tradeInUnavailable/locked'
    TRADEINEXPIRED_HEADER = '#tooltips:tradeInExpired/header'
    TRADEINEXPIRED_BODY = '#tooltips:tradeInExpired/body'
    TRADEINNOVEHICLES_HEADER = '#tooltips:tradeInNoVehicles/header'
    TRADEINNOVEHICLES_BODY = '#tooltips:tradeInNoVehicles/body'
    TANKCARUSELTOOLTIP_SERVICERECORDS_ELITESYSTEM = '#tooltips:tankCaruselTooltip/serviceRecords/eliteSystem'
    TANKCARUSELTOOLTIP_SERVICERECORDS_PRESTIGEELITESYSTEM = '#tooltips:tankCaruselTooltip/serviceRecords/prestigeEliteSystem'
    TANKCARUSELTOOLTIP_SERVICERECORDS_HEADER = '#tooltips:tankCaruselTooltip/serviceRecords/header'
    TANKCARUSELTOOLTIP_EARNINGS_HEADER = '#tooltips:tankCaruselTooltip/earnings/header'
    ...
    TANKCARUSELTOOLTIP_VEHICLETYPE_TIER_NORMAL_LIGHTTANK = '#tooltips:tankCaruselTooltip/vehicleType/tier/normal/lightTank'
    TANKCARUSELTOOLTIP_VEHICLETYPE_TIER_NORMAL_MEDIUMTANK = '#tooltips:tankCaruselTooltip/vehicleType/tier/normal/mediumTank'
    TANKCARUSELTOOLTIP_VEHICLETYPE_TIER_NORMAL_HEAVYTANK = '#tooltips:tankCaruselTooltip/vehicleType/tier/normal/heavyTank'
    TANKCARUSELTOOLTIP_VEHICLETYPE_TIER_NORMAL_AT_SPG = '#tooltips:tankCaruselTooltip/vehicleType/tier/normal/AT_SPG'
    TANKCARUSELTOOLTIP_VEHICLETYPE_TIER_NORMAL_SPG = '#tooltips:tankCaruselTooltip/vehicleType/tier/normal/SPG'
    TANKCARUSELTOOLTIP_VEHICLETYPE_TIER_ELITE_LIGHTTANK = '#tooltips:tankCaruselTooltip/vehicleType/tier/elite/lightTank'
    TANKCARUSELTOOLTIP_VEHICLETYPE_TIER_ELITE_MEDIUMTANK = '#tooltips:tankCaruselTooltip/vehicleType/tier/elite/mediumTank'
    TANKCARUSELTOOLTIP_VEHICLETYPE_TIER_ELITE_HEAVYTANK = '#tooltips:tankCaruselTooltip/vehicleType/tier/elite/heavyTank'
    TANKCARUSELTOOLTIP_VEHICLETYPE_TIER_ELITE_AT_SPG = '#tooltips:tankCaruselTooltip/vehicleType/tier/elite/AT_SPG'
    TANKCARUSELTOOLTIP_VEHICLETYPE_TIER_ELITE_SPG = '#tooltips:tankCaruselTooltip/vehicleType/tier/elite/SPG'
    TANKMAN_SECTION_CURRENTVEHICLE = '#tooltips:tankman/section/currentVehicle'
    TANKMAN_SECTION_BARRACKS = '#tooltips:tankman/section/barracks'
    TANKMAN_SECTION_SPECIALIZATION = '#tooltips:tankman/section/specialization'
    TANKMAN_SECTION_PREMIUMSPECIALIZATION = '#tooltips:tankman/section/premiumSpecialization'
    TANKMAN_SECTION_BONUS_COMMANDER = '#tooltips:tankman/section/bonus/commander'
    TANKMAN_SECTION_BONUS_DRIVER = '#tooltips:tankman/section/bonus/driver'
    TANKMAN_SECTION_BONUS_RADIOMAN = '#tooltips:tankman/section/bonus/radioman'
    TANKMAN_SECTION_BONUS_GUNNER = '#tooltips:tankman/section/bonus/gunner'
    TANKMAN_SECTION_BONUS_LOADER = '#tooltips:tankman/section/bonus/loader'
    TANKMAN_SECTION_BONUS_PERKS = '#tooltips:tankman/section/bonus/perks'
    TANKMAN_SECTION_BONUS_CONSUMS = '#tooltips:tankman/section/bonus/consums'
    TANKMAN_SECTION_BONUS_FINALVALUE = '#tooltips:tankman/section/bonus/finalValue'
    TANKMAN_SECTION_BONUS_DESCRIPTION = '#tooltips:tankman/section/bonus/description'
    TANKMAN_COMMANDERBONUS_TITLE = '#tooltips:tankman/commanderBonus/title'
    TANKMAN_COMMANDERBONUS_DESCRIPTION = '#tooltips:tankman/commanderBonus/description'
    TANKMAN_RESTOREINFO_LABEL = '#tooltips:tankman/restoreInfo/label'
    TANKMAN_RESTOREINFO_FREE = '#tooltips:tankman/restoreInfo/free'
    TANKMAN_RESTOREINFO_PAID = '#tooltips:tankman/restoreInfo/paid'
    TANKMAN_VOICEOVER_ROLE = '#tooltips:tankman/voiceover/role'
    TANKMAN_VOICEOVER_WITCHES = '#tooltips:tankman/voiceover/witches'
    ...
    BLUEPRINT_VEHICLEBLUEPRINTTOOLTIP_CHOSE = '#tooltips:blueprint/VehicleBlueprintTooltip/chose'
    ...
    BLUEPRINT_VEHICLEBLUEPRINTTOOLTIP_VEHICLEUNLOCKED_HEADER = '#tooltips:blueprint/VehicleBlueprintTooltip/vehicleUnlocked/header'
    BLUEPRINT_VEHICLEBLUEPRINTTOOLTIP_VEHICLEUNLOCKED_BODY = '#tooltips:blueprint/VehicleBlueprintTooltip/vehicleUnlocked/body'
    ...
    BLUEPRINT_BLUEPRINTFRAGMENTTOOLTIP_NATIONALDESCRIPTIONTIER = '#tooltips:blueprint/BlueprintFragmentTooltip/nationalDescriptionTier'
    BLUEPRINT_BLUEPRINTFRAGMENTTOOLTIP_INTELFRAGMENT = '#tooltips:blueprint/BlueprintFragmentTooltip/intelFragment'
    BLUEPRINT_BLUEPRINTFRAGMENTTOOLTIP_RANDOMNATIONAL_HEADER = '#tooltips:blueprint/BlueprintFragmentTooltip/randomNational/header'
    BLUEPRINT_BLUEPRINTFRAGMENTTOOLTIP_RANDOMNATIONAL_DESCRIPTION = '#tooltips:blueprint/BlueprintFragmentTooltip/randomNational/description'
    BLUEPRINT_RANDOMNATIONAL_HEADER = '#tooltips:blueprint/randomNational/header'
    BLUEPRINT_RANDOMNATIONAL_DESCRIPTION = '#tooltips:blueprint/randomNational/description'
    BLUEPRINT_RANDOMNATIONAL_ADDITIONALINFO = '#tooltips:blueprint/randomNational/additionalInfo'
    BLUEPRINT_BLUEPRINTFRAGMENTTOOLTIP_RANDOM_DISCOUNT = '#tooltips:blueprint/BlueprintFragmentTooltip/random/discount'
    BLUEPRINT_BLUEPRINTFRAGMENTTOOLTIP_RANDOM_HEADER = '#tooltips:blueprint/BlueprintFragmentTooltip/random/header'
    BLUEPRINT_BLUEPRINTFRAGMENTTOOLTIP_RANDOM_DESCRIPTION = '#tooltips:blueprint/BlueprintFragmentTooltip/random/description'
    BLUEPRINT_BLUEPRINTFRAGMENTTOOLTIP_INTELDESCRIPTION = '#tooltips:blueprint/BlueprintFragmentTooltip/intelDescription'
    BLUEPRINT_BLUEPRINTFRAGMENTTOOLTIP_INTELDESCRIPTIONTIER = '#tooltips:blueprint/BlueprintFragmentTooltip/intelDescriptionTier'
    BLUEPRINT_BLUEPRINTFRAGMENTTOOLTIP_ADDITIONALINFO = '#tooltips:blueprint/BlueprintFragmentTooltip/additionalInfo'
    ...
    VEHICLESELLDIALOG_ACCEPTBUTTONTOOLTIP_NOTENOUGHCURRENCY_BODY = '#tooltips:vehicleSellDialog/acceptButtonTooltip/notEnoughCurrency/body'
    VEHICLESELLDIALOG_ACCEPTBUTTONTOOLTIP_VEHICLESELLLIMIT_BODY = '#tooltips:vehicleSellDialog/acceptButtonTooltip/vehicleSellLimit/body'
    ...
    FORTIFICATION_SORTIE_CONFIGUREBTNENABLED = '#tooltips:fortification/sortie/configureBtnEnabled'
    FORTIFICATION_SORTIE_CONFIGUREBTNDISABLED = '#tooltips:fortification/sortie/configureBtnDisabled'
    ...
    FORTIFICATION_SORTIE_GUNNERROLE_HEADER = '#tooltips:fortification/sortie/gunnerRole/header'
    FORTIFICATION_SORTIE_GUNNERROLE_BODY = '#tooltips:fortification/sortie/gunnerRole/body'
    FORTIFICATION_SORTIE_INSPIREROLE_HEADER = '#tooltips:fortification/sortie/inspireRole/header'
    FORTIFICATION_SORTIE_INSPIREROLE_BODY = '#tooltips:fortification/sortie/inspireRole/body'
    FORTIFICATION_SORTIE_BOTHROLE_HEADER = '#tooltips:fortification/sortie/bothRole/header'
    FORTIFICATION_SORTIE_BOTHROLE_BODY = '#tooltips:fortification/sortie/bothRole/body'
    ...
    FORTIFICATION_SORTIE_BATTLEROOM_UNFROZEVEHICLEBTN = '#tooltips:fortification/sortie/battleRoom/unfrozeVehicleBtn'
    FORTIFICATION_SORTIE_BATTLEROOM_UNFROZEVEHICLEBTN_DISABLED_HEADER = '#tooltips:fortification/sortie/battleRoom/unfrozeVehicleBtn/disabled/header'
    FORTIFICATION_SORTIE_BATTLEROOM_UNFROZEVEHICLEBTN_DISABLED_BODY = '#tooltips:fortification/sortie/battleRoom/unfrozeVehicleBtn/disabled/body'
    FORTIFICATION_SORTIE_BATTLEROOM_VEHBROKENICON = '#tooltips:fortification/sortie/battleRoom/vehBrokenIcon'
    ...
    BATTLERESULTS_PREMIUMBONUS_TANKSTATECHANGED_HEADER = '#tooltips:battleResults/premiumBonus/tankStateChanged/header'
    BATTLERESULTS_PREMIUMBONUS_TANKSTATECHANGED_BODY = '#tooltips:battleResults/premiumBonus/tankStateChanged/body'
    BATTLERESULTS_PREMIUMBONUS_TANKMENSTATECHANGED_HEADER = '#tooltips:battleResults/premiumBonus/tankmenStateChanged/header'
    BATTLERESULTS_PREMIUMBONUS_TANKMENSTATECHANGED_BODY = '#tooltips:battleResults/premiumBonus/tankmenStateChanged/body'
    BATTLERESULTS_PREMIUMBONUS_XPTOTMENCHANGED_BODY = '#tooltips:battleResults/premiumBonus/xpToTmenChanged/body'
    BATTLERESULTS_NEWSKILLUNLOCK_BONUS_HEADER = '#tooltips:battleResults/newSkillUnlock/bonus/header'
    BATTLERESULTS_NEWSKILLUNLOCK_BONUS_BODY = '#tooltips:battleResults/newSkillUnlock/bonus/body'
    ...
    HANGARTUTORIAL_PERSONALCASE_FREESKILLS_TITLE = '#tooltips:hangarTutorial/personalCase/freeSkills/title'
    HANGARTUTORIAL_PERSONALCASE_FREESKILLS_HEADERDESCRIPTION = '#tooltips:hangarTutorial/personalCase/freeSkills/headerDescription'
    HANGARTUTORIAL_PERSONALCASE_FREESKILLS_NEWPERKTITLE = '#tooltips:hangarTutorial/personalCase/freeSkills/newPerkTitle'
    HANGARTUTORIAL_PERSONALCASE_FREESKILLS_NEWPERKDESCRIPTION = '#tooltips:hangarTutorial/personalCase/freeSkills/newPerkDescription'
    ...
    PERKS_INFO_SINGLE_LOWEFFICIENCY = '#tooltips:perks/info/single/lowEfficiency'
    PERKS_INFO_SINGLE_LOWLEVEL = '#tooltips:perks/info/single/lowLevel'
    PERKS_INFO_SINGLE_BOTH = '#tooltips:perks/info/single/both'
    PERKS_INFO_GROUP_LOWEFFICIENCY = '#tooltips:perks/info/group/lowEfficiency'
    PERKS_INFO_GROUP_LOWLEVEL = '#tooltips:perks/info/group/lowLevel'
    PERKS_INFO_GROUP_BOTH = '#tooltips:perks/info/group/both'
    ...
    PERKS_NOTFULLWITHDIRECTIVE = '#tooltips:perks/notFullWithDirective'
    PERKS_FULLWITHDIRECTIVE = '#tooltips:perks/fullWithDirective'
    PERKS_EFFICIENCY_REDUCED = '#tooltips:perks/efficiency/reduced'
    PERKS_EFFICIENCY_UNTRAINED = '#tooltips:perks/efficiency/untrained'
    ...
    HANGARTUTORIAL_PERSONALCASE_ADDITIONAL_FREEPERKSTITLE = '#tooltips:hangarTutorial/personalCase/additional/freePerksTitle'
    HANGARTUTORIAL_PERSONALCASE_ADDITIONAL_FREEPERKSDESCRIPTION = '#tooltips:hangarTutorial/personalCase/additional/freePerksDescription'
    ...
    HANGARTUTORIAL_PERSONALCASE_ADDITIONAL_CREWSKINSTITLE = '#tooltips:hangarTutorial/personalCase/additional/crewSkinsTitle'
    HANGARTUTORIAL_PERSONALCASE_ADDITIONAL_CREWSKINSDESCRIPTION = '#tooltips:hangarTutorial/personalCase/additional/crewSkinsDescription'
    ...
    BOOSTERSWINDOW_BOOSTER_LONGDESCRIPTIONSPECIALEXPIRABLE = '#tooltips:boostersWindow/booster/longDescriptionSpecialExpirable'
    ...
    BOOSTERSWINDOW_BOOSTER_EFFECTTIME_TITLE = '#tooltips:boostersWindow/booster/effectTime/title'
    BOOSTERSWINDOW_BOOSTER_EFFECTTIME_DESCRIPTION = '#tooltips:boostersWindow/booster/effectTime/description'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_TITLE = '#tooltips:boostersWindow/booster/activateInfo/title'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_DESCRIPTION = '#tooltips:boostersWindow/booster/activateInfo/description'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_BASICRESERVE = '#tooltips:boostersWindow/booster/activateInfo/basicReserve'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_IMPROVEDRESERVE = '#tooltips:boostersWindow/booster/activateInfo/improvedReserve'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_TITLE_BOOSTER_XP = '#tooltips:boostersWindow/booster/activateInfo/title/booster_xp'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_TITLE_BOOSTER_CREDITS = '#tooltips:boostersWindow/booster/activateInfo/title/booster_credits'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_TITLE_BOOSTER_FREE_XP_AND_CREW_XP = '#tooltips:boostersWindow/booster/activateInfo/title/booster_free_xp_and_crew_xp'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_TITLE_BOOSTER_FL_XP = '#tooltips:boostersWindow/booster/activateInfo/title/booster_fl_xp'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_TITLE_BOOSTER_FREE_XP = '#tooltips:boostersWindow/booster/activateInfo/title/booster_free_xp'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_TITLE_BOOSTER_CREW_XP = '#tooltips:boostersWindow/booster/activateInfo/title/booster_crew_xp'
    ...
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_NOTACTIVATED = '#tooltips:boostersWindow/booster/activateInfo/notActivated'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_INDEPOT = '#tooltips:boostersWindow/booster/activateInfo/inDepot'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_BONUS = '#tooltips:boostersWindow/booster/activateInfo/bonus'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_PURCHASE = '#tooltips:boostersWindow/booster/activateInfo/purchase'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_NOTENOUGH = '#tooltips:boostersWindow/booster/activateInfo/notEnough'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_BONUSVALUETIME_BOOSTER_XP = '#tooltips:boostersWindow/booster/activateInfo/bonusValueTime/booster_xp'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_BONUSVALUETIME_BOOSTER_FREE_XP = '#tooltips:boostersWindow/booster/activateInfo/bonusValueTime/booster_free_xp'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_BONUSVALUETIME_BOOSTER_CREW_XP = '#tooltips:boostersWindow/booster/activateInfo/bonusValueTime/booster_crew_xp'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_BONUSVALUETIME_BOOSTER_FREE_XP_AND_CREW_XP = '#tooltips:boostersWindow/booster/activateInfo/bonusValueTime/booster_free_xp_and_crew_xp'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_BONUSVALUETIME_BOOSTER_CREDITS = '#tooltips:boostersWindow/booster/activateInfo/bonusValueTime/booster_credits'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_BONUSVALUETIME_BOOSTER_FL_XP = '#tooltips:boostersWindow/booster/activateInfo/bonusValueTime/booster_fl_xp'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_NONEXPIRABLERESERVES = '#tooltips:boostersWindow/booster/activateInfo/nonExpirableReserves'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_EXPIRABLERESERVES = '#tooltips:boostersWindow/booster/activateInfo/expirableReserves'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_EXPIRESOON = '#tooltips:boostersWindow/booster/activateInfo/expireSoon'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_EXPIRETODAY = '#tooltips:boostersWindow/booster/activateInfo/expireToday'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_EXPIRATIONTIMER = '#tooltips:boostersWindow/booster/activateInfo/expirationTimer'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_DESCRIPTIONCAPTION = '#tooltips:boostersWindow/booster/activateInfo/descriptionCaption'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_DESCRIPTIONTEXT = '#tooltips:boostersWindow/booster/activateInfo/descriptionText'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_TIMELEFT = '#tooltips:boostersWindow/booster/activateInfo/timeLeft'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_EXPIRABLE = '#tooltips:boostersWindow/booster/activateInfo/expirable'
    BOOSTERSWINDOW_BOOSTER_ACTIVATEINFO_WILLEXPIREAFTER = '#tooltips:boostersWindow/booster/activateInfo/willExpireAfter'
    ...
    AWARDITEM_GROUPS_HEADER = '#tooltips:awardItem/groups/header'
    AWARDITEM_GROUPS_BODY = '#tooltips:awardItem/groups/body'
    ...
    AWARDITEM_GOLD_COMPENSATION = '#tooltips:awardItem/gold/compensation'
    ...
    AWARDITEM_BPTALER_HEADER = '#tooltips:awardItem/bptaler/header'
    AWARDITEM_BPTALER_BODY = '#tooltips:awardItem/bptaler/body'
    ...
    AWARDITEM_PREMIUM_PLUS_BODY = '#tooltips:awardItem/premium_plus/body'
    ...
    AWARDITEM_RANKED_202203_ACCESS_HEADER = '#tooltips:awardItem/ranked_202203_access/header'
    AWARDITEM_RANKED_202203_ACCESS_BODY = '#tooltips:awardItem/ranked_202203_access/body'
    ...
    AWARDITEM_EXCLUDED_MAPS_HEADER = '#tooltips:awardItem/excluded_maps/header'
    AWARDITEM_EXCLUDED_MAPS_BODY = '#tooltips:awardItem/excluded_maps/body'
    ...
    AWARDITEM_ATTENDANCE_REWARD_HEADER = '#tooltips:awardItem/attendance_reward/header'
    AWARDITEM_ATTENDANCE_REWARD_BODY = '#tooltips:awardItem/attendance_reward/body'
    AWARDITEM_BATTLE_BONUSES_HEADER = '#tooltips:awardItem/battle_bonuses/header'
    AWARDITEM_BATTLE_BONUSES_BODY = '#tooltips:awardItem/battle_bonuses/body'
    AWARDITEM_BADGES_HEADER = '#tooltips:awardItem/badges/header'
    AWARDITEM_BADGES_BODY = '#tooltips:awardItem/badges/body'
    AWARDITEM_ADDITIONAL_BONUSES_HEADER = '#tooltips:awardItem/additional_bonuses/header'
    ...
    AWARDITEM_RANDOMNATIONALBLUEPRINT_BODY = '#tooltips:awardItem/randomNationalBlueprint/body'
    AWARDITEM_HIGHLIGHTED = '#tooltips:awardItem/highlighted'
    AWARDITEM_RANDOMNATIONALBROCHURE_HEADER = '#tooltips:awardItem/randomNationalBrochure/header'
    AWARDITEM_RANDOMNATIONALBROCHURE_HIGHLIGHTED = '#tooltips:awardItem/randomNationalBrochure/highlighted'
    AWARDITEM_RANDOMNATIONALBROCHURE_BODY = '#tooltips:awardItem/randomNationalBrochure/body'
    AWARDITEM_RANDOMNATIONALGUIDE_HEADER = '#tooltips:awardItem/randomNationalGuide/header'
    AWARDITEM_RANDOMNATIONALGUIDE_HIGHLIGHTED = '#tooltips:awardItem/randomNationalGuide/highlighted'
    AWARDITEM_RANDOMNATIONALGUIDE_BODY = '#tooltips:awardItem/randomNationalGuide/body'
    AWARDITEM_RANDOMNATIONALCREWBOOK_HEADER = '#tooltips:awardItem/randomNationalCrewBook/header'
    AWARDITEM_RANDOMNATIONALCREWBOOK_HIGHLIGHTED = '#tooltips:awardItem/randomNationalCrewBook/highlighted'
    AWARDITEM_RANDOMNATIONALCREWBOOK_BODY = '#tooltips:awardItem/randomNationalCrewBook/body'
    ...
    RANKEDBATTLEVIEW_REWARDSVIEW_TABS_YEAR_SCOREPOINT_HEADER = '#tooltips:rankedBattleView/rewardsView/tabs/year/scorePoint/header'
    RANKEDBATTLEVIEW_REWARDSVIEW_TABS_YEAR_SCOREPOINT_BODY_MAINTEXT = '#tooltips:rankedBattleView/rewardsView/tabs/year/scorePoint/body/mainText'
    RANKEDBATTLEVIEW_REWARDSVIEW_TABS_YEAR_SCOREPOINT_BODY_EXCHANGETEXT = '#tooltips:rankedBattleView/rewardsView/tabs/year/scorePoint/body/exchangeText'
    RANKEDBATTLEVIEW_STATS_DIVISIONEFFICIENCY_HEADER = '#tooltips:rankedBattleView/stats/divisionEfficiency/header'
    RANKEDBATTLEVIEW_STATS_DIVISIONEFFICIENCY_BODY = '#tooltips:rankedBattleView/stats/divisionEfficiency/body'
    RANKEDBATTLEVIEW_STATS_QUALIFICATIONEFFICIENCY_HEADER = '#tooltips:rankedBattleView/stats/qualificationEfficiency/header'
    RANKEDBATTLEVIEW_STATS_QUALIFICATIONEFFICIENCY_BODY = '#tooltips:rankedBattleView/stats/qualificationEfficiency/body'
    RANKEDBATTLEVIEW_STATS_SEASONEFFICIENCY_HEADER = '#tooltips:rankedBattleView/stats/seasonEfficiency/header'
    RANKEDBATTLEVIEW_STATS_SEASONEFFICIENCY_BODY = '#tooltips:rankedBattleView/stats/seasonEfficiency/body'
    RANKEDBATTLEVIEW_STATS_STRIPESINLEAGUE_HEADER = '#tooltips:rankedBattleView/stats/stripesInLeague/header'
    RANKEDBATTLEVIEW_STATS_STRIPESINLEAGUE_BODY = '#tooltips:rankedBattleView/stats/stripesInLeague/body'
    RANKEDBATTLEVIEW_STATS_BATTLESINLEAGUE_HEADER = '#tooltips:rankedBattleView/stats/battlesInLeague/header'
    RANKEDBATTLEVIEW_STATS_BATTLESINLEAGUE_BODY = '#tooltips:rankedBattleView/stats/battlesInLeague/body'
    RANKEDBATTLEVIEW_STATS_STRIPESTOTAL_HEADER = '#tooltips:rankedBattleView/stats/stripesTotal/header'
    RANKEDBATTLEVIEW_STATS_STRIPESTOTAL_BODY = '#tooltips:rankedBattleView/stats/stripesTotal/body'
    RANKEDBATTLEVIEW_STATS_BATTLESTOTAL_HEADER = '#tooltips:rankedBattleView/stats/battlesTotal/header'
    RANKEDBATTLEVIEW_STATS_BATTLESTOTAL_BODY = '#tooltips:rankedBattleView/stats/battlesTotal/body'
    RANKEDBATTLEVIEW_STATS_QUALIFICATIONSTEPS_HEADER = '#tooltips:rankedBattleView/stats/qualificationSteps/header'
    RANKEDBATTLEVIEW_STATS_QUALIFICATIONSTEPS_BODY = '#tooltips:rankedBattleView/stats/qualificationSteps/body'
    RANKEDBATTLESVIEW_RANKS_HEADER = '#tooltips:rankedBattlesView/ranks/header'
    ...
    RANKEDBATTLESVIEW_YEARRATING_BODY_DISABLED = '#tooltips:rankedBattlesView/yearRating/body/disabled'
    ...
    RANKED_WIDGET_EFFICIENCY_PREVIOUSUPDATE = '#tooltips:ranked/widget/efficiency/previousUpdate'
    RANKED_WIDGET_POSITION_TITLE = '#tooltips:ranked/widget/position/title'
    RANKED_WIDGET_POSITION_DESCRIPTION = '#tooltips:ranked/widget/position/description'
    RANKED_WIDGET_POSITION_UPDATELABEL = '#tooltips:ranked/widget/position/updateLabel'
    RANKED_WIDGET_POSITION_UNAVAILABLELABEL = '#tooltips:ranked/widget/position/unavailableLabel'
    ...
    CUSTOMIZATION_TABS_STATTRACKER_BODY = '#tooltips:customization/tabs/statTracker/body'
    ...
    MODULEINFO_PARAMS_NORMALIZATIONANGLE = '#tooltips:moduleInfo/params/normalizationAngle'
    MODULEINFO_PARAMS_RICOCHETANGLE = '#tooltips:moduleInfo/params/ricochetAngle'
    MODULEINFO_PARAMS_CRITICALHITCHANCE = '#tooltips:moduleInfo/params/criticalHitChance'
    MODULEINFO_PARAMS_PENETRATIONLOSS = '#tooltips:moduleInfo/params/penetrationLoss'
    TANK_PARAMS_DESC_LOWCHARGESHOTAVGDAMAGE = '#tooltips:tank_params/desc/lowChargeShotAvgDamage'
    TANK_PARAMS_DESC_LOWCHARGESHOTPENETRATION = '#tooltips:tank_params/desc/lowChargeShotPenetration'
    TANK_PARAMS_DESC_LOWCHARGESHOTRATEOFFIRE = '#tooltips:tank_params/desc/lowChargeShotRateOfFire'
    TANK_PARAMS_DESC_LOWCHARGESHOTDISPERTION = '#tooltips:tank_params/desc/lowChargeShotDispertion'
    TANK_PARAMS_DESC_LOWCHARGESHOTVELOCITY = '#tooltips:tank_params/desc/lowChargeShotVelocity'
    TANK_PARAMS_DESC_LOWCHARGESHOTBLOCKDURATION = '#tooltips:tank_params/desc/lowChargeShotBlockDuration'
    TANK_PARAMS_DESC_SHELLCALIBRATIONAVGPENETRATION = '#tooltips:tank_params/desc/shellCalibrationAvgPenetration'
    TANK_PARAMS_DESC_SHELLCALIBRATIONAVGDAMAGE = '#tooltips:tank_params/desc/shellCalibrationAvgDamage'
    TANK_PARAMS_DESC_FURYMAXRELOADEFFAVGDPM = '#tooltips:tank_params/desc/furyMaxReloadEffAvgDpm'
    TANK_PARAMS_DESC_FURYMAXRELOADEFFICIENCYLEVEL = '#tooltips:tank_params/desc/furyMaxReloadEfficiencyLevel'
    TANK_PARAMS_DESC_FURYRELOADSPEEDBONUSPEREFFICIENCYLEVEL = '#tooltips:tank_params/desc/furyReloadSpeedBonusPerEfficiencyLevel'
    TANK_PARAMS_DESC_FURYRELOADEFFICIENCYLEVELDURATION = '#tooltips:tank_params/desc/furyReloadEfficiencyLevelDuration'
    TANK_PARAMS_DESC_FURYRELOADEFFICIENCYLEVELPERHIT = '#tooltips:tank_params/desc/furyReloadEfficiencyLevelPerHit'
    TANK_PARAMS_DESC_FURYRELOADEFFICIENCYLEVELPERDESTRUCTION = '#tooltips:tank_params/desc/furyReloadEfficiencyLevelPerDestruction'
    TANK_PARAMS_DESC_ACCURACYDISPERSIONCAP = '#tooltips:tank_params/desc/accuracyDispersionCap'
    TANK_PARAMS_DESC_ACCURACYWHILEMOVINGDISPERSIONCAP = '#tooltips:tank_params/desc/accuracyWhileMovingDispersionCap'
    TANK_PARAMS_DESC_MAXACCURACYLEVEL = '#tooltips:tank_params/desc/maxAccuracyLevel'
    TANK_PARAMS_DESC_ACCURACYDISPERSIONPERLEVEL = '#tooltips:tank_params/desc/accuracyDispersionPerLevel'
    TANK_PARAMS_DESC_ACCURACYSPEEDLIMIT = '#tooltips:tank_params/desc/accuracySpeedLimit'
    TANK_PARAMS_DESC_ACCURACYLEVELGAINTIME = '#tooltips:tank_params/desc/accuracyLevelGainTime'
    TANK_PARAMS_DESC_PREHEATDMGCAP = '#tooltips:tank_params/desc/preheatDmgCap'
    TANK_PARAMS_DESC_PREHEATDISPERSIONCAP = '#tooltips:tank_params/desc/preheatDispersionCap'
    TANK_PARAMS_DESC_PREHEATTIMETOFULL = '#tooltips:tank_params/desc/preheatTimeToFull'
    TANK_PARAMS_DESC_PREHEATTIMETOZERO = '#tooltips:tank_params/desc/preheatTimeToZero'
    TANK_PARAMS_DESC_PREHEATSPEEDLIMIT = '#tooltips:tank_params/desc/preheatSpeedLimit'
    TANK_PARAMS_DESC_PREHEATTRANSITIONDELAY = '#tooltips:tank_params/desc/preheatTransitionDelay'
    TANK_PARAMS_DESC_ENGINEPOWERWITHBOOSTERS = '#tooltips:tank_params/desc/enginePowerWithBoosters'
    TANK_PARAMS_DESC_TOPSPEEDWITHBOOSTERS = '#tooltips:tank_params/desc/topSpeedWithBoosters'
    TANK_PARAMS_DESC_REVERSESPEEDREDUCTIONWITHBOOSTERS = '#tooltips:tank_params/desc/reverseSpeedReductionWithBoosters'
    TANK_PARAMS_DESC_TRAVERSESPEEDREDUCTIONWITHBOOSTERS = '#tooltips:tank_params/desc/traverseSpeedReductionWithBoosters'
    TANK_PARAMS_DESC_BOOSTERDURATION = '#tooltips:tank_params/desc/boosterDuration'
    TANK_PARAMS_DESC_BOOSTERCOOLINGTIME = '#tooltips:tank_params/desc/boosterCoolingTime'
    TANK_PARAMS_DESC_REACTIVATIONLIMIT = '#tooltips:tank_params/desc/reactivationLimit'
    TANK_PARAMS_DESC_REACTIVATIONDELAY = '#tooltips:tank_params/desc/reactivationDelay'
    TANK_PARAMS_DESC_HEATAVGDMGPERLVL = '#tooltips:tank_params/desc/heatAvgDmgPerLvl'
    TANK_PARAMS_DESC_HEATTIMETOREACHLEVEL = '#tooltips:tank_params/desc/heatTimeToReachLevel'
    TANK_PARAMS_DESC_HEATTIMEBEFOREOVERHEAT = '#tooltips:tank_params/desc/heatTimeBeforeOverheat'
    TANK_PARAMS_DESC_HEATCHARGEOVERHEATDURATION = '#tooltips:tank_params/desc/heatChargeOverheatDuration'
    TANK_PARAMS_DESC_PASSIVECOINCIDECESHOOTINGCHARGE = '#tooltips:tank_params/desc/passiveCoincideceShootingCharge'
    TANK_PARAMS_DESC_ACTIVECOINCIDECESHOOTINGCHARGE = '#tooltips:tank_params/desc/activeCoincideceShootingCharge'
    TANK_PARAMS_DESC_COINCIDENCEELECTROMECHANICALSIGHTDURATION = '#tooltips:tank_params/desc/coincidenceElectromechanicalSightDuration'
    TANK_PARAMS_DESC_AIMINGTIMECOINCIDENCEELECTROMECHANICALSIGHT = '#tooltips:tank_params/desc/aimingTimeCoincidenceElectromechanicalSight'
    TANK_PARAMS_DESC_DISPERSIONAT100MCOINCIDENCEELECTROMECHANICALSIGHT = '#tooltips:tank_params/desc/dispersionAt100mCoincidenceElectromechanicalSight'
    TANK_PARAMS_DESC_RELOADTIMECOINCIDENCE = '#tooltips:tank_params/desc/reloadTimeCoincidence'
    TANK_PARAMS_DESC_SWITCHENGINEMODEBOTHMODES = '#tooltips:tank_params/desc/switchEngineModeBothModes'
    TANK_PARAMS_DESC_TURBOSPEEDCAP = '#tooltips:tank_params/desc/turboSpeedCap'
    TANK_PARAMS_DESC_ENGINETURBOPOWERCAP = '#tooltips:tank_params/desc/engineTurboPowerCap'
    TANK_PARAMS_DESC_AIMINGTIMETURBO = '#tooltips:tank_params/desc/aimingTimeTurbo'
    TANK_PARAMS_DESC_MOVEMENTTRAVERSEDISPERSIONTURBO = '#tooltips:tank_params/desc/movementTraverseDispersionTurbo'
    TANK_PARAMS_DESC_HULLTRAVERSEDISPERSIONTURBO = '#tooltips:tank_params/desc/hullTraverseDispersionTurbo'
    TANK_PARAMS_DESC_GUNTRAVERSEDISPERSIONTURBO = '#tooltips:tank_params/desc/gunTraverseDispersionTurbo'
    TANK_PARAMS_DESC_IONAFTERBURNERPASSIVETURBOCHARGE = '#tooltips:tank_params/desc/ionAfterburnerPassiveTurboCharge'
    TANK_PARAMS_DESC_IONAFTERBURNERACTIVETURBOCHARGE = '#tooltips:tank_params/desc/ionAfterburnerActiveTurboCharge'
    TANK_PARAMS_DESC_IONAFTERBURNERDURATION = '#tooltips:tank_params/desc/ionAfterburnerDuration'
    TANK_PARAMS_DESC_IONAFTERBURNERDURATIONSPEEDCAP = '#tooltips:tank_params/desc/ionAfterburnerDurationSpeedCap'
    TANK_PARAMS_DESC_IONAFTERBURNERDURATIONENGINEPOWER = '#tooltips:tank_params/desc/ionAfterburnerDurationEnginePower'
    TANK_PARAMS_DESC_DESIGNATORINITIALCOOLDOWNS = '#tooltips:tank_params/desc/designatorInitialCooldownS'
    TANK_PARAMS_DESC_DESIGNATORCOOLDOWNS = '#tooltips:tank_params/desc/designatorCooldownS'
    TANK_PARAMS_DESC_DESIGNATORMARKDURATIONS = '#tooltips:tank_params/desc/designatorMarkDurationS'
    TANK_PARAMS_DESC_DESIGNATORMARKEDENEMIESADDITIONALDAMAGE = '#tooltips:tank_params/desc/designatorMarkedEnemiesAdditionalDamage'
    ...
    TANK_PARAMS_DESC_FORWARDMAXSPEED = '#tooltips:tank_params/desc/forwardMaxSpeed'
    ...
    TANK_PARAMS_DESC_TEMPERATURERELOADTIME = '#tooltips:tank_params/desc/temperatureReloadTime'
    ...
    TANK_PARAMS_DESC_AUTORELOADTIME_BOOST_SHORTDESCRIPTION = '#tooltips:tank_params/desc/autoReloadTime/boost/shortDescription'
    TANK_PARAMS_DESC_RELOADTIMESECS = '#tooltips:tank_params/desc/reloadTimeSecs'
    TANK_PARAMS_DESC_RELOADTIMESECS_TWINGUN = '#tooltips:tank_params/desc/reloadTimeSecs/twinGun'
    TANK_PARAMS_DESC_TWINGUNSWITCHFIREMODETIME = '#tooltips:tank_params/desc/twinGunSwitchFireModeTime'
    TANK_PARAMS_DESC_TWINGUNTOPSPEED = '#tooltips:tank_params/desc/twinGunTopSpeed'
    TANK_PARAMS_DESC_SHOTDISPERSIONANGLE_TWINGUN = '#tooltips:tank_params/desc/shotDispersionAngle/twinGun'
    TANK_PARAMS_DESC_SHELLLOADINGTIME = '#tooltips:tank_params/desc/shellLoadingTime'
    ...
    TANK_PARAMS_AVGPARAMCOMMENT_MAXMUTABLEDAMAGE = '#tooltips:tank_params/avgParamComment/maxMutableDamage'
    TANK_PARAMS_AVGPARAMCOMMENT_MINMUTABLEDAMAGE = '#tooltips:tank_params/avgParamComment/minMutableDamage'
    TANK_PARAMS_AVGPARAMCOMMENT_PIERCINGPOWER = '#tooltips:tank_params/avgParamComment/piercingPower'
    TANK_PARAMS_AVGPARAMCOMMENT_MAXPIERCINGPOWER = '#tooltips:tank_params/avgParamComment/maxPiercingPower'
    TANK_PARAMS_AVGPARAMCOMMENT_MINPIERCINGPOWER = '#tooltips:tank_params/avgParamComment/minPiercingPower'
    TANK_PARAMS_DESC_AVGDAMAGEPERMINUTE = '#tooltips:tank_params/desc/avgDamagePerMinute'
    TANK_PARAMS_DESC_TEMPERATUREAVGDAMAGEPERMINUTE = '#tooltips:tank_params/desc/temperatureAvgDamagePerMinute'
    ...
    TANK_PARAMS_DESC_TEMPERATURESHOTDISPERSIONANGLE = '#tooltips:tank_params/desc/temperatureShotDispersionAngle'
    ...
    TANK_PARAMS_DESC_TEMPERATUREAIMINGTIME = '#tooltips:tank_params/desc/temperatureAimingTime'
    ...
    TANK_PARAMS_DESC_DUALACCURACYCOOLINGDELAY = '#tooltips:tank_params/desc/dualAccuracyCoolingDelay'
    TANK_PARAMS_DESC_IMPROVEDDAMAGEENEMIESBYRAMMING = '#tooltips:tank_params/desc/improvedDamageEnemiesByRamming'
    TANK_PARAMS_DESC_IMPROVEDDAMAGEENEMIESCHASSISBYRAMMING = '#tooltips:tank_params/desc/improvedDamageEnemiesChassisByRamming'
    TANK_PARAMS_DESC_CONCENTRATIONMODECOOLDOWN = '#tooltips:tank_params/desc/concentrationModeCooldown'
    TANK_PARAMS_DESC_CONCENTRATIONMODEDURATION = '#tooltips:tank_params/desc/concentrationModeDuration'
    TANK_PARAMS_DESC_EXTRASHOTCLIPRELOADTIME = '#tooltips:tank_params/desc/extraShotClipReloadTime'
    TANK_PARAMS_DESC_POWERMODETHRESHOLD = '#tooltips:tank_params/desc/powerModeThreshold'
    TANK_PARAMS_DESC_POWERMODEDURATION = '#tooltips:tank_params/desc/powerModeDuration'
    TANK_PARAMS_DESC_SECONDARYRELOADTIMESECS = '#tooltips:tank_params/desc/secondaryReloadTimeSecs'
    TANK_PARAMS_DESC_SECONDARYTOTALBURSTSIZE = '#tooltips:tank_params/desc/secondaryTotalBurstSize'
    TANK_PARAMS_DESC_SECONDARYAVGDAMAGE = '#tooltips:tank_params/desc/secondaryAvgDamage'
    TANK_PARAMS_DESC_SECONDARYAVGPIERCINGPOWER = '#tooltips:tank_params/desc/secondaryAvgPiercingPower'
    TANK_PARAMS_DESC_PILLBOXHORIZONTALROTATIONSPEED = '#tooltips:tank_params/desc/pillboxHorizontalRotationSpeed'
    TANK_PARAMS_DESC_PILLBOXVERTICALROTATIONSPEED = '#tooltips:tank_params/desc/pillboxVerticalRotationSpeed'
    TANK_PARAMS_DESC_PILLBOXSWITCHONTIME = '#tooltips:tank_params/desc/pillboxSwitchOnTime'
    TANK_PARAMS_DESC_PILLBOXSWITCHOFFTIME = '#tooltips:tank_params/desc/pillboxSwitchOffTime'
    TANK_PARAMS_DESC_CHARGEABLEBURSTPENETRATIONCOUNT = '#tooltips:tank_params/desc/chargeableBurstPenetrationCount'
    TANK_PARAMS_DESC_CHARGEABLEBURSTSIZE = '#tooltips:tank_params/desc/chargeableBurstSize'
    TANK_PARAMS_DESC_CHARGEABLEBURSTRELOAD = '#tooltips:tank_params/desc/chargeableBurstReload'
    TANK_PARAMS_DESC_CHARGEABLEBURSTDISPERSION = '#tooltips:tank_params/desc/chargeableBurstDispersion'
    TANK_PARAMS_DESC_STATIONARYRELOADSWITCHONTIME = '#tooltips:tank_params/desc/stationaryReloadSwitchOnTime'
    TANK_PARAMS_DESC_STATIONARYRELOADSWITCHOFFTIME = '#tooltips:tank_params/desc/stationaryReloadSwitchOffTime'
    TANK_PARAMS_DESC_COOLINGDELAY = '#tooltips:tank_params/desc/coolingDelay'
    TANK_PARAMS_DESC_COOLINGTIME = '#tooltips:tank_params/desc/coolingTime'
    TANK_PARAMS_DESC_HEATINGPERSHOT = '#tooltips:tank_params/desc/heatingPerShot'
    TANK_PARAMS_DESC_OVERHEATDURATION = '#tooltips:tank_params/desc/overheatDuration'
    TANK_PARAMS_DESC_TIMETOOVERHEAT = '#tooltips:tank_params/desc/timeToOverheat'
    TANK_PARAMS_DESC_STAGEDJETBOOSTERSENGINEPOWER = '#tooltips:tank_params/desc/stagedJetBoostersEnginePower'
    TANK_PARAMS_DESC_STAGEDJETBOOSTERSTOPSPEED = '#tooltips:tank_params/desc/stagedJetBoostersTopSpeed'
    TANK_PARAMS_DESC_STAGEDJETBOOSTERSSPEEDLIMITS = '#tooltips:tank_params/desc/stagedJetBoostersSpeedLimits'
    TANK_PARAMS_DESC_STAGEDJETBOOSTERSROTATIONSPEED = '#tooltips:tank_params/desc/stagedJetBoostersRotationSpeed'
    TANK_PARAMS_DESC_STAGEDJETBOOSTERSCHARGESCOUNT = '#tooltips:tank_params/desc/stagedJetBoostersChargesCount'
    TANK_PARAMS_DESC_STAGEDJETBOOSTERSCHARGEDURATION = '#tooltips:tank_params/desc/stagedJetBoostersChargeDuration'
    TANK_PARAMS_DESC_STAGEDJETBOOSTERSCOOLDOWNTIME = '#tooltips:tank_params/desc/stagedJetBoostersCooldownTime'
    TANK_PARAMS_DESC_PROPELLANTPRELIMITDAMAGEBONUS = '#tooltips:tank_params/desc/propellantPreLimitDamageBonus'
    TANK_PARAMS_DESC_PROPELLANTPOSTLIMITDAMAGESPIKE = '#tooltips:tank_params/desc/propellantPostLimitDamageSpike'
    TANK_PARAMS_DESC_PROPELLANTPOSTLIMITDAMAGEBONUS = '#tooltips:tank_params/desc/propellantPostLimitDamageBonus'
    TANK_PARAMS_DESC_PROPELLANTCHARGINGPERSEC = '#tooltips:tank_params/desc/propellantChargingPerSec'
    TANK_PARAMS_DESC_PROPELLANTCHARGESPENDINGAFTERSHOT = '#tooltips:tank_params/desc/propellantChargeSpendingAfterShot'
    TANK_PARAMS_DESC_PROPELLANTCHARGELIMIT = '#tooltips:tank_params/desc/propellantChargeLimit'
    TANK_PARAMS_DESC_PROPELLANTDISCHARGINGPERSEC = '#tooltips:tank_params/desc/propellantDischargingPerSec'
    TANK_PARAMS_DESC_PROPELLANTPOSTLIMITDISPERSION = '#tooltips:tank_params/desc/propellantPostLimitDispersion'
    TANK_PARAMS_DESC_PROPELLANTPOSTLIMITAIMINGTIME = '#tooltips:tank_params/desc/propellantPostLimitAimingTime'
    TANK_PARAMS_DESC_PROPELLANTOVERCHARGESWITCHCOOLDOWN = '#tooltips:tank_params/desc/propellantOverchargeSwitchCooldown'
    TANK_PARAMS_DESC_WHEELEDDASHABILITYDURATION = '#tooltips:tank_params/desc/wheeledDashAbilityDuration'
    TANK_PARAMS_DESC_WHEELEDDASHENGINEPOWER = '#tooltips:tank_params/desc/wheeledDashEnginePower'
    TANK_PARAMS_DESC_WHEELEDDASHTOPSPEED = '#tooltips:tank_params/desc/wheeledDashTopSpeed'
    TANK_PARAMS_DESC_WHEELEDDASHABILITYRELOADTIME = '#tooltips:tank_params/desc/wheeledDashAbilityReloadTime'
    TANK_PARAMS_DESC_WHEELEDDASHABILITYRELOADTIMEBONUS = '#tooltips:tank_params/desc/wheeledDashAbilityReloadTimeBonus'
    TANK_PARAMS_DESC_WHEELEDDASHSPEEDLIMITS = '#tooltips:tank_params/desc/wheeledDashSpeedLimits'
    TANK_PARAMS_DESC_WHEELEDDASHREVERSESPEED = '#tooltips:tank_params/desc/wheeledDashReverseSpeed'
    TANK_PARAMS_DESC_AUXILIARYROCKETLAUNCHERRELOADTIME = '#tooltips:tank_params/desc/auxiliaryRocketLauncherReloadTime'
    TANK_PARAMS_DESC_AUXILIARYROCKETLAUNCHERAVGDAMAGE = '#tooltips:tank_params/desc/auxiliaryRocketLauncherAvgDamage'
    TANK_PARAMS_DESC_AUXILIARYROCKETLAUNCHERPENETRATION = '#tooltips:tank_params/desc/auxiliaryRocketLauncherPenetration'
    TANK_PARAMS_DESC_AUXILIARYROCKETLAUNCHERVELOCITY = '#tooltips:tank_params/desc/auxiliaryRocketLauncherVelocity'
    TANK_PARAMS_DESC_AUXILIARYROCKETLAUNCHERDISPERSION = '#tooltips:tank_params/desc/auxiliaryRocketLauncherDispersion'
    TANK_PARAMS_DESC_SHELLPARAMSSWITCHINGTIME = '#tooltips:tank_params/desc/shellParamsSwitchingTime'
    TANK_PARAMS_DESC_AUTORELOADERSURGEMAXCHARGES = '#tooltips:tank_params/desc/autoreloaderSurgeMaxCharges'
    TANK_PARAMS_DESC_AUTORELOADERSURGEINITCHARGES = '#tooltips:tank_params/desc/autoreloaderSurgeInitCharges'
    TANK_PARAMS_DESC_AUTORELOADERSURGECHARGETIMESLOW = '#tooltips:tank_params/desc/autoreloaderSurgeChargeTimeSlow'
    TANK_PARAMS_DESC_AUTORELOADERSURGECHARGETIMEFAST = '#tooltips:tank_params/desc/autoreloaderSurgeChargeTimeFast'
    TANK_PARAMS_DESC_AUTORELOADERSURGEBOOSTEDRELOADTIME = '#tooltips:tank_params/desc/autoreloaderSurgeBoostedReloadTime'
    TANK_PARAMS_DESC_BUSTLEFEEDDAMAGEPERSHOT = '#tooltips:tank_params/desc/bustleFeedDamagePerShot'
    TANK_PARAMS_DESC_BUSTLEFEEDRATEOFFIRE = '#tooltips:tank_params/desc/bustleFeedRateOfFire'
    TANK_PARAMS_DESC_BUSTLEFEEDSWITCHINGTOEASMMODE = '#tooltips:tank_params/desc/bustleFeedSwitchingToEASMMode'
    TANK_PARAMS_DESC_BUSTLEFEEDSWITCHINGTOSTANDARDMODE = '#tooltips:tank_params/desc/bustleFeedSwitchingToStandardMode'
    TANK_PARAMS_DESC_BUSTLEFEEDMAXSPEED = '#tooltips:tank_params/desc/bustleFeedMaxSpeed'
    TANK_PARAMS_DESC_SIGHTPOINTERDEPLOYTIME = '#tooltips:tank_params/desc/sightPointerDeployTime'
    TANK_PARAMS_DESC_SIGHTPOINTERRELOADTIME = '#tooltips:tank_params/desc/sightPointerReloadTime'
    TANK_PARAMS_DESC_SIGHTPOINTERDURATION = '#tooltips:tank_params/desc/sightPointerDuration'
    TANK_PARAMS_DESC_SIGHTPOINTERROTATIONSPEED = '#tooltips:tank_params/desc/sightPointerRotationSpeed'
    TANK_PARAMS_DESC_SIGHTPOINTERSECTORANGLESTART = '#tooltips:tank_params/desc/sightPointerSectorAngleStart'
    TANK_PARAMS_DESC_SIGHTPOINTERSECTORANGLEEND = '#tooltips:tank_params/desc/sightPointerSectorAngleEnd'
    TANK_PARAMS_DESC_SIGHTPOINTERSELFSPOTTINGTIME = '#tooltips:tank_params/desc/sightPointerSelfSpottingTime'
    TANK_PARAMS_DESC_SIGHTPOINTERVIEWRANGE = '#tooltips:tank_params/desc/sightPointerViewRange'
    TANK_PARAMS_DESC_SIGHTPOINTERCONSEALMENTFOLIAGE = '#tooltips:tank_params/desc/sightPointerConsealmentFoliage'
    TANK_PARAMS_DESC_SIGHTPOINTERCONSEALMENTMOVING = '#tooltips:tank_params/desc/sightPointerConsealmentMoving'
    ...
    VEHICLEPARAMS_BONUS_PERK_TEMPLATE = '#tooltips:vehicleParams/bonus/perk/template'
    ...
    VEHICLEPARAMS_BONUS_VEHPOSTPROGRESSIONPAIRMODIFICATION_TEMPLATE = '#tooltips:vehicleParams/bonus/vehPostProgressionPairModification/template'
    VEHICLEPARAMS_BONUS_VEHPOSTPROGRESSIONBASEMODIFICATION_TEMPLATE = '#tooltips:vehicleParams/bonus/vehPostProgressionBaseModification/template'
    VEHICLEPARAMS_BONUS_VEHSKILLTREEPOSTPROGRESSIONBASEMODIFICATION_TEMPLATE = '#tooltips:vehicleParams/bonus/vehSkillTreePostProgressionBaseModification/template'
    ...
    VEHICLEPARAMS_BONUS_POSSIBLE_NOTINSTALLED_DEFAULT = '#tooltips:vehicleParams/bonus/possible/notInstalled/default'
    VEHICLEPARAMS_BONUS_POSSIBLE_ISINACTIVE = '#tooltips:vehicleParams/bonus/possible/isInactive'
    VEHICLEPARAMS_BONUS_POSSIBLE_NOTINSTALLED_PAIRMODIFICATION = '#tooltips:vehicleParams/bonus/possible/notInstalled/pairModification'
    VEHICLEPARAMS_BONUS_POSSIBLE_NOTINSTALLED_BASEMODIFICATION = '#tooltips:vehicleParams/bonus/possible/notInstalled/baseModification'
    ...
    VEHICLEPREVIEW_VEHICLEPANEL_INFO_HEADER_CREW_ONESKILL_FORONE = '#tooltips:vehiclePreview/vehiclePanel/info/header/crew/oneSkill/forOne'
    VEHICLEPREVIEW_VEHICLEPANEL_INFO_HEADER_CREW_NEWSKILL_FORONE = '#tooltips:vehiclePreview/vehiclePanel/info/header/crew/newSkill/forOne'
    VEHICLEPREVIEW_VEHICLEPANEL_INFO_HEADER_CREW_ONESKILL_FORALL = '#tooltips:vehiclePreview/vehiclePanel/info/header/crew/oneSkill/forAll'
    VEHICLEPREVIEW_VEHICLEPANEL_INFO_HEADER_CREW_NEWSKILL_FORALL = '#tooltips:vehiclePreview/vehiclePanel/info/header/crew/newSkill/forAll'
    VEHICLEPREVIEW_VEHICLEPANEL_INFO_HEADER_CREW_ANYSKILLS = '#tooltips:vehiclePreview/vehiclePanel/info/header/crew/AnySkills'
    VEHICLEPREVIEW_VEHICLEPANEL_INFO_HEADER_NOCREW = '#tooltips:vehiclePreview/vehiclePanel/info/header/noCrew'
    VEHICLEPREVIEW_TANKMAN_SKILLSTITLE = '#tooltips:vehiclePreview/tankman/skillsTitle'
    VEHICLEPREVIEW_TANKMAN_NEWPERK_HEADER = '#tooltips:vehiclePreview/tankman/newPerk/header'
    ...
    VEHICLEPREVIEW_BUYBUTTON_WALLETUNAVAILABLE_HEADER = '#tooltips:vehiclePreview/buyButton/walletUnavailable/header'
    VEHICLEPREVIEW_BUYBUTTON_WALLETUNAVAILABLE_BODY = '#tooltips:vehiclePreview/buyButton/walletUnavailable/body'
    ...
    VEHICLEPREVIEW_MODULSNOMODULES_BODY = '#tooltips:vehiclePreview/modulsnoModules/body'
    VEHICLEPREVIEW_ELITEBONUS_CREW_HEADER = '#tooltips:vehiclePreview/eliteBonus/crew/header'
    VEHICLEPREVIEW_ELITEBONUS_CREW_BODY = '#tooltips:vehiclePreview/eliteBonus/crew/body'
    VEHICLEPREVIEW_ELITEBONUS_BATTLE_HEADER = '#tooltips:vehiclePreview/eliteBonus/battle/header'
    VEHICLEPREVIEW_ELITEBONUS_BATTLE_BODY = '#tooltips:vehiclePreview/eliteBonus/battle/body'
    VEHICLEPREVIEW_ELITEBONUS_REPLACE_HEADER = '#tooltips:vehiclePreview/eliteBonus/replace/header'
    VEHICLEPREVIEW_ELITEBONUS_REPLACE_BODY = '#tooltips:vehiclePreview/eliteBonus/replace/body'
    ...
    VEHICLEPREVIEW_BOXTOOLTIP_STATTRACKER_HEADER = '#tooltips:vehiclePreview/boxTooltip/statTracker/header'
    ...
    SETTINGS_KEY_HIGHLIGHTLOCATION_TITLE = '#tooltips:settings/key/highlightLocation/title'
    SETTINGS_KEY_HIGHLIGHTLOCATION_BODY = '#tooltips:settings/key/highlightLocation/body'
    SETTINGS_KEY_HIGHLIGHTTARGET_TITLE = '#tooltips:settings/key/highlightTarget/title'
    SETTINGS_KEY_HIGHLIGHTTARGET_BODY = '#tooltips:settings/key/highlightTarget/body'
    SETTINGS_KEY_SHOWRADIALMENU_TITLE = '#tooltips:settings/key/showRadialMenu/title'
    SETTINGS_KEY_SHOWRADIALMENU_BODYA = '#tooltips:settings/key/showRadialMenu/bodyA'
    SETTINGS_KEY_SHOWRADIALMENU_ATTENTION = '#tooltips:settings/key/showRadialMenu/attention'
    SETTINGS_KEY_SHOWRADIALMENU_BODYB = '#tooltips:settings/key/showRadialMenu/bodyB'
    ...
    SETTINGS_KEYSPECIALABILITY_TITLE = '#tooltips:settings/keySpecialAbility/title'
    SETTINGS_KEYSPECIALABILITY_BODY = '#tooltips:settings/keySpecialAbility/body'
    ...
    SKILLS_NEWPERK_HEADER = '#tooltips:skills/newPerk/header'
    ...
    STATISTICS_TAB_QUESTS_STATUS_ONPAUSE_HEADER = '#tooltips:statistics/tab/quests/status/onPause/header'
    STATISTICS_TAB_QUESTS_STATUS_ONPAUSE_BODY = '#tooltips:statistics/tab/quests/status/onPause/body'
    QUESTPROGRESSTRACKING_STATUS_ONPAUSE_HEADER = '#tooltips:questProgressTracking/status/onPause/header'
    QUESTPROGRESSTRACKING_STATUS_ONPAUSE_BODY = '#tooltips:questProgressTracking/status/onPause/body'
    ...
    QUESTS_COMPLETE_PROGRESSWEEKLY_HEADER = '#tooltips:quests/complete/progressWeekly/header'
    QUESTS_COMPLETE_PROGRESSDAILY_BODY = '#tooltips:quests/complete/progressDaily/body'
    QUESTS_COMPLETE_PROGRESSWEEKLY_BODY = '#tooltips:quests/complete/progressWeekly/body'
    QUESTS_COMPLETE_PERSONAL_PROGRESSDAILY_BODY = '#tooltips:quests/complete/personal/progressDaily/body'
    QUESTS_COMPLETE_PERSONAL_PROGRESSWEEKLY_BODY = '#tooltips:quests/complete/personal/progressWeekly/body'
    QUESTS_COMPLETE_PROGRESSDAILY_DAILYCOUNT = '#tooltips:quests/complete/progressDaily/dailyCount'
    QUESTS_COMPLETE_PROGRESSWEEKLY_WEEKLYCOUNT = '#tooltips:quests/complete/progressWeekly/weeklyCount'
    ...
    QUESTS_BONUSES_TOKEN_RESOURCE_CLAN_PROMORESOURCE_BODY = '#tooltips:quests/bonuses/token/resource/clan_promoresource/body'
    QUESTS_BONUSES_TOKEN_BATTLE_BONUS_X5_LABEL = '#tooltips:quests/bonuses/token/battle_bonus_x5/label'
    QUESTS_BONUSES_TOKEN_BATTLE_BONUS_X5_HEADER = '#tooltips:quests/bonuses/token/battle_bonus_x5/header'
    QUESTS_BONUSES_TOKEN_BATTLE_BONUS_X5_BODY = '#tooltips:quests/bonuses/token/battle_bonus_x5/body'
    QUESTS_BONUSES_TOKEN_CREW_BONUS_X3_LABEL = '#tooltips:quests/bonuses/token/crew_bonus_x3/label'
    QUESTS_BONUSES_TOKEN_CREW_BONUS_X3_HEADER = '#tooltips:quests/bonuses/token/crew_bonus_x3/header'
    QUESTS_BONUSES_TOKEN_CREW_BONUS_X3_BODY = '#tooltips:quests/bonuses/token/crew_bonus_x3/body'
    QUESTS_BONUSES_TOKEN_EXCHANGERATE_GOLD_EXCHANGE_HEADER = '#tooltips:quests/bonuses/token/exchangeRate/gold_exchange/header'
    QUESTS_BONUSES_TOKEN_EXCHANGERATE_EXPERIENCE_TRANSLATION_HEADER = '#tooltips:quests/bonuses/token/exchangeRate/experience_translation/header'
    QUESTS_BONUSES_TOKEN_PERSONAL_MISSIONS_POINTS_HEADER = '#tooltips:quests/bonuses/token/personal_missions_points/header'
    QUESTS_BONUSES_TOKEN_PERSONAL_MISSIONS_POINTS_BODY = '#tooltips:quests/bonuses/token/personal_missions_points/body'
    QUESTS_BONUSES_ATTACHMENTS_SET_BODY = '#tooltips:quests/bonuses/attachments_set/body'
    ...
    ADVANCED_LOW_CHARGE_SHOT_FOOTER = '#tooltips:advanced/LOW_CHARGE_SHOT/footer'
    ADVANCED_LOW_CHARGE_SHOT_FIREMODE = '#tooltips:advanced/LOW_CHARGE_SHOT/fireMode'
    ADVANCED_LOW_CHARGE_SHOT_FIRERATE = '#tooltips:advanced/LOW_CHARGE_SHOT/fireRate'
    ...
    ADVANCED_QUALITYFUEL = '#tooltips:advanced/qualityFuel'
    ADVANCED_EXCELLENTFUEL = '#tooltips:advanced/excellentFuel'
    ...
    ADVANCED_MODERNIZEDIMPROVEDSIGHTSENHANCEDAIMDRIVES = '#tooltips:advanced/modernizedImprovedSightsEnhancedAimDrives'
    ADVANCED_MODERNIZEDAIMDRIVESAIMINGSTABILIZER = '#tooltips:advanced/modernizedAimDrivesAimingStabilizer'
    ADVANCED_MODERNIZEDEXTRAHEALTHRESERVEANTIFRAGMENTATIONLINING = '#tooltips:advanced/modernizedExtraHealthReserveAntifragmentationLining'
    ADVANCED_MODERNIZEDTURBOCHARGERROTATIONMECHANISM = '#tooltips:advanced/modernizedTurbochargerRotationMechanism'
    ADVANCED_IMPROVEDSIGHTS = '#tooltips:advanced/improvedSights'
    ADVANCED_EXTRAHEALTHRESERVE = '#tooltips:advanced/extraHealthReserve'
    ADVANCED_IMPROVEDRADIOCOMMUNICATION = '#tooltips:advanced/improvedRadioCommunication'
    ADVANCED_IMPROVEDROTATIONMECHANISM = '#tooltips:advanced/improvedRotationMechanism'
    ...
    PERSONALMISSIONS_OPERATION_FOOTER_TITLE_ONPAUSE = '#tooltips:personalMissions/operation/footer/title/onPause'
    ...
    PERSONALMISSIONS_OPERATION_FOOTER_DESCR_COMPLETIONTOKENS_PM3 = '#tooltips:personalMissions/operation/footer/descr/completionTokens/pm3'
    ...
    PERSONALMISSIONS_OPERATION_FOOTER_DESCR_MAINREWARDRECEIVED = '#tooltips:personalMissions/operation/footer/descr/mainRewardReceived'
    ...
    PERSONALMISSIONS_OPERATION_FOOTER_DESCR_EXCELLENTDONE = '#tooltips:personalMissions/operation/footer/descr/excellentDone'
    PERSONALMISSIONS_OPERATION_FOOTER_ACTIVATECAMPAIGN_HEADER = '#tooltips:personalMissions/operation/footer/activateCampaign/header'
    PERSONALMISSIONS_OPERATION_FOOTER_ACTIVATECAMPAIGN_BODY = '#tooltips:personalMissions/operation/footer/activateCampaign/body'
    PERSONALMISSIONS_OPERATION_FOOTER_ACTIVATEMISSIONS_HEADER = '#tooltips:personalMissions/operation/footer/activateMissions/header'
    PERSONALMISSIONS_OPERATION_FOOTER_ACTIVATEMISSIONS_BODY = '#tooltips:personalMissions/operation/footer/activateMissions/body'
    ...
    PERSONALMISSIONS_MAPREGION_DESCR_DISABLED = '#tooltips:personalMissions/mapRegion/descr/disabled'
    ...
    PERSONALMISSIONS_MAPREGION_FOOTER_TITLE_ONPAUSE = '#tooltips:personalMissions/mapRegion/footer/title/onPause'
    ...
    PERSONALMISSIONS_STATUS_ONPAUSE_HEADER = '#tooltips:personalMissions/status/onPause/header'
    PERSONALMISSIONS_STATUS_ONPAUSE_BODY = '#tooltips:personalMissions/status/onPause/body'
    PERSONALMISSIONS_ONPAUSEBTN_TURNONPAUSE_HEADER = '#tooltips:personalMissions/onPauseBtn/turnOnPause/header'
    PERSONALMISSIONS_ONPAUSEBTN_TURNONPAUSE_BODY = '#tooltips:personalMissions/onPauseBtn/turnOnPause/body'
    PERSONALMISSIONS_ONPAUSEBTN_TURNOFFPAUSE_HEADER = '#tooltips:personalMissions/onPauseBtn/turnOffPause/header'
    PERSONALMISSIONS_ONPAUSEBTN_TURNOFFPAUSE_BODY = '#tooltips:personalMissions/onPauseBtn/turnOffPause/body'
    PERSONALMISSIONS_ONPAUSEBTN_DISABLED_HEADER = '#tooltips:personalMissions/onPauseBtn/disabled/header'
    PERSONALMISSIONS_ONPAUSEBTN_DISABLED_BODY = '#tooltips:personalMissions/onPauseBtn/disabled/body'
    ...
    SHOWDAMAGEICON_SPACEDARMORBLOCKED = '#tooltips:showDamageIcon/spacedArmorBlocked'
    SHOWDAMAGEICON_TRACKBLOCKED = '#tooltips:showDamageIcon/trackBlocked'
    SHOWDAMAGEICON_WHEELBLOCKED = '#tooltips:showDamageIcon/wheelBlocked'
    SHOWDAMAGEICON_MISSARMOR = '#tooltips:showDamageIcon/missArmor'
    ...
    STORAGE_FILTER_PERSONALRESERVES_BTNS_TYPE_COMBOEXP = '#tooltips:storage/filter/personalReserves/btns/type/comboExp'
    STORAGE_FILTER_PERSONALRESERVES_BTNS_TYPE_EXPIRABLE = '#tooltips:storage/filter/personalReserves/btns/type/expirable'
    STORAGE_FILTER_PERSONALRESERVES_BTNS_TYPE_NONEXPIRABLE = '#tooltips:storage/filter/personalReserves/btns/type/nonexpirable'
    STORAGE_FILTER_PERSONALRESERVES_BTNS_TYPE_PREMIUM = '#tooltips:storage/filter/personalReserves/btns/type/premium'
    ...
    NOTRECRUITEDTANKMAN_FREESKILLSTITLE = '#tooltips:notrecruitedtankman/freeSkillsTitle'
    ...
    NOTRECRUITEDTANKMAN_BASE_EVENT = '#tooltips:notrecruitedtankman/base/event'
    ...
    NOTRECRUITEDTANKMAN_CZECH_WOMAN_EVENT = '#tooltips:notrecruitedtankman/czech_woman/event'
    ...
    NOTRECRUITEDTANKMAN_TANKMAN_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankman/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_LABEL = '#tooltips:notrecruitedtankman/tankmen/label'
    NOTRECRUITEDTANKMAN_TANKMEN_DESC = '#tooltips:notrecruitedtankman/tankmen/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen/howToGetInfo'
    ...
    NOTRECRUITEDTANKMAN_TWITCH6_LABEL = '#tooltips:notrecruitedtankman/twitch6/label'
    NOTRECRUITEDTANKMAN_TWITCH6_DESC = '#tooltips:notrecruitedtankman/twitch6/desc'
    NOTRECRUITEDTANKMAN_TWITCH7_LABEL = '#tooltips:notrecruitedtankman/twitch7/label'
    NOTRECRUITEDTANKMAN_TWITCH7_DESC = '#tooltips:notrecruitedtankman/twitch7/desc'
    NOTRECRUITEDTANKMAN_TWITCH8_LABEL = '#tooltips:notrecruitedtankman/twitch8/label'
    ...
    NOTRECRUITEDTANKMAN_COMMANDER_STARLIGHT_LABEL = '#tooltips:notrecruitedtankman/commander_starlight/label'
    NOTRECRUITEDTANKMAN_COMMANDER_STARLIGHT_DESC = '#tooltips:notrecruitedtankman/commander_starlight/desc'
    NOTRECRUITEDTANKMAN_COMMANDER_MAEVE_LABEL = '#tooltips:notrecruitedtankman/commander_maeve/label'
    NOTRECRUITEDTANKMAN_COMMANDER_MAEVE_DESC = '#tooltips:notrecruitedtankman/commander_maeve/desc'
    NOTRECRUITEDTANKMAN_COMMANDER_OMELIA_LABEL = '#tooltips:notrecruitedtankman/commander_omelia/label'
    NOTRECRUITEDTANKMAN_COMMANDER_OMELIA_DESC = '#tooltips:notrecruitedtankman/commander_omelia/desc'
    NOTRECRUITEDTANKMAN_COMMANDER_DUKE_LABEL = '#tooltips:notrecruitedtankman/commander_duke/label'
    ...
    NOTRECRUITEDTANKMAN_COMMANDER_PATRICK_LABEL = '#tooltips:notrecruitedtankman/commander_patrick/label'
    NOTRECRUITEDTANKMAN_COMMANDER_PATRICK_DESC = '#tooltips:notrecruitedtankman/commander_patrick/desc'
    NOTRECRUITEDTANKMAN_NY20WOMAN_LABEL = '#tooltips:notrecruitedtankman/ny20woman/label'
    NOTRECRUITEDTANKMAN_NY20WOMAN_DESC = '#tooltips:notrecruitedtankman/ny20woman/desc'
    NOTRECRUITEDTANKMAN_NY20DEFAULTGIRL_LABEL = '#tooltips:notrecruitedtankman/ny20defaultGirl/label'
    NOTRECRUITEDTANKMAN_NY20DEFAULTGIRL_DESC = '#tooltips:notrecruitedtankman/ny20defaultGirl/desc'
    NOTRECRUITEDTANKMAN_NY20DEFAULTGIRL_HOWTOGETINFO = '#tooltips:notrecruitedtankman/ny20defaultGirl/howToGetInfo'
    NOTRECRUITEDTANKMAN_NY20DEFAULTGIRL_ADDITIONALALERT = '#tooltips:notrecruitedtankman/ny20defaultGirl/additionalAlert'
    NOTRECRUITEDTANKMAN_NY20MEN_LABEL = '#tooltips:notrecruitedtankman/ny20men/label'
    NOTRECRUITEDTANKMAN_NY20MEN_DESC = '#tooltips:notrecruitedtankman/ny20men/desc'
    NOTRECRUITEDTANKMAN_NY20MEN_HOWTOGETINFO = '#tooltips:notrecruitedtankman/ny20men/howToGetInfo'
    NOTRECRUITEDTANKMAN_NY20MEN_ADDITIONALALERT = '#tooltips:notrecruitedtankman/ny20men/additionalAlert'
    NOTRECRUITEDTANKMAN_NY20SNOWMEN_LABEL = '#tooltips:notrecruitedtankman/ny20snowmen/label'
    NOTRECRUITEDTANKMAN_NY20SNOWMEN_DESC = '#tooltips:notrecruitedtankman/ny20snowmen/desc'
    NOTRECRUITEDTANKMAN_NY20SNOWMEN_HOWTOGETINFO = '#tooltips:notrecruitedtankman/ny20snowmen/howToGetInfo'
    NOTRECRUITEDTANKMAN_NY20SNOWMEN_ADDITIONALALERT = '#tooltips:notrecruitedtankman/ny20snowmen/additionalAlert'
    NOTRECRUITEDTANKMAN_NY21MEN_LABEL = '#tooltips:notrecruitedtankman/ny21men/label'
    NOTRECRUITEDTANKMAN_NY21MEN_DESC = '#tooltips:notrecruitedtankman/ny21men/desc'
    NOTRECRUITEDTANKMAN_NY21WOMAN_LABEL = '#tooltips:notrecruitedtankman/ny21woman/label'
    NOTRECRUITEDTANKMAN_NY21WOMAN_DESC = '#tooltips:notrecruitedtankman/ny21woman/desc'
    NOTRECRUITEDTANKMAN_BOB20_COMMANDER1_RU_LABEL = '#tooltips:notrecruitedtankman/bob20_commander1_ru/label'
    NOTRECRUITEDTANKMAN_BOB20_COMMANDER1_RU_DESC = '#tooltips:notrecruitedtankman/bob20_commander1_ru/desc'
    NOTRECRUITEDTANKMAN_BOB20_COMMANDER2_RU_LABEL = '#tooltips:notrecruitedtankman/bob20_commander2_ru/label'
    NOTRECRUITEDTANKMAN_BOB20_COMMANDER2_RU_DESC = '#tooltips:notrecruitedtankman/bob20_commander2_ru/desc'
    NOTRECRUITEDTANKMAN_BOB20_COMMANDER3_RU_LABEL = '#tooltips:notrecruitedtankman/bob20_commander3_ru/label'
    NOTRECRUITEDTANKMAN_BOB20_COMMANDER3_RU_DESC = '#tooltips:notrecruitedtankman/bob20_commander3_ru/desc'
    NOTRECRUITEDTANKMAN_BOB20_COMMANDER4_RU_LABEL = '#tooltips:notrecruitedtankman/bob20_commander4_ru/label'
    NOTRECRUITEDTANKMAN_BOB20_COMMANDER4_RU_DESC = '#tooltips:notrecruitedtankman/bob20_commander4_ru/desc'
    NOTRECRUITEDTANKMAN_BOB20_COMMANDER1_EU_LABEL = '#tooltips:notrecruitedtankman/bob20_commander1_eu/label'
    NOTRECRUITEDTANKMAN_BOB20_COMMANDER1_EU_DESC = '#tooltips:notrecruitedtankman/bob20_commander1_eu/desc'
    NOTRECRUITEDTANKMAN_BOB20_COMMANDER2_EU_LABEL = '#tooltips:notrecruitedtankman/bob20_commander2_eu/label'
    NOTRECRUITEDTANKMAN_BOB20_COMMANDER2_EU_DESC = '#tooltips:notrecruitedtankman/bob20_commander2_eu/desc'
    NOTRECRUITEDTANKMAN_BOB20_COMMANDER3_EU_LABEL = '#tooltips:notrecruitedtankman/bob20_commander3_eu/label'
    NOTRECRUITEDTANKMAN_BOB20_COMMANDER3_EU_DESC = '#tooltips:notrecruitedtankman/bob20_commander3_eu/desc'
    NOTRECRUITEDTANKMAN_BOB20_COMMANDER4_EU_LABEL = '#tooltips:notrecruitedtankman/bob20_commander4_eu/label'
    NOTRECRUITEDTANKMAN_BOB20_COMMANDER4_EU_DESC = '#tooltips:notrecruitedtankman/bob20_commander4_eu/desc'
    NOTRECRUITEDTANKMAN_BOB20_COMMANDER1_NA_LABEL = '#tooltips:notrecruitedtankman/bob20_commander1_na/label'
    NOTRECRUITEDTANKMAN_BOB20_COMMANDER1_NA_DESC = '#tooltips:notrecruitedtankman/bob20_commander1_na/desc'
    NOTRECRUITEDTANKMAN_BOB20_COMMANDER2_NA_LABEL = '#tooltips:notrecruitedtankman/bob20_commander2_na/label'
    NOTRECRUITEDTANKMAN_BOB20_COMMANDER2_NA_DESC = '#tooltips:notrecruitedtankman/bob20_commander2_na/desc'
    NOTRECRUITEDTANKMAN_BOB20_COMMANDER1_ASIA_LABEL = '#tooltips:notrecruitedtankman/bob20_commander1_asia/label'
    NOTRECRUITEDTANKMAN_BOB20_COMMANDER1_ASIA_DESC = '#tooltips:notrecruitedtankman/bob20_commander1_asia/desc'
    NOTRECRUITEDTANKMAN_BOB20_COMMANDER2_ASIA_LABEL = '#tooltips:notrecruitedtankman/bob20_commander2_asia/label'
    ...
    NOTRECRUITEDTANKMAN_HW21_COMMANDER2_LABEL = '#tooltips:notrecruitedtankman/hw21_commander2/label'
    NOTRECRUITEDTANKMAN_HW21_COMMANDER2_DESC = '#tooltips:notrecruitedtankman/hw21_commander2/desc'
    NOTRECRUITEDTANKMAN_HW21_COMMANDER2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/hw21_commander2/howToGetInfo'
    NOTRECRUITEDTANKMAN_HW21_COMMANDER4_LABEL = '#tooltips:notrecruitedtankman/hw21_commander4/label'
    NOTRECRUITEDTANKMAN_HW21_COMMANDER4_DESC = '#tooltips:notrecruitedtankman/hw21_commander4/desc'
    NOTRECRUITEDTANKMAN_HW21_COMMANDER4_HOWTOGETINFO = '#tooltips:notrecruitedtankman/hw21_commander4/howToGetInfo'
    NOTRECRUITEDTANKMAN_HW21_COMMANDER5_LABEL = '#tooltips:notrecruitedtankman/hw21_commander5/label'
    NOTRECRUITEDTANKMAN_HW21_COMMANDER5_DESC = '#tooltips:notrecruitedtankman/hw21_commander5/desc'
    NOTRECRUITEDTANKMAN_HW21_COMMANDER5_HOWTOGETINFO = '#tooltips:notrecruitedtankman/hw21_commander5/howToGetInfo'
    NOTRECRUITEDTANKMAN_HW24_COMMANDER1_LABEL = '#tooltips:notrecruitedtankman/hw24_commander1/label'
    NOTRECRUITEDTANKMAN_HW24_COMMANDER1_DESC = '#tooltips:notrecruitedtankman/hw24_commander1/desc'
    NOTRECRUITEDTANKMAN_HW24_COMMANDER2_LABEL = '#tooltips:notrecruitedtankman/hw24_commander2/label'
    NOTRECRUITEDTANKMAN_HW24_COMMANDER2_DESC = '#tooltips:notrecruitedtankman/hw24_commander2/desc'
    NOTRECRUITEDTANKMAN_HW24_COMMANDER4_LABEL = '#tooltips:notrecruitedtankman/hw24_commander4/label'
    NOTRECRUITEDTANKMAN_HW24_COMMANDER4_DESC = '#tooltips:notrecruitedtankman/hw24_commander4/desc'
    NOTRECRUITEDTANKMAN_HW24_COMMANDER5_LABEL = '#tooltips:notrecruitedtankman/hw24_commander5/label'
    NOTRECRUITEDTANKMAN_HW24_COMMANDER5_DESC = '#tooltips:notrecruitedtankman/hw24_commander5/desc'
    NOTRECRUITEDTANKMAN_HW25_QUICKYBABY_LABEL = '#tooltips:notrecruitedtankman/hw25_Quickybaby/label'
    NOTRECRUITEDTANKMAN_HW25_QUICKYBABY_DESC = '#tooltips:notrecruitedtankman/hw25_Quickybaby/desc'
    NOTRECRUITEDTANKMAN_HW25_MAILAND_LABEL = '#tooltips:notrecruitedtankman/hw25_Mailand/label'
    NOTRECRUITEDTANKMAN_HW25_MAILAND_DESC = '#tooltips:notrecruitedtankman/hw25_Mailand/desc'
    NOTRECRUITEDTANKMAN_HW25_MOUZAKROBAT_LABEL = '#tooltips:notrecruitedtankman/hw25_MouzAkrobat/label'
    NOTRECRUITEDTANKMAN_HW25_MOUZAKROBAT_DESC = '#tooltips:notrecruitedtankman/hw25_MouzAkrobat/desc'
    NOTRECRUITEDTANKMAN_HW25_SKILL4LTU_LABEL = '#tooltips:notrecruitedtankman/hw25_Skill4ltu/label'
    NOTRECRUITEDTANKMAN_HW25_SKILL4LTU_DESC = '#tooltips:notrecruitedtankman/hw25_Skill4ltu/desc'
    NOTRECRUITEDTANKMAN_HW25_LUJUN_CN_LABEL = '#tooltips:notrecruitedtankman/hw25_LuJun_CN/label'
    NOTRECRUITEDTANKMAN_HW25_LUJUN_CN_DESC = '#tooltips:notrecruitedtankman/hw25_LuJun_CN/desc'
    NOTRECRUITEDTANKMAN_HW25_TITI_CN_LABEL = '#tooltips:notrecruitedtankman/hw25_Titi_CN/label'
    NOTRECRUITEDTANKMAN_HW25_TITI_CN_DESC = '#tooltips:notrecruitedtankman/hw25_Titi_CN/desc'
    NOTRECRUITEDTANKMAN_HW25_DAKUN_CN_LABEL = '#tooltips:notrecruitedtankman/hw25_DaKun_CN/label'
    NOTRECRUITEDTANKMAN_HW25_DAKUN_CN_DESC = '#tooltips:notrecruitedtankman/hw25_DaKun_CN/desc'
    NOTRECRUITEDTANKMAN_HW25_PANCHEZHANG_CN_LABEL = '#tooltips:notrecruitedtankman/hw25_Panchezhang_CN/label'
    NOTRECRUITEDTANKMAN_HW25_PANCHEZHANG_CN_DESC = '#tooltips:notrecruitedtankman/hw25_Panchezhang_CN/desc'
    NOTRECRUITEDTANKMAN_COMMANDER_BP1_LABEL = '#tooltips:notrecruitedtankman/commander_bp1/label'
    NOTRECRUITEDTANKMAN_COMMANDER_BP1_DESC = '#tooltips:notrecruitedtankman/commander_bp1/desc'
    NOTRECRUITEDTANKMAN_COMMANDER_BP1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/commander_bp1/howToGetInfo'
    NOTRECRUITEDTANKMAN_COMMANDER_BP2_LABEL = '#tooltips:notrecruitedtankman/commander_bp2/label'
    NOTRECRUITEDTANKMAN_COMMANDER_BP2_DESC = '#tooltips:notrecruitedtankman/commander_bp2/desc'
    NOTRECRUITEDTANKMAN_COMMANDER_BP2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/commander_bp2/howToGetInfo'
    NOTRECRUITEDTANKMAN_BP_COMMANDER_1_1_LABEL = '#tooltips:notrecruitedtankman/bp-commander-1_1/label'
    NOTRECRUITEDTANKMAN_BP_COMMANDER_1_1_DESC = '#tooltips:notrecruitedtankman/bp-commander-1_1/desc'
    NOTRECRUITEDTANKMAN_BP_COMMANDER_1_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/bp-commander-1_1/howToGetInfo'
    ...
    NOTRECRUITEDTANKMAN_COMMANDER_BINGO_LABEL = '#tooltips:notrecruitedtankman/commander_bingo/label'
    NOTRECRUITEDTANKMAN_COMMANDER_BINGO_DESC = '#tooltips:notrecruitedtankman/commander_bingo/desc'
    NOTRECRUITEDTANKMAN_COMMANDER_BARONESS_LABEL = '#tooltips:notrecruitedtankman/commander_baroness/label'
    NOTRECRUITEDTANKMAN_COMMANDER_BARONESS_DESC = '#tooltips:notrecruitedtankman/commander_baroness/desc'
    NOTRECRUITEDTANKMAN_COMMANDER_COVER_GIRL_LABEL = '#tooltips:notrecruitedtankman/commander_cover_girl/label'
    NOTRECRUITEDTANKMAN_COMMANDER_COVER_GIRL_DESC = '#tooltips:notrecruitedtankman/commander_cover_girl/desc'
    ...
    NOTRECRUITEDTANKMAN_COMMANDER_NANSEN_LABEL = '#tooltips:notrecruitedtankman/commander_nansen/label'
    NOTRECRUITEDTANKMAN_COMMANDER_NANSEN_DESC = '#tooltips:notrecruitedtankman/commander_nansen/desc'
    NOTRECRUITEDTANKMAN_COMMANDER_HILLEN_LABEL = '#tooltips:notrecruitedtankman/commander_hillen/label'
    NOTRECRUITEDTANKMAN_COMMANDER_HILLEN_DESC = '#tooltips:notrecruitedtankman/commander_hillen/desc'
    NOTRECRUITEDTANKMAN_COMMANDER_HOB_LABEL = '#tooltips:notrecruitedtankman/commander_hob/label'
    ...
    NOTRECRUITEDTANKMAN_COMMANDER_TWITCH50_LABEL = '#tooltips:notrecruitedtankman/commander_twitch50/label'
    NOTRECRUITEDTANKMAN_COMMANDER_TWITCH50_DESC = '#tooltips:notrecruitedtankman/commander_twitch50/desc'
    NOTRECRUITEDTANKMAN_POLISH_COMMANDER_LABEL = '#tooltips:notrecruitedtankman/polish_commander/label'
    NOTRECRUITEDTANKMAN_POLISH_COMMANDER_DESC = '#tooltips:notrecruitedtankman/polish_commander/desc'
    ...
    NOTRECRUITEDTANKMAN_OOW21_STRATEGIST_COMMANDER_EVENT = '#tooltips:notrecruitedtankman/oow21_strategist_commander/event'
    NOTRECRUITEDTANKMAN_OOW21_STRATEGIST_COMMANDER_DESC = '#tooltips:notrecruitedtankman/oow21_strategist_commander/desc'
    NOTRECRUITEDTANKMAN_OOW21_STRATEGIST_COMMANDER_LABEL = '#tooltips:notrecruitedtankman/oow21_strategist_commander/label'
    NOTRECRUITEDTANKMAN_OOW21_TANKER_1_COMMANDER_EVENT = '#tooltips:notrecruitedtankman/oow21_tanker_1_commander/event'
    NOTRECRUITEDTANKMAN_OOW21_TANKER_1_COMMANDER_DESC = '#tooltips:notrecruitedtankman/oow21_tanker_1_commander/desc'
    NOTRECRUITEDTANKMAN_OOW21_TANKER_1_COMMANDER_LABEL = '#tooltips:notrecruitedtankman/oow21_tanker_1_commander/label'
    NOTRECRUITEDTANKMAN_OOW21_TANKER_2_COMMANDER_EVENT = '#tooltips:notrecruitedtankman/oow21_tanker_2_commander/event'
    NOTRECRUITEDTANKMAN_OOW21_TANKER_2_COMMANDER_DESC = '#tooltips:notrecruitedtankman/oow21_tanker_2_commander/desc'
    NOTRECRUITEDTANKMAN_OOW21_TANKER_2_COMMANDER_LABEL = '#tooltips:notrecruitedtankman/oow21_tanker_2_commander/label'
    NOTRECRUITEDTANKMAN_OOW21_TANKER_3_COMMANDER_EVENT = '#tooltips:notrecruitedtankman/oow21_tanker_3_commander/event'
    NOTRECRUITEDTANKMAN_OOW21_TANKER_3_COMMANDER_DESC = '#tooltips:notrecruitedtankman/oow21_tanker_3_commander/desc'
    NOTRECRUITEDTANKMAN_OOW21_TANKER_3_COMMANDER_LABEL = '#tooltips:notrecruitedtankman/oow21_tanker_3_commander/label'
    ...
    FRONTLINEPACKPREVIEW_HEADER = '#tooltips:frontlinePackPreview/header'
    FRONTLINEPACKPREVIEW_BODY = '#tooltips:frontlinePackPreview/body'
    FRONTLINEPACKPREVIEW_TRADEINBODY = '#tooltips:frontlinePackPreview/tradeInBody'
    FRONTLINEPACKPREVIEW_DISCOUNT = '#tooltips:frontlinePackPreview/discount'
    FRONTLINEPACKPREVIEW_GIFT = '#tooltips:frontlinePackPreview/gift'
    FRONTLINERANK_HEADER = '#tooltips:frontlineRank/header'
    FRONTLINERANK_FIRSTRANKDESCR = '#tooltips:frontlineRank/firstRankDescr'
    FRONTLINERANK_EXP = '#tooltips:frontlineRank/exp'
    ...
    SQUADBONUS_COMPLEX_DEFAULT_HEADER = '#tooltips:squadBonus/complex/default/header'
    SQUADBONUS_COMPLEX_DEFAULT_BODY = '#tooltips:squadBonus/complex/default/body'
    ...
    CREWBOOKS_STORAGE_FILTERS_UNIVERSALBOOK_TITLE = '#tooltips:crewBooks/storage/filters/universalBook/title'
    ...
    CUSTOMIZATION_STORAGE_FILTERS_STYLE_TITLE = '#tooltips:customization/storage/filters/style/title'
    CUSTOMIZATION_STORAGE_FILTERS_PAINTS_TITLE = '#tooltips:customization/storage/filters/paints/title'
    CUSTOMIZATION_STORAGE_FILTERS_CAMOUFLAGE_TITLE = '#tooltips:customization/storage/filters/camouflage/title'
    CUSTOMIZATION_STORAGE_FILTERS_DECALS_TITLE = '#tooltips:customization/storage/filters/decals/title'
    ...
    CUSTOMIZATION_STORAGE_FILTERS_STATTRACKERS_TITLE = '#tooltips:customization/storage/filters/statTrackers/title'
    ...
    BATTLEPASSOFFER_ALLNATIONS = '#tooltips:battlePassOffer/allNations'
    BATTLEPASSOFFER_BLUEPRINTINFO = '#tooltips:battlePassOffer/blueprintInfo'
    BATTLEPASSOFFER_CREWBOOKINFO = '#tooltips:battlePassOffer/crewBookInfo'
    BATTLEPASSOFFER_POINT = '#tooltips:battlePassOffer/point'
    BATTLEPASSOFFER_ETC = '#tooltips:battlePassOffer/etc'
    BATTLEPASSOFFER_TITLE_TROPHY_GIFT = '#tooltips:battlePassOffer/title/trophy_gift'
    BATTLEPASSOFFER_FOOTER_TROPHY_GIFT = '#tooltips:battlePassOffer/footer/trophy_gift'
    BATTLEPASSOFFER_TITLE_NEW_DEVICE_GIFT = '#tooltips:battlePassOffer/title/new_device_gift'
    BATTLEPASSOFFER_FOOTER_NEW_DEVICE_GIFT = '#tooltips:battlePassOffer/footer/new_device_gift'
    ...
    BATTLEPASSOFFER_TITLE_BROCHURE_GIFT = '#tooltips:battlePassOffer/title/brochure_gift'
    ...
    BATTLEPASSOFFER_TITLE_CREWBOOK_GIFT = '#tooltips:battlePassOffer/title/crewbook_gift'
    BATTLEPASSOFFER_FOOTER_CREWBOOK_GIFT = '#tooltips:battlePassOffer/footer/crewbook_gift'
    BATTLEPASSOFFER_TITLE_MODERNIZED_DEVICE_GIFT = '#tooltips:battlePassOffer/title/modernized_device_gift'
    BATTLEPASSOFFER_FOOTER_MODERNIZED_DEVICE_GIFT = '#tooltips:battlePassOffer/footer/modernized_device_gift'
    BATTLEPASSOFFER_TITLE_BATTLE_BOOSTER_GIFT = '#tooltips:battlePassOffer/title/battle_booster_gift'
    BATTLEPASSOFFER_FOOTER_BATTLE_BOOSTER_GIFT = '#tooltips:battlePassOffer/footer/battle_booster_gift'
    ...
    BATTLE_ROYALE_HANGAR_VEHICLE_DESCRIPTION_FRANCE = '#tooltips:battle_royale/hangar/vehicle/description/france'
    BATTLE_ROYALE_HANGAR_VEHICLE_DESCRIPTION_UK = '#tooltips:battle_royale/hangar/vehicle/description/uk'
    ...
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_RU1_YUSHA_LABEL = '#tooltips:notrecruitedtankman/bob21_commander_ru1_Yusha/label'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_RU1_YUSHA_DESC = '#tooltips:notrecruitedtankman/bob21_commander_ru1_Yusha/desc'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_RU1_VSPISHKA_LABEL = '#tooltips:notrecruitedtankman/bob21_commander_ru1_Vspishka/label'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_RU1_VSPISHKA_DESC = '#tooltips:notrecruitedtankman/bob21_commander_ru1_Vspishka/desc'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_RU2_AMWAY921_LABEL = '#tooltips:notrecruitedtankman/bob21_commander_ru2_Amway921/label'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_RU2_AMWAY921_DESC = '#tooltips:notrecruitedtankman/bob21_commander_ru2_Amway921/desc'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_RU2_KORBENDAILAS_LABEL = '#tooltips:notrecruitedtankman/bob21_commander_ru2_Korbendailas/label'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_RU2_KORBENDAILAS_DESC = '#tooltips:notrecruitedtankman/bob21_commander_ru2_Korbendailas/desc'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_RU3_LEBWA_LABEL = '#tooltips:notrecruitedtankman/bob21_commander_ru3_Lebwa/label'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_RU3_LEBWA_DESC = '#tooltips:notrecruitedtankman/bob21_commander_ru3_Lebwa/desc'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_RU3_INSPIRER_LABEL = '#tooltips:notrecruitedtankman/bob21_commander_ru3_Inspirer/label'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_RU3_INSPIRER_DESC = '#tooltips:notrecruitedtankman/bob21_commander_ru3_Inspirer/desc'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_RU4_EVILGRANNY_LABEL = '#tooltips:notrecruitedtankman/bob21_commander_ru4_Evilgranny/label'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_RU4_EVILGRANNY_DESC = '#tooltips:notrecruitedtankman/bob21_commander_ru4_Evilgranny/desc'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_RU4_NEARYOU_LABEL = '#tooltips:notrecruitedtankman/bob21_commander_ru4_Nearyou/label'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_RU4_NEARYOU_DESC = '#tooltips:notrecruitedtankman/bob21_commander_ru4_Nearyou/desc'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_EU1_CIRCON_LABEL = '#tooltips:notrecruitedtankman/bob21_commander_eu1_Circon/label'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_EU1_CIRCON_DESC = '#tooltips:notrecruitedtankman/bob21_commander_eu1_Circon/desc'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_EU2_DAKILLZOR_LABEL = '#tooltips:notrecruitedtankman/bob21_commander_eu2_Dakillzor/label'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_EU2_DAKILLZOR_DESC = '#tooltips:notrecruitedtankman/bob21_commander_eu2_Dakillzor/desc'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_EU3_NEWMULTI2K_LABEL = '#tooltips:notrecruitedtankman/bob21_commander_eu3_Newmulti2k/label'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_EU3_NEWMULTI2K_DESC = '#tooltips:notrecruitedtankman/bob21_commander_eu3_Newmulti2k/desc'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_EU4_ORZANEL_LABEL = '#tooltips:notrecruitedtankman/bob21_commander_eu4_Orzanel/label'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_EU4_ORZANEL_DESC = '#tooltips:notrecruitedtankman/bob21_commander_eu4_Orzanel/desc'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_NA1_CABBAGEMECHANIC_LABEL = '#tooltips:notrecruitedtankman/bob21_commander_na1_Cabbagemechanic/label'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_NA1_CABBAGEMECHANIC_DESC = '#tooltips:notrecruitedtankman/bob21_commander_na1_Cabbagemechanic/desc'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_NA2_TRAGICLOSS_LABEL = '#tooltips:notrecruitedtankman/bob21_commander_na2_Tragicloss/label'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_NA2_TRAGICLOSS_DESC = '#tooltips:notrecruitedtankman/bob21_commander_na2_Tragicloss/desc'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_NA3_CMDRAF_LABEL = '#tooltips:notrecruitedtankman/bob21_commander_na3_Cmdraf/label'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_NA3_CMDRAF_DESC = '#tooltips:notrecruitedtankman/bob21_commander_na3_Cmdraf/desc'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_ASIA1_MASTERTORTOISE_LABEL = '#tooltips:notrecruitedtankman/bob21_commander_asia1_Mastertortoise/label'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_ASIA1_MASTERTORTOISE_DESC = '#tooltips:notrecruitedtankman/bob21_commander_asia1_Mastertortoise/desc'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_ASIA2_SUMMERTIGER_LABEL = '#tooltips:notrecruitedtankman/bob21_commander_asia2_Summertiger/label'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_ASIA2_SUMMERTIGER_DESC = '#tooltips:notrecruitedtankman/bob21_commander_asia2_Summertiger/desc'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_ASIA3_MAHARLIKA_LABEL = '#tooltips:notrecruitedtankman/bob21_commander_asia3_Maharlika/label'
    NOTRECRUITEDTANKMAN_BOB21_COMMANDER_ASIA3_MAHARLIKA_DESC = '#tooltips:notrecruitedtankman/bob21_commander_asia3_Maharlika/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP3_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp3_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP3_1_DESC = '#tooltips:notrecruitedtankman/tankmen_bp3_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP3_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp3_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP3_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp3_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP3_2_DESC = '#tooltips:notrecruitedtankman/tankmen_bp3_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP3_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp3_2/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP3_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp3_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP3_3_DESC = '#tooltips:notrecruitedtankman/tankmen_bp3_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP3_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp3_3/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP5_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp5_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP5_1_DESC = '#tooltips:notrecruitedtankman/tankmen_bp5_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP5_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp5_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP5_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp5_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP5_2_DESC = '#tooltips:notrecruitedtankman/tankmen_bp5_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP5_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp5_2/howToGetInfo'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_BP7_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp7_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP7_1_DESC = '#tooltips:notrecruitedtankman/tankmen_bp7_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP7_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp7_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP7_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp7_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP7_2_DESC = '#tooltips:notrecruitedtankman/tankmen_bp7_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP7_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp7_2/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP7_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp7_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP7_3_DESC = '#tooltips:notrecruitedtankman/tankmen_bp7_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP7_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp7_3/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP7_4_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp7_4/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP7_4_DESC = '#tooltips:notrecruitedtankman/tankmen_bp7_4/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP7_4_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp7_4/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP8_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp8_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP8_1_DESC = '#tooltips:notrecruitedtankman/tankmen_bp8_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP8_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp8_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP8_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp8_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP8_2_DESC = '#tooltips:notrecruitedtankman/tankmen_bp8_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP8_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp8_2/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP8_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp8_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP8_3_DESC = '#tooltips:notrecruitedtankman/tankmen_bp8_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP8_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp8_3/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP8_4_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp8_4/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP8_4_DESC = '#tooltips:notrecruitedtankman/tankmen_bp8_4/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP8_4_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp8_4/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP8_5_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp8_5/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP8_5_DESC = '#tooltips:notrecruitedtankman/tankmen_bp8_5/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP8_5_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp8_5/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP8_6_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp8_6/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP8_6_DESC = '#tooltips:notrecruitedtankman/tankmen_bp8_6/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP8_6_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp8_6/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP8_7_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp8_7/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP8_7_DESC = '#tooltips:notrecruitedtankman/tankmen_bp8_7/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP8_7_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp8_7/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP8_8_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp8_8/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP8_8_DESC = '#tooltips:notrecruitedtankman/tankmen_bp8_8/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP8_8_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp8_8/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP9_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp9_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP9_1_DESC = '#tooltips:notrecruitedtankman/tankmen_bp9_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP9_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp9_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP9_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp9_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP9_2_DESC = '#tooltips:notrecruitedtankman/tankmen_bp9_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP9_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp9_2/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP9_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp9_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP9_3_DESC = '#tooltips:notrecruitedtankman/tankmen_bp9_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP9_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp9_3/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP10_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp10_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP10_1_DESC = '#tooltips:notrecruitedtankman/tankmen_bp10_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP10_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp10_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP10_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp10_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP10_2_DESC = '#tooltips:notrecruitedtankman/tankmen_bp10_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP10_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp10_2/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP10_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp10_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP10_3_DESC = '#tooltips:notrecruitedtankman/tankmen_bp10_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP10_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp10_3/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BPH_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_bph_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BPH_1_DESC = '#tooltips:notrecruitedtankman/tankmen_bph_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BPH_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bph_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BPH_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_bph_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BPH_2_DESC = '#tooltips:notrecruitedtankman/tankmen_bph_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BPH_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bph_2/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BPH_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_bph_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BPH_3_DESC = '#tooltips:notrecruitedtankman/tankmen_bph_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BPH_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bph_3/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BPH_4_LABEL = '#tooltips:notrecruitedtankman/tankmen_bph_4/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BPH_4_DESC = '#tooltips:notrecruitedtankman/tankmen_bph_4/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BPH_4_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bph_4/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP11_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp11_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP11_1_DESC = '#tooltips:notrecruitedtankman/tankmen_bp11_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP11_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp11_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP11_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp11_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP11_2_DESC = '#tooltips:notrecruitedtankman/tankmen_bp11_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP11_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp11_2/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP11_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp11_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP11_3_DESC = '#tooltips:notrecruitedtankman/tankmen_bp11_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP11_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp11_3/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP11_4_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp11_4/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP11_4_DESC = '#tooltips:notrecruitedtankman/tankmen_bp11_4/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP11_4_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp11_4/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp12_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_1_DESC = '#tooltips:notrecruitedtankman/tankmen_bp12_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp12_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp12_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_2_DESC = '#tooltips:notrecruitedtankman/tankmen_bp12_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp12_2/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp12_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_3_DESC = '#tooltips:notrecruitedtankman/tankmen_bp12_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp12_3/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_4_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp12_4/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_4_DESC = '#tooltips:notrecruitedtankman/tankmen_bp12_4/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_4_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp12_4/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_5_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp12_5/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_5_DESC = '#tooltips:notrecruitedtankman/tankmen_bp12_5/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_5_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp12_5/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_6_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp12_6/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_6_DESC = '#tooltips:notrecruitedtankman/tankmen_bp12_6/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_6_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp12_6/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_7_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp12_7/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_7_DESC = '#tooltips:notrecruitedtankman/tankmen_bp12_7/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_7_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp12_7/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1003_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp1003_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1003_1_DESC = '#tooltips:notrecruitedtankman/tankmen_bp1003_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1003_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp1003_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_8_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp12_8/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_8_DESC = '#tooltips:notrecruitedtankman/tankmen_bp12_8/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_8_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp12_8/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_9_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp12_9/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_9_DESC = '#tooltips:notrecruitedtankman/tankmen_bp12_9/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_9_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp12_9/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_10_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp12_10/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_10_DESC = '#tooltips:notrecruitedtankman/tankmen_bp12_10/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP12_10_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp12_10/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1002_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp1002_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1002_1_DESC = '#tooltips:notrecruitedtankman/tankmen_bp1002_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1002_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp1002_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1002_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp1002_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1002_2_DESC = '#tooltips:notrecruitedtankman/tankmen_bp1002_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1002_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp1002_2/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1002_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp1002_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1002_3_DESC = '#tooltips:notrecruitedtankman/tankmen_bp1002_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1002_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp1002_3/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1002_4_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp1002_4/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1002_4_DESC = '#tooltips:notrecruitedtankman/tankmen_bp1002_4/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1002_4_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp1002_4/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1002_5_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp1002_5/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1002_5_DESC = '#tooltips:notrecruitedtankman/tankmen_bp1002_5/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1002_5_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp1002_5/howToGetInfo'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P3_1_LABEL = '#tooltips:notrecruitedtankman/onslaught_p3_1/label'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P3_1_DESC = '#tooltips:notrecruitedtankman/onslaught_p3_1/desc'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P3_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/onslaught_p3_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P3_2_LABEL = '#tooltips:notrecruitedtankman/onslaught_p3_2/label'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P3_2_DESC = '#tooltips:notrecruitedtankman/onslaught_p3_2/desc'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P3_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/onslaught_p3_2/howToGetInfo'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P3_3_LABEL = '#tooltips:notrecruitedtankman/onslaught_p3_3/label'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P3_3_DESC = '#tooltips:notrecruitedtankman/onslaught_p3_3/desc'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P3_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/onslaught_p3_3/howToGetInfo'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P3_4_LABEL = '#tooltips:notrecruitedtankman/onslaught_p3_4/label'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P3_4_DESC = '#tooltips:notrecruitedtankman/onslaught_p3_4/desc'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P3_4_HOWTOGETINFO = '#tooltips:notrecruitedtankman/onslaught_p3_4/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP13_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp13_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP13_1_DESC = '#tooltips:notrecruitedtankman/tankmen_bp13_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP13_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp13_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP13_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp13_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP13_2_DESC = '#tooltips:notrecruitedtankman/tankmen_bp13_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP13_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp13_2/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP13_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp13_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP13_3_DESC = '#tooltips:notrecruitedtankman/tankmen_bp13_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP13_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp13_3/howToGetInfo'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_BP13_4_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp13_4/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP13_5_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp13_5/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP13_5_DESC = '#tooltips:notrecruitedtankman/tankmen_bp13_5/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP13_5_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp13_5/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP13_6_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp13_6/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP13_6_DESC = '#tooltips:notrecruitedtankman/tankmen_bp13_6/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP13_6_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp13_6/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP13_7_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp13_7/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP13_7_DESC = '#tooltips:notrecruitedtankman/tankmen_bp13_7/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP13_7_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp13_7/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP13_8_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp13_8/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP13_8_DESC = '#tooltips:notrecruitedtankman/tankmen_bp13_8/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP13_8_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp13_8/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP13_9_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp13_9/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP13_9_DESC = '#tooltips:notrecruitedtankman/tankmen_bp13_9/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP13_9_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp13_9/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp14_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_1_DESC = '#tooltips:notrecruitedtankman/tankmen_bp14_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp14_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp14_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_2_DESC = '#tooltips:notrecruitedtankman/tankmen_bp14_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp14_2/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp14_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_3_DESC = '#tooltips:notrecruitedtankman/tankmen_bp14_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp14_3/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_4_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp14_4/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_4_DESC = '#tooltips:notrecruitedtankman/tankmen_bp14_4/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_4_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp14_4/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_5_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp14_5/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_5_DESC = '#tooltips:notrecruitedtankman/tankmen_bp14_5/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_5_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp14_5/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_6_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp14_6/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_6_DESC = '#tooltips:notrecruitedtankman/tankmen_bp14_6/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP14_6_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp14_6/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_AUC_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_auc_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_AUC_1_DESC = '#tooltips:notrecruitedtankman/tankmen_auc_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_AUC_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_auc_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_AUC_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_auc_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_AUC_2_DESC = '#tooltips:notrecruitedtankman/tankmen_auc_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_AUC_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_auc_2/howToGetInfo'
    ...
    DEMONSTRATOR_PLATOONWARNING_BODY = '#tooltips:demonstrator/platoonWarning/body'
    SELECTABLECREWBOOK_GUIDE_FOOTER = '#tooltips:selectableCrewbook/guide/footer'
    SELECTABLECREWBOOK_BROCHURE_FOOTER = '#tooltips:selectableCrewbook/brochure/footer'
    SELECTABLECREWBOOK_GUIDE_TITLE = '#tooltips:selectableCrewbook/guide/title'
    SELECTABLECREWBOOK_BROCHURE_TITLE = '#tooltips:selectableCrewbook/brochure/title'
    SELECTABLECREWBOOK_ALLNATIONS = '#tooltips:selectableCrewbook/allNations'
    SELECTABLECREWBOOK_INFO = '#tooltips:selectableCrewbook/info'
    RANDOMCREWBOOK_GUIDE_HEADER = '#tooltips:randomCrewbook/guide/header'
    RANDOMCREWBOOK_BROCHURE_HEADER = '#tooltips:randomCrewbook/brochure/header'
    RANDOMCREWBOOK_BODY = '#tooltips:randomCrewbook/body'
    CONFIRMEMAILTOOLTIP_TITLE_NOTCONFIRMED = '#tooltips:confirmEmailTooltip/title/notConfirmed'
    CONFIRMEMAILTOOLTIP_SUBTITLE_NOTCONFIRMED = '#tooltips:confirmEmailTooltip/subtitle/notConfirmed'
    CONFIRMEMAILTOOLTIP_REWARDTITLE = '#tooltips:confirmEmailTooltip/rewardTitle'
    CONFIRMEMAILTOOLTIP_TITLE_CONFIRMED = '#tooltips:confirmEmailTooltip/title/confirmed'
    CONFIRMEMAILTOOLTIP_SUBTITLE_CONFIRMED = '#tooltips:confirmEmailTooltip/subtitle/confirmed'
    ACCOUNTCOMPLETIONHANGAR_SIMPLE_TITLE = '#tooltips:accountCompletionHangar/simple/title'
    ACCOUNTCOMPLETIONHANGAR_SIMPLE_TEXT = '#tooltips:accountCompletionHangar/simple/text'
    ACCOUNTCOMPLETION_EMAIL_TITLETOOLTIP = '#tooltips:accountCompletion/email/titleTooltip'
    ...
    MODE_SELECTOR_INFO_BODY = '#tooltips:mode_selector/info/body'
    MODE_SELECTOR_PROGRESSIONBTN_BODY = '#tooltips:mode_selector/progressionBtn/body'
    MODE_SELECTOR_RANKED_BONUS_HEADER = '#tooltips:mode_selector/ranked/bonus/header'
    MODE_SELECTOR_RANKED_BONUS_AVAILABLE = '#tooltips:mode_selector/ranked/bonus/available'
    MODE_SELECTOR_RANKED_BONUS_DESCRIPTION = '#tooltips:mode_selector/ranked/bonus/description'
    MODE_SELECTOR_RANKED_QUALIFICATION_HEADER = '#tooltips:mode_selector/ranked/qualification/header'
    MODE_SELECTOR_RANKED_QUALIFICATION_DESCRIPTION = '#tooltips:mode_selector/ranked/qualification/description'
    BLUEPRINTS_CONVERSIONVIEW_ICON_NOTENOUGHFRAGMENTS = '#tooltips:blueprints/conversionView/icon/notEnoughFragments'
    BLUEPRINTS_CONVERSIONVIEW_CONFIRM_NOTENOUGHFRAGMENTS = '#tooltips:blueprints/conversionView/confirm/notEnoughFragments'
    BLUEPRINTS_CONVERSIONVIEW_TITLE = '#tooltips:blueprints/conversionView/title'
    BLUEPRINTS_CONVERSIONVIEW_ALLIANCE_TITLE_NAME_ALLIANCE_USSR = '#tooltips:blueprints/conversionView/alliance/title/name/Alliance-USSR'
    BLUEPRINTS_CONVERSIONVIEW_ALLIANCE_TITLE_NAME_ALLIANCE_GERMANY = '#tooltips:blueprints/conversionView/alliance/title/name/Alliance-Germany'
    BLUEPRINTS_CONVERSIONVIEW_ALLIANCE_TITLE_NAME_ALLIANCE_USA = '#tooltips:blueprints/conversionView/alliance/title/name/Alliance-USA'
    BLUEPRINTS_CONVERSIONVIEW_ALLIANCE_TITLE_NAME_ALLIANCE_FRANCE = '#tooltips:blueprints/conversionView/alliance/title/name/Alliance-France'
    BLUEPRINTS_CONVERSIONVIEW_SUBTITLE = '#tooltips:blueprints/conversionView/subTitle'
    BLUEPRINTS_CONVERSIONVIEW_DESC = '#tooltips:blueprints/conversionView/desc'
    BLUEPRINTS_CONVERSIONVIEW_ALLIANCE_DESC_NAME_ALLIANCE_USSR = '#tooltips:blueprints/conversionView/alliance/desc/name/Alliance-USSR'
    BLUEPRINTS_CONVERSIONVIEW_ALLIANCE_DESC_NAME_ALLIANCE_GERMANY = '#tooltips:blueprints/conversionView/alliance/desc/name/Alliance-Germany'
    BLUEPRINTS_CONVERSIONVIEW_ALLIANCE_DESC_NAME_ALLIANCE_USA = '#tooltips:blueprints/conversionView/alliance/desc/name/Alliance-USA'
    BLUEPRINTS_CONVERSIONVIEW_ALLIANCE_DESC_NAME_ALLIANCE_FRANCE = '#tooltips:blueprints/conversionView/alliance/desc/name/Alliance-France'
    BLUEPRINTS_CONVERSIONVIEW_ALLIANCE_NATIONS_ALLIANCE_USSR = '#tooltips:blueprints/conversionView/alliance/nations/Alliance-USSR'
    BLUEPRINTS_CONVERSIONVIEW_ALLIANCE_NATIONS_ALLIANCE_GERMANY = '#tooltips:blueprints/conversionView/alliance/nations/Alliance-Germany'
    BLUEPRINTS_CONVERSIONVIEW_ALLIANCE_NATIONS_ALLIANCE_USA = '#tooltips:blueprints/conversionView/alliance/nations/Alliance-USA'
    BLUEPRINTS_CONVERSIONVIEW_ALLIANCE_NATIONS_ALLIANCE_FRANCE = '#tooltips:blueprints/conversionView/alliance/nations/Alliance-France'
    BLUEPRINTS_CONVERSIONVIEW_CONTENT_TITLE = '#tooltips:blueprints/conversionView/content/title'
    BLUEPRINTS_CONVERSIONVIEW_CONTENT_FIRST_TITLE = '#tooltips:blueprints/conversionView/content/first/title'
    BLUEPRINTS_CONVERSIONVIEW_CONTENT_FIRST_BODY = '#tooltips:blueprints/conversionView/content/first/body'
    BLUEPRINTS_CONVERSIONVIEW_CONTENT_SECOND = '#tooltips:blueprints/conversionView/content/second'
    BLUEPRINTS_CONVERSIONVIEW_CONTENT_FRAGMENTAMOUNT = '#tooltips:blueprints/conversionView/content/fragmentAmount'
    BLUEPRINTS_CONVERSIONVIEW_ALLIANCE_CONTENT_NAME_ALLIANCE_USSR = '#tooltips:blueprints/conversionView/alliance/content/name/Alliance-USSR'
    BLUEPRINTS_CONVERSIONVIEW_ALLIANCE_CONTENT_NAME_ALLIANCE_GERMANY = '#tooltips:blueprints/conversionView/alliance/content/name/Alliance-Germany'
    ...
    COMMON_NOTENOUGH = '#tooltips:common/notEnough'
    ...
    IDLE_CREW_TOOLTIP_STATUS_UNAVAILABLE_DESCRIPTION_POSTPROGRESSIONREACHED = '#tooltips:idle_crew_tooltip/status/unavailable/description/postProgressionReached'
    ...
    PREBATTLE_READYBUTTON_VEHICLESREQUIRED3_BODY = '#tooltips:prebattle/readyButton/vehiclesRequired3/body'
    ...
    NOTRECRUITEDTANKMAN_NY22MEN_A_LABEL = '#tooltips:notrecruitedtankman/ny22men_A/label'
    NOTRECRUITEDTANKMAN_NY22MEN_A_DESC = '#tooltips:notrecruitedtankman/ny22men_A/desc'
    NOTRECRUITEDTANKMAN_NY22MEN_LABEL = '#tooltips:notrecruitedtankman/ny22men/label'
    NOTRECRUITEDTANKMAN_NY22MEN_DESC = '#tooltips:notrecruitedtankman/ny22men/desc'
    NOTRECRUITEDTANKMAN_NY22WOMAN_LABEL = '#tooltips:notrecruitedtankman/ny22woman/label'
    NOTRECRUITEDTANKMAN_NY22WOMAN_DESC = '#tooltips:notrecruitedtankman/ny22woman/desc'
    NOTRECRUITEDTANKMAN_NY22DEFAULTGIRL_LABEL = '#tooltips:notrecruitedtankman/ny22defaultGirl/label'
    NOTRECRUITEDTANKMAN_NY22DEFAULTGIRL_DESC = '#tooltips:notrecruitedtankman/ny22defaultGirl/desc'
    NOTRECRUITEDTANKMAN_NY22DEFAULTGIRL_HOWTOGETINFO = '#tooltips:notrecruitedtankman/ny22defaultGirl/howToGetInfo'
    NOTRECRUITEDTANKMAN_NY23RUBY_GIRL_1_LABEL = '#tooltips:notrecruitedtankman/ny23ruby_girl_1/label'
    NOTRECRUITEDTANKMAN_NY23RUBY_GIRL_1_EVENT = '#tooltips:notrecruitedtankman/ny23ruby_girl_1/event'
    NOTRECRUITEDTANKMAN_NY23RUBY_GIRL_1_DESC = '#tooltips:notrecruitedtankman/ny23ruby_girl_1/desc'
    NOTRECRUITEDTANKMAN_NY23_GIRL_M_LABEL = '#tooltips:notrecruitedtankman/ny23_girl_m/label'
    NOTRECRUITEDTANKMAN_NY23_GIRL_M_EVENT = '#tooltips:notrecruitedtankman/ny23_girl_m/event'
    NOTRECRUITEDTANKMAN_NY23_GIRL_M_DESC = '#tooltips:notrecruitedtankman/ny23_girl_m/desc'
    NOTRECRUITEDTANKMAN_NY23DEFAULTGIRL_LABEL = '#tooltips:notrecruitedtankman/ny23defaultGirl/label'
    NOTRECRUITEDTANKMAN_NY23DEFAULTGIRL_DESC = '#tooltips:notrecruitedtankman/ny23defaultGirl/desc'
    NOTRECRUITEDTANKMAN_NY23DEFAULTGIRL_HOWTOGETINFO = '#tooltips:notrecruitedtankman/ny23defaultGirl/howToGetInfo'
    NOTRECRUITEDTANKMAN_NY23_GIRL_1_LABEL = '#tooltips:notrecruitedtankman/ny23_girl_1/label'
    NOTRECRUITEDTANKMAN_NY23_GIRL_1_DESC = '#tooltips:notrecruitedtankman/ny23_girl_1/desc'
    NOTRECRUITEDTANKMAN_NY23_GIRL_2_LABEL = '#tooltips:notrecruitedtankman/ny23_girl_2/label'
    NOTRECRUITEDTANKMAN_NY23_GIRL_2_DESC = '#tooltips:notrecruitedtankman/ny23_girl_2/desc'
    NOTRECRUITEDTANKMAN_NY23_GIRL_3_LABEL = '#tooltips:notrecruitedtankman/ny23_girl_3/label'
    NOTRECRUITEDTANKMAN_NY23_GIRL_3_DESC = '#tooltips:notrecruitedtankman/ny23_girl_3/desc'
    NOTRECRUITEDTANKMAN_NY23_GIRL_4_LABEL = '#tooltips:notrecruitedtankman/ny23_girl_4/label'
    NOTRECRUITEDTANKMAN_NY23_GIRL_4_DESC = '#tooltips:notrecruitedtankman/ny23_girl_4/desc'
    NOTRECRUITEDTANKMAN_NY24DEFAULTGIRL_LABEL = '#tooltips:notrecruitedtankman/ny24defaultGirl/label'
    NOTRECRUITEDTANKMAN_NY24DEFAULTGIRL_DESC = '#tooltips:notrecruitedtankman/ny24defaultGirl/desc'
    NOTRECRUITEDTANKMAN_NY24DEFAULTGIRL_HOWTOGETINFO = '#tooltips:notrecruitedtankman/ny24defaultGirl/howToGetInfo'
    NOTRECRUITEDTANKMAN_NY24_MEN_LABEL = '#tooltips:notrecruitedtankman/ny24_men/label'
    NOTRECRUITEDTANKMAN_NY24_MEN_DESC = '#tooltips:notrecruitedtankman/ny24_men/desc'
    NOTRECRUITEDTANKMAN_NY24_GIRL_1_LABEL = '#tooltips:notrecruitedtankman/ny24_girl_1/label'
    NOTRECRUITEDTANKMAN_NY24_GIRL_1_DESC = '#tooltips:notrecruitedtankman/ny24_girl_1/desc'
    NOTRECRUITEDTANKMAN_NY24_GIRL_2_LABEL = '#tooltips:notrecruitedtankman/ny24_girl_2/label'
    NOTRECRUITEDTANKMAN_NY24_GIRL_2_DESC = '#tooltips:notrecruitedtankman/ny24_girl_2/desc'
    NOTRECRUITEDTANKMAN_NY24_GIRL_3_LABEL = '#tooltips:notrecruitedtankman/ny24_girl_3/label'
    NOTRECRUITEDTANKMAN_NY24_GIRL_3_DESC = '#tooltips:notrecruitedtankman/ny24_girl_3/desc'
    NOTRECRUITEDTANKMAN_NY24_GIRL_4_LABEL = '#tooltips:notrecruitedtankman/ny24_girl_4/label'
    NOTRECRUITEDTANKMAN_NY24_GIRL_4_DESC = '#tooltips:notrecruitedtankman/ny24_girl_4/desc'
    NOTRECRUITEDTANKMAN_NY25DEFAULTGIRL_EVENT = '#tooltips:notrecruitedtankman/ny25defaultGirl/event'
    NOTRECRUITEDTANKMAN_NY25DEFAULTGIRL_LABEL = '#tooltips:notrecruitedtankman/ny25defaultGirl/label'
    NOTRECRUITEDTANKMAN_NY25DEFAULTGIRL_DESC = '#tooltips:notrecruitedtankman/ny25defaultGirl/desc'
    NOTRECRUITEDTANKMAN_NY25DEFAULTGIRL_HOWTOGETINFO = '#tooltips:notrecruitedtankman/ny25defaultGirl/howToGetInfo'
    NOTRECRUITEDTANKMAN_NY25_MEN_EVENT = '#tooltips:notrecruitedtankman/ny25_men/event'
    NOTRECRUITEDTANKMAN_NY25_MEN_LABEL = '#tooltips:notrecruitedtankman/ny25_men/label'
    NOTRECRUITEDTANKMAN_NY25_MEN_DESC = '#tooltips:notrecruitedtankman/ny25_men/desc'
    NOTRECRUITEDTANKMAN_NY25_GIRL_1_LABEL = '#tooltips:notrecruitedtankman/ny25_girl_1/label'
    NOTRECRUITEDTANKMAN_NY25_GIRL_1_DESC = '#tooltips:notrecruitedtankman/ny25_girl_1/desc'
    NOTRECRUITEDTANKMAN_NY25_GIRL_2_LABEL = '#tooltips:notrecruitedtankman/ny25_girl_2/label'
    NOTRECRUITEDTANKMAN_NY25_GIRL_2_DESC = '#tooltips:notrecruitedtankman/ny25_girl_2/desc'
    NOTRECRUITEDTANKMAN_NY25_GIRL_3_LABEL = '#tooltips:notrecruitedtankman/ny25_girl_3/label'
    NOTRECRUITEDTANKMAN_NY25_GIRL_3_DESC = '#tooltips:notrecruitedtankman/ny25_girl_3/desc'
    NOTRECRUITEDTANKMAN_NY25_GIRL_4_LABEL = '#tooltips:notrecruitedtankman/ny25_girl_4/label'
    NOTRECRUITEDTANKMAN_NY25_GIRL_4_DESC = '#tooltips:notrecruitedtankman/ny25_girl_4/desc'
    NOTRECRUITEDTANKMAN_NY26DEFAULTGIRL_EVENT = '#tooltips:notrecruitedtankman/ny26defaultGirl/event'
    NOTRECRUITEDTANKMAN_NY26DEFAULTGIRL_LABEL = '#tooltips:notrecruitedtankman/ny26defaultGirl/label'
    NOTRECRUITEDTANKMAN_NY26DEFAULTGIRL_DESC = '#tooltips:notrecruitedtankman/ny26defaultGirl/desc'
    NOTRECRUITEDTANKMAN_NY26DEFAULTGIRL_HOWTOGETINFO = '#tooltips:notrecruitedtankman/ny26defaultGirl/howToGetInfo'
    NOTRECRUITEDTANKMAN_NY26_MEN_EVENT = '#tooltips:notrecruitedtankman/ny26_men/event'
    NOTRECRUITEDTANKMAN_NY26_MEN_LABEL = '#tooltips:notrecruitedtankman/ny26_men/label'
    NOTRECRUITEDTANKMAN_NY26_MEN_DESC = '#tooltips:notrecruitedtankman/ny26_men/desc'
    NOTRECRUITEDTANKMAN_NY26_GIRL_1_LABEL = '#tooltips:notrecruitedtankman/ny26_girl_1/label'
    NOTRECRUITEDTANKMAN_NY26_GIRL_1_DESC = '#tooltips:notrecruitedtankman/ny26_girl_1/desc'
    NOTRECRUITEDTANKMAN_NY26_GIRL_2_LABEL = '#tooltips:notrecruitedtankman/ny26_girl_2/label'
    NOTRECRUITEDTANKMAN_NY26_GIRL_2_DESC = '#tooltips:notrecruitedtankman/ny26_girl_2/desc'
    NOTRECRUITEDTANKMAN_NY26_GIRL_3_LABEL = '#tooltips:notrecruitedtankman/ny26_girl_3/label'
    NOTRECRUITEDTANKMAN_NY26_GIRL_3_DESC = '#tooltips:notrecruitedtankman/ny26_girl_3/desc'
    NOTRECRUITEDTANKMAN_NY26_GIRL_4_LABEL = '#tooltips:notrecruitedtankman/ny26_girl_4/label'
    NOTRECRUITEDTANKMAN_NY26_GIRL_4_DESC = '#tooltips:notrecruitedtankman/ny26_girl_4/desc'
    ADDITIONALREWARDS_LEVELHEADER = '#tooltips:additionalRewards/levelHeader'
    ADDITIONALREWARDS_GOLD = '#tooltips:additionalRewards/gold'
    ADDITIONALREWARDS_CREDITS = '#tooltips:additionalRewards/credits'
    ADDITIONALREWARDS_CRYSTAL = '#tooltips:additionalRewards/crystal'
    ADDITIONALREWARDS_XP = '#tooltips:additionalRewards/xp'
    ADDITIONALREWARDS_FREEXP = '#tooltips:additionalRewards/freeXP'
    ADDITIONALREWARDS_TANKMENXP = '#tooltips:additionalRewards/tankmenXP'
    ADDITIONALREWARDS_CUSTOMIZATIONS_CAMOUFLAGE = '#tooltips:additionalRewards/customizations/camouflage'
    ADDITIONALREWARDS_CUSTOMIZATIONS_STYLE = '#tooltips:additionalRewards/customizations/style'
    ADDITIONALREWARDS_CUSTOMIZATIONS_PROGRESSIONSTYLE = '#tooltips:additionalRewards/customizations/progressionStyle'
    ADDITIONALREWARDS_CUSTOMIZATIONS_3D_STYLE = '#tooltips:additionalRewards/customizations/3d_style'
    ADDITIONALREWARDS_CUSTOMIZATIONS_DECAL = '#tooltips:additionalRewards/customizations/decal'
    ADDITIONALREWARDS_CUSTOMIZATIONS_PROJECTIONDECAL = '#tooltips:additionalRewards/customizations/projectionDecal'
    ADDITIONALREWARDS_CUSTOMIZATIONS_MODIFICATION = '#tooltips:additionalRewards/customizations/modification'
    ADDITIONALREWARDS_CUSTOMIZATIONS_PAINT = '#tooltips:additionalRewards/customizations/paint'
    ADDITIONALREWARDS_CUSTOMIZATIONS_INSCRIPTION = '#tooltips:additionalRewards/customizations/inscription'
    ADDITIONALREWARDS_CUSTOMIZATIONS_EMBLEM = '#tooltips:additionalRewards/customizations/emblem'
    ADDITIONALREWARDS_CUSTOMIZATIONS_ATTACHMENT = '#tooltips:additionalRewards/customizations/attachment'
    ADDITIONALREWARDS_PREMIUM = '#tooltips:additionalRewards/premium'
    ...
    SEASONALBATTLESELECTOR_TIMETABLE_TITLE = '#tooltips:seasonalBattleSelector/timeTable/title'
    SEASONALBATTLESELECTOR_TIMETABLE_TODAY = '#tooltips:seasonalBattleSelector/timeTable/today'
    SEASONALBATTLESELECTOR_TIMETABLE_TOMORROW = '#tooltips:seasonalBattleSelector/timeTable/tomorrow'
    SEASONALBATTLESELECTOR_TIMETABLE_INTERVAL = '#tooltips:seasonalBattleSelector/timeTable/interval'
    SEASONALBATTLESELECTOR_TIMETABLE_EMPTY = '#tooltips:seasonalBattleSelector/timeTable/empty'
    SEASONALBATTLESELECTOR_TILLEND = '#tooltips:seasonalBattleSelector/tillEnd'
    TILLTIME_DAYS = '#tooltips:tillTime/days'
    TILLTIME_HOURS = '#tooltips:tillTime/hours'
    TILLTIME_MIN = '#tooltips:tillTime/min'
    TILLTIME_LESSMIN = '#tooltips:tillTime/lessMin'
    ...
    PERIODICREWARD_BODY = '#tooltips:periodicReward/body'
    NOTRECRUITEDTANKMAN_COMMANDER_REBRANDING_DESC = '#tooltips:notrecruitedtankman/commander_rebranding/desc'
    NOTRECRUITEDTANKMAN_COMMANDER_REBRANDING_LABEL = '#tooltips:notrecruitedtankman/commander_rebranding/label'
    NOTRECRUITEDTANKMAN_WT22_BOSS_COMMANDER_DESC = '#tooltips:notrecruitedtankman/wt22_boss_commander/desc'
    ...
    NOTRECRUITEDTANKMAN_WT_2023_HANNELORE_DESC = '#tooltips:notrecruitedtankman/wt_2023_hannelore/desc'
    NOTRECRUITEDTANKMAN_WT_2023_HANNELORE_LABEL = '#tooltips:notrecruitedtankman/wt_2023_hannelore/label'
    NOTRECRUITEDTANKMAN_WT_2023_DRIVER_DESC = '#tooltips:notrecruitedtankman/wt_2023_driver/desc'
    NOTRECRUITEDTANKMAN_WT_2023_DRIVER_LABEL = '#tooltips:notrecruitedtankman/wt_2023_driver/label'
    NOTRECRUITEDTANKMAN_WT_2024_VONKRIEGER_DESC = '#tooltips:notrecruitedtankman/wt_2024_vonkrieger/desc'
    NOTRECRUITEDTANKMAN_WT_2024_VONKRIEGER_LABEL = '#tooltips:notrecruitedtankman/wt_2024_vonkrieger/label'
    NOTRECRUITEDTANKMAN_WT_2024_ERMELINDA_DESC = '#tooltips:notrecruitedtankman/wt_2024_ermelinda/desc'
    NOTRECRUITEDTANKMAN_WT_2024_ERMELINDA_LABEL = '#tooltips:notrecruitedtankman/wt_2024_ermelinda/label'
    NOTRECRUITEDTANKMAN_WT_2024_QUICKYBABY_DESC = '#tooltips:notrecruitedtankman/wt_2024_quickybaby/desc'
    NOTRECRUITEDTANKMAN_WT_2024_QUICKYBABY_LABEL = '#tooltips:notrecruitedtankman/wt_2024_quickybaby/label'
    NOTRECRUITEDTANKMAN_WT_2024_DAKILLZOR_DESC = '#tooltips:notrecruitedtankman/wt_2024_dakillzor/desc'
    NOTRECRUITEDTANKMAN_WT_2024_DAKILLZOR_LABEL = '#tooltips:notrecruitedtankman/wt_2024_dakillzor/label'
    NOTRECRUITEDTANKMAN_WT_2024_MOUZAKROBAT_DESC = '#tooltips:notrecruitedtankman/wt_2024_mouzakrobat/desc'
    NOTRECRUITEDTANKMAN_WT_2024_MOUZAKROBAT_LABEL = '#tooltips:notrecruitedtankman/wt_2024_mouzakrobat/label'
    NOTRECRUITEDTANKMAN_WT_2024_SKILL4LTU_DESC = '#tooltips:notrecruitedtankman/wt_2024_skill4ltu/desc'
    NOTRECRUITEDTANKMAN_WT_2024_SKILL4LTU_LABEL = '#tooltips:notrecruitedtankman/wt_2024_skill4ltu/label'
    NOTRECRUITEDTANKMAN_WT_CN2024_ZHONGPENGFEI_DESC = '#tooltips:notrecruitedtankman/wt_CN2024_zhongpengfei/desc'
    NOTRECRUITEDTANKMAN_WT_CN2024_ZHONGPENGFEI_LABEL = '#tooltips:notrecruitedtankman/wt_CN2024_zhongpengfei/label'
    NOTRECRUITEDTANKMAN_WT_CN2024_BMENG_DESC = '#tooltips:notrecruitedtankman/wt_CN2024_bmeng/desc'
    NOTRECRUITEDTANKMAN_WT_CN2024_BMENG_LABEL = '#tooltips:notrecruitedtankman/wt_CN2024_bmeng/label'
    NOTRECRUITEDTANKMAN_WT_CN2024_YITUANTUAN_DESC = '#tooltips:notrecruitedtankman/wt_CN2024_yituantuan/desc'
    NOTRECRUITEDTANKMAN_WT_CN2024_YITUANTUAN_LABEL = '#tooltips:notrecruitedtankman/wt_CN2024_yituantuan/label'
    NOTRECRUITEDTANKMAN_WT_CN2024_SAONIAN_DESC = '#tooltips:notrecruitedtankman/wt_CN2024_saonian/desc'
    NOTRECRUITEDTANKMAN_WT_CN2024_SAONIAN_LABEL = '#tooltips:notrecruitedtankman/wt_CN2024_saonian/label'
    NOTRECRUITEDTANKMAN_COSM02_KIRK_LABEL = '#tooltips:notrecruitedtankman/cosm02_Kirk/label'
    NOTRECRUITEDTANKMAN_COSM02_KIRK_DESC = '#tooltips:notrecruitedtankman/cosm02_Kirk/desc'
    NOTRECRUITEDTANKMAN_COSM02_KIRK_HOWTOGETINFO = '#tooltips:notrecruitedtankman/cosm02_Kirk/howToGetInfo'
    NOTRECRUITEDTANKMAN_COSM02_SPOCK_LABEL = '#tooltips:notrecruitedtankman/cosm02_Spock/label'
    NOTRECRUITEDTANKMAN_COSM02_SPOCK_DESC = '#tooltips:notrecruitedtankman/cosm02_Spock/desc'
    NOTRECRUITEDTANKMAN_COSM02_SPOCK_HOWTOGETINFO = '#tooltips:notrecruitedtankman/cosm02_Spock/howToGetInfo'
    NOTRECRUITEDTANKMAN_COSM02_SULU_LABEL = '#tooltips:notrecruitedtankman/cosm02_Sulu/label'
    NOTRECRUITEDTANKMAN_COSM02_SULU_DESC = '#tooltips:notrecruitedtankman/cosm02_Sulu/desc'
    NOTRECRUITEDTANKMAN_COSM02_SULU_HOWTOGETINFO = '#tooltips:notrecruitedtankman/cosm02_Sulu/howToGetInfo'
    NOTRECRUITEDTANKMAN_COSM02_MCCOY_LABEL = '#tooltips:notrecruitedtankman/cosm02_McCoy/label'
    NOTRECRUITEDTANKMAN_COSM02_MCCOY_DESC = '#tooltips:notrecruitedtankman/cosm02_McCoy/desc'
    NOTRECRUITEDTANKMAN_COSM02_MCCOY_HOWTOGETINFO = '#tooltips:notrecruitedtankman/cosm02_McCoy/howToGetInfo'
    NOTRECRUITEDTANKMAN_COSM02_UHURA_LABEL = '#tooltips:notrecruitedtankman/cosm02_Uhura/label'
    NOTRECRUITEDTANKMAN_COSM02_UHURA_DESC = '#tooltips:notrecruitedtankman/cosm02_Uhura/desc'
    NOTRECRUITEDTANKMAN_COSM02_UHURA_HOWTOGETINFO = '#tooltips:notrecruitedtankman/cosm02_Uhura/howToGetInfo'
    NOTRECRUITEDTANKMAN_COSM02_SCOTTY_LABEL = '#tooltips:notrecruitedtankman/cosm02_Scotty/label'
    NOTRECRUITEDTANKMAN_COSM02_SCOTTY_DESC = '#tooltips:notrecruitedtankman/cosm02_Scotty/desc'
    NOTRECRUITEDTANKMAN_COSM02_SCOTTY_HOWTOGETINFO = '#tooltips:notrecruitedtankman/cosm02_Scotty/howToGetInfo'
    NOTRECRUITEDTANKMAN_BIRTHDAY14_DEER_LABEL = '#tooltips:notrecruitedtankman/birthday14_deer/label'
    NOTRECRUITEDTANKMAN_BIRTHDAY14_DEER_DESC = '#tooltips:notrecruitedtankman/birthday14_deer/desc'
    NOTRECRUITEDTANKMAN_BIRTHDAY14_DEER_HOWTOGETINFO = '#tooltips:notrecruitedtankman/birthday14_deer/howToGetInfo'
    NOTRECRUITEDTANKMAN_BIRTHDAY14_CAT_LABEL = '#tooltips:notrecruitedtankman/birthday14_cat/label'
    NOTRECRUITEDTANKMAN_BIRTHDAY14_CAT_DESC = '#tooltips:notrecruitedtankman/birthday14_cat/desc'
    NOTRECRUITEDTANKMAN_BIRTHDAY14_CAT_HOWTOGETINFO = '#tooltips:notrecruitedtankman/birthday14_cat/howToGetInfo'
    NOTRECRUITEDTANKMAN_BIRTHDAY14_MOUSE_LABEL = '#tooltips:notrecruitedtankman/birthday14_mouse/label'
    NOTRECRUITEDTANKMAN_BIRTHDAY14_MOUSE_DESC = '#tooltips:notrecruitedtankman/birthday14_mouse/desc'
    NOTRECRUITEDTANKMAN_BIRTHDAY14_MOUSE_HOWTOGETINFO = '#tooltips:notrecruitedtankman/birthday14_mouse/howToGetInfo'
    NOTRECRUITEDTANKMAN_MARTY_VOLE_LABEL = '#tooltips:notrecruitedtankman/Marty_Vole/label'
    NOTRECRUITEDTANKMAN_MARTY_VOLE_DESC = '#tooltips:notrecruitedtankman/Marty_Vole/desc'
    NOTRECRUITEDTANKMAN_MARTY_VOLE_HOWTOGETINFO = '#tooltips:notrecruitedtankman/Marty_Vole/howToGetInfo'
    NOTRECRUITEDTANKMAN_LUMBERJACK_LABEL = '#tooltips:notrecruitedtankman/Lumberjack/label'
    NOTRECRUITEDTANKMAN_LUMBERJACK_DESC = '#tooltips:notrecruitedtankman/Lumberjack/desc'
    NOTRECRUITEDTANKMAN_LUMBERJACK_HOWTOGETINFO = '#tooltips:notrecruitedtankman/Lumberjack/howToGetInfo'
    NOTRECRUITEDTANKMAN_BOOSTEROID_FOXWOOD_LABEL = '#tooltips:notrecruitedtankman/boosteroid_foxwood/label'
    NOTRECRUITEDTANKMAN_BOOSTEROID_FOXWOOD_DESC = '#tooltips:notrecruitedtankman/boosteroid_foxwood/desc'
    NOTRECRUITEDTANKMAN_BOOSTEROID_FOXWOOD_HOWTOGETINFO = '#tooltips:notrecruitedtankman/boosteroid_foxwood/howToGetInfo'
    NOTRECRUITEDTANKMAN_BOOSTEROID_EXTRAORDINAIRE_LABEL = '#tooltips:notrecruitedtankman/boosteroid_extraordinaire/label'
    NOTRECRUITEDTANKMAN_BOOSTEROID_EXTRAORDINAIRE_DESC = '#tooltips:notrecruitedtankman/boosteroid_extraordinaire/desc'
    NOTRECRUITEDTANKMAN_BOOSTEROID_EXTRAORDINAIRE_HOWTOGETINFO = '#tooltips:notrecruitedtankman/boosteroid_extraordinaire/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_mtlb1_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_1_DESC = '#tooltips:notrecruitedtankman/tankmen_mtlb1_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_mtlb1_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_mtlb1_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_2_DESC = '#tooltips:notrecruitedtankman/tankmen_mtlb1_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_mtlb1_2/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_mtlb1_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_3_DESC = '#tooltips:notrecruitedtankman/tankmen_mtlb1_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_mtlb1_3/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_4_LABEL = '#tooltips:notrecruitedtankman/tankmen_mtlb1_4/label'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_4_DESC = '#tooltips:notrecruitedtankman/tankmen_mtlb1_4/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_4_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_mtlb1_4/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_5_LABEL = '#tooltips:notrecruitedtankman/tankmen_mtlb1_5/label'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_5_DESC = '#tooltips:notrecruitedtankman/tankmen_mtlb1_5/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_5_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_mtlb1_5/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_6_LABEL = '#tooltips:notrecruitedtankman/tankmen_mtlb1_6/label'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_6_DESC = '#tooltips:notrecruitedtankman/tankmen_mtlb1_6/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_6_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_mtlb1_6/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP15_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp15_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP15_1_DESC = '#tooltips:notrecruitedtankman/tankmen_bp15_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP15_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp15_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP15_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp15_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP15_2_DESC = '#tooltips:notrecruitedtankman/tankmen_bp15_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP15_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp15_2/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP15_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp15_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP15_3_DESC = '#tooltips:notrecruitedtankman/tankmen_bp15_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP15_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp15_3/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP15_4_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp15_4/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP15_4_DESC = '#tooltips:notrecruitedtankman/tankmen_bp15_4/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP15_4_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp15_4/howToGetInfo'
    COMMANDERBONUS_NAME = '#tooltips:commanderBonus/name'
    COMMANDERBONUS_DESCRIPTION = '#tooltips:commanderBonus/description'
    COMMANDERBONUS_ALT_DESCRIPTION = '#tooltips:commanderBonus/alt/description'
    COMMANDERBONUS_ALT_INFO = '#tooltips:commanderBonus/alt/info'
    QUICKTRAINING_NOTTRAINEDTHISVEHICLE = '#tooltips:quickTraining/notTrainedThisVehicle'
    QUICKTRAINING_LOWPECREW = '#tooltips:quickTraining/LowPECrew'
    QUICKTRAINING_LOWPENOTFULLCREW = '#tooltips:quickTraining/LowPENotFullCrew'
    QUICKTRAINING_LOWPENOTTRAINEDCREW = '#tooltips:quickTraining/LowPENotTrainedCrew'
    QUICKTRAINING_LOWPENOTTRAINEDNOTFULLCREW = '#tooltips:quickTraining/LowPENotTrainedNotFullCrew'
    QUICKTRAINING_LOWPETIPSPERSONAL = '#tooltips:quickTraining/LowPEtipsPersonal'
    ...
    QUICKTRAINING_WILLFULLTRAINEDPERSONAL = '#tooltips:quickTraining/WillFullTrainedPersonal'
    QUICKTRAINING_WILLFULLTRAINEDFEWMEMBERS = '#tooltips:quickTraining/WillFullTrainedFewMembers'
    QUICKTRAINING_WILLFULLTRAINEDCREW = '#tooltips:quickTraining/WillFullTrainedCrew'
    QUICKTRAINING_FULLTRAINEDPERSONAL = '#tooltips:quickTraining/FullTrainedPersonal'
    QUICKTRAINING_FULLTRAINEDFEWMEMBERS = '#tooltips:quickTraining/FullTrainedFewMembers'
    QUICKTRAINING_ALLFULLTRAINED = '#tooltips:quickTraining/AllFullTrained'
    QUICKTRAINING_FULLTRAINEDTANKMAN = '#tooltips:quickTraining/FullTrainedTankman'
    QUICKTRAINING_LOSTXPTOOLTIP_HEADER = '#tooltips:quickTraining/lostXpTooltip/header'
    QUICKTRAINING_LOSTXPTOOLTIP_BODY = '#tooltips:quickTraining/lostXpTooltip/body'
    QUICKTRAINING_UNAVAILABLE_HEADER_FREEXP = '#tooltips:quickTraining/unavailable/header/freeXp'
    QUICKTRAINING_UNAVAILABLE_HEADER_BOOK = '#tooltips:quickTraining/unavailable/header/book'
    QUICKTRAINING_UNAVAILABLE_HEADER_ALLTRAINED = '#tooltips:quickTraining/unavailable/header/allTrained'
    QUICKTRAINING_UNAVAILABLE_BODY_PERKLIMIT = '#tooltips:quickTraining/unavailable/body/perkLimit'
    QUICKTRAINING_UNAVAILABLE_BODY_LOWEFFICIENCY = '#tooltips:quickTraining/unavailable/body/lowEfficiency'
    QUICKTRAINING_UNAVAILABLE_BODY_ALLFULLYTRAINED = '#tooltips:quickTraining/unavailable/body/allFullyTrained'
    QUICKTRAINING_XPENOUGHFORPOSTPROGRESSION = '#tooltips:quickTraining/xpEnoughforPostProgression'
    ...
    PREMIUMVEHICLE_CONTENT_EXPERIENCE = '#tooltips:premiumVehicle/content/experience'
    PREMIUMVEHICLE_CONTENT_CREDITS = '#tooltips:premiumVehicle/content/credits'
    PREMIUMVEHICLE_CONTENT_TRANSFER = '#tooltips:premiumVehicle/content/transfer'
    PREMIUMVEHICLE_INFO = '#tooltips:premiumVehicle/info'
    SPECIALIZATIONWOTPLUS_HEADER = '#tooltips:specializationWotPlus/header'
    SPECIALIZATIONWOTPLUS_VEHICLE = '#tooltips:specializationWotPlus/vehicle'
    SPECIALIZATIONWOTPLUS_DESCRIPTION = '#tooltips:specializationWotPlus/description'
    SPECIALIZATIONWOTPLUS_CONTENT_HEADER = '#tooltips:specializationWotPlus/content/header'
    SPECIALIZATIONWOTPLUS_CONTENT_TRANSFER = '#tooltips:specializationWotPlus/content/transfer'
    BATTLESDETAILS_HEADER = '#tooltips:battlesDetails/header'
    BATTLESDETAILS_BODY = '#tooltips:battlesDetails/body'
    DISMISSEDTOGGLE_HEADER = '#tooltips:dismissedToggle/header'
    DISMISSEDTOGGLE_SUBHEADER = '#tooltips:dismissedToggle/subHeader'
    DISMISSEDTOGGLE_BODY = '#tooltips:dismissedToggle/body'
    DISMISSEDTOGGLE_RECOVER_TOTAL = '#tooltips:dismissedToggle/recover/total'
    DISMISSEDTOGGLE_RECOVER_FREE = '#tooltips:dismissedToggle/recover/free'
    DISMISSEDTOGGLE_RECOVER_PAID = '#tooltips:dismissedToggle/recover/paid'
    DISMISSEDTOGGLE_FOOTER_HEADER = '#tooltips:dismissedToggle/footer/header'
    DISMISSEDTOGGLE_FOOTER_BODY = '#tooltips:dismissedToggle/footer/body'
    VEHCMPSKILLSTOOLTIP_HEADER = '#tooltips:vehCmpSkillsTooltip/header'
    VEHCMPSKILLSTOOLTIP_INFO_HEADER = '#tooltips:vehCmpSkillsTooltip/info/header'
    VEHCMPSKILLSTOOLTIP_INFO_TEXT = '#tooltips:vehCmpSkillsTooltip/info/text'
    CONVERSION_RECEIVED_HEADER = '#tooltips:conversion/received/header'
    CONVERSION_NOTRECEIVED_HEADER = '#tooltips:conversion/notReceived/header'
    CONVERSION_RECEIVED_BODY = '#tooltips:conversion/received/body'
    CONVERSION_NOTRECEIVED_BODY = '#tooltips:conversion/notReceived/body'
    NPSCOMPENSATION_HEADER = '#tooltips:npsCompensation/header'
    NPSCOMPENSATION_BODY = '#tooltips:npsCompensation/body'
    NPSCOMPENSATION_DIRECTIVES = '#tooltips:npsCompensation/directives'
    SKILL_UNTRAINED_HEADER = '#tooltips:skill/untrained/header'
    SKILL_UNTRAINED_BODY = '#tooltips:skill/untrained/body'
    SKILL_UNTRAINED_EXPLANATION = '#tooltips:skill/untrained/explanation'
    SKILL_UNTRAINED_ADDITIONAL = '#tooltips:skill/untrained/additional'
    SKILLSEFFICIENCY_HEADER = '#tooltips:skillsEfficiency/header'
    SKILLSEFFICIENCY_SUBHEADER = '#tooltips:skillsEfficiency/subHeader'
    SKILLSEFFICIENCY_INFORMATION1 = '#tooltips:skillsEfficiency/information1'
    SKILLSEFFICIENCY_INFORMATION2 = '#tooltips:skillsEfficiency/information2'
    SKILLSEFFICIENCY_ALTDESCRIPTION = '#tooltips:skillsEfficiency/altDescription'
    SKILLSEFFICIENCY_RETRAININGDISCOUNTINFORMATION = '#tooltips:skillsEfficiency/retrainingDiscountInformation'
    SKILLSEFFICIENCY_PROGRESS = '#tooltips:skillsEfficiency/progress'
    RETRAIN_PRICECARD_DISABLE_USELESS_HEADER = '#tooltips:retrain/priceCard/disable/useless/header'
    RETRAIN_PRICECARD_DISABLE_USELESS_BODY = '#tooltips:retrain/priceCard/disable/useless/body'
    RETRAIN_PRICECARD_DISABLE_DISCOUNT_HEADER = '#tooltips:retrain/priceCard/disable/discount/header'
    RETRAIN_PRICECARD_DISABLE_DISCOUNT_BODY = '#tooltips:retrain/priceCard/disable/discount/body'
    RETRAIN_PRICECARD_DISABLE_ROLECHANGE_HEADER = '#tooltips:retrain/priceCard/disable/roleChange/header'
    RETRAIN_PRICECARD_DISABLE_ROLECHANGE_BODY = '#tooltips:retrain/priceCard/disable/roleChange/body'
    RETRAIN_CHANGEROLE_DISABLE_CREWLOCK_HEADER = '#tooltips:retrain/changeRole/disable/crewLock/header'
    RETRAIN_CHANGEROLE_DISABLE_CREWLOCK_BODY = '#tooltips:retrain/changeRole/disable/crewLock/body'
    RETRAIN_CHANGEROLE_DISABLE_FREEOPERATION_HEADER = '#tooltips:retrain/changeRole/disable/freeOperation/header'
    RETRAIN_CHANGEROLE_DISABLE_FREEOPERATION_BODY = '#tooltips:retrain/changeRole/disable/freeOperation/body'
    RETRAIN_CHANGEROLE_DISABLE_FORCED_HEADER = '#tooltips:retrain/changeRole/disable/forced/header'
    RETRAIN_CHANGEROLE_DISABLE_FORCED_BODY = '#tooltips:retrain/changeRole/disable/forced/body'
    RETRAIN_TANKMANDISCOUNT_HEADER = '#tooltips:retrain/tankmanDiscount/header'
    RETRAIN_TANKMANDISCOUNT_FULL_BODY = '#tooltips:retrain/tankmanDiscount/full/body'
    RETRAIN_TANKMANDISCOUNT_HALF_BODY = '#tooltips:retrain/tankmanDiscount/half/body'
    RETRAIN_CHANGEROLE_WARNING_HEADER = '#tooltips:retrain/changeRole/warning/header'
    RETRAIN_CHANGEROLE_WARNING_BODY = '#tooltips:retrain/changeRole/warning/body'
    BUTTONS_RETRAIN_BODY = '#tooltips:buttons/retrain/body'
    BUTTONS_INCREASE_BODY = '#tooltips:buttons/increase/body'
    LIVEOPS_ENTRYPOINTTOOLTIP_TITLE = '#tooltips:liveOps/entryPointTooltip/title'
    LIVEOPS_ENTRYPOINTTOOLTIP_BODY = '#tooltips:liveOps/entryPointTooltip/body'
    LIVEOPS_ENTRYPOINTTOOLTIP_DATE_START = '#tooltips:liveOps/entryPointTooltip/date/start'
    LIVEOPS_ENTRYPOINTTOOLTIP_DATE_END = '#tooltips:liveOps/entryPointTooltip/date/end'
    LIVEOPS_ENTRYPOINTTOOLTIP_FINISHED = '#tooltips:liveOps/entryPointTooltip/finished'
    LIVEOPS_ENTRYPOINTTOOLTIP_RESULTS = '#tooltips:liveOps/entryPointTooltip/results'
    POSTPROGRESSION_TITLE = '#tooltips:postProgression/title'
    POSTPROGRESSION_DESCRIPTION_TOP = '#tooltips:postProgression/description/top'
    POSTPROGRESSION_TIPS_1 = '#tooltips:postProgression/tips/1'
    POSTPROGRESSION_TIPS_2 = '#tooltips:postProgression/tips/2'
    POSTPROGRESSION_TIPS_3 = '#tooltips:postProgression/tips/3'
    POSTPROGRESSION_DESCRIPTION_BOTTOM = '#tooltips:postProgression/description/bottom'
    POSTPROGRESSION_WARNING = '#tooltips:postProgression/warning'
    MENTORASSIGNMENT_TITLE = '#tooltips:mentorAssignment/title'
    MENTORASSIGNMENT_DESCRIPTION = '#tooltips:mentorAssignment/description'
    MENTORASSIGNMENT_WARNING_FREESKILLS = '#tooltips:mentorAssignment/warning/freeSkills'
    MENTORASSIGNMENT_WARNING_CREWREMOVE = '#tooltips:mentorAssignment/warning/crewRemove'
    MENTORASSIGNMENT_ADVANCED_HEADER = '#tooltips:mentorAssignment/advanced/header'
    MENTORASSIGNMENT_ADVANCED_DESCRIPTION = '#tooltips:mentorAssignment/advanced/description'
    WEATHER_ZONEBLIZZARD_HEADER = '#tooltips:weather/zoneBlizzard/header'
    WEATHER_ZONEBLIZZARD_BODY = '#tooltips:weather/zoneBlizzard/body'
    WEATHER_ZONEFIRE_HEADER = '#tooltips:weather/zoneFire/header'
    WEATHER_ZONEFIRE_BODY = '#tooltips:weather/zoneFire/body'
    WEATHER_ZONEFOG_HEADER = '#tooltips:weather/zoneFog/header'
    WEATHER_ZONEFOG_BODY = '#tooltips:weather/zoneFog/body'
    WEATHER_ZONERAIN_HEADER = '#tooltips:weather/zoneRain/header'
    WEATHER_ZONERAIN_BODY = '#tooltips:weather/zoneRain/body'
    WEATHER_ZONESANDSTORM_HEADER = '#tooltips:weather/zoneSandstorm/header'
    WEATHER_ZONESANDSTORM_BODY = '#tooltips:weather/zoneSandstorm/body'
    WEATHER_ZONESMOKE_HEADER = '#tooltips:weather/zoneSmoke/header'
    WEATHER_ZONESMOKE_BODY = '#tooltips:weather/zoneSmoke/body'
    WEATHER_ZONETORNADO_HEADER = '#tooltips:weather/zoneTornado/header'
    WEATHER_ZONETORNADO_BODY = '#tooltips:weather/zoneTornado/body'
    NOTRECRUITEDTANKMAN_TANKMEN_BP15_5_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp15_5/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP15_5_DESC = '#tooltips:notrecruitedtankman/tankmen_bp15_5/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP15_5_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp15_5/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP15_6_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp15_6/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP15_6_DESC = '#tooltips:notrecruitedtankman/tankmen_bp15_6/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP15_6_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp15_6/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP15_7_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp15_7/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP15_7_DESC = '#tooltips:notrecruitedtankman/tankmen_bp15_7/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP15_7_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp15_7/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP15_8_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp15_8/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP15_8_DESC = '#tooltips:notrecruitedtankman/tankmen_bp15_8/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP15_8_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp15_8/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP15_9_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp15_9/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP15_9_DESC = '#tooltips:notrecruitedtankman/tankmen_bp15_9/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP15_9_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp15_9/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1004_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp1004_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1004_1_DESC = '#tooltips:notrecruitedtankman/tankmen_bp1004_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1004_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp1004_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1004_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp1004_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1004_2_DESC = '#tooltips:notrecruitedtankman/tankmen_bp1004_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1004_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp1004_2/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1004_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp1004_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1004_3_DESC = '#tooltips:notrecruitedtankman/tankmen_bp1004_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1004_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp1004_3/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1004_4_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp1004_4/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1004_4_DESC = '#tooltips:notrecruitedtankman/tankmen_bp1004_4/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1004_4_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp1004_4/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1004_5_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp1004_5/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1004_5_DESC = '#tooltips:notrecruitedtankman/tankmen_bp1004_5/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1004_5_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp1004_5/howToGetInfo'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_BP16_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp16_1/howToGetInfo'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_BP16_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp16_2/howToGetInfo'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_BP16_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp16_3/howToGetInfo'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_BP16_4_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp16_4/howToGetInfo'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_BP16_5_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp16_5/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP16_6_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp16_6/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP16_6_DESC = '#tooltips:notrecruitedtankman/tankmen_bp16_6/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP16_6_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp16_6/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP16_7_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp16_7/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP16_7_DESC = '#tooltips:notrecruitedtankman/tankmen_bp16_7/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP16_7_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp16_7/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP16_8_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp16_8/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP16_8_DESC = '#tooltips:notrecruitedtankman/tankmen_bp16_8/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP16_8_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp16_8/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP16_9_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp16_9/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP16_9_DESC = '#tooltips:notrecruitedtankman/tankmen_bp16_9/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP16_9_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp16_9/howToGetInfo'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P4_1_LABEL = '#tooltips:notrecruitedtankman/onslaught_p4_1/label'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P4_1_DESC = '#tooltips:notrecruitedtankman/onslaught_p4_1/desc'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P4_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/onslaught_p4_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P4_2_LABEL = '#tooltips:notrecruitedtankman/onslaught_p4_2/label'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P4_2_DESC = '#tooltips:notrecruitedtankman/onslaught_p4_2/desc'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P4_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/onslaught_p4_2/howToGetInfo'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P4_3_LABEL = '#tooltips:notrecruitedtankman/onslaught_p4_3/label'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P4_3_DESC = '#tooltips:notrecruitedtankman/onslaught_p4_3/desc'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P4_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/onslaught_p4_3/howToGetInfo'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P4_4_LABEL = '#tooltips:notrecruitedtankman/onslaught_p4_4/label'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P4_4_DESC = '#tooltips:notrecruitedtankman/onslaught_p4_4/desc'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P4_4_HOWTOGETINFO = '#tooltips:notrecruitedtankman/onslaught_p4_4/howToGetInfo'
    COMMENDATIONS_COMMS_LIKES_SCT_TXT_H_01 = '#tooltips:commendations/comms_likes_sct_txt_h_01'
    COMMENDATIONS_COMMS_LIKES_SCT_TXT_T_01 = '#tooltips:commendations/comms_likes_sct_txt_t_01'
    COMMENDATIONS_COMMS_LIKES_SCT_TXT_H_02 = '#tooltips:commendations/comms_likes_sct_txt_h_02'
    COMMENDATIONS_COMMS_LIKES_SCT_TXT_T_02 = '#tooltips:commendations/comms_likes_sct_txt_t_02'
    COMMENDATIONS_COMMS_LIKES_SCT_TXT_H_03 = '#tooltips:commendations/comms_likes_sct_txt_h_03'
    COMMENDATIONS_COMMS_LIKES_SCT_TXT_T_03 = '#tooltips:commendations/comms_likes_sct_txt_t_03'
    COMMENDATIONS_COMMS_LIKES_SCT_TXT_H_04 = '#tooltips:commendations/comms_likes_sct_txt_h_04'
    COMMENDATIONS_COMMS_LIKES_SCT_TXT_T_04 = '#tooltips:commendations/comms_likes_sct_txt_t_04'
    COMMENDATIONS_COMMS_LIKES_SCT_TXT_H_05 = '#tooltips:commendations/comms_likes_sct_txt_h_05'
    COMMENDATIONS_COMMS_LIKES_SCT_TXT_T_05 = '#tooltips:commendations/comms_likes_sct_txt_t_05'
    LIVETAGS_BODY_ALLY_DAMAGE = '#tooltips:liveTags/body/ally/damage'
    LIVETAGS_BODY_ALLY_ASSIST = '#tooltips:liveTags/body/ally/assist'
    LIVETAGS_BODY_ALLY_DAMAGE_BLOCK = '#tooltips:liveTags/body/ally/damage/block'
    LIVETAGS_BODY_ALLY_DAMAGE_ASSIST = '#tooltips:liveTags/body/ally/damage/assist'
    LIVETAGS_BODY_ALLY_BLOCK_ASSIST = '#tooltips:liveTags/body/ally/block/assist'
    LIVETAGS_BODY_ALLY_DAMAGE_BLOCK_ASSIST = '#tooltips:liveTags/body/ally/damage/block/assist'
    LIVETAGS_BODY_CURRENTPLAYER_DAMAGE = '#tooltips:liveTags/body/currentPlayer/damage'
    LIVETAGS_BODY_CURRENTPLAYER_BLOCK = '#tooltips:liveTags/body/currentPlayer/block'
    LIVETAGS_BODY_CURRENTPLAYER_ASSIST = '#tooltips:liveTags/body/currentPlayer/assist'
    LIVETAGS_BODY_CURRENTPLAYER_DAMAGE_BLOCK = '#tooltips:liveTags/body/currentPlayer/damage/block'
    LIVETAGS_BODY_CURRENTPLAYER_DAMAGE_ASSIST = '#tooltips:liveTags/body/currentPlayer/damage/assist'
    LIVETAGS_BODY_CURRENTPLAYER_BLOCK_ASSIST = '#tooltips:liveTags/body/currentPlayer/block/assist'
    LIVETAGS_BODY_CURRENTPLAYER_DAMAGE_BLOCK_ASSIST = '#tooltips:liveTags/body/currentPlayer/damage/block/assist'
    LIVETAGS_TITLE_DAMAGE = '#tooltips:liveTags/title/damage'
    LIVETAGS_TITLE_ASSIST = '#tooltips:liveTags/title/assist'
    LIVETAGS_TITLE_BLOCK = '#tooltips:liveTags/title/block'
    LIVETAGS_TITLE_DAMAGE_ASSIST = '#tooltips:liveTags/title/damage/assist'
    LIVETAGS_TITLE_DAMAGE_BLOCK = '#tooltips:liveTags/title/damage/block'
    LIVETAGS_TITLE_BLOCK_ASSIST = '#tooltips:liveTags/title/block/assist'
    LIVETAGS_TITLE_DAMAGE_BLOCK_ASSIST = '#tooltips:liveTags/title/damage/block/assist'
    NOTRECRUITEDTANKMAN_BOOSTEROID_FENCER_LABEL = '#tooltips:notrecruitedtankman/boosteroid_fencer/label'
    NOTRECRUITEDTANKMAN_BOOSTEROID_FENCER_DESC = '#tooltips:notrecruitedtankman/boosteroid_fencer/desc'
    NOTRECRUITEDTANKMAN_BOOSTEROID_FENCER_HOWTOGETINFO = '#tooltips:notrecruitedtankman/boosteroid_fencer/howToGetInfo'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp17_1/howToGetInfo'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp17_2/howToGetInfo'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp17_3/howToGetInfo'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_4_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp17_4/howToGetInfo'
    NOTRECRUITEDTANKMAN_FRONTMAN_LABEL = '#tooltips:notrecruitedtankman/frontman/label'
    NOTRECRUITEDTANKMAN_FRONTMAN_DESC = '#tooltips:notrecruitedtankman/frontman/desc'
    NOTRECRUITEDTANKMAN_FRONTMAN_HOWTOGETINFO = '#tooltips:notrecruitedtankman/frontman/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_PM3_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_pm3_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_PM3_1_DESC = '#tooltips:notrecruitedtankman/tankmen_pm3_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_PM3_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_pm3_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_PM3_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_pm3_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_PM3_2_DESC = '#tooltips:notrecruitedtankman/tankmen_pm3_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_PM3_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_pm3_2/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_PM3_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_pm3_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_PM3_3_DESC = '#tooltips:notrecruitedtankman/tankmen_pm3_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_PM3_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_pm3_3/howToGetInfo'
    NOTRECRUITEDTANKMAN_WT_CLONE_BOSS_LABEL = '#tooltips:notrecruitedtankman/wt_clone_boss/label'
    NOTRECRUITEDTANKMAN_WT_CLONE_BOSS_DESC = '#tooltips:notrecruitedtankman/wt_clone_boss/desc'
    NOTRECRUITEDTANKMAN_WT_CLONE_BOSS_HOWTOGETINFO = '#tooltips:notrecruitedtankman/wt_clone_boss/howToGetInfo'
    NOTRECRUITEDTANKMAN_WT_CLONE_HUNTER_1_LABEL = '#tooltips:notrecruitedtankman/wt_clone_hunter_1/label'
    NOTRECRUITEDTANKMAN_WT_CLONE_HUNTER_1_DESC = '#tooltips:notrecruitedtankman/wt_clone_hunter_1/desc'
    NOTRECRUITEDTANKMAN_WT_CLONE_HUNTER_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/wt_clone_hunter_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_WT_CLONE_HUNTER_2_LABEL = '#tooltips:notrecruitedtankman/wt_clone_hunter_2/label'
    NOTRECRUITEDTANKMAN_WT_CLONE_HUNTER_2_DESC = '#tooltips:notrecruitedtankman/wt_clone_hunter_2/desc'
    NOTRECRUITEDTANKMAN_WT_CLONE_HUNTER_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/wt_clone_hunter_2/howToGetInfo'
    NOTRECRUITEDTANKMAN_WT_CLONE_HUNTER_3_LABEL = '#tooltips:notrecruitedtankman/wt_clone_hunter_3/label'
    NOTRECRUITEDTANKMAN_WT_CLONE_HUNTER_3_DESC = '#tooltips:notrecruitedtankman/wt_clone_hunter_3/desc'
    NOTRECRUITEDTANKMAN_WT_CLONE_HUNTER_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/wt_clone_hunter_3/howToGetInfo'
    NOTRECRUITEDTANKMAN_WT_CLONE_HUNTER_4_LABEL = '#tooltips:notrecruitedtankman/wt_clone_hunter_4/label'
    NOTRECRUITEDTANKMAN_WT_CLONE_HUNTER_4_DESC = '#tooltips:notrecruitedtankman/wt_clone_hunter_4/desc'
    NOTRECRUITEDTANKMAN_WT_CLONE_HUNTER_4_HOWTOGETINFO = '#tooltips:notrecruitedtankman/wt_clone_hunter_4/howToGetInfo'
    SKILL_NEWPERK_ZEROPERK_TITLE = '#tooltips:skill/newPerk/zeroPerk/title'
    SKILL_NEWPERK_ZEROPERK_TEXT = '#tooltips:skill/newPerk/zeroPerk/text'
    SKILL_NEWPERK_PERK_TITLE = '#tooltips:skill/newPerk/perk/title'
    SKILL_NEWPERK_PERK_TEXT = '#tooltips:skill/newPerk/perk/text'
    SKILL_NAME_BROTHERHOOD = '#tooltips:skill/name/brotherhood'
    NOTRECRUITEDTANKMAN_FISHERMAN_LABEL = '#tooltips:notrecruitedtankman/fisherman/label'
    NOTRECRUITEDTANKMAN_FISHERMAN_DESC = '#tooltips:notrecruitedtankman/fisherman/desc'
    NOTRECRUITEDTANKMAN_FISHERMAN_HOWTOGETINFO = '#tooltips:notrecruitedtankman/fisherman/howToGetInfo'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_5_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp17_5/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_6_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp17_6/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_6_DESC = '#tooltips:notrecruitedtankman/tankmen_bp17_6/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_6_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp17_6/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_7_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp17_7/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_7_DESC = '#tooltips:notrecruitedtankman/tankmen_bp17_7/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_7_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp17_7/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_8_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp17_8/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_8_DESC = '#tooltips:notrecruitedtankman/tankmen_bp17_8/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_8_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp17_8/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_9_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp17_9/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_9_DESC = '#tooltips:notrecruitedtankman/tankmen_bp17_9/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_9_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp17_9/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_10_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp17_10/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_10_DESC = '#tooltips:notrecruitedtankman/tankmen_bp17_10/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_10_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp17_10/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_11_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp17_11/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_11_DESC = '#tooltips:notrecruitedtankman/tankmen_bp17_11/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_11_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp17_11/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_12_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp17_12/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_12_DESC = '#tooltips:notrecruitedtankman/tankmen_bp17_12/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_12_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp17_12/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_13_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp17_13/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_13_DESC = '#tooltips:notrecruitedtankman/tankmen_bp17_13/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_13_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp17_13/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_14_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp17_14/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_14_DESC = '#tooltips:notrecruitedtankman/tankmen_bp17_14/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_14_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp17_14/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_15_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp17_15/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_15_DESC = '#tooltips:notrecruitedtankman/tankmen_bp17_15/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP17_15_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp17_15/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP18_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp18_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP18_1_DESC = '#tooltips:notrecruitedtankman/tankmen_bp18_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP18_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp18_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP18_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp18_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP18_2_DESC = '#tooltips:notrecruitedtankman/tankmen_bp18_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP18_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp18_2/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP18_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp18_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP18_3_DESC = '#tooltips:notrecruitedtankman/tankmen_bp18_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP18_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp18_3/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP18_4_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp18_4/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP18_4_DESC = '#tooltips:notrecruitedtankman/tankmen_bp18_4/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP18_4_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp18_4/howToGetInfo'
    NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_KEI_LABEL = '#tooltips:notrecruitedtankman/girls_und_panzer_kei/label'
    NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_KEI_DESC = '#tooltips:notrecruitedtankman/girls_und_panzer_kei/desc'
    NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_KEI_HOWTOGETINFO = '#tooltips:notrecruitedtankman/girls_und_panzer_kei/howToGetInfo'
    NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_NAOMI_LABEL = '#tooltips:notrecruitedtankman/girls_und_panzer_naomi/label'
    NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_NAOMI_DESC = '#tooltips:notrecruitedtankman/girls_und_panzer_naomi/desc'
    NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_NAOMI_HOWTOGETINFO = '#tooltips:notrecruitedtankman/girls_und_panzer_naomi/howToGetInfo'
    NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_SAUNDERS_LABEL = '#tooltips:notrecruitedtankman/girls_und_panzer_saunders/label'
    NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_SAUNDERS_DESC = '#tooltips:notrecruitedtankman/girls_und_panzer_saunders/desc'
    NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_SAUNDERS_HOWTOGETINFO = '#tooltips:notrecruitedtankman/girls_und_panzer_saunders/howToGetInfo'
    NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_ALISA_LABEL = '#tooltips:notrecruitedtankman/girls_und_panzer_alisa/label'
    NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_ALISA_DESC = '#tooltips:notrecruitedtankman/girls_und_panzer_alisa/desc'
    NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_ALISA_HOWTOGETINFO = '#tooltips:notrecruitedtankman/girls_und_panzer_alisa/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP18_5_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp18_5/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP18_5_DESC = '#tooltips:notrecruitedtankman/tankmen_bp18_5/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP18_5_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp18_5/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP18_6_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp18_6/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP18_6_DESC = '#tooltips:notrecruitedtankman/tankmen_bp18_6/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP18_6_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp18_6/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP18_7_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp18_7/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP18_7_DESC = '#tooltips:notrecruitedtankman/tankmen_bp18_7/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP18_7_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp18_7/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP18_8_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp18_8/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP18_8_DESC = '#tooltips:notrecruitedtankman/tankmen_bp18_8/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP18_8_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp18_8/howToGetInfo'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_BP1005_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp1005_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1005_1_DESC = '#tooltips:notrecruitedtankman/tankmen_bp1005_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1005_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp1005_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1005_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp1005_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1005_2_DESC = '#tooltips:notrecruitedtankman/tankmen_bp1005_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1005_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp1005_2/howToGetInfo'
    ...
    NOTRECRUITEDTANKMAN_CHEF_DAMIEN_LABEL = '#tooltips:notrecruitedtankman/chef_damien/label'
    NOTRECRUITEDTANKMAN_CHEF_DAMIEN_DESC = '#tooltips:notrecruitedtankman/chef_damien/desc'
    NOTRECRUITEDTANKMAN_CHEF_DAMIEN_HOWTOGETINFO = '#tooltips:notrecruitedtankman/chef_damien/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1006_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp1006_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1006_1_DESC = '#tooltips:notrecruitedtankman/tankmen_bp1006_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1006_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp1006_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1006_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp1006_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1006_2_DESC = '#tooltips:notrecruitedtankman/tankmen_bp1006_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1006_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp1006_2/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1006_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp1006_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1006_3_DESC = '#tooltips:notrecruitedtankman/tankmen_bp1006_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1006_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp1006_3/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1006_4_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp1006_4/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1006_4_DESC = '#tooltips:notrecruitedtankman/tankmen_bp1006_4/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1006_4_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp1006_4/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1006_5_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp1006_5/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1006_5_DESC = '#tooltips:notrecruitedtankman/tankmen_bp1006_5/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1006_5_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp1006_5/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1006_6_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp1006_6/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1006_6_DESC = '#tooltips:notrecruitedtankman/tankmen_bp1006_6/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP1006_6_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp1006_6/howToGetInfo'
    NOTRECRUITEDTANKMAN_LUNAR26_COMMANDER_LABEL = '#tooltips:notrecruitedtankman/lunar26_commander/label'
    NOTRECRUITEDTANKMAN_LUNAR26_COMMANDER_DESC = '#tooltips:notrecruitedtankman/lunar26_commander/desc'
    NOTRECRUITEDTANKMAN_LUNAR26_COMMANDER_HOWTOGETINFO = '#tooltips:notrecruitedtankman/lunar26_commander/howToGetInfo'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_BP19_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp19_1/howToGetInfo'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_BP19_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp19_2/howToGetInfo'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_BP19_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp19_3/howToGetInfo'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_BP19_4_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp19_4/howToGetInfo'
    NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_ERWIN_LABEL = '#tooltips:notrecruitedtankman/girls_und_panzer_erwin/label'
    NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_ERWIN_DESC = '#tooltips:notrecruitedtankman/girls_und_panzer_erwin/desc'
    NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_ERWIN_HOWTOGETINFO = '#tooltips:notrecruitedtankman/girls_und_panzer_erwin/howToGetInfo'
    NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_SAEMONZA_LABEL = '#tooltips:notrecruitedtankman/girls_und_panzer_saemonza/label'
    NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_SAEMONZA_DESC = '#tooltips:notrecruitedtankman/girls_und_panzer_saemonza/desc'
    NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_SAEMONZA_HOWTOGETINFO = '#tooltips:notrecruitedtankman/girls_und_panzer_saemonza/howToGetInfo'
    NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_CAESAR_LABEL = '#tooltips:notrecruitedtankman/girls_und_panzer_caesar/label'
    NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_CAESAR_DESC = '#tooltips:notrecruitedtankman/girls_und_panzer_caesar/desc'
    NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_CAESAR_HOWTOGETINFO = '#tooltips:notrecruitedtankman/girls_und_panzer_caesar/howToGetInfo'
    NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_ORYOU_LABEL = '#tooltips:notrecruitedtankman/girls_und_panzer_oryou/label'
    NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_ORYOU_DESC = '#tooltips:notrecruitedtankman/girls_und_panzer_oryou/desc'
    NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_ORYOU_HOWTOGETINFO = '#tooltips:notrecruitedtankman/girls_und_panzer_oryou/howToGetInfo'
    ...
    NOTRECRUITEDTANKMAN_TANKMEN_BP19_5_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp19_5/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP19_6_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp19_6/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP19_6_DESC = '#tooltips:notrecruitedtankman/tankmen_bp19_6/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP19_6_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp19_6/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP19_7_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp19_7/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP19_7_DESC = '#tooltips:notrecruitedtankman/tankmen_bp19_7/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP19_7_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp19_7/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP19_8_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp19_8/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP19_8_DESC = '#tooltips:notrecruitedtankman/tankmen_bp19_8/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP19_8_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp19_8/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP19_9_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp19_9/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP19_9_DESC = '#tooltips:notrecruitedtankman/tankmen_bp19_9/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP19_9_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp19_9/howToGetInfo'
    NOTRECRUITEDTANKMAN_SOUTHPAWBOXER_LABEL = '#tooltips:notrecruitedtankman/southpawBoxer/label'
    NOTRECRUITEDTANKMAN_SOUTHPAWBOXER_DESC = '#tooltips:notrecruitedtankman/southpawBoxer/desc'
    NOTRECRUITEDTANKMAN_SOUTHPAWBOXER_HOWTOGETINFO = '#tooltips:notrecruitedtankman/southpawBoxer/howToGetInfo'
    W2GTENABLE_HEADER = '#tooltips:w2gtEnable/header'
    W2GTENABLE_BODY = '#tooltips:w2gtEnable/body'
    W2GT_ZONE_BRAWLING_HEADER = '#tooltips:w2gt/zone/brawling/header'
    W2GT_ZONE_BRAWLING_BODY = '#tooltips:w2gt/zone/brawling/body'
    W2GT_ZONE_AMBUSH_HEADER = '#tooltips:w2gt/zone/ambush/header'
    W2GT_ZONE_AMBUSH_BODY = '#tooltips:w2gt/zone/ambush/body'
    W2GT_ZONE_UNIVERSAL_HEADER = '#tooltips:w2gt/zone/universal/header'
    W2GT_ZONE_UNIVERSAL_BODY = '#tooltips:w2gt/zone/universal/body'
    W2GT_ZONE_RECON_HEADER = '#tooltips:w2gt/zone/recon/header'
    W2GT_ZONE_RECON_BODY = '#tooltips:w2gt/zone/recon/body'
    W2GT_ZONE_ARTILLERY_HEADER = '#tooltips:w2gt/zone/artillery/header'
    W2GT_ZONE_ARTILLERY_BODY = '#tooltips:w2gt/zone/artillery/body'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P5_1_LABEL = '#tooltips:notrecruitedtankman/onslaught_p5_1/label'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P5_1_DESC = '#tooltips:notrecruitedtankman/onslaught_p5_1/desc'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P5_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/onslaught_p5_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P5_2_LABEL = '#tooltips:notrecruitedtankman/onslaught_p5_2/label'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P5_2_DESC = '#tooltips:notrecruitedtankman/onslaught_p5_2/desc'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P5_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/onslaught_p5_2/howToGetInfo'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P5_3_LABEL = '#tooltips:notrecruitedtankman/onslaught_p5_3/label'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P5_3_DESC = '#tooltips:notrecruitedtankman/onslaught_p5_3/desc'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P5_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/onslaught_p5_3/howToGetInfo'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P5_4_LABEL = '#tooltips:notrecruitedtankman/onslaught_p5_4/label'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P5_4_DESC = '#tooltips:notrecruitedtankman/onslaught_p5_4/desc'
    NOTRECRUITEDTANKMAN_ONSLAUGHT_P5_4_HOWTOGETINFO = '#tooltips:notrecruitedtankman/onslaught_p5_4/howToGetInfo'
    SHELL_MECHANICS_LOWCHARGESHOT_DESCRIPTION_SPECIALMODE = '#tooltips:shell/mechanics/lowChargeShot/description/specialMode'
    SHELL_MECHANICS_LOWCHARGESHOT_DESCRIPTION_AFFECTEDPARAMS = '#tooltips:shell/mechanics/lowChargeShot/description/affectedParams'
    SHELL_MECHANICS_LOWCHARGESHOT_DESCRIPTION = '#tooltips:shell/mechanics/lowChargeShot/description'
    SHELL_MECHANICS_LOWCHARGESHOT_PARAMSHEADER_BASIC = '#tooltips:shell/mechanics/lowChargeShot/paramsHeader/basic'
    SHELL_MECHANICS_LOWCHARGESHOT_PARAMSHEADER_SPECIFIC = '#tooltips:shell/mechanics/lowChargeShot/paramsHeader/specific'
    SHELL_MECHANICS_LOWCHARGESHOT_INFOBLOCK = '#tooltips:shell/mechanics/lowChargeShot/infoBlock'
    SHELL_MECHANICS_SHELLPARAMSSWITCHER_DESCRIPTION = '#tooltips:shell/mechanics/shellParamsSwitcher/description'
    SHELL_MECHANICS_SHELLPARAMSSWITCHER_PARAMSHEADER_BASIC = '#tooltips:shell/mechanics/shellParamsSwitcher/paramsHeader/basic'
    SHELL_MECHANICS_SHELLPARAMSSWITCHER_PARAMSHEADER_SPECIFIC = '#tooltips:shell/mechanics/shellParamsSwitcher/paramsHeader/specific'
    SHELL_MECHANICS_SHELLCALIBRATION_DESCRIPTION = '#tooltips:shell/mechanics/shellCalibration/description'
    SHELL_MECHANICS_SHELLCALIBRATION_PARAMSHEADER = '#tooltips:shell/mechanics/shellCalibration/paramsHeader'
    SPECIALMECHANICS_SHELLCALIBRATION_AVGDAMAGE = '#tooltips:specialMechanics/shellCalibration/avgDamage'
    SPECIALMECHANICS_SHELLCALIBRATION_AVGPIERCINGPOWER = '#tooltips:specialMechanics/shellCalibration/avgPiercingPower'
    SHELL_MECHANICS_BUSTLEFEED_DESCRIPTION = '#tooltips:shell/mechanics/bustleFeed/description'
    SHELL_MECHANICS_BUSTLEFEED_PARAMSHEADER_BASIC = '#tooltips:shell/mechanics/bustleFeed/paramsHeader/basic'
    SHELL_MECHANICS_BUSTLEFEED_PARAMSHEADER_SPECIFIC = '#tooltips:shell/mechanics/bustleFeed/paramsHeader/specific'
    NOTRECRUITEDTANKMAN_TANKMEN_BP20_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp20_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP20_1_DESC = '#tooltips:notrecruitedtankman/tankmen_bp20_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP20_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp20_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP20_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp20_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP20_2_DESC = '#tooltips:notrecruitedtankman/tankmen_bp20_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP20_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp20_2/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP20_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp20_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP20_3_DESC = '#tooltips:notrecruitedtankman/tankmen_bp20_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP20_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp20_3/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP20_4_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp20_4/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP20_4_DESC = '#tooltips:notrecruitedtankman/tankmen_bp20_4/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP20_4_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp20_4/howToGetInfo'
    NOTRECRUITEDTANKMAN_TIGERSMIDFIELDER_LABEL = '#tooltips:notrecruitedtankman/tigersMidfielder/label'
    NOTRECRUITEDTANKMAN_TIGERSMIDFIELDER_DESC = '#tooltips:notrecruitedtankman/tigersMidfielder/desc'
    NOTRECRUITEDTANKMAN_TIGERSMIDFIELDER_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tigersMidfielder/howToGetInfo'
    NOTRECRUITEDTANKMAN_TIGERSWINGER_LABEL = '#tooltips:notrecruitedtankman/tigersWinger/label'
    NOTRECRUITEDTANKMAN_TIGERSWINGER_DESC = '#tooltips:notrecruitedtankman/tigersWinger/desc'
    NOTRECRUITEDTANKMAN_TIGERSWINGER_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tigersWinger/howToGetInfo'
    NOTRECRUITEDTANKMAN_DESERTRAT_LABEL = '#tooltips:notrecruitedtankman/desertRat/label'
    NOTRECRUITEDTANKMAN_DESERTRAT_DESC = '#tooltips:notrecruitedtankman/desertRat/desc'
    NOTRECRUITEDTANKMAN_DESERTRAT_HOWTOGETINFO = '#tooltips:notrecruitedtankman/desertRat/howToGetInfo'
    NOTRECRUITEDTANKMAN_SERVICEWOMAN_LABEL = '#tooltips:notrecruitedtankman/servicewoman/label'
    NOTRECRUITEDTANKMAN_SERVICEWOMAN_DESC = '#tooltips:notrecruitedtankman/servicewoman/desc'
    NOTRECRUITEDTANKMAN_SERVICEWOMAN_HOWTOGETINFO = '#tooltips:notrecruitedtankman/servicewoman/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP20_5_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp20_5/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP20_5_DESC = '#tooltips:notrecruitedtankman/tankmen_bp20_5/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP20_5_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp20_5/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP20_6_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp20_6/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP20_6_DESC = '#tooltips:notrecruitedtankman/tankmen_bp20_6/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP20_6_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp20_6/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP20_7_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp20_7/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP20_7_DESC = '#tooltips:notrecruitedtankman/tankmen_bp20_7/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP20_7_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp20_7/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP20_8_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp20_8/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP20_8_DESC = '#tooltips:notrecruitedtankman/tankmen_bp20_8/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP20_8_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp20_8/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP20_9_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp20_9/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP20_9_DESC = '#tooltips:notrecruitedtankman/tankmen_bp20_9/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP20_9_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp20_9/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP21_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp21_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP21_1_DESC = '#tooltips:notrecruitedtankman/tankmen_bp21_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP21_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp21_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP21_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp21_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP21_2_DESC = '#tooltips:notrecruitedtankman/tankmen_bp21_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP21_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp21_2/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP21_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp21_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP21_3_DESC = '#tooltips:notrecruitedtankman/tankmen_bp21_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP21_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp21_3/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_BP21_4_LABEL = '#tooltips:notrecruitedtankman/tankmen_bp21_4/label'
    NOTRECRUITEDTANKMAN_TANKMEN_BP21_4_DESC = '#tooltips:notrecruitedtankman/tankmen_bp21_4/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_BP21_4_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_bp21_4/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_PM4_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_pm4_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_PM4_1_DESC = '#tooltips:notrecruitedtankman/tankmen_pm4_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_PM4_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_pm4_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_JAGER_MAILAND_LABEL = '#tooltips:notrecruitedtankman/jager_mailand/label'
    NOTRECRUITEDTANKMAN_JAGER_MAILAND_DESC = '#tooltips:notrecruitedtankman/jager_mailand/desc'
    NOTRECRUITEDTANKMAN_JAGER_MAILAND_HOWTOGETINFO = '#tooltips:notrecruitedtankman/jager_mailand/howToGetInfo'
    NOTRECRUITEDTANKMAN_JAGER_MOUZAKROBAT_LABEL = '#tooltips:notrecruitedtankman/jager_mouzakrobat/label'
    NOTRECRUITEDTANKMAN_JAGER_MOUZAKROBAT_DESC = '#tooltips:notrecruitedtankman/jager_mouzakrobat/desc'
    NOTRECRUITEDTANKMAN_JAGER_MOUZAKROBAT_HOWTOGETINFO = '#tooltips:notrecruitedtankman/jager_mouzakrobat/howToGetInfo'
    NOTRECRUITEDTANKMAN_BIRTHDAY16_CREW_1_LABEL = '#tooltips:notrecruitedtankman/birthday16_crew_1/label'
    NOTRECRUITEDTANKMAN_BIRTHDAY16_CREW_1_DESC = '#tooltips:notrecruitedtankman/birthday16_crew_1/desc'
    NOTRECRUITEDTANKMAN_BIRTHDAY16_CREW_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/birthday16_crew_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_BIRTHDAY16_CREW_2_LABEL = '#tooltips:notrecruitedtankman/birthday16_crew_2/label'
    NOTRECRUITEDTANKMAN_BIRTHDAY16_CREW_2_DESC = '#tooltips:notrecruitedtankman/birthday16_crew_2/desc'
    NOTRECRUITEDTANKMAN_BIRTHDAY16_CREW_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/birthday16_crew_2/howToGetInfo'
    NOTRECRUITEDTANKMAN_BIRTHDAY16_CREW_3_LABEL = '#tooltips:notrecruitedtankman/birthday16_crew_3/label'
    NOTRECRUITEDTANKMAN_BIRTHDAY16_CREW_3_DESC = '#tooltips:notrecruitedtankman/birthday16_crew_3/desc'
    NOTRECRUITEDTANKMAN_BIRTHDAY16_CREW_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/birthday16_crew_3/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_1_LABEL = '#tooltips:notrecruitedtankman/tankmen_mtlb4_1/label'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_1_DESC = '#tooltips:notrecruitedtankman/tankmen_mtlb4_1/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_1_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_mtlb4_1/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_2_LABEL = '#tooltips:notrecruitedtankman/tankmen_mtlb4_2/label'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_2_DESC = '#tooltips:notrecruitedtankman/tankmen_mtlb4_2/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_2_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_mtlb4_2/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_3_LABEL = '#tooltips:notrecruitedtankman/tankmen_mtlb4_3/label'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_3_DESC = '#tooltips:notrecruitedtankman/tankmen_mtlb4_3/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_3_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_mtlb4_3/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_4_LABEL = '#tooltips:notrecruitedtankman/tankmen_mtlb4_4/label'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_4_DESC = '#tooltips:notrecruitedtankman/tankmen_mtlb4_4/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_4_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_mtlb4_4/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_5_LABEL = '#tooltips:notrecruitedtankman/tankmen_mtlb4_5/label'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_5_DESC = '#tooltips:notrecruitedtankman/tankmen_mtlb4_5/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_5_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_mtlb4_5/howToGetInfo'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_6_LABEL = '#tooltips:notrecruitedtankman/tankmen_mtlb4_6/label'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_6_DESC = '#tooltips:notrecruitedtankman/tankmen_mtlb4_6/desc'
    NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_6_HOWTOGETINFO = '#tooltips:notrecruitedtankman/tankmen_mtlb4_6/howToGetInfo'
    ...
    TANK_PARAMS_DESC_ENUM = (
     TANK_PARAMS_DESC_LOWCHARGESHOTAVGDAMAGE,
     TANK_PARAMS_DESC_LOWCHARGESHOTPENETRATION,
     TANK_PARAMS_DESC_LOWCHARGESHOTRATEOFFIRE,
     TANK_PARAMS_DESC_LOWCHARGESHOTDISPERTION,
     TANK_PARAMS_DESC_LOWCHARGESHOTVELOCITY,
     TANK_PARAMS_DESC_LOWCHARGESHOTBLOCKDURATION,
     TANK_PARAMS_DESC_SHELLCALIBRATIONAVGPENETRATION,
     TANK_PARAMS_DESC_SHELLCALIBRATIONAVGDAMAGE,
     ...
     TANK_PARAMS_DESC_FURYRELOADEFFICIENCYLEVELPERHIT,
     TANK_PARAMS_DESC_FURYRELOADEFFICIENCYLEVELPERDESTRUCTION,
     TANK_PARAMS_DESC_ACCURACYDISPERSIONCAP,
     TANK_PARAMS_DESC_ACCURACYWHILEMOVINGDISPERSIONCAP,
     TANK_PARAMS_DESC_MAXACCURACYLEVEL,
     TANK_PARAMS_DESC_ACCURACYDISPERSIONPERLEVEL,
     TANK_PARAMS_DESC_ACCURACYSPEEDLIMIT,
     TANK_PARAMS_DESC_ACCURACYLEVELGAINTIME,
     TANK_PARAMS_DESC_PREHEATDMGCAP,
     TANK_PARAMS_DESC_PREHEATDISPERSIONCAP,
     TANK_PARAMS_DESC_PREHEATTIMETOFULL,
     TANK_PARAMS_DESC_PREHEATTIMETOZERO,
     TANK_PARAMS_DESC_PREHEATSPEEDLIMIT,
     TANK_PARAMS_DESC_PREHEATTRANSITIONDELAY,
     TANK_PARAMS_DESC_ENGINEPOWERWITHBOOSTERS,
     TANK_PARAMS_DESC_TOPSPEEDWITHBOOSTERS,
     TANK_PARAMS_DESC_REVERSESPEEDREDUCTIONWITHBOOSTERS,
     TANK_PARAMS_DESC_TRAVERSESPEEDREDUCTIONWITHBOOSTERS,
     TANK_PARAMS_DESC_BOOSTERDURATION,
     TANK_PARAMS_DESC_BOOSTERCOOLINGTIME,
     TANK_PARAMS_DESC_REACTIVATIONLIMIT,
     TANK_PARAMS_DESC_REACTIVATIONDELAY,
     TANK_PARAMS_DESC_HEATAVGDMGPERLVL,
     TANK_PARAMS_DESC_HEATTIMETOREACHLEVEL,
     TANK_PARAMS_DESC_HEATTIMEBEFOREOVERHEAT,
     TANK_PARAMS_DESC_HEATCHARGEOVERHEATDURATION,
     TANK_PARAMS_DESC_PASSIVECOINCIDECESHOOTINGCHARGE,
     TANK_PARAMS_DESC_ACTIVECOINCIDECESHOOTINGCHARGE,
     TANK_PARAMS_DESC_COINCIDENCEELECTROMECHANICALSIGHTDURATION,
     TANK_PARAMS_DESC_AIMINGTIMECOINCIDENCEELECTROMECHANICALSIGHT,
     TANK_PARAMS_DESC_DISPERSIONAT100MCOINCIDENCEELECTROMECHANICALSIGHT,
     TANK_PARAMS_DESC_RELOADTIMECOINCIDENCE,
     TANK_PARAMS_DESC_SWITCHENGINEMODEBOTHMODES,
     TANK_PARAMS_DESC_TURBOSPEEDCAP,
     TANK_PARAMS_DESC_ENGINETURBOPOWERCAP,
     TANK_PARAMS_DESC_AIMINGTIMETURBO,
     TANK_PARAMS_DESC_MOVEMENTTRAVERSEDISPERSIONTURBO,
     TANK_PARAMS_DESC_HULLTRAVERSEDISPERSIONTURBO,
     TANK_PARAMS_DESC_GUNTRAVERSEDISPERSIONTURBO,
     TANK_PARAMS_DESC_IONAFTERBURNERPASSIVETURBOCHARGE,
     TANK_PARAMS_DESC_IONAFTERBURNERACTIVETURBOCHARGE,
     TANK_PARAMS_DESC_IONAFTERBURNERDURATION,
     TANK_PARAMS_DESC_IONAFTERBURNERDURATIONSPEEDCAP,
     TANK_PARAMS_DESC_IONAFTERBURNERDURATIONENGINEPOWER,
     TANK_PARAMS_DESC_DESIGNATORINITIALCOOLDOWNS,
     TANK_PARAMS_DESC_DESIGNATORCOOLDOWNS,
     TANK_PARAMS_DESC_DESIGNATORMARKDURATIONS,
     TANK_PARAMS_DESC_DESIGNATORMARKEDENEMIESADDITIONALDAMAGE,
     ...
     TANK_PARAMS_DESC_FORWARDMAXSPEED,
     ...
     TANK_PARAMS_DESC_TEMPERATURERELOADTIME,
     ...
     TANK_PARAMS_DESC_AUTORELOADTIME_BOOST_SHORTDESCRIPTION,
     TANK_PARAMS_DESC_RELOADTIMESECS,
     TANK_PARAMS_DESC_RELOADTIMESECS_TWINGUN,
     TANK_PARAMS_DESC_TWINGUNSWITCHFIREMODETIME,
     TANK_PARAMS_DESC_TWINGUNTOPSPEED,
     TANK_PARAMS_DESC_SHOTDISPERSIONANGLE_TWINGUN,
     TANK_PARAMS_DESC_SHELLLOADINGTIME,
     ...
     TANK_PARAMS_DESC_TEMPERATUREAVGDAMAGEPERMINUTE,
     ...
     TANK_PARAMS_DESC_TEMPERATURESHOTDISPERSIONANGLE,
     TANK_PARAMS_DESC_SHOTDISPERSIONANGLE_WITHDUALACCURACY,
     TANK_PARAMS_DESC_AIMINGTIME,
     TANK_PARAMS_DESC_TEMPERATUREAIMINGTIME,
     ...
     TANK_PARAMS_DESC_IMPROVEDDAMAGEENEMIESBYRAMMING,
     TANK_PARAMS_DESC_IMPROVEDDAMAGEENEMIESCHASSISBYRAMMING,
     TANK_PARAMS_DESC_CONCENTRATIONMODECOOLDOWN,
     TANK_PARAMS_DESC_CONCENTRATIONMODEDURATION,
     TANK_PARAMS_DESC_EXTRASHOTCLIPRELOADTIME,
     TANK_PARAMS_DESC_POWERMODETHRESHOLD,
     TANK_PARAMS_DESC_POWERMODEDURATION,
     TANK_PARAMS_DESC_SECONDARYRELOADTIMESECS,
     TANK_PARAMS_DESC_SECONDARYTOTALBURSTSIZE,
     TANK_PARAMS_DESC_SECONDARYAVGDAMAGE,
     TANK_PARAMS_DESC_SECONDARYAVGPIERCINGPOWER,
     TANK_PARAMS_DESC_PILLBOXHORIZONTALROTATIONSPEED,
     TANK_PARAMS_DESC_PILLBOXVERTICALROTATIONSPEED,
     TANK_PARAMS_DESC_PILLBOXSWITCHONTIME,
     TANK_PARAMS_DESC_PILLBOXSWITCHOFFTIME,
     TANK_PARAMS_DESC_CHARGEABLEBURSTPENETRATIONCOUNT,
     TANK_PARAMS_DESC_CHARGEABLEBURSTSIZE,
     TANK_PARAMS_DESC_CHARGEABLEBURSTRELOAD,
     ...
     TANK_PARAMS_DESC_COOLINGDELAY,
     TANK_PARAMS_DESC_COOLINGTIME,
     TANK_PARAMS_DESC_HEATINGPERSHOT,
     TANK_PARAMS_DESC_OVERHEATDURATION,
     TANK_PARAMS_DESC_TIMETOOVERHEAT,
     TANK_PARAMS_DESC_STAGEDJETBOOSTERSENGINEPOWER,
     TANK_PARAMS_DESC_STAGEDJETBOOSTERSTOPSPEED,
     TANK_PARAMS_DESC_STAGEDJETBOOSTERSSPEEDLIMITS,
     TANK_PARAMS_DESC_STAGEDJETBOOSTERSROTATIONSPEED,
     TANK_PARAMS_DESC_STAGEDJETBOOSTERSCHARGESCOUNT,
     TANK_PARAMS_DESC_STAGEDJETBOOSTERSCHARGEDURATION,
     TANK_PARAMS_DESC_STAGEDJETBOOSTERSCOOLDOWNTIME,
     TANK_PARAMS_DESC_PROPELLANTPRELIMITDAMAGEBONUS,
     TANK_PARAMS_DESC_PROPELLANTPOSTLIMITDAMAGESPIKE,
     TANK_PARAMS_DESC_PROPELLANTPOSTLIMITDAMAGEBONUS,
     TANK_PARAMS_DESC_PROPELLANTCHARGINGPERSEC,
     TANK_PARAMS_DESC_PROPELLANTCHARGESPENDINGAFTERSHOT,
     TANK_PARAMS_DESC_PROPELLANTCHARGELIMIT,
     TANK_PARAMS_DESC_PROPELLANTDISCHARGINGPERSEC,
     TANK_PARAMS_DESC_PROPELLANTPOSTLIMITDISPERSION,
     TANK_PARAMS_DESC_PROPELLANTPOSTLIMITAIMINGTIME,
     TANK_PARAMS_DESC_PROPELLANTOVERCHARGESWITCHCOOLDOWN,
     TANK_PARAMS_DESC_WHEELEDDASHABILITYDURATION,
     TANK_PARAMS_DESC_WHEELEDDASHENGINEPOWER,
     TANK_PARAMS_DESC_WHEELEDDASHTOPSPEED,
     TANK_PARAMS_DESC_WHEELEDDASHABILITYRELOADTIME,
     TANK_PARAMS_DESC_WHEELEDDASHABILITYRELOADTIMEBONUS,
     TANK_PARAMS_DESC_WHEELEDDASHSPEEDLIMITS,
     TANK_PARAMS_DESC_WHEELEDDASHREVERSESPEED,
     TANK_PARAMS_DESC_AUXILIARYROCKETLAUNCHERRELOADTIME,
     TANK_PARAMS_DESC_AUXILIARYROCKETLAUNCHERAVGDAMAGE,
     TANK_PARAMS_DESC_AUXILIARYROCKETLAUNCHERPENETRATION,
     TANK_PARAMS_DESC_AUXILIARYROCKETLAUNCHERVELOCITY,
     TANK_PARAMS_DESC_AUXILIARYROCKETLAUNCHERDISPERSION,
     TANK_PARAMS_DESC_SHELLPARAMSSWITCHINGTIME,
     TANK_PARAMS_DESC_AUTORELOADERSURGEMAXCHARGES,
     TANK_PARAMS_DESC_AUTORELOADERSURGEINITCHARGES,
     TANK_PARAMS_DESC_AUTORELOADERSURGECHARGETIMESLOW,
     TANK_PARAMS_DESC_AUTORELOADERSURGECHARGETIMEFAST,
     TANK_PARAMS_DESC_AUTORELOADERSURGEBOOSTEDRELOADTIME,
     TANK_PARAMS_DESC_BUSTLEFEEDDAMAGEPERSHOT,
     TANK_PARAMS_DESC_BUSTLEFEEDRATEOFFIRE,
     TANK_PARAMS_DESC_BUSTLEFEEDSWITCHINGTOEASMMODE,
     TANK_PARAMS_DESC_BUSTLEFEEDSWITCHINGTOSTANDARDMODE,
     TANK_PARAMS_DESC_BUSTLEFEEDMAXSPEED,
     TANK_PARAMS_DESC_SIGHTPOINTERDEPLOYTIME,
     TANK_PARAMS_DESC_SIGHTPOINTERRELOADTIME,
     TANK_PARAMS_DESC_SIGHTPOINTERDURATION,
     TANK_PARAMS_DESC_SIGHTPOINTERROTATIONSPEED,
     TANK_PARAMS_DESC_SIGHTPOINTERSECTORANGLESTART,
     TANK_PARAMS_DESC_SIGHTPOINTERSECTORANGLEEND,
     TANK_PARAMS_DESC_SIGHTPOINTERSELFSPOTTINGTIME,
     TANK_PARAMS_DESC_SIGHTPOINTERVIEWRANGE,
     TANK_PARAMS_DESC_SIGHTPOINTERCONSEALMENTFOLIAGE,
     TANK_PARAMS_DESC_SIGHTPOINTERCONSEALMENTMOVING)
    ...
    AWARDITEM_ALL_HEADER_ENUM = (
     ...
     AWARDITEM_EXCLUDED_MAPS_HEADER,
     AWARDITEM_FREE_EQUIPMENT_DEMOUNTING_HEADER,
     AWARDITEM_EXCLUSIVE_VEHICLE_HEADER,
     AWARDITEM_ATTENDANCE_REWARD_HEADER,
     AWARDITEM_BATTLE_BONUSES_HEADER,
    ...
    AWARDITEM_ALL_BODY_ENUM = (
     ...
     AWARDITEM_EXCLUDED_MAPS_BODY,
     AWARDITEM_FREE_EQUIPMENT_DEMOUNTING_BODY,
     AWARDITEM_EXCLUSIVE_VEHICLE_BODY,
     AWARDITEM_ATTENDANCE_REWARD_BODY,
     AWARDITEM_BATTLE_BONUSES_BODY,
    ...
    VEHICLEPREVIEW_BUYBUTTON_ALL_ENUM = (
     ...
     VEHICLEPREVIEW_BUYBUTTON_WALLETUNAVAILABLE_HEADER,
     VEHICLEPREVIEW_BUYBUTTON_WALLETUNAVAILABLE_BODY,
    ...
    ADVANCED_ENUM = (
     ...
     ADVANCED_LOW_CHARGE_SHOT_FOOTER,
     ADVANCED_LOW_CHARGE_SHOT_FIREMODE,
     ADVANCED_LOW_CHARGE_SHOT_FIRERATE,
     ...
     ADVANCED_QUALITYFUEL,
     ADVANCED_EXCELLENTFUEL,
     ...
     ADVANCED_MODERNIZEDIMPROVEDSIGHTSENHANCEDAIMDRIVES,
     ADVANCED_MODERNIZEDAIMDRIVESAIMINGSTABILIZER,
     ADVANCED_MODERNIZEDEXTRAHEALTHRESERVEANTIFRAGMENTATIONLINING,
     ADVANCED_MODERNIZEDTURBOCHARGERROTATIONMECHANISM,
     ADVANCED_IMPROVEDSIGHTS,
     ADVANCED_EXTRAHEALTHRESERVE,
     ADVANCED_IMPROVEDRADIOCOMMUNICATION,
    ...
    NOTRECRUITEDTANKMAN_ALL_EVENT_ENUM = (
     ...
     NOTRECRUITEDTANKMAN_OOW21_TANKER_2_COMMANDER_EVENT,
     NOTRECRUITEDTANKMAN_OOW21_TANKER_3_COMMANDER_EVENT,
     NOTRECRUITEDTANKMAN_OOW21_TANKER_4_COMMANDER_EVENT,
     NOTRECRUITEDTANKMAN_NY23RUBY_GIRL_1_EVENT,
     NOTRECRUITEDTANKMAN_NY23_GIRL_M_EVENT,
     NOTRECRUITEDTANKMAN_NY25DEFAULTGIRL_EVENT,
     NOTRECRUITEDTANKMAN_NY25_MEN_EVENT,
     NOTRECRUITEDTANKMAN_NY26DEFAULTGIRL_EVENT,
     NOTRECRUITEDTANKMAN_NY26_MEN_EVENT)
    NOTRECRUITEDTANKMAN_ALL_LABEL_ENUM = (
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_LABEL,
     ...
     NOTRECRUITEDTANKMAN_COMMANDER_STARLIGHT_LABEL,
     NOTRECRUITEDTANKMAN_COMMANDER_MAEVE_LABEL,
     ...
     NOTRECRUITEDTANKMAN_COMMANDER_PATRICK_LABEL,
     NOTRECRUITEDTANKMAN_NY20WOMAN_LABEL,
     NOTRECRUITEDTANKMAN_NY20DEFAULTGIRL_LABEL,
     NOTRECRUITEDTANKMAN_NY20MEN_LABEL,
     NOTRECRUITEDTANKMAN_NY20SNOWMEN_LABEL,
     NOTRECRUITEDTANKMAN_NY21MEN_LABEL,
     NOTRECRUITEDTANKMAN_NY21WOMAN_LABEL,
     NOTRECRUITEDTANKMAN_BOB20_COMMANDER1_RU_LABEL,
     NOTRECRUITEDTANKMAN_BOB20_COMMANDER2_RU_LABEL,
     NOTRECRUITEDTANKMAN_BOB20_COMMANDER3_RU_LABEL,
     NOTRECRUITEDTANKMAN_BOB20_COMMANDER4_RU_LABEL,
     NOTRECRUITEDTANKMAN_BOB20_COMMANDER1_EU_LABEL,
     NOTRECRUITEDTANKMAN_BOB20_COMMANDER2_EU_LABEL,
     NOTRECRUITEDTANKMAN_BOB20_COMMANDER3_EU_LABEL,
     NOTRECRUITEDTANKMAN_BOB20_COMMANDER4_EU_LABEL,
     NOTRECRUITEDTANKMAN_BOB20_COMMANDER1_NA_LABEL,
     NOTRECRUITEDTANKMAN_BOB20_COMMANDER2_NA_LABEL,
     NOTRECRUITEDTANKMAN_BOB20_COMMANDER1_ASIA_LABEL,
     NOTRECRUITEDTANKMAN_BOB20_COMMANDER2_ASIA_LABEL,
     NOTRECRUITEDTANKMAN_HW19_COMMANDERS_LABEL,
     NOTRECRUITEDTANKMAN_HW21_COMMANDER1_LABEL,
     NOTRECRUITEDTANKMAN_HW21_COMMANDER2_LABEL,
     NOTRECRUITEDTANKMAN_HW21_COMMANDER4_LABEL,
     NOTRECRUITEDTANKMAN_HW21_COMMANDER5_LABEL,
     NOTRECRUITEDTANKMAN_HW24_COMMANDER1_LABEL,
     NOTRECRUITEDTANKMAN_HW24_COMMANDER2_LABEL,
     NOTRECRUITEDTANKMAN_HW24_COMMANDER4_LABEL,
     NOTRECRUITEDTANKMAN_HW24_COMMANDER5_LABEL,
     NOTRECRUITEDTANKMAN_HW25_QUICKYBABY_LABEL,
     NOTRECRUITEDTANKMAN_HW25_MAILAND_LABEL,
     NOTRECRUITEDTANKMAN_HW25_MOUZAKROBAT_LABEL,
     NOTRECRUITEDTANKMAN_HW25_SKILL4LTU_LABEL,
     NOTRECRUITEDTANKMAN_HW25_LUJUN_CN_LABEL,
     NOTRECRUITEDTANKMAN_HW25_TITI_CN_LABEL,
     NOTRECRUITEDTANKMAN_HW25_DAKUN_CN_LABEL,
     NOTRECRUITEDTANKMAN_HW25_PANCHEZHANG_CN_LABEL,
     NOTRECRUITEDTANKMAN_COMMANDER_BP1_LABEL,
     ...
     NOTRECRUITEDTANKMAN_COMMANDER_BINGO_LABEL,
     NOTRECRUITEDTANKMAN_COMMANDER_BARONESS_LABEL,
     ...
     NOTRECRUITEDTANKMAN_COMMANDER_NANSEN_LABEL,
     ...
     NOTRECRUITEDTANKMAN_COMMANDER_TWITCH50_LABEL,
     NOTRECRUITEDTANKMAN_POLISH_COMMANDER_LABEL,
     ...
     NOTRECRUITEDTANKMAN_OOW21_STRATEGIST_COMMANDER_LABEL,
     NOTRECRUITEDTANKMAN_OOW21_TANKER_1_COMMANDER_LABEL,
     ...
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_RU2_KORBENDAILAS_LABEL,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_RU3_LEBWA_LABEL,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_RU3_INSPIRER_LABEL,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_RU4_EVILGRANNY_LABEL,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_RU4_NEARYOU_LABEL,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_EU1_CIRCON_LABEL,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_EU2_DAKILLZOR_LABEL,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_EU3_NEWMULTI2K_LABEL,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_EU4_ORZANEL_LABEL,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_NA1_CABBAGEMECHANIC_LABEL,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_NA2_TRAGICLOSS_LABEL,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_NA3_CMDRAF_LABEL,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_ASIA1_MASTERTORTOISE_LABEL,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_ASIA2_SUMMERTIGER_LABEL,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_ASIA3_MAHARLIKA_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP3_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP3_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP3_3_LABEL,
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_BP7_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP7_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP7_3_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP7_4_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP8_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP8_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP8_3_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP8_4_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP8_5_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP8_6_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP8_7_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP8_8_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP9_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP9_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP9_3_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP10_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP10_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP10_3_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BPH_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BPH_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BPH_3_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BPH_4_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP11_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP11_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP11_3_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP11_4_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_3_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_4_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_5_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_6_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_7_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1003_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_8_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_9_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_10_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1002_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1002_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1002_3_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1002_4_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1002_5_LABEL,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P3_1_LABEL,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P3_2_LABEL,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P3_3_LABEL,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P3_4_LABEL,
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_BP13_5_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP13_6_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP13_7_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP13_8_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP13_9_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_3_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_4_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_5_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_6_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_AUC_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_AUC_2_LABEL,
     ...
     NOTRECRUITEDTANKMAN_NY22MEN_A_LABEL,
     NOTRECRUITEDTANKMAN_NY22MEN_LABEL,
     NOTRECRUITEDTANKMAN_NY22WOMAN_LABEL,
     NOTRECRUITEDTANKMAN_NY22DEFAULTGIRL_LABEL,
     NOTRECRUITEDTANKMAN_NY23RUBY_GIRL_1_LABEL,
     NOTRECRUITEDTANKMAN_NY23_GIRL_M_LABEL,
     NOTRECRUITEDTANKMAN_NY23DEFAULTGIRL_LABEL,
     NOTRECRUITEDTANKMAN_NY23_GIRL_1_LABEL,
     NOTRECRUITEDTANKMAN_NY23_GIRL_2_LABEL,
     NOTRECRUITEDTANKMAN_NY23_GIRL_3_LABEL,
     NOTRECRUITEDTANKMAN_NY23_GIRL_4_LABEL,
     NOTRECRUITEDTANKMAN_NY24DEFAULTGIRL_LABEL,
     NOTRECRUITEDTANKMAN_NY24_MEN_LABEL,
     NOTRECRUITEDTANKMAN_NY24_GIRL_1_LABEL,
     NOTRECRUITEDTANKMAN_NY24_GIRL_2_LABEL,
     NOTRECRUITEDTANKMAN_NY24_GIRL_3_LABEL,
     NOTRECRUITEDTANKMAN_NY24_GIRL_4_LABEL,
     NOTRECRUITEDTANKMAN_NY25DEFAULTGIRL_LABEL,
     NOTRECRUITEDTANKMAN_NY25_MEN_LABEL,
     NOTRECRUITEDTANKMAN_NY25_GIRL_1_LABEL,
     NOTRECRUITEDTANKMAN_NY25_GIRL_2_LABEL,
     NOTRECRUITEDTANKMAN_NY25_GIRL_3_LABEL,
     NOTRECRUITEDTANKMAN_NY25_GIRL_4_LABEL,
     NOTRECRUITEDTANKMAN_NY26DEFAULTGIRL_LABEL,
     NOTRECRUITEDTANKMAN_NY26_MEN_LABEL,
     NOTRECRUITEDTANKMAN_NY26_GIRL_1_LABEL,
     NOTRECRUITEDTANKMAN_NY26_GIRL_2_LABEL,
     NOTRECRUITEDTANKMAN_NY26_GIRL_3_LABEL,
     NOTRECRUITEDTANKMAN_NY26_GIRL_4_LABEL,
     ...
     NOTRECRUITEDTANKMAN_WT_2023_HANNELORE_LABEL,
     NOTRECRUITEDTANKMAN_WT_2023_DRIVER_LABEL,
     NOTRECRUITEDTANKMAN_WT_2024_VONKRIEGER_LABEL,
     NOTRECRUITEDTANKMAN_WT_2024_ERMELINDA_LABEL,
     NOTRECRUITEDTANKMAN_WT_2024_QUICKYBABY_LABEL,
     NOTRECRUITEDTANKMAN_WT_2024_DAKILLZOR_LABEL,
     NOTRECRUITEDTANKMAN_WT_2024_MOUZAKROBAT_LABEL,
     NOTRECRUITEDTANKMAN_WT_2024_SKILL4LTU_LABEL,
     NOTRECRUITEDTANKMAN_WT_CN2024_ZHONGPENGFEI_LABEL,
     NOTRECRUITEDTANKMAN_WT_CN2024_BMENG_LABEL,
     NOTRECRUITEDTANKMAN_WT_CN2024_YITUANTUAN_LABEL,
     NOTRECRUITEDTANKMAN_WT_CN2024_SAONIAN_LABEL,
     NOTRECRUITEDTANKMAN_COSM02_KIRK_LABEL,
     NOTRECRUITEDTANKMAN_COSM02_SPOCK_LABEL,
     NOTRECRUITEDTANKMAN_COSM02_SULU_LABEL,
     NOTRECRUITEDTANKMAN_COSM02_MCCOY_LABEL,
     NOTRECRUITEDTANKMAN_COSM02_UHURA_LABEL,
     NOTRECRUITEDTANKMAN_COSM02_SCOTTY_LABEL,
     NOTRECRUITEDTANKMAN_BIRTHDAY14_DEER_LABEL,
     NOTRECRUITEDTANKMAN_BIRTHDAY14_CAT_LABEL,
     NOTRECRUITEDTANKMAN_BIRTHDAY14_MOUSE_LABEL,
     NOTRECRUITEDTANKMAN_MARTY_VOLE_LABEL,
     NOTRECRUITEDTANKMAN_LUMBERJACK_LABEL,
     NOTRECRUITEDTANKMAN_BOOSTEROID_FOXWOOD_LABEL,
     NOTRECRUITEDTANKMAN_BOOSTEROID_EXTRAORDINAIRE_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_3_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_4_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_5_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_6_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP15_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP15_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP15_3_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP15_4_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP15_5_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP15_6_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP15_7_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP15_8_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP15_9_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1004_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1004_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1004_3_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1004_4_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1004_5_LABEL,
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_BP16_6_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP16_7_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP16_8_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP16_9_LABEL,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P4_1_LABEL,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P4_2_LABEL,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P4_3_LABEL,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P4_4_LABEL,
     NOTRECRUITEDTANKMAN_BOOSTEROID_FENCER_LABEL,
     ...
     NOTRECRUITEDTANKMAN_FRONTMAN_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_PM3_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_PM3_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_PM3_3_LABEL,
     NOTRECRUITEDTANKMAN_WT_CLONE_BOSS_LABEL,
     NOTRECRUITEDTANKMAN_WT_CLONE_HUNTER_1_LABEL,
     NOTRECRUITEDTANKMAN_WT_CLONE_HUNTER_2_LABEL,
     NOTRECRUITEDTANKMAN_WT_CLONE_HUNTER_3_LABEL,
     NOTRECRUITEDTANKMAN_WT_CLONE_HUNTER_4_LABEL,
     NOTRECRUITEDTANKMAN_FISHERMAN_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_5_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_6_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_7_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_8_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_9_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_10_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_11_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_12_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_13_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_14_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_15_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP18_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP18_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP18_3_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP18_4_LABEL,
     NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_KEI_LABEL,
     NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_NAOMI_LABEL,
     NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_SAUNDERS_LABEL,
     NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_ALISA_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP18_5_LABEL,
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_BP1005_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1005_2_LABEL,
     ...
     NOTRECRUITEDTANKMAN_CHEF_DAMIEN_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1006_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1006_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1006_3_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1006_4_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1006_5_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1006_6_LABEL,
     NOTRECRUITEDTANKMAN_LUNAR26_COMMANDER_LABEL,
     ...
     NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_ERWIN_LABEL,
     NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_SAEMONZA_LABEL,
     NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_CAESAR_LABEL,
     NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_ORYOU_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP19_5_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP19_6_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP19_7_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP19_8_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP19_9_LABEL,
     NOTRECRUITEDTANKMAN_SOUTHPAWBOXER_LABEL,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P5_1_LABEL,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P5_2_LABEL,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P5_3_LABEL,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P5_4_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP20_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP20_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP20_3_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP20_4_LABEL,
     NOTRECRUITEDTANKMAN_TIGERSMIDFIELDER_LABEL,
     NOTRECRUITEDTANKMAN_TIGERSWINGER_LABEL,
     NOTRECRUITEDTANKMAN_DESERTRAT_LABEL,
     NOTRECRUITEDTANKMAN_SERVICEWOMAN_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP20_5_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP20_6_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP20_7_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP20_8_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP20_9_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP21_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP21_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP21_3_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_BP21_4_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_PM4_1_LABEL,
     NOTRECRUITEDTANKMAN_JAGER_MAILAND_LABEL,
     NOTRECRUITEDTANKMAN_JAGER_MOUZAKROBAT_LABEL,
     NOTRECRUITEDTANKMAN_BIRTHDAY16_CREW_1_LABEL,
     NOTRECRUITEDTANKMAN_BIRTHDAY16_CREW_2_LABEL,
     NOTRECRUITEDTANKMAN_BIRTHDAY16_CREW_3_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_1_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_2_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_3_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_4_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_5_LABEL,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_6_LABEL)
    NOTRECRUITEDTANKMAN_ALL_DESC_ENUM = (
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_DESC,
     ...
     NOTRECRUITEDTANKMAN_COMMANDER_STARLIGHT_DESC,
     NOTRECRUITEDTANKMAN_COMMANDER_MAEVE_DESC,
     ...
     NOTRECRUITEDTANKMAN_COMMANDER_PATRICK_DESC,
     NOTRECRUITEDTANKMAN_NY20WOMAN_DESC,
     NOTRECRUITEDTANKMAN_NY20DEFAULTGIRL_DESC,
     NOTRECRUITEDTANKMAN_NY20MEN_DESC,
     NOTRECRUITEDTANKMAN_NY20SNOWMEN_DESC,
     NOTRECRUITEDTANKMAN_NY21MEN_DESC,
     NOTRECRUITEDTANKMAN_NY21WOMAN_DESC,
     NOTRECRUITEDTANKMAN_BOB20_COMMANDER1_RU_DESC,
     NOTRECRUITEDTANKMAN_BOB20_COMMANDER2_RU_DESC,
     NOTRECRUITEDTANKMAN_BOB20_COMMANDER3_RU_DESC,
     NOTRECRUITEDTANKMAN_BOB20_COMMANDER4_RU_DESC,
     NOTRECRUITEDTANKMAN_BOB20_COMMANDER1_EU_DESC,
     NOTRECRUITEDTANKMAN_BOB20_COMMANDER2_EU_DESC,
     NOTRECRUITEDTANKMAN_BOB20_COMMANDER3_EU_DESC,
     NOTRECRUITEDTANKMAN_BOB20_COMMANDER4_EU_DESC,
     NOTRECRUITEDTANKMAN_BOB20_COMMANDER1_NA_DESC,
     NOTRECRUITEDTANKMAN_BOB20_COMMANDER2_NA_DESC,
     NOTRECRUITEDTANKMAN_BOB20_COMMANDER1_ASIA_DESC,
     NOTRECRUITEDTANKMAN_BOB20_COMMANDER2_ASIA_DESC,
     NOTRECRUITEDTANKMAN_HW19_COMMANDERS_DESC,
     NOTRECRUITEDTANKMAN_HW21_COMMANDER1_DESC,
     NOTRECRUITEDTANKMAN_HW21_COMMANDER2_DESC,
     NOTRECRUITEDTANKMAN_HW21_COMMANDER4_DESC,
     NOTRECRUITEDTANKMAN_HW21_COMMANDER5_DESC,
     NOTRECRUITEDTANKMAN_HW24_COMMANDER1_DESC,
     NOTRECRUITEDTANKMAN_HW24_COMMANDER2_DESC,
     NOTRECRUITEDTANKMAN_HW24_COMMANDER4_DESC,
     NOTRECRUITEDTANKMAN_HW24_COMMANDER5_DESC,
     NOTRECRUITEDTANKMAN_HW25_QUICKYBABY_DESC,
     NOTRECRUITEDTANKMAN_HW25_MAILAND_DESC,
     NOTRECRUITEDTANKMAN_HW25_MOUZAKROBAT_DESC,
     NOTRECRUITEDTANKMAN_HW25_SKILL4LTU_DESC,
     NOTRECRUITEDTANKMAN_HW25_LUJUN_CN_DESC,
     NOTRECRUITEDTANKMAN_HW25_TITI_CN_DESC,
     NOTRECRUITEDTANKMAN_HW25_DAKUN_CN_DESC,
     NOTRECRUITEDTANKMAN_HW25_PANCHEZHANG_CN_DESC,
     NOTRECRUITEDTANKMAN_COMMANDER_BP1_DESC,
     ...
     NOTRECRUITEDTANKMAN_COMMANDER_BINGO_DESC,
     NOTRECRUITEDTANKMAN_COMMANDER_BARONESS_DESC,
     ...
     NOTRECRUITEDTANKMAN_COMMANDER_NANSEN_DESC,
     ...
     NOTRECRUITEDTANKMAN_COMMANDER_TWITCH50_DESC,
     NOTRECRUITEDTANKMAN_POLISH_COMMANDER_DESC,
     ...
     NOTRECRUITEDTANKMAN_OOW21_STRATEGIST_COMMANDER_DESC,
     NOTRECRUITEDTANKMAN_OOW21_TANKER_1_COMMANDER_DESC,
     ...
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_RU2_KORBENDAILAS_DESC,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_RU3_LEBWA_DESC,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_RU3_INSPIRER_DESC,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_RU4_EVILGRANNY_DESC,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_RU4_NEARYOU_DESC,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_EU1_CIRCON_DESC,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_EU2_DAKILLZOR_DESC,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_EU3_NEWMULTI2K_DESC,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_EU4_ORZANEL_DESC,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_NA1_CABBAGEMECHANIC_DESC,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_NA2_TRAGICLOSS_DESC,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_NA3_CMDRAF_DESC,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_ASIA1_MASTERTORTOISE_DESC,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_ASIA2_SUMMERTIGER_DESC,
     NOTRECRUITEDTANKMAN_BOB21_COMMANDER_ASIA3_MAHARLIKA_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP3_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP3_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP3_3_DESC,
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_BP7_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP7_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP7_3_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP7_4_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP8_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP8_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP8_3_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP8_4_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP8_5_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP8_6_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP8_7_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP8_8_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP9_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP9_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP9_3_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP10_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP10_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP10_3_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BPH_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BPH_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BPH_3_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BPH_4_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP11_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP11_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP11_3_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP11_4_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_3_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_4_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_5_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_6_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_7_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1003_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_8_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_9_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_10_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1002_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1002_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1002_3_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1002_4_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1002_5_DESC,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P3_1_DESC,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P3_2_DESC,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P3_3_DESC,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P3_4_DESC,
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_BP13_5_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP13_6_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP13_7_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP13_8_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP13_9_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_3_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_4_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_5_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_6_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_AUC_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_AUC_2_DESC,
     ...
     NOTRECRUITEDTANKMAN_NY22MEN_A_DESC,
     NOTRECRUITEDTANKMAN_NY22MEN_DESC,
     NOTRECRUITEDTANKMAN_NY22WOMAN_DESC,
     NOTRECRUITEDTANKMAN_NY22DEFAULTGIRL_DESC,
     NOTRECRUITEDTANKMAN_NY23RUBY_GIRL_1_DESC,
     NOTRECRUITEDTANKMAN_NY23_GIRL_M_DESC,
     NOTRECRUITEDTANKMAN_NY23DEFAULTGIRL_DESC,
     NOTRECRUITEDTANKMAN_NY23_GIRL_1_DESC,
     NOTRECRUITEDTANKMAN_NY23_GIRL_2_DESC,
     NOTRECRUITEDTANKMAN_NY23_GIRL_3_DESC,
     NOTRECRUITEDTANKMAN_NY23_GIRL_4_DESC,
     NOTRECRUITEDTANKMAN_NY24DEFAULTGIRL_DESC,
     NOTRECRUITEDTANKMAN_NY24_MEN_DESC,
     NOTRECRUITEDTANKMAN_NY24_GIRL_1_DESC,
     NOTRECRUITEDTANKMAN_NY24_GIRL_2_DESC,
     NOTRECRUITEDTANKMAN_NY24_GIRL_3_DESC,
     NOTRECRUITEDTANKMAN_NY24_GIRL_4_DESC,
     NOTRECRUITEDTANKMAN_NY25DEFAULTGIRL_DESC,
     NOTRECRUITEDTANKMAN_NY25_MEN_DESC,
     NOTRECRUITEDTANKMAN_NY25_GIRL_1_DESC,
     NOTRECRUITEDTANKMAN_NY25_GIRL_2_DESC,
     NOTRECRUITEDTANKMAN_NY25_GIRL_3_DESC,
     NOTRECRUITEDTANKMAN_NY25_GIRL_4_DESC,
     NOTRECRUITEDTANKMAN_NY26DEFAULTGIRL_DESC,
     NOTRECRUITEDTANKMAN_NY26_MEN_DESC,
     NOTRECRUITEDTANKMAN_NY26_GIRL_1_DESC,
     NOTRECRUITEDTANKMAN_NY26_GIRL_2_DESC,
     NOTRECRUITEDTANKMAN_NY26_GIRL_3_DESC,
     NOTRECRUITEDTANKMAN_NY26_GIRL_4_DESC,
     ...
     NOTRECRUITEDTANKMAN_WT_2023_HANNELORE_DESC,
     NOTRECRUITEDTANKMAN_WT_2023_DRIVER_DESC,
     NOTRECRUITEDTANKMAN_WT_2024_VONKRIEGER_DESC,
     NOTRECRUITEDTANKMAN_WT_2024_ERMELINDA_DESC,
     NOTRECRUITEDTANKMAN_WT_2024_QUICKYBABY_DESC,
     NOTRECRUITEDTANKMAN_WT_2024_DAKILLZOR_DESC,
     NOTRECRUITEDTANKMAN_WT_2024_MOUZAKROBAT_DESC,
     NOTRECRUITEDTANKMAN_WT_2024_SKILL4LTU_DESC,
     NOTRECRUITEDTANKMAN_WT_CN2024_ZHONGPENGFEI_DESC,
     NOTRECRUITEDTANKMAN_WT_CN2024_BMENG_DESC,
     NOTRECRUITEDTANKMAN_WT_CN2024_YITUANTUAN_DESC,
     NOTRECRUITEDTANKMAN_WT_CN2024_SAONIAN_DESC,
     NOTRECRUITEDTANKMAN_COSM02_KIRK_DESC,
     NOTRECRUITEDTANKMAN_COSM02_SPOCK_DESC,
     NOTRECRUITEDTANKMAN_COSM02_SULU_DESC,
     NOTRECRUITEDTANKMAN_COSM02_MCCOY_DESC,
     NOTRECRUITEDTANKMAN_COSM02_UHURA_DESC,
     NOTRECRUITEDTANKMAN_COSM02_SCOTTY_DESC,
     NOTRECRUITEDTANKMAN_BIRTHDAY14_DEER_DESC,
     NOTRECRUITEDTANKMAN_BIRTHDAY14_CAT_DESC,
     NOTRECRUITEDTANKMAN_BIRTHDAY14_MOUSE_DESC,
     NOTRECRUITEDTANKMAN_MARTY_VOLE_DESC,
     NOTRECRUITEDTANKMAN_LUMBERJACK_DESC,
     NOTRECRUITEDTANKMAN_BOOSTEROID_FOXWOOD_DESC,
     NOTRECRUITEDTANKMAN_BOOSTEROID_EXTRAORDINAIRE_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_3_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_4_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_5_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_6_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP15_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP15_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP15_3_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP15_4_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP15_5_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP15_6_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP15_7_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP15_8_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP15_9_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1004_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1004_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1004_3_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1004_4_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1004_5_DESC,
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_BP16_6_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP16_7_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP16_8_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP16_9_DESC,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P4_1_DESC,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P4_2_DESC,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P4_3_DESC,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P4_4_DESC,
     NOTRECRUITEDTANKMAN_BOOSTEROID_FENCER_DESC,
     ...
     NOTRECRUITEDTANKMAN_FRONTMAN_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_PM3_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_PM3_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_PM3_3_DESC,
     NOTRECRUITEDTANKMAN_WT_CLONE_BOSS_DESC,
     NOTRECRUITEDTANKMAN_WT_CLONE_HUNTER_1_DESC,
     NOTRECRUITEDTANKMAN_WT_CLONE_HUNTER_2_DESC,
     NOTRECRUITEDTANKMAN_WT_CLONE_HUNTER_3_DESC,
     NOTRECRUITEDTANKMAN_WT_CLONE_HUNTER_4_DESC,
     NOTRECRUITEDTANKMAN_FISHERMAN_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_5_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_6_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_7_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_8_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_9_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_10_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_11_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_12_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_13_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_14_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_15_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP18_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP18_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP18_3_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP18_4_DESC,
     NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_KEI_DESC,
     NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_NAOMI_DESC,
     NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_SAUNDERS_DESC,
     NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_ALISA_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP18_5_DESC,
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_BP1005_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1005_2_DESC,
     ...
     NOTRECRUITEDTANKMAN_CHEF_DAMIEN_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1006_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1006_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1006_3_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1006_4_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1006_5_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1006_6_DESC,
     NOTRECRUITEDTANKMAN_LUNAR26_COMMANDER_DESC,
     ...
     NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_ERWIN_DESC,
     NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_SAEMONZA_DESC,
     NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_CAESAR_DESC,
     NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_ORYOU_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP19_5_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP19_6_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP19_7_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP19_8_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP19_9_DESC,
     NOTRECRUITEDTANKMAN_SOUTHPAWBOXER_DESC,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P5_1_DESC,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P5_2_DESC,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P5_3_DESC,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P5_4_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP20_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP20_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP20_3_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP20_4_DESC,
     NOTRECRUITEDTANKMAN_TIGERSMIDFIELDER_DESC,
     NOTRECRUITEDTANKMAN_TIGERSWINGER_DESC,
     NOTRECRUITEDTANKMAN_DESERTRAT_DESC,
     NOTRECRUITEDTANKMAN_SERVICEWOMAN_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP20_5_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP20_6_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP20_7_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP20_8_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP20_9_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP21_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP21_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP21_3_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_BP21_4_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_PM4_1_DESC,
     NOTRECRUITEDTANKMAN_JAGER_MAILAND_DESC,
     NOTRECRUITEDTANKMAN_JAGER_MOUZAKROBAT_DESC,
     NOTRECRUITEDTANKMAN_BIRTHDAY16_CREW_1_DESC,
     NOTRECRUITEDTANKMAN_BIRTHDAY16_CREW_2_DESC,
     NOTRECRUITEDTANKMAN_BIRTHDAY16_CREW_3_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_1_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_2_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_3_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_4_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_5_DESC,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_6_DESC)
    NOTRECRUITEDTANKMAN_ALL_HOWTOGETINFO_ENUM = (
     ...
     NOTRECRUITEDTANKMAN_HW21_COMMANDER5_HOWTOGETINFO,
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_BP7_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP7_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP7_3_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP7_4_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP8_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP8_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP8_3_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP8_4_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP8_5_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP8_6_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP8_7_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP8_8_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP9_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP9_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP9_3_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP10_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP10_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP10_3_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BPH_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BPH_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BPH_3_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BPH_4_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP11_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP11_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP11_3_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP11_4_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_3_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_4_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_5_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_6_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_7_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1003_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_8_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_9_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP12_10_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1002_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1002_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1002_3_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1002_4_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1002_5_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P3_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P3_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P3_3_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P3_4_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP13_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP13_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP13_3_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP13_4_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP13_5_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP13_6_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP13_7_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP13_8_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP13_9_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_3_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_4_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_5_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP14_6_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_AUC_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_AUC_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_NY22DEFAULTGIRL_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_NY23DEFAULTGIRL_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_NY24DEFAULTGIRL_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_NY25DEFAULTGIRL_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_NY26DEFAULTGIRL_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_COSM02_KIRK_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_COSM02_SPOCK_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_COSM02_SULU_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_COSM02_MCCOY_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_COSM02_UHURA_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_COSM02_SCOTTY_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_BIRTHDAY14_DEER_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_BIRTHDAY14_CAT_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_BIRTHDAY14_MOUSE_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_MARTY_VOLE_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_LUMBERJACK_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_BOOSTEROID_FOXWOOD_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_BOOSTEROID_EXTRAORDINAIRE_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_3_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_4_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_5_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB1_6_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP15_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP15_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP15_3_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP15_4_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP15_5_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP15_6_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP15_7_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP15_8_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP15_9_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1004_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1004_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1004_3_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1004_4_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1004_5_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP16_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP16_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP16_3_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP16_4_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP16_5_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP16_6_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP16_7_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP16_8_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP16_9_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P4_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P4_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P4_3_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P4_4_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_BOOSTEROID_FENCER_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_3_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_4_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_FRONTMAN_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_PM3_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_PM3_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_PM3_3_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_WT_CLONE_BOSS_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_WT_CLONE_HUNTER_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_WT_CLONE_HUNTER_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_WT_CLONE_HUNTER_3_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_WT_CLONE_HUNTER_4_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_FISHERMAN_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_5_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_6_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_7_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_8_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_9_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_10_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_11_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_12_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_13_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_14_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP17_15_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP18_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP18_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP18_3_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP18_4_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_KEI_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_NAOMI_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_SAUNDERS_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_ALISA_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP18_5_HOWTOGETINFO,
     ...
     NOTRECRUITEDTANKMAN_TANKMEN_BP1005_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1005_2_HOWTOGETINFO,
     ...
     NOTRECRUITEDTANKMAN_CHEF_DAMIEN_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1006_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1006_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1006_3_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1006_4_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1006_5_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP1006_6_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_LUNAR26_COMMANDER_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP19_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP19_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP19_3_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP19_4_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_ERWIN_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_SAEMONZA_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_CAESAR_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_GIRLS_UND_PANZER_ORYOU_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP19_5_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP19_6_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP19_7_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP19_8_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP19_9_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_SOUTHPAWBOXER_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P5_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P5_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P5_3_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_ONSLAUGHT_P5_4_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP20_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP20_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP20_3_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP20_4_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TIGERSMIDFIELDER_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TIGERSWINGER_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_DESERTRAT_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_SERVICEWOMAN_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP20_5_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP20_6_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP20_7_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP20_8_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP20_9_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP21_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP21_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP21_3_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_BP21_4_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_PM4_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_JAGER_MAILAND_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_JAGER_MOUZAKROBAT_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_BIRTHDAY16_CREW_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_BIRTHDAY16_CREW_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_BIRTHDAY16_CREW_3_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_1_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_2_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_3_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_4_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_5_HOWTOGETINFO,
     NOTRECRUITEDTANKMAN_TANKMEN_MTLB4_6_HOWTOGETINFO)
