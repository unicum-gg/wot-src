...
class MESSENGER(object):
    ...
    SERVICECHANNELMESSAGES_BATTLERESULTS_GOLDBANKGAIN = '#messenger:serviceChannelMessages/battleResults/goldBankGain'
    ...
    SERVICECHANNELMESSAGES_BATTLERESULTS_QUESTS_BATTLEQUESTSBATTLEPASSPOINTS = '#messenger:serviceChannelMessages/battleResults/quests/battleQuestsBattlePassPoints'
    ...
    SERVICECHANNELMESSAGES_ARMORYYARD_BUTTON_MAIN = '#messenger:serviceChannelMessages/armoryYard/button/main'
    SERVICECHANNELMESSAGES_ARMORYYARD_BUTTON_POSTPROGRESSION = '#messenger:serviceChannelMessages/armoryYard/button/postProgression'
    SERVICECHANNELMESSAGES_ARMORYYARD_BUTTON_QUEST = '#messenger:serviceChannelMessages/armoryYard/button/quest'
    ...
    SERVICECHANNELMESSAGES_INVOICEDEBITED_BOOSTERS = '#messenger:serviceChannelMessages/invoiceDebited/boosters'
    ...
    SERVICECHANNELMESSAGES_AUTOEQUIPNOTENOUGH = '#messenger:serviceChannelMessages/autoEquipNotEnough'
    ...
    SERVICECHANNELMESSAGES_LOOTBOXESBUY_BUTTON = '#messenger:serviceChannelMessages/lootBoxesBuy/button'
    ...
    CHAT_ACTION_REQUEST_ECHO_CHANNEL = '#messenger:chat_action/REQUEST_ECHO_CHANNEL'
    ...
    SERVICECHANNELMESSAGES_BATTLEPASSREWARD_HEADER_QUESTGIFTBP = '#messenger:serviceChannelMessages/battlePassReward/header/questGiftBP'
    ...
    SERVICECHANNELMESSAGES_BATTLEPASSREWARD_BATTLE_CHAPTERFINALNOTFIND_TEXT = '#messenger:serviceChannelMessages/battlePassReward/battle/chapterFinalNotFind/text'
    ...
    SERVICECHANNELMESSAGES_BATTLEPASSMARATHONSTART_BUTTON = '#messenger:serviceChannelMessages/battlePassMarathonStart/button'
    SERVICECHANNELMESSAGES_BATTLEPASSMARATHONWILLENDSOON_BUTTON = '#messenger:serviceChannelMessages/battlePassMarathonWillEndSoon/button'
    SERVICECHANNELMESSAGES_BATTLEPASS_REACHEDCAPWEEK_HEADER = '#messenger:serviceChannelMessages/battlePass/reachedCapWeek/header'
    SERVICECHANNELMESSAGES_BATTLEPASS_REACHEDCAPWEEK_TEXT = '#messenger:serviceChannelMessages/battlePass/reachedCapWeek/text'
    SERVICECHANNELMESSAGES_BATTLEPASS_CAPRESET_HEADER = '#messenger:serviceChannelMessages/battlePass/capReset/header'
    SERVICECHANNELMESSAGES_BATTLEPASS_CAPRESET_TEXT = '#messenger:serviceChannelMessages/battlePass/capReset/text'
    SERVICECHANNELMESSAGES_BATTLEPASS_REACHEDCAPFACTOR_HEADER = '#messenger:serviceChannelMessages/battlePass/reachedCapFactor/header'
    SERVICECHANNELMESSAGES_BATTLEPASS_REACHEDCAPFACTOR_TEXT = '#messenger:serviceChannelMessages/battlePass/reachedCapFactor/text'
    ...
    SERVICECHANNELMESSAGES_BRBATTLERESULTS_DISQUALIFIED = '#messenger:serviceChannelMessages/BRbattleResults/disqualified'
    SERVICECHANNELMESSAGES_BRBATTLERESULTS_NO_REWARD = '#messenger:serviceChannelMessages/BRbattleResults/no_reward'
    ...
    SERVICECHANNELMESSAGES_EXCLUDEDMAP_SUBSCRIPTION_HEADER = '#messenger:serviceChannelMessages/excludedMap/subscription/header'
    SERVICECHANNELMESSAGES_EXCLUDEDMAP_SUBSCRIPTION_ENABLED = '#messenger:serviceChannelMessages/excludedMap/subscription/enabled'
    SERVICECHANNELMESSAGES_EXCLUDEDMAP_SUBSCRIPTION_DISABLED = '#messenger:serviceChannelMessages/excludedMap/subscription/disabled'
    SERVICECHANNELMESSAGES_EXCLUDEDMAP_EVENT_HEADER = '#messenger:serviceChannelMessages/excludedMap/event/header'
    SERVICECHANNELMESSAGES_EXCLUDEDMAP_EVENT_ENABLED = '#messenger:serviceChannelMessages/excludedMap/event/enabled'
    SERVICECHANNELMESSAGES_EXCLUDEDMAP_EVENT_DISABLED = '#messenger:serviceChannelMessages/excludedMap/event/disabled'
    ...
    SERVICECHANNELMESSAGES_WOTPLUS_AVAILABLEMESSAGE_TITLE = '#messenger:serviceChannelMessages/wotPlus/availableMessage/title'
    SERVICECHANNELMESSAGES_WOTPLUS_UNLOCKTRIALMESSAGE_TITLE = '#messenger:serviceChannelMessages/wotPlus/unlockTrialMessage/title'
    ...
    SERVICECHANNELMESSAGES_WOTPLUS_UNLOCKTRIALMESSAGE_TEXT = '#messenger:serviceChannelMessages/wotPlus/unlockTrialMessage/text'
    ...
    SERVICECHANNELMESSAGES_WOTPLUS_AVAILABLEMESSAGE_TEXT = '#messenger:serviceChannelMessages/wotPlus/availableMessage/text'
    ...
    SERVICECHANNELMESSAGES_WOTPLUS_PASSIVEXP_INVALIDCREW_TITLE = '#messenger:serviceChannelMessages/wotPlus/passiveXP/invalidCrew/title'
    SERVICECHANNELMESSAGES_WOTPLUS_PASSIVEXP_INVALIDCREW_TEXT = '#messenger:serviceChannelMessages/wotPlus/passiveXP/invalidCrew/text'
    ...
    SERVICECHANNELMESSAGES_WOTPLUS_DAILYQUESTSEXTRAREWARDS_ISDISABLED_TITLE = '#messenger:serviceChannelMessages/wotPlus/dailyQuestsExtraRewards/isDisabled/title'
    SERVICECHANNELMESSAGES_WOTPLUS_DAILYQUESTSEXTRAREWARDS_ISENABLED_TITLE = '#messenger:serviceChannelMessages/wotPlus/dailyQuestsExtraRewards/isEnabled/title'
    SERVICECHANNELMESSAGES_WOTPLUS_TEAMCREDITSBONUS_ISDISABLED_TITLE = '#messenger:serviceChannelMessages/wotPlus/teamCreditsBonus/isDisabled/title'
    SERVICECHANNELMESSAGES_WOTPLUS_TEAMCREDITSBONUS_ISENABLED_TITLE = '#messenger:serviceChannelMessages/wotPlus/teamCreditsBonus/isEnabled/title'
    SERVICECHANNELMESSAGES_PREMIUMSUBS_PREMIUMSUBSINVOICERECEIVED_TITLE = '#messenger:serviceChannelMessages/premiumSubs/premiumSubsInvoiceReceived/title'
    SERVICECHANNELMESSAGES_PREMIUMSUBS_PREMIUMSUBSINVOICERECEIVED_BODY = '#messenger:serviceChannelMessages/premiumSubs/premiumSubsInvoiceReceived/body'
    SERVICECHANNELMESSAGES_PREMIUMSUBS_PREMIUMSUBSTRIALUPDATED_TITLE = '#messenger:serviceChannelMessages/premiumSubs/premiumSubsTrialUpdated/title'
    SERVICECHANNELMESSAGES_PREMIUMSUBS_PREMIUMSUBSTRIALUPDATED_BODY = '#messenger:serviceChannelMessages/premiumSubs/premiumSubsTrialUpdated/body'
    ...
    SERVICECHANNELMESSAGES_BATTLEMATTERS_AWARDS_RECEIVED_BUTTON = '#messenger:serviceChannelMessages/battleMatters/awards/received/button'
    ...
    PLATFORMCURRENCYMSG_RECEIVED_SACOIN = '#messenger:platformCurrencyMsg/received/sacoin'
    ...
    PLATFORMCURRENCYMSG_RECEIVED_HONEY_COIN = '#messenger:platformCurrencyMsg/received/honey_coin'
    PLATFORMCURRENCYMSG_DEBITED_HONEY_COIN = '#messenger:platformCurrencyMsg/debited/honey_coin'
    ...
    SERVICECHANNELMESSAGES_RESOURCEWELL_TOPREWARD_TITLE = '#messenger:serviceChannelMessages/resourceWell/topReward/title'
    SERVICECHANNELMESSAGES_RESOURCEWELL_TOPREWARD_TEXT = '#messenger:serviceChannelMessages/resourceWell/topReward/text'
    SERVICECHANNELMESSAGES_RESOURCEWELL_TOPREWARD_ADDITIONALTEXT = '#messenger:serviceChannelMessages/resourceWell/topReward/additionalText'
    SERVICECHANNELMESSAGES_RESOURCEWELL_REGULARREWARD_TITLE = '#messenger:serviceChannelMessages/resourceWell/regularReward/title'
    SERVICECHANNELMESSAGES_RESOURCEWELL_REGULARREWARD_TEXT = '#messenger:serviceChannelMessages/resourceWell/regularReward/text'
    SERVICECHANNELMESSAGES_RESOURCEWELL_START_BUTTON = '#messenger:serviceChannelMessages/resourceWell/start/button'
    SERVICECHANNELMESSAGES_RESOURCEWELL_START_TITLE = '#messenger:serviceChannelMessages/resourceWell/start/title'
    SERVICECHANNELMESSAGES_RESOURCEWELL_START_TEXT = '#messenger:serviceChannelMessages/resourceWell/start/text'
    SERVICECHANNELMESSAGES_RESOURCEWELL_END_TITLE = '#messenger:serviceChannelMessages/resourceWell/end/title'
    SERVICECHANNELMESSAGES_RESOURCEWELL_END_TEXT = '#messenger:serviceChannelMessages/resourceWell/end/text'
    SERVICECHANNELMESSAGES_RESOURCEWELL_PAUSE_TEXT = '#messenger:serviceChannelMessages/resourceWell/pause/text'
    SERVICECHANNELMESSAGES_RESOURCEWELL_ENABLED_TEXT = '#messenger:serviceChannelMessages/resourceWell/enabled/text'
    SERVICECHANNELMESSAGES_RESOURCEWELL_NOVEHICLES_TITLE = '#messenger:serviceChannelMessages/resourceWell/noVehicles/title'
    SERVICECHANNELMESSAGES_RESOURCEWELL_NOVEHICLES_TEXT = '#messenger:serviceChannelMessages/resourceWell/noVehicles/text'
    ...
    SERVICECHANNELMESSAGES_TRADINGCARAVAN_BUTTON = '#messenger:serviceChannelMessages/tradingCaravan/button'
    SERVICECHANNELMESSAGES_TRADINGCARAVAN_REFILL_TITLE = '#messenger:serviceChannelMessages/tradingCaravan/refill/title'
    SERVICECHANNELMESSAGES_TRADINGCARAVAN_REFILL_TEXT = '#messenger:serviceChannelMessages/tradingCaravan/refill/text'
    ...
    SERVICECHANNELMESSAGES_INTEGRATEDAUCTION_WINRATE_HEADER = '#messenger:serviceChannelMessages/integratedAuction/winRate/header'
    SERVICECHANNELMESSAGES_INTEGRATEDAUCTION_WINRATE_TEXT = '#messenger:serviceChannelMessages/integratedAuction/winRate/text'
    SERVICECHANNELMESSAGES_INTEGRATEDAUCTION_RATEEQUAL_TEXT = '#messenger:serviceChannelMessages/integratedAuction/rateEqual/text'
    ...
    SERVICECHANNELMESSAGES_WOTPLUSINTRONOTIFICATION_HEADER = '#messenger:serviceChannelMessages/WotPlusIntroNotification/header'
    SERVICECHANNELMESSAGES_WOTPLUSINTRONOTIFICATION_BODY = '#messenger:serviceChannelMessages/WotPlusIntroNotification/body'
    ...
    SERVICECHANNELMESSAGES_LIMITEDUICONTENTUNLOCKED_SPECBATTLES = '#messenger:serviceChannelMessages/limitedUIContentUnlocked/specBattles'
    SERVICECHANNELMESSAGES_LIMITEDUICONTENTUNLOCKED_COMP7 = '#messenger:serviceChannelMessages/limitedUIContentUnlocked/comp7'
    SERVICECHANNELMESSAGES_LIMITEDUICONTENTUNLOCKED_ARCADE = '#messenger:serviceChannelMessages/limitedUIContentUnlocked/arcade'
    SERVICECHANNELMESSAGES_LIMITEDUICONTENTUNLOCKED_FIELDTRIALS = '#messenger:serviceChannelMessages/limitedUIContentUnlocked/fieldTrials'
    SERVICECHANNELMESSAGES_LIMITEDUICONTENTUNLOCKED_FRONTLINE = '#messenger:serviceChannelMessages/limitedUIContentUnlocked/frontline'
    SERVICECHANNELMESSAGES_LIMITEDUICONTENTUNLOCKED_RANKED = '#messenger:serviceChannelMessages/limitedUIContentUnlocked/ranked'
    SERVICECHANNELMESSAGES_CHATSUNLOCKED_TITLE = '#messenger:serviceChannelMessages/chatsUnlocked/title'
    SERVICECHANNELMESSAGES_CHATSUNLOCKED_SUBTITLE = '#messenger:serviceChannelMessages/chatsUnlocked/subtitle'
    SERVICECHANNELMESSAGES_CHATSUNLOCKED_CHANNELS = '#messenger:serviceChannelMessages/chatsUnlocked/channels'
    SERVICECHANNELMESSAGES_CHATSUNLOCKED_BATTLE = '#messenger:serviceChannelMessages/chatsUnlocked/battle'
    SERVICECHANNELMESSAGES_CHATSUNLOCKED_PRIVATE = '#messenger:serviceChannelMessages/chatsUnlocked/private'
    ...
    SERVICECHANNELMESSAGES_LIMITEDUIPLATOONLOCKED_TEXT = '#messenger:serviceChannelMessages/limitedUIPlatoonLocked/text'
    SERVICECHANNELMESSAGES_LIMITEDUIPLATOONLOCKED_TEXTNONAME = '#messenger:serviceChannelMessages/limitedUIPlatoonLocked/textNoName'
    SERVICECHANNELMESSAGES_LIMITEDUIPLATOONLOCKED_RANKED = '#messenger:serviceChannelMessages/limitedUIPlatoonLocked/RANKED'
    SERVICECHANNELMESSAGES_LIMITEDUIPLATOONLOCKED_COMP7 = '#messenger:serviceChannelMessages/limitedUIPlatoonLocked/COMP7'
    SERVICECHANNELMESSAGES_LIMITEDUIPLATOONLOCKED_FUN_RANDOM = '#messenger:serviceChannelMessages/limitedUIPlatoonLocked/FUN_RANDOM'
    SERVICECHANNELMESSAGES_LIMITEDUIPLATOONLOCKED_EPIC = '#messenger:serviceChannelMessages/limitedUIPlatoonLocked/EPIC'
    SERVICECHANNELMESSAGES_LIMITEDUIPLATOONLOCKED_VERSUS_AI = '#messenger:serviceChannelMessages/limitedUIPlatoonLocked/VERSUS_AI'
    SERVICECHANNELMESSAGES_STALLPURCHASERECEIPT_TITLE = '#messenger:serviceChannelMessages/stallPurchaseReceipt/title'
    ...
    CHAT_ACTION_ENUM = (
     ...
     CHAT_ACTION_REQUEST_ECHO_CHANNEL)
