...
class MESSENGER(object):
    ...
    LISTVIEW_NEWS_HEADER = '#messenger:listView/news/header'
    LISTVIEW_NEWS_CHECKNEWSBTN = '#messenger:listView/news/checkNewsBtn'
    ...
    BATTLE_RECEIVERS_CHATISLOCKEDPARENTALCONTROLTOOLTIP = '#messenger:battle/receivers/chatIsLockedParentalControlToolTip'
    BATTLE_RECEIVERS_CHATISLOCKEDCOUNTRYCONTROLTOOLTIP = '#messenger:battle/receivers/chatIsLockedCountryControlToolTip'
    BATTLE_RECEIVERS_CHATISLOCKEDOTHERCONTROLTOOLTIP = '#messenger:battle/receivers/chatIsLockedOtherControlToolTip'
    ...
    CLIENT_WARNING_AFKWARNING_MESSAGE = '#messenger:client/warning/AFKWarning/message'
    ...
    CLIENT_COMP7_DISABLEVOIP = '#messenger:client/COMP7/disableVOIP'
    CLIENT_BATTLE_ROYALE_SQUAD_DISABLEVOIP = '#messenger:client/BATTLE_ROYALE_SQUAD/disableVOIP'
    ...
    CLIENT_COMMENDATIONS_COMMS_SENT = '#messenger:client/commendations/comms_sent'
    CLIENT_COMMENDATIONS_COMMS_RECEIVED = '#messenger:client/commendations/comms_received'
    CLIENT_COMMENDATIONS_COMMS_MUTUAL = '#messenger:client/commendations/comms_mutual'
    ...
    SERVICECHANNELMESSAGES_BATTLERESULTS_QUESTS_EQUIPCOIN = '#messenger:serviceChannelMessages/battleResults/quests/equipCoin'
    ...
    SERVICECHANNELMESSAGES_BATTLERESULTS_NOTIFICATION_PERSONALMISSIONS_4_HEADER = '#messenger:serviceChannelMessages/battleResults/notification/personalMissions/4/header'
    SERVICECHANNELMESSAGES_BATTLERESULTS_NOTIFICATION_PERSONALMISSIONS_4_DESCRIPTION = '#messenger:serviceChannelMessages/battleResults/notification/personalMissions/4/description'
    SERVICECHANNELMESSAGES_BATTLERESULTS_NOTIFICATION_PERSONALMISSIONS_4_STAGE_3_DESCRIPTION = '#messenger:serviceChannelMessages/battleResults/notification/personalMissions/4/stage/3/description'
    SERVICECHANNELMESSAGES_BATTLERESULTS_NOTIFICATION_PERSONALMISSIONS_4_STAGE_2_DESCRIPTION = '#messenger:serviceChannelMessages/battleResults/notification/personalMissions/4/stage/2/description'
    SERVICECHANNELMESSAGES_BATTLERESULTS_NOTIFICATION_PERSONALMISSIONS_4_STAGE_1_DESCRIPTION = '#messenger:serviceChannelMessages/battleResults/notification/personalMissions/4/stage/1/description'
    ...
    SERVICECHANNELMESSAGES_CURRENCYUPDATE_RECEIVED_EQUIPCOIN = '#messenger:serviceChannelMessages/currencyUpdate/received/equipCoin'
    ...
    SERVICECHANNELMESSAGES_CURRENCYUPDATE_DEBITED_EQUIPCOIN = '#messenger:serviceChannelMessages/currencyUpdate/debited/equipCoin'
    ...
    SERVICECHANNELMESSAGES_INVOICERECEIVED_EQUIPCOINACCRUED = '#messenger:serviceChannelMessages/invoiceReceived/equipCoinAccrued'
    SERVICECHANNELMESSAGES_INVOICERECEIVED_EQUIPCOINDEBITED = '#messenger:serviceChannelMessages/invoiceReceived/equipCoinDebited'
    ...
    SERVICECHANNELMESSAGES_MULTIPLIER = '#messenger:serviceChannelMessages/multiplier'
    ...
    SERVICECHANNELMESSAGES_INVOICERECEIVED_EQUIPMENT = '#messenger:serviceChannelMessages/invoiceReceived/equipment'
    ...
    SERVICECHANNELMESSAGES_INVOICERECEIVED_OFFERSACCRUED = '#messenger:serviceChannelMessages/invoiceReceived/offersAccrued'
    SERVICECHANNELMESSAGES_INVOICERECEIVED_OFFERSDEBITED = '#messenger:serviceChannelMessages/invoiceReceived/offersDebited'
    ...
    SERVICECHANNELMESSAGES_INVOICERECEIVED_PURCHASE_TITLE_STEAM_DLC = '#messenger:serviceChannelMessages/invoiceReceived/purchase/title/steam_dlc'
    SERVICECHANNELMESSAGES_INVOICERECEIVED_PURCHASE_TITLE_STEAM_INVENTORY = '#messenger:serviceChannelMessages/invoiceReceived/purchase/title/steam_inventory'
    ...
    SERVICECHANNELMESSAGES_INVOICERECEIVED_PRESTIGEADDED = '#messenger:serviceChannelMessages/invoiceReceived/prestigeAdded'
    SERVICECHANNELMESSAGES_INVOICERECEIVED_PRESTIGESET_FULL = '#messenger:serviceChannelMessages/invoiceReceived/prestigeSet/full'
    SERVICECHANNELMESSAGES_INVOICERECEIVED_PRESTIGESET_JUSTLEVEL = '#messenger:serviceChannelMessages/invoiceReceived/prestigeSet/justLevel'
    ...
    SERVICECHANNELMESSAGES_BOOSTERENDED = '#messenger:serviceChannelMessages/boosterEnded'
    SERVICECHANNELMESSAGES_BOOSTEREXPIRED_MESSAGE = '#messenger:serviceChannelMessages/boosterExpired/message'
    SERVICECHANNELMESSAGES_BOOSTEREXPIRED_TITLE = '#messenger:serviceChannelMessages/boosterExpired/title'
    ...
    SERVICECHANNELMESSAGES_SYSMSG_TITLES_DECONSTRUCTING = '#messenger:serviceChannelMessages/sysMsg/titles/deconstructing'
    SERVICECHANNELMESSAGES_SYSMSG_DECONSTRUCTINGMULT_ITEMSTEMPLATE = '#messenger:serviceChannelMessages/sysMsg/deconstructingMult/itemsTemplate'
    SERVICECHANNELMESSAGES_SYSMSG_DECONSTRUCTING_HEAD = '#messenger:serviceChannelMessages/sysMsg/deconstructing/head'
    ...
    SERVICECHANNELMESSAGES_SYSMSG_CONVERTER_POSTPROGRESSION_HEADER = '#messenger:serviceChannelMessages/sysMsg/converter/postProgression/header'
    SERVICECHANNELMESSAGES_SYSMSG_CONVERTER_POSTPROGRESSION_DESCRIPTION = '#messenger:serviceChannelMessages/sysMsg/converter/postProgression/description'
    SERVICECHANNELMESSAGES_SYSMSG_CONVERTER_POSTPROGRESSION_VEHICLESLIST_DELIMITER = '#messenger:serviceChannelMessages/sysMsg/converter/postProgression/vehiclesList/delimiter'
    SERVICECHANNELMESSAGES_SYSMSG_CONVERTER_POSTPROGRESSION_VEHICLESLIST_ADDITIONALCOUNT = '#messenger:serviceChannelMessages/sysMsg/converter/postProgression/vehiclesList/additionalCount'
    ...
    SERVICECHANNELMESSAGES_BONDEQUIPMENTCHOOSING = '#messenger:serviceChannelMessages/bondEquipmentChoosing'
    SERVICECHANNELMESSAGES_BONDEQUIPMENTCHOOSINGBUTTON = '#messenger:serviceChannelMessages/bondEquipmentChoosingButton'
    ...
    SERVICECHANNELMESSAGES_LUNARBOXESAUTOOPEN_HEADER = '#messenger:serviceChannelMessages/lunarBoxesAutoOpen/header'
    SERVICECHANNELMESSAGES_LUNARBOXESAUTOOPEN_BODY = '#messenger:serviceChannelMessages/lunarBoxesAutoOpen/body'
    SERVICECHANNELMESSAGES_LUNARBOXESAUTOOPEN_PROJECTION_DECAL = '#messenger:serviceChannelMessages/lunarBoxesAutoOpen/projection_decal'
    SERVICECHANNELMESSAGES_LUNARBOXESAUTOOPEN_MANY_PROJECTION_DECAL = '#messenger:serviceChannelMessages/lunarBoxesAutoOpen/many/projection_decal'
    ...
    SERVICECHANNELMESSAGES_PIGGYBANK_CONTINUEAFTERSMASHED_PIGGYBANK = '#messenger:serviceChannelMessages/piggyBank/continueAfterSmashed/piggyBank'
    SERVICECHANNELMESSAGES_PIGGYBANK_CONTINUEAFTERSMASHED_GOLDBANK = '#messenger:serviceChannelMessages/piggyBank/continueAfterSmashed/goldBank'
    ...
    SERVICECHANNELMESSAGES_EPICREWARD_UNIVERSALBOOK_GIFT = '#messenger:serviceChannelMessages/epicReward/universalBook_gift'
    ...
    SERVICECHANNELMESSAGES_EPICREWARD_MENTORINGLICENSE_GIFT = '#messenger:serviceChannelMessages/epicReward/mentoringLicense_gift'
    ...
    SERVICECHANNELMESSAGES_EPICBATTLERESULTS_SCENARIO = '#messenger:serviceChannelMessages/epicBattleResults/scenario'
    ...
    SERVICECHANNELMESSAGES_BATTLEPASSREWARD_HEADER_BUYBPWITHLEVELS = '#messenger:serviceChannelMessages/battlePassReward/header/buyBPWithLevels'
    SERVICECHANNELMESSAGES_BATTLEPASSREWARD_HEADER_VOTED = '#messenger:serviceChannelMessages/battlePassReward/header/voted'
    SERVICECHANNELMESSAGES_BATTLEPASSREWARD_HEADER_AUTOSELECTREWARD = '#messenger:serviceChannelMessages/battlePassReward/header/autoSelectReward'
    ...
    SERVICECHANNELMESSAGES_BATTLEPASSREWARD_BATTLE_CHAPTERFINAL_TEXT = '#messenger:serviceChannelMessages/battlePassReward/battle/chapterFinal/text'
    ...
    SERVICECHANNELMESSAGES_BATTLEPASSREWARD_POSTPROGRESSION_NEWLEVEL_TEXT = '#messenger:serviceChannelMessages/battlePassReward/postProgression/newLevel/text'
    ...
    SERVICECHANNELMESSAGES_BATTLEPASS_FREEPOINTSUSED_HEADER = '#messenger:serviceChannelMessages/battlePass/freePointsUsed/header'
    SERVICECHANNELMESSAGES_BATTLEPASS_FREEPOINTSUSED_TEXT = '#messenger:serviceChannelMessages/battlePass/freePointsUsed/text'
    SERVICECHANNELMESSAGES_BATTLEPASS_FREEPOINTSUSED_POSTPROGRESSION_TEXT = '#messenger:serviceChannelMessages/battlePass/freePointsUsed/postProgression/text'
    SERVICECHANNELMESSAGES_BATTLEPASS_POSTPROGRESSIONACTIVATED_TEXT = '#messenger:serviceChannelMessages/battlePass/postProgressionActivated/text'
    SERVICECHANNELMESSAGES_BATTLEPASS_POSTPROGRESSIONPAUSED_TEXT = '#messenger:serviceChannelMessages/battlePass/postProgressionPaused/text'
    SERVICECHANNELMESSAGES_BATTLEPASSHREWARD_BATTLE_NEWLEVEL_TEXT = '#messenger:serviceChannelMessages/battlePassHReward/battle/newLevel/text'
    SERVICECHANNELMESSAGES_BATTLEPASSHREWARD_BATTLE_FINAL_TEXT = '#messenger:serviceChannelMessages/battlePassHReward/battle/final/text'
    SERVICECHANNELMESSAGES_BATTLEPASSHREWARD_BATTLE_CHAPTERFINAL_TEXT = '#messenger:serviceChannelMessages/battlePassHReward/battle/chapterFinal/text'
    SERVICECHANNELMESSAGES_BATTLEPASSHREWARD_BUYWITHOUTREWARDS_TEXT = '#messenger:serviceChannelMessages/battlePassHReward/buyWithoutRewards/text'
    SERVICECHANNELMESSAGES_BATTLEPASSHREWARD_BUYWITHREWARDS_TEXT = '#messenger:serviceChannelMessages/battlePassHReward/buyWithRewards/text'
    SERVICECHANNELMESSAGES_BATTLEPASSHREWARD_BUYPROGRESS_TEXT = '#messenger:serviceChannelMessages/battlePassHReward/buyProgress/text'
    ...
    SERVICECHANNELMESSAGES_DOGTAGS_COUPLED = '#messenger:serviceChannelMessages/dogTags/coupled'
    ...
    SERVICECHANNELMESSAGES_EXCLUDEDMAP_AVAILABLE_TITLE = '#messenger:serviceChannelMessages/excludedMap/available/title'
    ...
    SERVICECHANNELMESSAGES_WOTPLUS_GOLDRESERVE_ISDISABLED_TEXT = '#messenger:serviceChannelMessages/wotPlus/goldReserve/isDisabled/text'
    SERVICECHANNELMESSAGES_WOTPLUS_GOLDRESERVE_ISENABLED_TITLE = '#messenger:serviceChannelMessages/wotPlus/goldReserve/isEnabled/title'
    SERVICECHANNELMESSAGES_WOTPLUS_PASSIVEXP_WASTING_TITLE = '#messenger:serviceChannelMessages/wotPlus/passiveXP/wasting/title'
    SERVICECHANNELMESSAGES_WOTPLUS_PASSIVEXP_NOTANK_TEXT = '#messenger:serviceChannelMessages/wotPlus/passiveXP/noTank/text'
    SERVICECHANNELMESSAGES_WOTPLUS_PASSIVEXP_INCOMPATIBLECREW_TITLE = '#messenger:serviceChannelMessages/wotPlus/passiveXP/incompatibleCrew/title'
    SERVICECHANNELMESSAGES_WOTPLUS_PASSIVEXP_INCOMPATIBLECREW_TEXT = '#messenger:serviceChannelMessages/wotPlus/passiveXP/incompatibleCrew/text'
    SERVICECHANNELMESSAGES_WOTPLUS_PASSIVEXP_ALLCREWAREVETERANS_TEXT = '#messenger:serviceChannelMessages/wotPlus/passiveXP/allCrewAreVeterans/text'
    SERVICECHANNELMESSAGES_WOTPLUS_PASSIVEXP_WASTING_TEXT = '#messenger:serviceChannelMessages/wotPlus/passiveXP/wasting/text'
    SERVICECHANNELMESSAGES_WOTPLUS_RENTAL_NOTANK_TITLE = '#messenger:serviceChannelMessages/wotPlus/rental/noTank/title'
    SERVICECHANNELMESSAGES_WOTPLUS_RENTAL_NOTANK_TEXT = '#messenger:serviceChannelMessages/wotPlus/rental/noTank/text'
    SERVICECHANNELMESSAGES_WOTPLUS_PASSIVEXP_ISDISABLED_TITLE = '#messenger:serviceChannelMessages/wotPlus/passiveXP/isDisabled/title'
    SERVICECHANNELMESSAGES_WOTPLUS_PASSIVEXP_ISDISABLED_TEXT = '#messenger:serviceChannelMessages/wotPlus/passiveXP/isDisabled/text'
    SERVICECHANNELMESSAGES_WOTPLUS_PASSIVEXP_ISENABLED_TITLE = '#messenger:serviceChannelMessages/wotPlus/passiveXP/isEnabled/title'
    SERVICECHANNELMESSAGES_WOTPLUS_PASSIVEXP_ISACTIVATED_TEXT = '#messenger:serviceChannelMessages/wotPlus/passiveXP/isActivated/text'
    SERVICECHANNELMESSAGES_WOTPLUS_PASSIVEXP_ISDEACTIVATED_TEXT = '#messenger:serviceChannelMessages/wotPlus/passiveXP/isDeactivated/text'
    SERVICECHANNELMESSAGES_WOTPLUS_PASSIVEXP_SWITCHING_TITLE = '#messenger:serviceChannelMessages/wotPlus/passiveXP/switching/title'
    SERVICECHANNELMESSAGES_WOTPLUS_PASSIVEXP_SWITCHING_TEXT = '#messenger:serviceChannelMessages/wotPlus/passiveXP/switching/text'
    SERVICECHANNELMESSAGES_WOTPLUS_EXCLUSIVEVEHICLE_UNSUBSCRIBED_TEXT = '#messenger:serviceChannelMessages/wotPlus/exclusiveVehicle/unsubscribed/text'
    SERVICECHANNELMESSAGES_WOTPLUS_EXCLUSIVEVEHICLE_SUBSCRIBED_TEXT = '#messenger:serviceChannelMessages/wotPlus/exclusiveVehicle/subscribed/text'
    ...
    SERVICECHANNELMESSAGES_WOTPLUS_DAILYATTENDANCES_ISDISABLED_TITLE = '#messenger:serviceChannelMessages/wotPlus/dailyAttendances/isDisabled/title'
    SERVICECHANNELMESSAGES_WOTPLUS_DAILYATTENDANCES_ISDISABLED_TEXT = '#messenger:serviceChannelMessages/wotPlus/dailyAttendances/isDisabled/text'
    SERVICECHANNELMESSAGES_WOTPLUS_DAILYATTENDANCES_ISENABLED_TITLE = '#messenger:serviceChannelMessages/wotPlus/dailyAttendances/isEnabled/title'
    SERVICECHANNELMESSAGES_WOTPLUS_DAILYATTENDANCEREWARDED_TITLE = '#messenger:serviceChannelMessages/wotPlus/dailyAttendanceRewarded/title'
    SERVICECHANNELMESSAGES_WOTPLUS_DAILYATTENDANCEREWARDED_ENDTEXT = '#messenger:serviceChannelMessages/wotPlus/dailyAttendanceRewarded/endText'
    SERVICECHANNELMESSAGES_WOTPLUS_DAILYATTENDANCEREWARDED_BIG_TITLE = '#messenger:serviceChannelMessages/wotPlus/dailyAttendanceRewarded/big/title'
    SERVICECHANNELMESSAGES_WOTPLUS_DAILYATTENDANCEREWARDED_BIG_CYCLESTARTED_STARTTEXT = '#messenger:serviceChannelMessages/wotPlus/dailyAttendanceRewarded/big/cycleStarted/startText'
    SERVICECHANNELMESSAGES_WOTPLUS_DAILYATTENDANCEREWARDED_BIG_CYCLESTARTED_ENDTEXT = '#messenger:serviceChannelMessages/wotPlus/dailyAttendanceRewarded/big/cycleStarted/endText'
    ...
    SERVICECHANNELMESSAGES_BADGE_UNAVAILABLE_TITLE = '#messenger:serviceChannelMessages/badge/unavailable/title'
    SERVICECHANNELMESSAGES_ADDITIONALXP_AVAILABLE_TITLE = '#messenger:serviceChannelMessages/additionalXP/available/title'
    SERVICECHANNELMESSAGES_ADDITIONALXP_UNAVAILABLE_TITLE = '#messenger:serviceChannelMessages/additionalXP/unavailable/title'
    SERVICECHANNELMESSAGES_OPTIONALDEVICESASSISTANT_AVAILABLE_TITLE = '#messenger:serviceChannelMessages/optionalDevicesAssistant/available/title'
    ...
    SERVICECHANNELMESSAGES_BATTLEMATTERS_AWARDS_MEDIUM_BODY = '#messenger:serviceChannelMessages/battleMatters/awards/medium/body'
    SERVICECHANNELMESSAGES_BATTLEMATTERS_AWARDS_DONE_BODY = '#messenger:serviceChannelMessages/battleMatters/awards/done/body'
    SERVICECHANNELMESSAGES_BATTLEMATTERS_AWARDS_TOKENAWARD_BODY = '#messenger:serviceChannelMessages/battleMatters/awards/tokenAward/body'
    SERVICECHANNELMESSAGES_BATTLEMATTERS_AWARDS_TOKENAWARD_BODY_REWARDRECEIVED = '#messenger:serviceChannelMessages/battleMatters/awards/tokenAward/body/rewardReceived'
    SERVICECHANNELMESSAGES_BATTLEMATTERS_AWARDS_TOKENAWARD_BODY_VEHICLE = '#messenger:serviceChannelMessages/battleMatters/awards/tokenAward/body/vehicle'
    SERVICECHANNELMESSAGES_BATTLEMATTERS_AWARDS_TOKENAWARD_BODY_CREW = '#messenger:serviceChannelMessages/battleMatters/awards/tokenAward/body/crew'
    SERVICECHANNELMESSAGES_BATTLEMATTERS_AWARDS_TOKENAWARD_BODY_SLOT = '#messenger:serviceChannelMessages/battleMatters/awards/tokenAward/body/slot'
    SERVICECHANNELMESSAGES_BATTLEMATTERS_AWARDS_RECEIVED = '#messenger:serviceChannelMessages/battleMatters/awards/received'
    SERVICECHANNELMESSAGES_BATTLEMATTERS_TASKREMINDER_TITLE = '#messenger:serviceChannelMessages/battleMatters/taskReminder/title'
    SERVICECHANNELMESSAGES_BATTLEMATTERS_TASKREMINDER_BODY = '#messenger:serviceChannelMessages/battleMatters/taskReminder/body'
    SERVICECHANNELMESSAGES_BATTLEMATTERS_TASKREMINDER_BUTTON = '#messenger:serviceChannelMessages/battleMatters/taskReminder/button'
    PLATFORMCURRENCYMSG_RECEIVED_WDRCOIN = '#messenger:platformCurrencyMsg/received/wdrcoin'
    ...
    PLATFORMCURRENCYMSG_RECEIVED_CLANVEHICLECOIN = '#messenger:platformCurrencyMsg/received/clanvehiclecoin'
    PLATFORMCURRENCYMSG_DEBITED_CLANVEHICLECOIN = '#messenger:platformCurrencyMsg/debited/clanvehiclecoin'
    PLATFORMCURRENCYMSG_RECEIVED_TOURCOIN = '#messenger:platformCurrencyMsg/received/tourcoin'
    PLATFORMCURRENCYMSG_DEBITED_TOURCOIN = '#messenger:platformCurrencyMsg/debited/tourcoin'
    PLATFORMCURRENCYMSG_RECEIVED_BPTALER = '#messenger:platformCurrencyMsg/received/bptaler'
    PLATFORMCURRENCYMSG_DEBITED_BPTALER = '#messenger:platformCurrencyMsg/debited/bptaler'
    ...
    SERVICECHANNELMESSAGES_RESOURCEWELL_PUT_TEXT = '#messenger:serviceChannelMessages/resourceWell/put/text'
    SERVICECHANNELMESSAGES_RESOURCEWELL_TAKE_TITLE = '#messenger:serviceChannelMessages/resourceWell/take/title'
    SERVICECHANNELMESSAGES_RESOURCEWELL_TAKE_TEXT = '#messenger:serviceChannelMessages/resourceWell/take/text'
    SERVICECHANNELMESSAGES_RESOURCEWELL_BLUEPRINTS = '#messenger:serviceChannelMessages/resourceWell/blueprints'
    SERVICECHANNELMESSAGES_RESOURCEWELL_BLUEPRINTCOUNT = '#messenger:serviceChannelMessages/resourceWell/blueprintCount'
    ...
    SERVICECHANNELMESSAGES_RESOURCEWELL_PROGRESS = '#messenger:serviceChannelMessages/resourceWell/progress'
    SERVICECHANNELMESSAGES_RESOURCEWELL_DETAILS_BUTTON = '#messenger:serviceChannelMessages/resourceWell/details/button'
    SERVICECHANNELMESSAGES_RESOURCEWELL_SPENDRESOURCES_BUTTON = '#messenger:serviceChannelMessages/resourceWell/spendResources/button'
    SERVICECHANNELMESSAGES_PROGRESSION2D_CAMOUFLAGE = '#messenger:serviceChannelMessages/progression2d/camouflage'
    SERVICECHANNELMESSAGES_PROGRESSION2D_DECAL = '#messenger:serviceChannelMessages/progression2d/decal'
    SERVICECHANNELMESSAGES_PROGRESSION2D_PROJECTIONDECAL = '#messenger:serviceChannelMessages/progression2d/projectionDecal'
    SERVICECHANNELMESSAGES_PROGRESSION2D_PAINT = '#messenger:serviceChannelMessages/progression2d/paint'
    ...
    SERVICECHANNELMESSAGES_FUNRANDOM_NEWSUBMODESBUTTON = '#messenger:serviceChannelMessages/funRandom/newSubModesButton'
    SERVICECHANNELMESSAGES_FUNRANDOM_PROGRESSIONSTAGEBUTTON = '#messenger:serviceChannelMessages/funRandom/progressionStageButton'
    ...
    SERVICECHANNELMESSAGES_PERSONALRESERVESRELEASE_TITLE = '#messenger:serviceChannelMessages/personalReservesRelease/title'
    SERVICECHANNELMESSAGES_PERSONALRESERVESRELEASE_DESCRIPTION = '#messenger:serviceChannelMessages/personalReservesRelease/description'
    SERVICECHANNELMESSAGES_PERSONALRESERVESSOONEXPIRE_TITLE = '#messenger:serviceChannelMessages/personalReservesSoonExpire/title'
    SERVICECHANNELMESSAGES_PERSONALRESERVESSOONEXPIRE_DESCRIPTION = '#messenger:serviceChannelMessages/personalReservesSoonExpire/description'
    SERVICECHANNELMESSAGES_WINBACKSELECTABLEREWARDENTRY_HEADER = '#messenger:serviceChannelMessages/winbackSelectableRewardEntry/header'
    SERVICECHANNELMESSAGES_WINBACKSELECTABLEREWARDENTRY_BODY = '#messenger:serviceChannelMessages/winbackSelectableRewardEntry/body'
    SERVICECHANNELMESSAGES_WINBACKSELECTABLEREWARDENTRY_BUTTON = '#messenger:serviceChannelMessages/winbackSelectableRewardEntry/button'
    SERVICECHANNELMESSAGES_WINBACK_AWARDS_HEADER = '#messenger:serviceChannelMessages/winback/awards/header'
    SERVICECHANNELMESSAGES_WINBACK_AWARDS_BODY = '#messenger:serviceChannelMessages/winback/awards/body'
    SERVICECHANNELMESSAGES_WINBACK_AWARDS_BUTTON = '#messenger:serviceChannelMessages/winback/awards/button'
    SERVICECHANNELMESSAGES_INVOICERECEIVED_UNLOCKEDMODULES = '#messenger:serviceChannelMessages/invoiceReceived/unlockedModules'
    SERVICECHANNELMESSAGES_WINBACK_AWARDS_VEHICLE = '#messenger:serviceChannelMessages/winback/awards/vehicle'
    SERVICECHANNELMESSAGES_WINBACK_AWARDS_DISCOUNT = '#messenger:serviceChannelMessages/winback/awards/discount'
    SERVICECHANNELMESSAGES_WINBACK_AWARDS_BLUEPRINTS = '#messenger:serviceChannelMessages/winback/awards/blueprints'
    ...
    SERVICECHANNELMESSAGES_PRESTIGE_LVLUP_TITLE = '#messenger:serviceChannelMessages/prestige/lvlUp/title'
    SERVICECHANNELMESSAGES_PRESTIGE_LVLUP_TEXT = '#messenger:serviceChannelMessages/prestige/lvlUp/text'
    SERVICECHANNELMESSAGES_PRESTIGE_LVLUP_BUTTON = '#messenger:serviceChannelMessages/prestige/lvlUp/button'
    SERVICECHANNELMESSAGES_PRESTIGE_FIRSTENTRY_TITLE = '#messenger:serviceChannelMessages/prestige/firstEntry/title'
    SERVICECHANNELMESSAGES_PRESTIGE_FIRSTENTRY_TEXT = '#messenger:serviceChannelMessages/prestige/firstEntry/text'
    SERVICECHANNELMESSAGES_PRESTIGE_FIRSTENTRY_BUTTON = '#messenger:serviceChannelMessages/prestige/firstEntry/button'
    SERVICECHANNELMESSAGES_STEAMEMAILCOMPLETION_HEADER = '#messenger:serviceChannelMessages/steamEmailCompletion/header'
    SERVICECHANNELMESSAGES_STEAMEMAILCOMPLETION_BODY = '#messenger:serviceChannelMessages/steamEmailCompletion/body'
    SERVICECHANNELMESSAGES_FAIRPLAYVIOLATION_TITLE_BANREMOVED = '#messenger:serviceChannelMessages/fairplayViolation/title/banRemoved'
    SERVICECHANNELMESSAGES_FAIRPLAYVIOLATION_TEXT_BANREMOVED = '#messenger:serviceChannelMessages/fairplayViolation/text/banRemoved'
    SERVICECHANNELMESSAGES_POSTPROGRESSION_UNLOCKED_HEADER = '#messenger:serviceChannelMessages/postProgression/unlocked/header'
    SERVICECHANNELMESSAGES_POSTPROGRESSION_UNLOCKED_TEXT = '#messenger:serviceChannelMessages/postProgression/unlocked/text'
    SERVICECHANNELMESSAGES_POSTPROGRESSION_UNLOCKED_BUTTON = '#messenger:serviceChannelMessages/postProgression/unlocked/button'
    SERVICECHANNELMESSAGES_POSTPROGRESSION_COMPLETED_HEADER = '#messenger:serviceChannelMessages/postProgression/completed/header'
    SERVICECHANNELMESSAGES_POSTPROGRESSION_COMPLETED_BUTTON = '#messenger:serviceChannelMessages/postProgression/completed/button'
    SERVICECHANNELMESSAGES_FAIRPLAYVIOLATION_BUTTON = '#messenger:serviceChannelMessages/fairplayViolation/button'
    SERVICECHANNELMESSAGES_FAIRPLAYVIOLATION_TITLE_WARNING = '#messenger:serviceChannelMessages/fairplayViolation/title/warning'
    SERVICECHANNELMESSAGES_FAIRPLAYVIOLATION_TEXT_WARNING = '#messenger:serviceChannelMessages/fairplayViolation/text/warning'
    SERVICECHANNELMESSAGES_FAIRPLAYVIOLATION_TITLE_PENALTY = '#messenger:serviceChannelMessages/fairplayViolation/title/penalty'
    SERVICECHANNELMESSAGES_FAIRPLAYVIOLATION_TEXT_PENALTY = '#messenger:serviceChannelMessages/fairplayViolation/text/penalty'
    ...
    SERVICECHANNELMESSAGES_EXTERNALVEHICLERENT_STARTED_TITLE = '#messenger:serviceChannelMessages/externalVehicleRent/started/title'
    SERVICECHANNELMESSAGES_EXTERNALVEHICLERENT_STARTED_VEHICLE = '#messenger:serviceChannelMessages/externalVehicleRent/started/vehicle'
    SERVICECHANNELMESSAGES_EXTERNALVEHICLERENT_EXPIRED_TITLE = '#messenger:serviceChannelMessages/externalVehicleRent/expired/title'
    SERVICECHANNELMESSAGES_EXTERNALVEHICLERENT_EXPIRED_VEHICLE = '#messenger:serviceChannelMessages/externalVehicleRent/expired/vehicle'
