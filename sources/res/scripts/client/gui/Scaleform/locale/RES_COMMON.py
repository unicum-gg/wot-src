...
class RES_COMMON(object):
    ...
    MAPS_ICONS_BATTLEPASS_WIDGET_BACKGROUND_SEASON_21_BG = '../maps/icons/battlePass/widget/background/season_21/bg.png'
    MAPS_ICONS_BLUEPRINTS_FRAGMENT_CONVERSION_BG = '../maps/icons/blueprints/fragment/conversion/bg.png'
    MAPS_ICONS_CHALLENGES_AWARDS_VIEW_BG = '../maps/icons/challenges/awards_view/bg.png'
    ...
    MAPS_ICONS_SKILLTREE_NOTIFICATIONS_PERK_AVAILABLE_BG = '../maps/icons/skillTree/notifications/perk_available/bg.png'
    ...
    MAPS_ICONS_UI_POPOVER_BG = '../maps/icons/ui/popover/bg.png'
    MAPS_ICONS_USERMISSIONS_SLIDER_BG = '../maps/icons/userMissions/slider/bg.png'
