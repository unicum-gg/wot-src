...
class RES_COMMON(object):
    ...
    MAPS_ICONS_BATTLE_STATS_BG = '../maps/icons/battle/stats/bg.png'
    ...
    MAPS_ICONS_CUSTOMIZATION_CART_BG = '../maps/icons/customization/cart/bg.png'
    ...
    MAPS_ICONS_CUSTOMIZATION_TOOLBAR_EXTENDED_BG = '../maps/icons/customization/toolbar/extended/bg.png'
    ...
    MAPS_ICONS_EARLY_ACCESS_BUY_TOKENS_CARD_SMALL_BG = '../maps/icons/early_access/buy_tokens/card_small/bg.png'
    MAPS_ICONS_EARLY_ACCESS_CAROUSEL_BG = '../maps/icons/early_access/carousel/bg.png'
    MAPS_ICONS_EARLY_ACCESS_CAROUSEL_PROGRESS_BAR_BG = '../maps/icons/early_access/carousel/progress_bar/bg.png'
    MAPS_ICONS_EARLY_ACCESS_QUESTS_PROGRESS_BAR_BG = '../maps/icons/early_access/quests/progress_bar/bg.png'
    MAPS_ICONS_EARLY_ACCESS_QUESTS_QUEST_TOKEN_BIG_BG = '../maps/icons/early_access/quests/quest/token/big/bg.png'
    MAPS_ICONS_EARLY_ACCESS_QUESTS_QUEST_TOKEN_SMALL_BG = '../maps/icons/early_access/quests/quest/token/small/bg.png'
    ...
    MAPS_ICONS_PERSONALMISSIONS3_INTROVIEW_BG = '../maps/icons/personalMissions3/IntroView/bg.png'
    MAPS_ICONS_PERSONALMISSIONS3_INTROVIEW_VIDEOBUTTON_BG = '../maps/icons/personalMissions3/IntroView/videoButton/bg.png'
    MAPS_ICONS_PERSONALMISSIONS3_OPERATIONSVIEW_BG = '../maps/icons/personalMissions3/OperationsView/bg.png'
    MAPS_ICONS_PERSONALMISSIONS3_QUESTSVIEW_BG = '../maps/icons/personalMissions3/QuestsView/bg.png'
    MAPS_ICONS_PERSONALMISSIONS3_REWARDSVIEW_BG = '../maps/icons/personalMissions3/RewardsView/bg.png'
    MAPS_ICONS_PERSONALMISSIONS3_TOOLTIPS_LASTOPERATIONTOOLTIP_BG = '../maps/icons/personalMissions3/tooltips/LastOperationTooltip/bg.png'
    MAPS_ICONS_PM_ANNOUNCE_TOOLTIPS_NEW_BG = '../maps/icons/pm_announce/tooltips/new/bg.png'
    ...
    MAPS_ICONS_TELECOM_BG = '../maps/icons/telecom/bg.png'
    MAPS_ICONS_TELECOM_SHARED_HERO_BG = '../maps/icons/telecom/shared/hero/bg.png'
