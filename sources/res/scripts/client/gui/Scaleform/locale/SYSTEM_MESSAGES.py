...
class SYSTEM_MESSAGES(object):
    ...
    ARENA_START_ERRORS_JOIN_WRONG_VEHICLE_LVL = '#system_messages:arena_start_errors/join/WRONG_VEHICLE_LVL'
    ...
    PERSONALMISSIONS_SELECT_SERVER_ERROR_NOT_GOTTEN_REWARD = '#system_messages:personalMissions/select/server_error/NOT_GOTTEN_REWARD'
    PERSONALMISSIONS_SELECT_SERVER_ERROR_NOT_BOUGHT_TILE = '#system_messages:personalMissions/select/server_error/NOT_BOUGHT_TILE'
    PERSONALMISSIONS_SELECT_SERVER_ERROR_QUEST_ALREADY_COMPLETED = '#system_messages:personalMissions/select/server_error/QUEST_ALREADY_COMPLETED'
    PERSONALMISSIONS_SELECT_SERVER_ERROR_NOT_UNLOCKED_QUEST = '#system_messages:personalMissions/select/server_error/NOT_UNLOCKED_QUEST'
    ...
    PERSONALMISSIONS_PAWN_SERVER_ERROR = '#system_messages:personalMissions/pawn/server_error'
    ...
    UNIT_WARNINGS_EXTERNAL_LEGIONARIES_MATCHING_CANCELED = '#system_messages:unit/warnings/EXTERNAL_LEGIONARIES_MATCHING_CANCELED'
    ...
    UNIT_WARNINGS_UNIT_ASSEMBLER_NO_DATE_RECEIVED = '#system_messages:unit/warnings/UNIT_ASSEMBLER_NO_DATE_RECEIVED'
    UNIT_WARNINGS_UNIT_ASSEMBLER_NO_MATCH_POSSIBLE = '#system_messages:unit/warnings/UNIT_ASSEMBLER_NO_MATCH_POSSIBLE'
    UNIT_WARNINGS_UNIT_ASSEMBLER_DISABLED = '#system_messages:unit/warnings/UNIT_ASSEMBLER_DISABLED'
    ...
    UNIT_WARNINGS_ANOTHER_PLAYER_BECOME_COMMANDER = '#system_messages:unit/warnings/ANOTHER_PLAYER_BECOME_COMMANDER'
    UNIT_WARNINGS_ANOTHER_PLAYER_BECOME_EQUIPMENT_COMMANDER = '#system_messages:unit/warnings/ANOTHER_PLAYER_BECOME_EQUIPMENT_COMMANDER'
    UNIT_WARNINGS_ANOTHER_PLAYER_BECOME_COMMANDER_WITH_EQUIPMENT_PERMISSION = '#system_messages:unit/warnings/ANOTHER_PLAYER_BECOME_COMMANDER_WITH_EQUIPMENT_PERMISSION'
    UNIT_WARNINGS_PLAYER_BECOME_COMMANDER = '#system_messages:unit/warnings/PLAYER_BECOME_COMMANDER'
    UNIT_NOTIFICATION_PLAYER_BECOME_EQUIPMENT_COMMANDER = '#system_messages:unit/notification/PLAYER_BECOME_EQUIPMENT_COMMANDER'
    UNIT_WARNINGS_PLAYER_BECOME_COMMANDER_WITH_EQUIPMENT_PERMISSION = '#system_messages:unit/warnings/PLAYER_BECOME_COMMANDER_WITH_EQUIPMENT_PERMISSION'
    ...
    TELECOM_NOTIFICATIONS_VEHICLERECEIVED_TITLE_DEFAULT = '#system_messages:telecom/notifications/vehicleReceived/title/default'
    TELECOM_NOTIFICATIONS_VEHICLERECEIVED_COMMENT_DEFAULT = '#system_messages:telecom/notifications/vehicleReceived/comment/default'
    TELECOM_NOTIFICATIONS_VEHICLERECEIVED_COMMENT_TWITCHPRIME = '#system_messages:telecom/notifications/vehicleReceived/comment/Twitchprime'
    TELECOM_NOTIFICATIONS_VEHICLERECEIVED_SUBCOMMENT_DEFAULT = '#system_messages:telecom/notifications/vehicleReceived/subcomment/default'
    TELECOM_NOTIFICATIONS_VEHICLERECEIVED_CREW_DEFAULT = '#system_messages:telecom/notifications/vehicleReceived/crew/default'
    TELECOM_NOTIFICATIONS_VEHICLEBLOCKED_TITLE_DEFAULT = '#system_messages:telecom/notifications/vehicleBlocked/title/default'
    TELECOM_NOTIFICATIONS_VEHICLEBLOCKED_COMMENT_DEFAULT = '#system_messages:telecom/notifications/vehicleBlocked/comment/default'
    TELECOM_NOTIFICATIONS_VEHICLEBLOCKED_SUBCOMMENT_DEFAULT = '#system_messages:telecom/notifications/vehicleBlocked/subcomment/default'
    TELECOM_NOTIFICATIONS_VEHICLEBLOCKED_SUBCOMMENT_TWITCHPRIME = '#system_messages:telecom/notifications/vehicleBlocked/subcomment/Twitchprime'
    TELECOM_NOTIFICATIONS_VEHICLEUNBLOCKED_TITLE_DEFAULT = '#system_messages:telecom/notifications/vehicleUnblocked/title/default'
    TELECOM_NOTIFICATIONS_VEHICLEUNBLOCKED_COMMENT_DEFAULT = '#system_messages:telecom/notifications/vehicleUnblocked/comment/default'
    TELECOM_NOTIFICATIONS_VEHICLEUNBLOCKED_SUBCOMMENT_DEFAULT = '#system_messages:telecom/notifications/vehicleUnblocked/subcomment/default'
    TELECOM_NOTIFICATIONS_VEHICLEREMOVED_TITLE_DEFAULT = '#system_messages:telecom/notifications/vehicleRemoved/title/default'
    TELECOM_NOTIFICATIONS_VEHICLEREMOVED_COMMENT_DEFAULT = '#system_messages:telecom/notifications/vehicleRemoved/comment/default'
    TELECOM_NOTIFICATIONS_VEHICLEREMOVED_SUBCOMMENT_DEFAULT = '#system_messages:telecom/notifications/vehicleRemoved/subcomment/default'
    ...
    RANKED_NOTIFICATIONS_LEAGUE2 = '#system_messages:ranked/notifications/league2'
    RANKED_NOTIFICATIONS_LEAGUE3 = '#system_messages:ranked/notifications/league3'
    RANKED_NOTIFICATIONS_POSITION = '#system_messages:ranked/notifications/position'
    RANKED_NOTIFICATIONS_MAXRANK = '#system_messages:ranked/notifications/maxRank'
    RANKED_NOTIFICATIONS_MAXRANKRESULT = '#system_messages:ranked/notifications/maxRankResult'
    RANKED_NOTIFICATIONS_LEAGUEPOINTS = '#system_messages:ranked/notifications/leaguePoints'
    RANKED_NOTIFICATIONS_SPRINTERTOP = '#system_messages:ranked/notifications/sprinterTop'
    RANKED_NOTIFICATIONS_SPRINTERIMPROVED = '#system_messages:ranked/notifications/sprinterImproved'
    RANKED_NOTIFICATIONS_SEASONPOINTS = '#system_messages:ranked/notifications/seasonPoints'
    RANKED_NOTIFICATIONS_BONUSNAME_BADGE = '#system_messages:ranked/notifications/bonusName/badge'
    ...
    PREMIUM_QUESTS_SWITCH_ON_BODY = '#system_messages:premium_quests/switch_on/body'
    DAILY_XP_BONUS_SWITCH_OFF_TITLE = '#system_messages:daily_xp_bonus/switch_off/title'
    DAILY_XP_BONUS_SWITCH_OFF_BODY = '#system_messages:daily_xp_bonus/switch_off/body'
    DAILY_XP_BONUS_SWITCH_ON_TITLE = '#system_messages:daily_xp_bonus/switch_on/title'
    DAILY_XP_BONUS_SWITCH_ON_BODY = '#system_messages:daily_xp_bonus/switch_on/body'
    PIGGYBANK_SWITCH_OFF_TITLE = '#system_messages:piggybank/switch_off/title'
    PIGGYBANK_SWITCH_OFF_BODY = '#system_messages:piggybank/switch_off/body'
    ...
    UNIT_ERROR_WGSHEVENT_NOTENOUGHSPAREPARTS = '#system_messages:unit/error/wgshEvent/NotEnoughSpareParts'
    ...
    UNIT_WARNINGS_ENUM = (
     ...
     UNIT_WARNINGS_UNIT_ASSEMBLER_NO_DATE_RECEIVED,
     UNIT_WARNINGS_UNIT_ASSEMBLER_NO_MATCH_POSSIBLE,
     UNIT_WARNINGS_UNIT_ASSEMBLER_DISABLED,
     ...
     UNIT_WARNINGS_ANOTHER_PLAYER_BECOME_COMMANDER,
    ...
    ALL_ENUM = (
     ...
     ARENA_START_ERRORS_JOIN_WRONG_VEHICLE_LVL,
     ...
     PERSONALMISSIONS_SELECT_SERVER_ERROR_NOT_GOTTEN_REWARD,
     PERSONALMISSIONS_SELECT_SERVER_ERROR_NOT_BOUGHT_TILE,
     PERSONALMISSIONS_SELECT_SERVER_ERROR_QUEST_ALREADY_COMPLETED,
     PERSONALMISSIONS_SELECT_SERVER_ERROR_NOT_UNLOCKED_QUEST,
     ...
     PERSONALMISSIONS_PAWN_SERVER_ERROR,
     ...
     TELECOM_NOTIFICATIONS_VEHICLERECEIVED_TITLE_DEFAULT,
     TELECOM_NOTIFICATIONS_VEHICLERECEIVED_COMMENT_DEFAULT,
     TELECOM_NOTIFICATIONS_VEHICLERECEIVED_COMMENT_TWITCHPRIME,
     TELECOM_NOTIFICATIONS_VEHICLERECEIVED_SUBCOMMENT_DEFAULT,
     TELECOM_NOTIFICATIONS_VEHICLERECEIVED_CREW_DEFAULT,
     TELECOM_NOTIFICATIONS_VEHICLEBLOCKED_TITLE_DEFAULT,
     TELECOM_NOTIFICATIONS_VEHICLEBLOCKED_COMMENT_DEFAULT,
     TELECOM_NOTIFICATIONS_VEHICLEBLOCKED_SUBCOMMENT_DEFAULT,
     TELECOM_NOTIFICATIONS_VEHICLEBLOCKED_SUBCOMMENT_TWITCHPRIME,
     TELECOM_NOTIFICATIONS_VEHICLEUNBLOCKED_TITLE_DEFAULT,
     TELECOM_NOTIFICATIONS_VEHICLEUNBLOCKED_COMMENT_DEFAULT,
     TELECOM_NOTIFICATIONS_VEHICLEUNBLOCKED_SUBCOMMENT_DEFAULT,
     TELECOM_NOTIFICATIONS_VEHICLEREMOVED_TITLE_DEFAULT,
     TELECOM_NOTIFICATIONS_VEHICLEREMOVED_COMMENT_DEFAULT,
     TELECOM_NOTIFICATIONS_VEHICLEREMOVED_SUBCOMMENT_DEFAULT,
     ...
     RANKED_NOTIFICATIONS_LEAGUE2,
     RANKED_NOTIFICATIONS_LEAGUE3,
     RANKED_NOTIFICATIONS_POSITION,
     RANKED_NOTIFICATIONS_MAXRANK,
     RANKED_NOTIFICATIONS_MAXRANKRESULT,
     RANKED_NOTIFICATIONS_LEAGUEPOINTS,
     RANKED_NOTIFICATIONS_SPRINTERTOP,
     RANKED_NOTIFICATIONS_SPRINTERIMPROVED,
     RANKED_NOTIFICATIONS_SEASONPOINTS,
     RANKED_NOTIFICATIONS_BONUSNAME_BADGE,
     RANKED_NOTIFICATIONS_BONUSNAME_BADGES,
     RANKED_NOTIFICATIONS_BONUSNAME_STYLE,
     RANKED_NOTIFICATIONS_BONUSNAME_STYLES,
     ...
     PREMIUM_QUESTS_SWITCH_ON_BODY,
     DAILY_XP_BONUS_SWITCH_OFF_TITLE,
     DAILY_XP_BONUS_SWITCH_OFF_BODY,
     DAILY_XP_BONUS_SWITCH_ON_TITLE,
     DAILY_XP_BONUS_SWITCH_ON_BODY,
     PIGGYBANK_SWITCH_OFF_TITLE,
     PIGGYBANK_SWITCH_OFF_BODY,
