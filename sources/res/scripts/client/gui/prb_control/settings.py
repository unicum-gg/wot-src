...
class PREBATTLE_RESTRICTION(object):
    ...
    EARLY_ACCESS_SPACE = 'earlyAccess/space'
    TICKETS_SHORTAGE = 'vehicle/ticketsShortage'
    GOLD_TICKETS_SHORTAGE = 'vehicle/goldTicketsShortage'
    SERVER_LIMITS = (
...
_PREBATTLE_DEFAULT_SETTINGS.update({'limits': {0: {}, 1: {}, 2: {}}})
