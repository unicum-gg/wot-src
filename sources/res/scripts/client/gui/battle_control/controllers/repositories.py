...
class Comp7ControllerRepository(ClassicControllersRepository):
    ...
    def create(cls, setup):
        ...
        repository.addArenaController(prebattle_comp7_skill_ctrl.PrebattleComp7SkillController(), setup)
