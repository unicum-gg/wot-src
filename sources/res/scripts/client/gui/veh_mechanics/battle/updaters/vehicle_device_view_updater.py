...
def makeUIDeviceState(devicesStatuses):
    return [ {'deviceName': VEHICLE_DEVICE_IN_COMPLEX_ITEM.get(deviceName, deviceName), 'deviceState': deviceState} for deviceName, deviceState in devicesStatuses.items()
           ]
