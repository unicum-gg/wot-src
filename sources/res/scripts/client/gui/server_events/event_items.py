...
class PMOperation(object):
    __slots__ = ('__id', '__info', '__quests', '__initialQuests', '__finalQuests',
                 '__isUnlocked', '__hasRequiredVehicles', '__achievements', '__tokens',
                 '__bonuses', '__isAwardAchieved', '__freeTokensCount', '__freeTokensTotalCount',
                 '__branch', '__disabled')
...
class PersonalMission(ServerEventAbstract):
    __slots__ = ServerEventAbstract.__slots__ + ('__pmType', '__pmQuestsProgress',
                                                 '__campaignID', '__hasRequiredVehicles',
                                                 '__canBePawned', '__conditionsProgress',
                                                 '__disabled', '__conditionsConfig')
...
class WtQuest(Quest):
    ...
    def isAvailable(self):
        if self.isBossQuest and not self.gameEventController.hasTokensByName('wtevent:boss1') and not self.gameEventController.hasSpecialBoss():
