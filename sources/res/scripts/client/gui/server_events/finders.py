...
CHAMPION_BADGE_AT_OPERATION_ID = {operationIds[(-1)]:CHAMPION_BADGES_BY_BRANCH[branch] for branch, operationIds in PM_BRANCH.BRANCH_TO_OPERATION_IDS.items() if CHAMPION_BADGES_BY_BRANCH.get(branch) if CHAMPION_BADGES_BY_BRANCH.get(branch)}
