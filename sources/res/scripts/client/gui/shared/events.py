...
class PersonalMissionsEvent(HasCtxEvent):
    ...
    ON_AWARD_PM_SCREEN_CLOSE = 'onAwardPmScreenClose'
    ON_ALL_REWARDS_PM3_VIEW_CLOSE = 'onAllRewardsPm3ViewClose'
...
class StrongholdEvent(HasCtxEvent):
    ...
    STRONGHOLD_REWARD_SELECTED = 'strongholdRewardSelected'
...
class NotifyCenterShowItemEvent(SharedEvent):
    SHOW_BASIC_WINDOW = 'notifycenter/basicWindow/show'
    CLOSE_POLL_WINDOW = 'notifycenter/pollWindow/close'
