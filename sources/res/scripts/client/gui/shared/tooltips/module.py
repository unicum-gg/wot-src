...
class _ModuleExtraStatuses(CONST_CONTAINER):
    ...
    AUTOLOADER_DUAL_GUN = 'autoreloadDualGun'
...
class ModuleTooltipBlockConstructor(object):
 ...
 'vehicleGunShotStabilizationChassisMovement', 'vehicleGunShotStabilizationChassisRotation'), 
       ...
       GUI_ITEM_TYPE.GUN: (
                         ...
                         'avgDamagePerMinute', 'stunMaxDurationList', DISPERSION_RADIUS,
       ...
       CLIP_GUN_MODULE_PARAM: (
                             ...
                             DISPERSION_RADIUS, DUAL_ACCURACY_COOLING_DELAY, 'maxShotDistance', AIMING_TIME_PROP_NAME), 
       AUTO_RELOAD_GUN_MODULE_PARAM: (
                                    ...
                                    BURST_TIME_INTERVAL, BURST_COUNT, BURST_SIZE,
                                    'stunMaxDurationList', DISPERSION_RADIUS,
       ...
       TURBOSHAFT_ENGINE_MODULE_PARAM: (
                                      'enginePower', TURBOSHAFT_ENGINE_POWER, 'fireStartingChance'), 
       ROCKET_ACCELERATION_ENGINE_MODULE_PARAM: (
                                               'enginePower', ROCKET_ACCELERATION_ENGINE_POWER, 'fireStartingChance'), 
       THERMAL_VISION_TURRET_MODULE_PARAM: (
                                          'armor', 'rotationSpeed', 'circularVisionRadius',
       ...
       AUTOSHOOT_FLAME_GUN_MODULE_PARAM: (
                                        'avgDamageList', 'avgPiercingPower', AVG_DAMAGE_PER_SECOND,
                                        'flameMaxDistance', AUTOSHOOT_FLAME_CHANGE_SHELL_TIME, AUOTSHOOT_FLAME_OVERHEAT_COOLING_TIME,
                                        DISPERSION_RADIUS, AIMING_TIME_PROP_NAME), 
       AUTOSHOOT_GUN_MODULE_PARAM: (
                                  'avgDamageList', 'avgPiercingPower', SHELLS_COUNT_PROP_NAME, 'shellsBurstCount',
                                  SHELL_RELOADING_TIME_PROP_NAME, RELOAD_MAGAZINE_TIME_PROP_NAME, BURST_TIME_INTERVAL,
                                  BURST_COUNT, BURST_SIZE, 'avgDamagePerMinute', 'stunMaxDurationList', DISPERSION_RADIUS,
                                  DUAL_ACCURACY_COOLING_DELAY, 'maxShotDistance', AIMING_TIME_PROP_NAME), 
       ...
       CLIP_DUAL_GUN_MODULE_PARAM: (
                                  'avgDamageList', 'avgPiercingPower', SHELLS_COUNT_PROP_NAME,
                                  RELOAD_TIME_SECS_PROP_NAME, DUAL_GUN_RATE_TIME,
                                  'shellsBurstCount', 'shellsFlameBurstCount',
                                  SHELL_RELOADING_TIME_PROP_NAME, RELOAD_MAGAZINE_TIME_PROP_NAME,
                                  DUAL_GUN_CHARGE_TIME,
                                  BURST_TIME_INTERVAL, BURST_COUNT, BURST_SIZE,
                                  'avgDamagePerMinute', 'stunMaxDurationList',
...
class DeluxKPIFormatter(KpiFormatter):
    ...
    def getValues(self):
        return (
         getKpiValueString(self.kpi, self.kpi.value, True),)
