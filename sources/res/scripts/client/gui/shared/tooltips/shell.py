...
_SHELL_TOOLTIP_FORMAT_SETTINGS.update({'avgDamage': {'rounder': backport.getIntegralFormat}, 'avgMutableDamage': {'rounder': backport.getIntegralFormat, 'separator': '-'}, 'piercingPower': {'rounder': backport.getIntegralFormat}})
_ASTERISK = '*'
