...
_ACHIEVEMENTS_BY_NAME = {(_AB.TOTAL, 'warrior'): _CustomAchieveFactory.get(_as.regular_ext.WarriorAchievement), 
   ...
   (_AB.TOTAL, 'medalGudz'): _CustomAchieveFactory.get(_as.class_progress.MedalGudzAchievement), 
   (_AB.TOTAL, 'medalSamokhin'): _CustomAchieveFactory.get(_as.class_progress.MedalSamokhinAchievement), 
   ...
   (_AB.TOTAL, 'medalUshakov'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   ...
   (_AB.SINGLE, 'BattlePassCommonPr_18_5_Marathon'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   ...
   (_AB.SINGLE, 'personalMissionsThird'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'ParagonsFirstSeason'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'Paragons_S2'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'ParagonsFirstElevenVehicle'): _AchieveFactory.get(_abstract_achievements.RegularAchievement), 
   (_AB.SINGLE, 'mt_comp_3_1'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'hw2023Medal01'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'hw2023Medal02'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   ...
   (_AB.SINGLE, 'comp7_3_3_champion'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_3_3_legend'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'hb24Medal'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_3_4'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_3_4_champion'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_3_4_legend'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   ...
   (_AB.SINGLE, 'comp7_4_1_legend'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_4_2'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_4_2_champion'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_4_2_legend'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   ...
   (_AB.SINGLE, 'portal2025Medal_1'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'portal2025Medal_2'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_5_2'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_5_2_champion'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_5_2_legend'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'clan_season_25_first'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'clan_season_25_last'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'NY26_AtmsphrLevel'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'NY26_CelebTaskCompleted'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.EPIC_BATTLE, 'saboteur'): _CustomAchieveFactory.get(_as.simple_progress.SaboteurAchievement), 
   (_AB.TOTAL, 'huntsman'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.TOTAL, 'medalBurda'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.TOTAL, 'medalDumitru'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'cosm2026_medal_1'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'cosm2026_medal_2'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_5_3'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_5_3_champion'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_5_3_legend'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'hb26MedalTanker'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'hb26MedalSPG'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_5_4'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_5_4_champion'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_5_4_legend'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'wt2026'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'clan_season_26_first'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'clan_season_26_last'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_6_1'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_6_1_champion_0'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_6_1_champion_1'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_6_1_champion_2'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_6_1_legend_0'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_6_1_legend_1'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_6_1_legend_2'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement)}
