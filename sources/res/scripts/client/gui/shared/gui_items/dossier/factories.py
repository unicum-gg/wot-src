...
_ACHIEVEMENTS_BY_NAME = {(_AB.TOTAL, 'warrior'): _CustomAchieveFactory.get(_as.regular_ext.WarriorAchievement), 
   ...
   (_AB.TOTAL, 'medalDumitru'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   ...
   (_AB.TOTAL, 'lumberjack'): _CustomAchieveFactory.get(_as.regular.LumberjackAchievement), 
   ...
   (_AB.SINGLE, '15YearsOfService'): _AchieveFactory.get(LoyalServiceAchievement), 
   ...
   (_AB.SINGLE, 'may23'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'june23'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'july23'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'august23'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'september23'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'december23'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'january24'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'february24'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'march24'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   ...
   (_AB.SINGLE, 'bootcampMedal'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   ...
   (_AB.SINGLE, 'BattlePassCommonPr_11'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'BattlePassCommonPr_12'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'BattlePassCommonPr_12extra'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'BattlePassCommonPr_NY24'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'BattlePassCommonPr_13'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'BattlePassCommonPr_14'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'BattlePassCommonPr_15'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'BattlePassCommonPr_15extra'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'BattlePassCommonPr_NY25'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   ...
   (_AB.SINGLE, 'BattlePassCommonPr_17extra_1'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   ...
   (_AB.SINGLE, 'BattlePassCommonPr_18extra_2'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   ...
   (_AB.SINGLE, 'NY24_CelebChallenge'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'NY24_AtmsphrLevel'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   ...
   (_AB.SINGLE, 'onboardingMedal'): _AchieveFactory.get(_abstract_achievements.RegularAchievement), 
   (_AB.SINGLE, 'comp7_3_1'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.TOTAL, 'wt2023HunterWins'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.TOTAL, 'wt2023BossWins'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.TOTAL, 'wt2023MaxPlasma'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'hw2023Medal'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_3_2'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_3_3'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_3_yearly_iron'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_3_yearly_bronze'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_3_yearly_silver'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_3_yearly_gold'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_3_yearly_champion'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_3_yearly_legend'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'Cosmic_StarTrekCrew'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'Cosmic_LiveLongAndProsper'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'Cosmic_KlingonValor'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_4_1'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_4_2'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_4_3'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_4_yearly_iron'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_4_yearly_bronze'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_4_yearly_silver'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   ...
   (_AB.SINGLE, 'vDayHero'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'ls2025Medal'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_5_1'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_5_2'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_5_3'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_5_yearly_iron'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_5_yearly_bronze'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_5_yearly_silver'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_5_yearly_gold'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_5_yearly_champion'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'comp7_5_yearly_legend'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'ls2_0Medal'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'sccHero'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'wot15thAnniversary'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'wot15thAnniversaryElite'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'wt2025progression'): _AchieveFactory.get(_abstract_achievements.RegularAchievement), 
   (_AB.SINGLE, 'twoPointZeroMedal'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
   (_AB.SINGLE, 'twoPointZeroCollectorMedal'): _AchieveFactory.get(_as.simple_progress_achvs.Collector20Achievement), 
   (_AB.SINGLE, 'hw2025Medal'): _AchieveFactory.get(_abstract_achievements.DeprecatedAchievement), 
