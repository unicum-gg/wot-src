...
class NOTIFICATION_TYPE(object):
    ...
    COMP7_OFFER_TOKENS = 27
    EXCHANGE_RATE_GOLD_DISCOUNT = 28
    EXCHANGE_RATE_XP_DISCOUNT = 29
    ADVENT_CALENDAR_DOORS_AVAILABLE = 30
    VEH_SKILL_TREE_PERK_AVAILABLE = 31
    OPEN_BUNDLE_ENTRY = 32
    CHALLENGES_START = 33
    CHALLENGES_REMINDER = 34
    HO_DOG_REMINDER = 35
    HO_MARKETPLACE_AVAILABLE = 36
    HO_FRIEND_RESOURCE_COLLECTING_AVAILABLE = 37
...
ITEMS_MAX_LENGTHS = {NOTIFICATION_TYPE.MESSAGE: 250, 
   ...
   NOTIFICATION_TYPE.COMP7_OFFER_TOKENS: 1, 
   NOTIFICATION_TYPE.HO_DOG_REMINDER: 1, 
   NOTIFICATION_TYPE.HO_MARKETPLACE_AVAILABLE: 1, 
   NOTIFICATION_TYPE.HO_FRIEND_RESOURCE_COLLECTING_AVAILABLE: 1, 
   NOTIFICATION_TYPE.HO_RESOURCE_REMINDER: 1, 
   NOTIFICATION_TYPE.HO_FRIEND_RESOURCE_REMINDER: 1, 
   NOTIFICATION_TYPE.HO_NO_FRIENDS_REMINDER: 1, 
   NOTIFICATION_TYPE.EXCHANGE_RATE_GOLD_DISCOUNT: 1, 
   NOTIFICATION_TYPE.EXCHANGE_RATE_XP_DISCOUNT: 1, 
   NOTIFICATION_TYPE.ADVENT_CALENDAR_DOORS_AVAILABLE: 1, 
   NOTIFICATION_TYPE.VEH_SKILL_TREE_PERK_AVAILABLE: 500, 
   NOTIFICATION_TYPE.OPEN_BUNDLE_ENTRY: 1, 
   NOTIFICATION_TYPE.CHALLENGES_START: 100, 
   NOTIFICATION_TYPE.CHALLENGES_REMINDER: 1}
