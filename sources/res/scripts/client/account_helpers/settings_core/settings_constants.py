...
class GRAPHICS(CONST_CONTAINER):
    ...
    SHOW_PREBATTLE_HIGHLIGHTS = 'showPrebattleHighlights'
    INCREASE_EFFECTS_CONTRAST_ENABLED = 'INCREASE_EFFECTS_CONTRAST_ENABLED'
...
class PersonalMission4(CONST_CONTAINER):
    INTRO_OP_11 = 'INTRO_OP_11'
    PM_BANNER_ANIMATION_KEY = 'PM_BANNER_ANIMATION_KEY'
    CHECKED_PM4_POINTS = 'CHECKED_PM4_POINTS'
    PART_NO = 'PART_NO'
    OPERATION_SHOWN = 'OPERATION_SHOWN'
