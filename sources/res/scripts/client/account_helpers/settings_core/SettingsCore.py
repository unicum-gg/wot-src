...
class SettingsCore(ISettingsCore):
    ...
    def init(self):
        ...
        SITUATIONAL_PERKS_SETTINGS_STORAGE = settings_storages.ServerSettingsStorage(self.serverSettings, self, SETTINGS_SECTIONS.SITUATIONAL_PERKS)
        ...
        self.__storages = {'game': GAME_SETTINGS_STORAGE, 
           ...
           'situationalPerks': SITUATIONAL_PERKS_SETTINGS_STORAGE, 
        ...
        self.__options = options.SettingsContainer(graphicSettings + (
         (
          GAME.REPLAY_ENABLED,
          options.ReplaySetting(GAME.REPLAY_ENABLED, storage=GAME_SETTINGS_STORAGE)),
         (
          GAME.SNIPER_ZOOM,
          options.SniperZoomSetting(GAME.SNIPER_ZOOM, storage=EXTENDED_GAME_SETTINGS_STORAGE)),
         (
          GAME.HULLLOCK_ENABLED,
          options.HullLockSetting(GAME.HULLLOCK_ENABLED, storage=EXTENDED_GAME_SETTINGS_STORAGE)),
         (
          GAME.PRE_COMMANDER_CAM,
          options.SettingTrueByDefault(GAME.PRE_COMMANDER_CAM, storage=EXTENDED_GAME_SETTINGS_STORAGE)),
         (
          GAME.COMMANDER_CAM,
          options.SettingTrueByDefault(GAME.COMMANDER_CAM, storage=EXTENDED_GAME_SETTINGS_STORAGE)),
         (
          GAME.SHOW_VEHICLE_HP_IN_PLAYERS_PANEL,
          options.VehicleHPInPlayersPanelSetting(GAME.SHOW_VEHICLE_HP_IN_PLAYERS_PANEL, storage=BATTLE_HUD_SETTINGS_STORAGE)),
         (
          GAME.SHOW_VEHICLE_HP_IN_MINIMAP,
          options.MinimapHPSettings(GAME.SHOW_VEHICLE_HP_IN_MINIMAP, storage=BATTLE_HUD_SETTINGS_STORAGE)),
         (
          GAME.HANGAR_CAM_PERIOD,
          options.HangarCamPeriodSetting(GAME.HANGAR_CAM_PERIOD, storage=EXTENDED_GAME_SETTINGS_STORAGE)),
         (
          GAME.HANGAR_CAM_PARALLAX_ENABLED,
         ...
         (
          ...
          options.BattleLoadingTipSetting(GAME.BATTLE_LOADING_INFO, GAME.BATTLE_LOADING_INFO)),
         (
          GAME.BATTLE_LOADING_RANKED_INFO,
          options.BattleLoadingTipSetting(GAME.BATTLE_LOADING_RANKED_INFO, GAME.BATTLE_LOADING_RANKED_INFO)),
         (
          GAME.SHOW_MARKS_ON_GUN,
          options.ShowMarksOnGunSetting(GAME.SHOW_MARKS_ON_GUN, storage=MARK_ON_GUN_SETTINGS_STORAGE)),
         (
          GAME.ANONYMIZER, options.AnonymizerSetting(GAME.ANONYMIZER)),
         (
          GAME.SHOW_VICTIMS_DOGTAG,
          options.DogtagsSetting(GAME.SHOW_VICTIMS_DOGTAG, storage=DOG_TAGS_SETTINGS_STORAGE)),
         (
         ...
         (
          GAME.INCREASED_ZOOM,
          options.IncreasedZoomSetting(GAME.INCREASED_ZOOM, storage=EXTENDED_GAME_SETTINGS_STORAGE)),
         (
          GAME.SNIPER_MODE_BY_SHIFT,
          options.SniperModeByShiftSetting(GAME.SNIPER_MODE_BY_SHIFT, storage=EXTENDED_GAME_SETTINGS_STORAGE)),
         (
          GAME.ENABLE_SPEEDOMETER,
          options.StorageAccountSetting(GAME.ENABLE_SPEEDOMETER, storage=EXTENDED_GAME_SETTINGS_STORAGE)),
         (
          GAME.ENABLE_REPAIR_TIMER,
          options.StorageAccountSetting(GAME.ENABLE_REPAIR_TIMER, storage=EXTENDED_GAME_SETTINGS_STORAGE)),
         (
          GAME.ENABLE_BATTLE_NOTIFIER,
         ...
         (
          ...
          options.MessengerSetting(GAME.ENABLE_OL_FILTER, storage=MESSENGER_SETTINGS_STORAGE)),
         (
          GAME.ENABLE_SPAM_FILTER,
          options.MessengerSetting(GAME.ENABLE_SPAM_FILTER, storage=MESSENGER_SETTINGS_STORAGE)),
         (
          GAME.SHOW_DATE_MESSAGE,
          options.MessengerDateTimeSetting(1, storage=MESSENGER_SETTINGS_STORAGE)),
         (
          GAME.SHOW_TIME_MESSAGE,
          options.MessengerDateTimeSetting(2, storage=MESSENGER_SETTINGS_STORAGE)),
         (
          GAME.INVITES_FROM_FRIENDS,
          options.MessengerSetting(GAME.INVITES_FROM_FRIENDS, storage=MESSENGER_SETTINGS_STORAGE)),
         (
          GAME.RECEIVE_CLAN_INVITES_NOTIFICATIONS,
          options.ClansSetting(GAME.RECEIVE_CLAN_INVITES_NOTIFICATIONS, storage=EXTENDED_GAME_SETTINGS_STORAGE)),
         (
          GAME.RECEIVE_FRIENDSHIP_REQUEST,
          options.MessengerSetting(GAME.RECEIVE_FRIENDSHIP_REQUEST, storage=MESSENGER_SETTINGS_STORAGE)),
         (
          GAME.RECEIVE_INVITES_IN_BATTLE,
          options.MessengerSetting(GAME.RECEIVE_INVITES_IN_BATTLE, storage=EXTENDED_MESSENGER_SETTINGS_STORAGE)),
         (
          GAME.STORE_RECEIVER_IN_BATTLE,
          options.MessengerSetting(GAME.STORE_RECEIVER_IN_BATTLE, storage=MESSENGER_SETTINGS_STORAGE)),
         (
          GAME.DISABLE_BATTLE_CHAT,
          options.MessengerSetting(GAME.DISABLE_BATTLE_CHAT, storage=MESSENGER_SETTINGS_STORAGE)),
         (
          GAME.CHAT_CONTACTS_LIST_ONLY,
          options.MessengerSetting(GAME.CHAT_CONTACTS_LIST_ONLY, storage=EXTENDED_MESSENGER_SETTINGS_STORAGE)),
         (
          GAME.PLAYERS_PANELS_SHOW_LEVELS,
          options.PlayersPanelSetting(GAME.PLAYERS_PANELS_SHOW_LEVELS, 'players_panel', 'showLevels', storage=GAME_SETTINGS_STORAGE)),
         (
          GAME.PLAYERS_PANELS_SHOW_TYPES,
         ...
         (
          GAME.SHOW_VECTOR_ON_MAP,
          options.MinimapSetting(GAME.SHOW_VECTOR_ON_MAP, storage=GAME_SETTINGS_STORAGE)),
         (
          GAME.SHOW_SECTOR_ON_MAP,
          options.MinimapSetting(GAME.SHOW_SECTOR_ON_MAP, storage=GAME_SETTINGS_STORAGE)),
         (
          GAME.SHOW_VEH_MODELS_ON_MAP,
          options.MinimapVehModelsSetting(GAME.SHOW_VEH_MODELS_ON_MAP, storage=GAME_SETTINGS_STORAGE)),
         (
          GAME.SHOW_ARTY_HIT_ON_MAP,
         ...
         (
          GAME.MINIMAP_MAX_VIEW_RANGE,
          options.StorageAccountSetting(GAME.MINIMAP_MAX_VIEW_RANGE, storage=EXTENDED_GAME_SETTINGS_STORAGE)),
         (
         ...
         (
          GAME.DOUBLE_CAROUSEL_TYPE,
          options.DoubleCarouselTypeSetting(GAME.DOUBLE_CAROUSEL_TYPE, storage=EXTENDED_GAME_SETTINGS_STORAGE)),
         (
         ...
         (
          GAME.MINIMAP_ALPHA_ENABLED,
          options.StorageAccountSetting(GAME.MINIMAP_ALPHA_ENABLED, storage=EXTENDED_GAME_SETTINGS_STORAGE)),
         (
         ...
         (
          GAME.SCROLL_SMOOTHING,
          options.StorageAccountSetting(GAME.SCROLL_SMOOTHING, storage=EXTENDED_GAME_2_SETTINGS_STORAGE)),
         (
          GAME.NEWBIE_PREBATTLE_HINTS,
          options.NewbiePrebattleHintsSetting(GAME.NEWBIE_PREBATTLE_HINTS, storage=EXTENDED_GAME_2_SETTINGS_STORAGE)),
         (
         ...
         (
          ...
          options.WindowSizeSetting(storage=VIDEO_SETTINGS_STORAGE)),
         (
          GRAPHICS.RESOLUTION,
          options.ResolutionSetting(storage=VIDEO_SETTINGS_STORAGE)),
         (
          GRAPHICS.REFRESH_RATE,
          options.RefreshRateSetting(storage=VIDEO_SETTINGS_STORAGE)),
         (
          GRAPHICS.VIDEO_MODE,
          options.VideoModeSettings(storage=VIDEO_SETTINGS_STORAGE)),
         (
         ...
         (
          SOUND.SOUND_DEVICE,
          options.SoundDevicePresetSetting(SOUND.SOUND_DEVICE, SOUND.SOUND_DEVICE, isPreview=True)),
         (
         ...
         (
          ...
          options.MouseInversionSetting(CONTROLS.MOUSE_VERT_INVERSION, 'vertInvert', storage=CONTROLS_SETTINGS_STORAGE)),
         (
          CONTROLS.BACK_DRAFT_INVERSION,
          options.BackDraftInversionSetting(storage=CONTROLS_SETTINGS_STORAGE)),
         (
         ...
         (
          AIM.SNIPER,
          options.AimSetting(AIM.SNIPER, storage=AIM_SETTINGS_STORAGE)),
         (
          SPGAim.SHOTS_RESULT_INDICATOR,
          options.SPGAimSetting(SPGAim.SHOTS_RESULT_INDICATOR, storage=SPG_AIM_SETTINGS_STORAGE)),
         (
          SPGAim.SPG_SCALE_WIDGET,
          options.SPGAimSetting(SPGAim.SPG_SCALE_WIDGET, storage=SPG_AIM_SETTINGS_STORAGE)),
         (
          SPGAim.SPG_STRATEGIC_CAM_MODE,
          options.SPGStrategicCamMode(SPGAim.SPG_STRATEGIC_CAM_MODE, storage=SPG_AIM_SETTINGS_STORAGE)),
         (
          SPGAim.AUTO_CHANGE_AIM_MODE,
          options.SPGAimSetting(SPGAim.AUTO_CHANGE_AIM_MODE, storage=SPG_AIM_SETTINGS_STORAGE)),
         (
          SPGAim.AIM_ENTRANCE_MODE,
          options.SPGAimEntranceMode(SPGAim.AIM_ENTRANCE_MODE, storage=SPG_AIM_SETTINGS_STORAGE)),
         (
          CONTOUR.ENHANCED_CONTOUR,
          options.ContourSetting(CONTOUR.ENHANCED_CONTOUR, storage=CONTOUR_SETTINGS_STORAGE)),
         (
          CONTOUR.CONTOUR_PENETRABLE_ZONE,
          options.ContourPenetratableZoneSetting(CONTOUR.CONTOUR_PENETRABLE_ZONE, storage=CONTOUR_SETTINGS_STORAGE)),
         (
         ...
         (
          MARKERS.DEAD,
          options.VehicleMarkerSetting(MARKERS.DEAD, storage=MARKERS_SETTINGS_STORAGE)),
         (
          MARKERS.ALLY,
          options.VehicleMarkerSetting(MARKERS.ALLY, storage=MARKERS_SETTINGS_STORAGE)),
         (
          DAMAGE_INDICATOR.TYPE,
          options.DamageIndicatorTypeSetting(DAMAGE_INDICATOR.TYPE, storage=DAMAGE_INDICATOR_SETTINGS_STORAGE)),
         (
         ...
         (
          DAMAGE_LOG.SHOW_DETAILS,
          options.DamageLogDetailsSetting(DAMAGE_LOG.SHOW_DETAILS, storage=DAMAGE_LOG_SETTINGS_STORAGE)),
         (
          DAMAGE_LOG.SHOW_EVENT_TYPES,
          options.DamageLogEventTypesSetting(DAMAGE_LOG.SHOW_EVENT_TYPES, storage=DAMAGE_LOG_SETTINGS_STORAGE)),
         (
          DAMAGE_LOG.EVENT_POSITIONS,
         ...
         (
          BATTLE_BORDER_MAP.TYPE_BORDER,
          options.BattleBorderMapType(BATTLE_BORDER_MAP.TYPE_BORDER, storage=BATTLE_BORDER_MAP_SETTINGS_STORAGE)),
         (
          QUESTS_PROGRESS.VIEW_TYPE,
          options.QuestsProgressViewType(QUESTS_PROGRESS.VIEW_TYPE, storage=QUESTS_PROGRESS_SETTINGS_STORAGE)),
         (
          QUESTS_PROGRESS.DISPLAY_TYPE,
          options.QuestsProgressDisplayType(QUESTS_PROGRESS.DISPLAY_TYPE, storage=QUESTS_PROGRESS_SETTINGS_STORAGE)),
         (
          SITUATIONAL_PERKS.ARMOR_PATCHING,
          options.SettingTrueByDefault(SITUATIONAL_PERKS.ARMOR_PATCHING, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (
          SITUATIONAL_PERKS.COMMANDER_EAGLE_EYE,
          options.SettingTrueByDefault(SITUATIONAL_PERKS.COMMANDER_EAGLE_EYE, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (
          SITUATIONAL_PERKS.COMMANDER_EMERGENCY,
          options.SettingTrueByDefault(SITUATIONAL_PERKS.COMMANDER_EMERGENCY, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (
          SITUATIONAL_PERKS.COMMANDER_TUTOR,
          options.SettingTrueByDefault(SITUATIONAL_PERKS.COMMANDER_TUTOR, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (
          SITUATIONAL_PERKS.COMMANDER_COORDINATION,
          options.SettingTrueByDefault(SITUATIONAL_PERKS.COMMANDER_COORDINATION, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (
          SITUATIONAL_PERKS.COMMANDER_HOLD_LINE,
          options.SettingTrueByDefault(SITUATIONAL_PERKS.COMMANDER_HOLD_LINE, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (
          SITUATIONAL_PERKS.COMMANDER_STAY_SHARP,
          options.SettingTrueByDefault(SITUATIONAL_PERKS.COMMANDER_STAY_SHARP, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (
          SITUATIONAL_PERKS.GUNNER_FOCUS,
          options.SettingTrueByDefault(SITUATIONAL_PERKS.GUNNER_FOCUS, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (
          SITUATIONAL_PERKS.GUNNER_LONE_WOLF,
          options.SettingTrueByDefault(SITUATIONAL_PERKS.GUNNER_LONE_WOLF, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (
          SITUATIONAL_PERKS.DRIVER_MOTOR_EXPERT,
          options.SettingTrueByDefault(SITUATIONAL_PERKS.DRIVER_MOTOR_EXPERT, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (
          SITUATIONAL_PERKS.DRIVER_SUSPENSION_REPAIR,
          options.SettingTrueByDefault(SITUATIONAL_PERKS.DRIVER_SUSPENSION_REPAIR, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (
          SITUATIONAL_PERKS.DRIVER_BULLETPROOF,
          options.SettingTrueByDefault(SITUATIONAL_PERKS.DRIVER_BULLETPROOF, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (
          SITUATIONAL_PERKS.LOADER_DESPERADO,
          options.SettingTrueByDefault(SITUATIONAL_PERKS.LOADER_DESPERADO, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (
          SITUATIONAL_PERKS.LOADER_INTUITION,
          options.SettingTrueByDefault(SITUATIONAL_PERKS.LOADER_INTUITION, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (
          SITUATIONAL_PERKS.LOADER_MELEE,
          options.SettingTrueByDefault(SITUATIONAL_PERKS.LOADER_MELEE, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (
          SITUATIONAL_PERKS.LOADER_SECOND_CHANCE,
          options.SettingTrueByDefault(SITUATIONAL_PERKS.LOADER_SECOND_CHANCE, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (
          SITUATIONAL_PERKS.RADIOMAN_SIDE_BY_SIDE,
          options.SettingTrueByDefault(SITUATIONAL_PERKS.RADIOMAN_SIDE_BY_SIDE, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (
          SITUATIONAL_PERKS.RADIOMAN_EXPERT,
          options.SettingTrueByDefault(SITUATIONAL_PERKS.RADIOMAN_EXPERT, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (
          SITUATIONAL_PERKS.RADIOMAN_THREAT_SEARCH,
          options.SettingTrueByDefault(SITUATIONAL_PERKS.RADIOMAN_THREAT_SEARCH, storage=SITUATIONAL_PERKS_SETTINGS_STORAGE)),
         (
          BATTLE_COMM.ENABLE_BATTLE_COMMUNICATION,
          options.SettingTrueByDefault(BATTLE_COMM.ENABLE_BATTLE_COMMUNICATION, storage=BATTLE_COMM_SETTINGS_STORAGE)),
         (
          BATTLE_COMM.SHOW_BASE_MARKERS,
          options.SettingTrueByDefault(BATTLE_COMM.SHOW_BASE_MARKERS, storage=BATTLE_COMM_SETTINGS_STORAGE)),
         (
          BATTLE_COMM.SHOW_CALLOUT_MESSAGES,
          options.SettingTrueByDefault(BATTLE_COMM.SHOW_CALLOUT_MESSAGES, storage=BATTLE_COMM_SETTINGS_STORAGE)),
         (
          BATTLE_COMM.SHOW_COM_IN_PLAYER_LIST,
          options.SettingTrueByDefault(BATTLE_COMM.SHOW_COM_IN_PLAYER_LIST, storage=BATTLE_COMM_SETTINGS_STORAGE)),
         (
          BATTLE_COMM.SHOW_STICKY_MARKERS,
          options.SettingTrueByDefault(BATTLE_COMM.SHOW_STICKY_MARKERS, storage=BATTLE_COMM_SETTINGS_STORAGE)),
         (
