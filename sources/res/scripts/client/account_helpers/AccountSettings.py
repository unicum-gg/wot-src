...
COMP7_LIGHT_CAROUSEL_FILTER_CLIENT_1 = 'COMP7_LIGHT_CAROUSEL_FILTER_CLIENT_1'
...
IS_BATTLE_PASS_START_ANIMATION_SEEN = 'isBattlePassStartAnimationSeen'
LAST_BATTLE_PASS_EXTRA_CHAPTER_SEEN = 'lastBattlePassExtraChapterSeen'
UMG_BATTLE_PASS_EXTRA_CHAPTER_SEEN = 'umgBattlePassExtraChapterSeen'
LAST_BATTLE_PASS_HOLIDAY_CHAPTER_SEEN = 'lastBattlePassHolidayChapterSeen'
BR_UI_SECTION = 'battleRoyale'
BR_PROGRESSION_SEEN_QUESTS = 'battleRoyaleSeenQuests'
...
COMP7_WEEKLY_WIDGET_SHOWN_QUEST = 'comp7WeeklyWidgetShownQuest'
...
OPEN_BUNDLE_NOTIFICATIONS = 'openBundle'
OPEN_BUNDLE_START_SHOWN = 'openBundleStartShown'
OPEN_BUNDLE_REMINDER_SHOWN = 'openBundleEndSoonShown'
OPEN_BUNDLE_ENTRY_POINT_SHOWN = 'openBundleEntryIntroShown'
OPEN_BUNDLE_ENTRY_POINT_ANIMATION_SHOWN = 'openBundleEntryAnimationShown'
OPEN_BUNDLE_INTRO_SHOWN = 'openBundleIntroShown'
...
NATIONS_VISITED = 'nationsVisited'
VEH_SKILL_TREE_HINT_SHOWN = 'vehSkillTreeHintShown'
VEH_SKILL_TREE_POPUP_SHOWN = 'vehSkillTreePopupShown'
VEH_SKILL_TREE_RECORDED_NOFITICATION_NODE = 'vehSkillTreeRecordedNotificationNode'
...
class PetSystem(object):
    SETTINGS = 'petSystemSettings'
    SEEN_PET_NAME_IDS = 'petSystemSeenPetNameIDs'
...
FRONTLINE_BANNER_FIRST_APPEARANCE_TIMESTAMP = 'frontlineBannerFirstAppearanceTimestamp'
FRONTLINE_BANNER_INTRO_CLICK_TIMESTAMP = 'frontlineBannerIntroClickTimestamp'
...
DEFAULT_VALUES = {KEY_FILTERS: {STORE_TAB: 0, 
                 ...
                 COMP7_CAROUSEL_FILTER_CLIENT_1: {'searchNameVehicle': '', 
                                                  'clanRented': False}, 
                 COMP7_LIGHT_CAROUSEL_FILTER_1: {'ussr': False, 
                                                 'germany': False, 
                                                 'usa': False, 
                                                 'china': False, 
                                                 'france': False, 
                                                 ...
                                                 'level_10': False, 
                                                 'level_11': False}, 
                 COMP7_LIGHT_CAROUSEL_FILTER_2: {'premium': False, 
                                                 'elite': False, 
                                                 'igr': False, 
                                                 'rented': True, 
                                                 'event': True, 
                 ...
                 COMP7_LIGHT_CAROUSEL_FILTER_3: {'own3DStyle': False, 
                                                 'canInstallAttachments': False}, 
                 COMP7_LIGHT_CAROUSEL_FILTER_CLIENT_1: {'searchNameVehicle': '', 
                                                        'clanRented': False}, 
                 MISSION_SELECTOR_FILTER: {'inventory': False}, 
                 PM_SELECTOR_FILTER: {'inventory': False}, 
                 ORDERS_FILTER: {'isSelected': False}, GUI_START_BEHAVIOR: {'isFreeXPInfoDialogShowed': False, 
                 ...
                 EULA_VERSION: {'version': 0}, FORT_MEMBER_TUTORIAL: {'wasShown': False}, IGR_PROMO: {'wasShown': False}, CONTACTS: {'showOfflineUsers': True, 'showOthersCategory': True}, BOOSTERS_FILTER: 0, 
                 ...
                 PROMO: {}, PROFILE_TECHNIQUE: {'selectedColumn': 4, 'selectedColumnSorting': 'descending', 'isInHangarSelected': False}, PROFILE_TECHNIQUE_MEMBER: {'selectedColumn': 4, 'selectedColumnSorting': 'descending'}, SPEAKERS_DEVICE: 0, 
   ...
   KEY_MANUAL: {LOBBY_MENU_MANUAL_TRIGGER_SHOWN: False, 
                MANUAL_NEW_CONTENT: {}}, 
   KEY_SETTINGS: {'unitWindow': {SELECTED_INTRO_VEHICLES_FIELD: []}, 'vehicleSellDialog': {'isOpened': False}, 
                  KNOWN_SELECTOR_BATTLES: set(), 
                  'tankmanDropSkillIdx': 0, 
                  'cursor': False, 
                  'arcade': {'mixing': {'alpha': 100, 'type': 3}, 'gunTag': {'alpha': 100, 'type': 9}, 'centralTag': {'alpha': 100, 'type': 8}, 'net': {'alpha': 100, 'type': 0}, 'reloader': {'alpha': 100, 'type': 0}, 'condition': {'alpha': 100, 'type': 0}, 'cassette': {'alpha': 100, 'type': 0}, 'reloaderTimer': {'alpha': 100, 'type': 0}, 'zoomIndicator': {'alpha': 100, 'type': 0}}, 'sniper': {'mixing': {'alpha': 90, 'type': 0}, 'gunTag': {'alpha': 90, 'type': 0}, 'centralTag': {'alpha': 90, 'type': 0}, 'net': {'alpha': 90, 'type': 0}, 'reloader': {'alpha': 90, 'type': 0}, 'condition': {'alpha': 90, 'type': 0}, 'cassette': {'alpha': 90, 'type': 0}, 'reloaderTimer': {'alpha': 100, 'type': 0}, 'zoomIndicator': {'alpha': 100, 'type': 0}}, 'spgAim': {SPGAim.SHOTS_RESULT_INDICATOR: True, 
                  ...
                  SOUND.PHYSICS_QUALITY: 'disabled', 
                  ...
                  NEW_SETTINGS_COUNTER: {'GameSettings': {BattleCommStorageKeys.SHOW_LOCATION_MARKERS: True, 
                  ...
                  CUSTOMIZATION_TABS_VISITED: set([1, 2, 3, 4, 5, 6, 7]), 
                  ...
                  HANGAR_VIEW_SETTINGS: {'allVehicles': {'crewEnabled': True, 
                                                         'ttcEnabled': True}}, 
                  HANGAR_KEY_BINDINGS: {'vehicleMenu': {}}, ArmorInspector.SETTINGS: {ArmorInspector.SELECTED_MODE: 'nominal'}}, 
   ...
   KEY_UI_FLAGS: {COMP7_UI_SECTION: {COMP7_WEEKLY_QUESTS_PAGE_TOKENS_COUNT: 0, 
                  ...
                  LIVE_OPS_WEB_EVENTS_UI_FLAGS: {}, 'uiSpamVisited_store': False, 
...
class AccountSettings(object):
    ...
    def convert():
        ...
        if currVersion != AccountSettings.version:
            ...
            if currVersion < 2:
                MARKER_SETTINGS_MAP = {'showVehicleIcon': 'markerBaseIcon', 'showVehicleLevel': 'markerBaseLevel', 
                ...
                for key, section in ads.items()[:]:
                    if key == 'account':
                        ...
                        for filterName, filterPickle in accFilters.items()[:]:
                            if filterName in ('cs_intro_view_vehicle', 'cs_list_view_vehicle',
                                              'cs_unit_view_vehicle', 'cs_unit_view_settings'):
            ...
            if currVersion < 25:
                for key, section in _filterAccountSection(ads):
                    accFilters = AccountSettings._readSection(section, KEY_FILTERS)
                    for filterName, filterPickle in accFilters.items():
                        if filterName in ('shop_module', 'shop_shell', 'inventory_vehicle',
                                          'inventory_module', 'inventory_shell',
                                          'inventory_optionalDevice', 'inventory_equipment'):
                            defaults = DEFAULT_VALUES[KEY_FILTERS][filterName].copy()
            ...
            if currVersion < 30:
                for key, section in _filterAccountSection(ads):
                    accFilters = AccountSettings._readSection(section, KEY_FILTERS)
                    for filterName, filterPickle in accFilters.items():
                        if filterName in ('inventory_vehicle', 'shop_current', 'inventory_current',
                                          'shop_tradeInVehicle', 'shop_restoreVehicle'):
            ...
            if currVersion < 34:
                import SoundGroups
                maxVolume = max(SoundGroups.g_instance.getVolume(category) for category in ('vehicles',
                                                                                            'ambient',
                                                                                            'voice',
                                                                                            'gui',
                                                                                            'effects',
            ...
            if currVersion < 38:
                for key, section in _filterAccountSection(ads):
                    ...
                    obsoleteKeys = ('questProgressShowsCount', 'trajectoryViewHintCounter',
                                    'siegeModeHintCounter')
            ...
            if currVersion < 75:
                for _, section in _filterAccountSection(ads):
                    ...
                    if WOT_PLUS in accSettings.keys():
                        ...
                        accSettings.write(WOT_PLUS, _pack(wotPlusSettings))
                    if 'shownWotPlusIntro' in accSettings.keys():
                        accSettings.write('shownWotPlusIntro', _pack(False))
            ...
            if currVersion < 89:
                ...
                for _, section in _filterAccountSection(ads):
                    ...
                    if WOT_PLUS in accSettings.keys():
                        wotPlusSettings = _unpack(accSettings[WOT_PLUS].asString)
                        wotPlusSettings.pop('isOnboardingShown', None)
                        accSettings.write(WOT_PLUS, _pack(wotPlusSettings))
                    if 'shownWotPlusIntro' in accSettings.keys():
                        accSettings.deleteSection('shownWotPlusIntro')
                        accSettings.deleteSection('optionalDevicesAssistantHintShown')

            if currVersion < 90:
                for key, section in _filterAccountSection(ads):
                    UISettings = AccountSettings._readSection(section, KEY_UI_FLAGS)
                    obsoleteKeys = ('comp7WeeklyQuestWidgetProgress', 'comp7WeeklyQuestInWidgetID',
                                    'comp7WeeklyQuestInWidgetState')
            ...
            if currVersion < 91:
                for key, section in _filterAccountSection(ads):
                    accSettings = AccountSettings._readSection(section, KEY_SETTINGS)
                    obsoleteKeys = ('comp7LightIntroShown', 'comp7LightProgressionPointsSeen')
                    for sectionName in obsoleteKeys:
                        if sectionName in accSettings.keys():
                            accSettings.deleteSection(sectionName)
            ...
            if currVersion < 95:
                ...
                for key, section in _filterAccountSection(ads):
                    ...
                    for filterKey in filtersSection.keys():
                        if filterKey in flFilters:
                            ...
                            if 'epicBattleSeason' in data:
                                data.pop('epicBattleSeason', None)
                ...
                for _, section in _filterAccountSection(ads):
                    ...
                    if NEW_SETTINGS_COUNTER in accSettings.keys():
                        ...
                        newSettingsCounters['ControlsSettings'].update({'specialAbility': True})
                        accSettings.write(NEW_SETTINGS_COUNTER, _pack(newSettingsCounters))
                    AccountSettings.clearKeyAndSetNewCommand('CMD_CM_SPECIAL_ABILITY', 'KEY_E')
                    CommandMapping.g_instance.restoreUserConfig()
                    bmKey = BattleMatters.BATTLE_MATTERS_SETTINGS
                    if bmKey in accSettings.keys():
                        bmAccSettings = _unpack(accSettings[bmKey].asString)
            ...
            if currVersion < 102:
                carouselFilters = (CAROUSEL_FILTER_2, RANKED_CAROUSEL_FILTER_2, EPICBATTLE_CAROUSEL_FILTER_2,
                 MAPBOX_CAROUSEL_FILTER_2, FUN_RANDOM_CAROUSEL_FILTER_2, COMP7_CAROUSEL_FILTER_2,
    ...
    def rebindKey(key, newCommand):
        ...
        for command, section in cmSection.items()[:]:
            ...
            if command == newCommand:
                ...
                newSection.writeString('fireKey', key)
            elif fireKey == key:
                cmSection.deleteSection(command)
                newSection = cmSection.createSection(command)
                newSection.writeString('fireKey', 'KEY_NONE')
