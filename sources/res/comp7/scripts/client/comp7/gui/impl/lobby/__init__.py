...
def registerComp7Lobby():
    ...
    from comp7.gui.prb_control.entities.pre_queue.actions_validator import Comp7TournamentValidator
    ...
    from gui.prb_control.entities.base.legacy.actions_validator import ARENA_GUI_TYPE_VALIDATORS
    ...
    ARENA_GUI_TYPE_VALIDATORS[tournamentGuiType] = Comp7TournamentValidator
