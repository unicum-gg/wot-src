...
class MuseumVehicleViewModel(ViewModel):
    __slots__ = ('onSelectVehicle', 'onBackToHangar', 'onMoveSpace', 'onStartMoving',
                 'onAudioCheckboxToggle', 'onExcursionPlay', 'onExcursionPause',
                 'onVehiclePlayTimeLog', 'onExcursionEnd')
