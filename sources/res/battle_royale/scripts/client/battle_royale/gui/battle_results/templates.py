...
_COMMON_VO_META = base.DictMeta({'arenaStr': '', 
   'userName': '', 
   'clanAbbrev': '', 
   'playerVehicles': [], 'playerPlace': 0, 
   'isSquadMode': False, 
   'vehicleStatus': {}, 'arenaBonusType': 0, 
   'hasPremium': False})
...
_PERSONAL_VO_META = base.DictMeta({'financialBalance': {}, 'financialBalancePrem': {}, 'stats': [], 'rewards': {}, 'battlePass': {}, 'dailyBonusFactor': 0})
...
_BATTLE_PASS_VO_META = base.PropertyMeta((('bpTopPoints', 0, 'bpTopPoints'), ))
