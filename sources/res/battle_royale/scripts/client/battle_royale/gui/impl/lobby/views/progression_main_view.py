...
class BattleRoyaleProgressionWindow(WindowImpl):
    ...
    def __init__(self, layer, **kwargs):
        super(BattleRoyaleProgressionWindow, self).__init__(content=BattleRoyaleProgressionMainView(R.views.battle_royale.mono.lobby.progression_main_view(), **kwargs), wndFlags=WindowFlags.WINDOW, layer=layer)
...
class BattleRoyaleProgressionMainView(ViewImpl):
    ...
    def createToolTipContent(self, event, contentID):
        ...
        if contentID == R.views.battle_royale.mono.lobby.tooltips.leaderboard_reward_tooltip_view():
