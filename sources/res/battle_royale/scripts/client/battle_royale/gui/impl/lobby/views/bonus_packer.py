...
class CurrenciesBonusUIPacker(SimpleBonusUIPacker):
    ...
    def _getContentId(cls, bonus):
        if bonus.getCode() == STP_COIN:
            return [R.views.battle_royale.mono.lobby.tooltips.proxy_currency_tooltip()]
        return super(CurrenciesBonusUIPacker, cls)._getContentId(bonus)
...
class BRTokenBonusUIPacker(TokenBonusUIPacker):
    ...
    def _getTokenBonusType(cls, tokenID, complexToken):
        ...
        return super(BRTokenBonusUIPacker, cls)._getTokenBonusType(tokenID, complexToken)
