...
_REWARDS_ORDER = (
 ...
 PREMIUM_ENTITLEMENTS.BASIC, 'goodies', 'crewBooks', 'freeXP', Currency.CREDITS, 'items', 'customizations',
 'slots', 'berths', 'blueprintsAny', BlueprintBonusTypes.BLUEPRINTS, 'tokens')
...
_ESSENTIAL_REWARDS = (
 Currency.GOLD, Currency.CREDITS, PREMIUM_ENTITLEMENTS.PLUS, PREMIUM_ENTITLEMENTS.BASIC, 'freeXP',
